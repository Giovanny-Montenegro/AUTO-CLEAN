  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_appointments_worktime" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_appointments_worktime_form();
	}
...
?>
  ...
  // ---------- Validate id_worktime_
  function do_ajax_form_appointments_worktime_validate_id_worktime_(iNumLinha)
  {
    var nomeCampo_id_worktime_ = "id_worktime_" + iNumLinha;
    var var_id_worktime_ = scAjaxGetFieldHidden(nomeCampo_id_worktime_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_worktime_validate_id_worktime_(var_id_worktime_, iNumLinha, var_script_case_init, do_ajax_form_appointments_worktime_validate_id_worktime__cb);
  } // do_ajax_form_appointments_worktime_validate_id_worktime_

  function do_ajax_form_appointments_worktime_validate_id_worktime__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "id_worktime_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_worktime_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "id_worktime_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "id_worktime_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_worktime_validate_id_worktime__cb

  // ---------- Validate worktime_time_
  function do_ajax_form_appointments_worktime_validate_worktime_time_(iNumLinha)
  {
    var nomeCampo_worktime_time_ = "worktime_time_" + iNumLinha;
    var var_worktime_time_ = scAjaxGetFieldText(nomeCampo_worktime_time_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_worktime_validate_worktime_time_(var_worktime_time_, iNumLinha, var_script_case_init, do_ajax_form_appointments_worktime_validate_worktime_time__cb);
  } // do_ajax_form_appointments_worktime_validate_worktime_time_

  function do_ajax_form_appointments_worktime_validate_worktime_time__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "worktime_time_" + iLineNumber;
    }
    else
    {
      sFieldValid = "worktime_time_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "worktime_time_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "worktime_time_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_worktime_validate_worktime_time__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_appointments_worktime_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_appointments_worktime_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_appointments_worktime_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_appointments_worktime_add_new_line_cb);
  } // do_ajax_form_appointments_worktime_add_new_line

  function do_ajax_form_appointments_worktime_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_appointments_worktime_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_appointments_worktime_backup_line(iNumLinha)
  {
    var var_id_worktime_ = scAjaxGetFieldHidden("id_worktime_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_worktime_backup_line(var_id_worktime_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_appointments_worktime_backup_line_cb);
  } // do_ajax_form_appointments_worktime_backup_line

  function do_ajax_form_appointments_worktime_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_appointments_worktime_backup_line_cb

  function do_ajax_form_appointments_worktime_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_appointments_worktime_cancel_insert

  function do_ajax_form_appointments_worktime_cancel_update(iSeqVert)
  {
    do_ajax_form_appointments_worktime_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_appointments_worktime_cancel_update

  function do_ajax_form_appointments_worktime_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_appointments_worktime_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_appointments_worktime_table_refresh()
  {
    var var_id_worktime_ = document.F2.id_worktime_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_appointments_worktime_table_refresh(var_id_worktime_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_appointments_worktime_table_refresh_cb);
  } //  do_ajax_form_appointments_worktime_table_refresh

  function do_ajax_form_appointments_worktime_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.id_worktime_.value = scAjaxGetKeyValue("id_worktime_");
    ...
    scAjaxAlert(do_ajax_form_appointments_worktime_table_refresh_cb_after_alert);
  } // do_ajax_form_appointments_worktime_table_refresh_cb
  function do_ajax_form_appointments_worktime_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_appointments_worktime_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_appointments_worktime_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_appointments_worktime_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_id_worktime_ = scAjaxGetFieldHidden("id_worktime_" + iNumLinha);
    var var_worktime_time_ = scAjaxGetFieldText("worktime_time_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_appointments_worktime_submit_form(var_id_worktime_, var_worktime_time_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_appointments_worktime_submit_form_cb);
  } // do_ajax_form_appointments_worktime_submit_form

  function do_ajax_form_appointments_worktime_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_worktime_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("worktime_time_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_appointments_worktime_submit_form_cb_after_alert);
  } // do_ajax_form_appointments_worktime_submit_form_cb
  function do_ajax_form_appointments_worktime_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_appointments_worktime_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_appointments_worktime_navigate_form()
  {
    perform_ajax_form_appointments_worktime_navigate_form();
  }

  function perform_ajax_form_appointments_worktime_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_appointments_worktime_cancel_insert(sc_form_appointments_worktime_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("id_worktime_" + iNavForm);
      scAjaxHideErrorDisplay("worktime_time_" + iNavForm);
    }
    var var_id_worktime_ = document.F2.id_worktime_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_appointments_worktime_navigate_form(var_id_worktime_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_appointments_worktime_navigate_form_cb);
  } // do_ajax_form_appointments_worktime_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments_worktime']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_appointments_worktime_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_worktime_.value = scAjaxGetKeyValue("id_worktime_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_appointments_worktime_navigate_form_cb_after_alert);
  } // do_ajax_form_appointments_worktime_navigate_form_cb
  function do_ajax_form_appointments_worktime_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_appointments_worktime_navigate_form_cb_after_alert

    function sc_form_appointments_worktime_get_last_line_number()
    {
    ...
    } //sc_form_appointments_worktime_get_last_line_number

  function sc_hide_form_appointments_worktime_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "id_worktime_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "worktime_time_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["id_worktime_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_appointments_worktime_fld_id_worktime'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["worktime_time_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_appointments_worktime_fld_worktime_time'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["id_worktime_"][iNumLinha] = "id_worktime_" + iNumLinha;
    ajax_field_mult["worktime_time_"][iNumLinha] = "worktime_time_" + iNumLinha;
    ajax_field_id["id_worktime_" + iNumLinha] = new Array("hidden_field_label_id_worktime_", "hidden_field_data_id_worktime_" + iNumLinha);
    ajax_field_id["worktime_time_" + iNumLinha] = new Array("hidden_field_label_worktime_time_", "hidden_field_data_worktime_time_" + iNumLinha);
    ajax_error_count["id_worktime_" + iNumLinha] = "off";
    ajax_error_count["worktime_time_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["id_worktime_" + iNumLinha] = "on";
    ajax_read_only["worktime_time_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["id_worktime_" + iNumLinha] = "on";
    ajax_read_only["worktime_time_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["id_worktime_" + iNumLinha] = null;
    ajax_error_list["worktime_time_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "id_worktime_": new Array(),
    "worktime_time_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["id_worktime_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_worktime_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_worktime_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_worktime_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_worktime_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["worktime_time_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["worktime_time_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["worktime_time_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["worktime_time_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["worktime_time_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_worktime_'])) ? $this->nmgp_cmp_readonly['id_worktime_'] : 'on';
?>
    scAjaxFieldRead("id_worktime_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['worktime_time_'])) ? $this->nmgp_cmp_readonly['worktime_time_'] : 'off';
?>
    scAjaxFieldRead("worktime_time_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("id_worktime_" + iSeq, "on");
    scAjaxFieldRead("worktime_time_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_worktime_" + iRow] || "on" == ajax_error_count["worktime_time_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_id_worktime_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_worktime_time_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_worktime_" + iRow] && "off" == ajax_error_count["worktime_time_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_worktime_" + iRow] = "off";
        ajax_error_count["worktime_time_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_id_worktime_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_worktime_time_" + iRow).removeClass("scFormErrorLine");
    }
  }
