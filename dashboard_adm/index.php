...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['dashboard_adm']['glo_nm_path_imag_temp'] . "/sc_apl_default_appointments1.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['dashboard_adm']['glo_nm_path_imag_temp'] . "/sc_apl_default_appointments1.txt"));
    }
    if (isset($apl_def)) {
        ...
        if (isset($_COOKIE['sc_actual_lang_appointments1'])) {
            $_SESSION['scriptcase']['dashboard_adm']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_appointments1'];
        }
    }
}
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['dashboard_adm']['glo_nm_conexao'], $this->root . $this->path_prod, 'appointments1', 1, $this->force_db_utf8); 
      } 
      else 
      { 
      ...
      if (in_array(strtolower($this->nm_tpbanco), $this->nm_bases_oracle))
      {
          ...
          $_SESSION['sc_session'][$this->sc_page]['dashboard_adm']['decimal_db'] = "."; 
      } 
  }

  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['dashboard_adm']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['dashboard_adm']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['dashboard_adm']['glo_nm_conexao'], $this->root . $this->path_prod, 'appointments1', 1, $this->force_db_utf8);
    }
    else {
...
class dashboard_adm_control {
    ...
    function init()
    {
        ...
        $_SESSION['scriptcase']['dashboard_scinit']['dashboard_adm']['dbifrm_widget5'] = rand(2, 10000);

        $_SESSION['scriptcase']['dashboard_toolbar']['dashboard_adm'] = array();

        $_SESSION['scriptcase']['dashboard_toolbar']['dashboard_adm']['grid_appointments_adm_dashboard'] = array(
            'form_update'     => true,
            'form_insert'     => true,
            'form_delete'     => true,
            'form_copy'       => true,
        ...
        $_SESSION['scriptcase']['dashboard_toolbar']['dashboard_adm']['chart_appointments_count'] = array(
            'form_update'     => true,
            'form_insert'     => true,
            'form_delete'     => true,
            'form_copy'       => true,
        ...
        $_SESSION['scriptcase']['dashboard_toolbar']['dashboard_adm']['chart_appointments_avg_rating'] = array(
            'form_update'     => true,
            'form_insert'     => true,
            'form_delete'     => true,
            'form_copy'       => true,
...
<div class='grid-stack'>
                <div  class="grid-stack-item" data-gs-x="3" data-gs-y="0" data-gs-width="9" data-gs-height="4"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-0">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-0">
                        <div class="widget-head" style="display:">
                            <h3 class="scContainerTitle"><?php echo $this->Ini->Nm_lang['lang_dash_title_1'] ?></h3>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-' id="id-div-iframe-0"><iframe id="id-iframe-0" name="dbifrm_widget2" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('grid_appointments_adm_dashboard'); ?>/?script_case_init=<?php echo $_SESSION["scriptcase"]["dashboard_scinit"]["dashboard_adm"]["dbifrm_widget2"] ?>&under_dashboard=1&dashboard_app=dashboard_adm&own_widget=dbifrm_widget2&compact_mode=1&remove_margin=1&remove_border=1" alt="5"></iframe></div>
                    </div>
                </div>
                <div  class="grid-stack-item" data-gs-x="0" data-gs-y="4" data-gs-width="6" data-gs-height="8"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-1">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-1">
                        <div class="widget-head" style="display:">
                            <h3 class="scContainerTitle"><?php echo $this->Ini->Nm_lang['lang_dash_title_2'] ?></h3>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-' id="id-div-iframe-1"><iframe id="id-iframe-1" name="dbifrm_widget3" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('chart_appointments_count'); ?>/?script_case_init=<?php echo $_SESSION["scriptcase"]["dashboard_scinit"]["dashboard_adm"]["dbifrm_widget3"] ?>&under_dashboard=1&dashboard_app=dashboard_adm&own_widget=dbifrm_widget3&compact_mode=1&remove_margin=0&remove_border=0"></iframe></div>
                    </div>
                </div>
                <div  class="grid-stack-item" data-gs-x="6" data-gs-y="4" data-gs-width="6" data-gs-height="8"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-2">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-2">
                        <div class="widget-head" style="display:">
                            <h3 class="scContainerTitle"><?php echo $this->Ini->Nm_lang['lang_dash_title_3'] ?></h3>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-' id="id-div-iframe-2"><iframe id="id-iframe-2" name="dbifrm_widget4" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('chart_appointments_avg_rating'); ?>/?script_case_init=<?php echo $_SESSION["scriptcase"]["dashboard_scinit"]["dashboard_adm"]["dbifrm_widget4"] ?>&under_dashboard=1&dashboard_app=dashboard_adm&own_widget=dbifrm_widget4&compact_mode=1&remove_margin=0&remove_border=0"></iframe></div>
                    </div>
                </div>
                <div  class="grid-stack-item" data-gs-x="0" data-gs-y="0" data-gs-width="3" data-gs-height="4"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-3">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-3">
                        <div class="widget-head" style="display:">
                            <h3 class="scContainerTitle"><?php echo $this->Ini->Nm_lang['lang_new_appointments'] ?></h3>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title- scContainerIndexMoldura scContainerIndexMoldura_widget5' style="height: 100%" id="id-div-iframe-3"><?php echo $this->getIndexContent_widget5(); ?></div>
                    </div>
                </div></div>
...
<?php
    ...
    function getIndexContentData_widget5() {
        ...
        {
            $sSql = "SELECT COUNT(appointments_id) FROM appointments WHERE (current_status_id = 1)";
        }
