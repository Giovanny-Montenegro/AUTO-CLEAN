<?php
   include_once('my_calendar_session.php');
   @ini_set('session.cookie_httponly', 1);
   @ini_set('session.use_only_cookies', 1);
   @ini_set('session.cookie_secure', 0);
   @session_start() ;
   $_SESSION['scriptcase']['my_calendar']['glo_nm_perfil']          = "conn_example";
   $_SESSION['scriptcase']['my_calendar']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['my_calendar']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['my_calendar']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['my_calendar']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['my_calendar']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['my_calendar']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['my_calendar']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['my_calendar']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['my_calendar']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['my_calendar']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['my_calendar']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['my_calendar']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['my_calendar']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['my_calendar']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['my_calendar']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['my_calendar']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class my_calendar_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['my_calendar']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "my_calendar"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['my_calendar']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['my_calendar']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['my_calendar']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['my_calendar']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['my_calendar']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['my_calendar']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['my_calendar']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['my_calendar']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['my_calendar']['save_session']['data'] = '';
      } 
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['my_calendar']['sub_cons_schema_all']))
      { 
         $this->str_schema_all    = $_SESSION['sc_session'][$this->sc_page]['my_calendar']['sub_cons_schema_all'];
         $this->str_schema_filter = $_SESSION['sc_session'][$this->sc_page]['my_calendar']['sub_cons_schema_filter'];
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/my_calendar';
      ...
      $_SESSION['sc_session'][$this->sc_page]['my_calendar']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['my_calendar']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['my_calendar']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['my_calendar']['actual_lang']) || $_SESSION['scriptcase']['my_calendar']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['my_calendar']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("my_calendar_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['my_calendar']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['my_calendar']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['my_calendar']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['my_calendar']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['my_calendar']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['my_calendar']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if(file_exists($out1_img_cache)){
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['my_calendar']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['my_calendar']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['my_calendar']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['my_calendar']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['my_calendar']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['my_calendar']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['my_calendar']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['my_calendar']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['my_calendar']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['my_calendar']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['my_calendar']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['my_calendar']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['my_calendar']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['my_calendar']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['my_calendar']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['my_calendar']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['my_calendar']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['my_calendar']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['my_calendar']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['my_calendar']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['my_calendar']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['my_calendar']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['my_calendar']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['my_calendar']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['my_calendar']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['my_calendar']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['my_calendar']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['my_calendar']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["my_calendar"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["my_calendar"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
        ...
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['my_calendar']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['my_calendar']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['my_calendar']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['my_calendar']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['my_calendar']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['my_calendar']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['my_calendar']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['my_calendar']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['my_calendar']['link_info']['remove_border'] = true;
        }

      if (!isset($_SESSION['sc_session'][$this->sc_page]['my_calendar']['responsive_chart']))
      {
          $_SESSION['sc_session'][$this->sc_page]['my_calendar']['responsive_chart'] = array(
              'enabled' => false,
              'active'  => false,
          );
      }
      if ($_SESSION['sc_session'][$this->sc_page]['my_calendar']['responsive_chart']['enabled'])
      {
          $_SESSION['sc_session'][$this->sc_page]['my_calendar']['responsive_chart']['active'] = true;
      }
      elseif ($_SESSION['sc_session'][$this->sc_page]['my_calendar']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->sc_page]['my_calendar']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->sc_page]['my_calendar']['dashboard_info']['maximized'])
      {
          $_SESSION['sc_session'][$this->sc_page]['my_calendar']['responsive_chart']['active'] = true;
      }
      else
      {
          $_SESSION['sc_session'][$this->sc_page]['my_calendar']['responsive_chart']['active'] = false;
      }
      if ($Tp_init == "Path_sub")
      {
          return;
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['my_calendar']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['my_calendar']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['my_calendar']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['my_calendar']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['my_calendar']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['my_calendar']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "my_calendar_erro.class.php"); 
      $this->Erro = new my_calendar_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('my_calendar'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['my_calendar']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['my_calendar']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['my_calendar']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['my_calendar']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['my_calendar']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['my_calendar']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['my_calendar']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['my_calendar']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['my_calendar']['glo_nm_conexao']) && $_SESSION['scriptcase']['my_calendar']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['my_calendar']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['my_calendar']['glo_nm_perfil']) && $_SESSION['scriptcase']['my_calendar']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['my_calendar']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['my_calendar']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['my_calendar']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['my_calendar']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['my_calendar']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['my_calendar']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['my_calendar']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['my_calendar']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['my_calendar']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['my_calendar']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['my_calendar']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['my_calendar']['embutida_init']) 
      {
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['my_calendar']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['my_calendar']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['my_calendar']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['my_calendar']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['my_calendar']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['my_calendar']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['my_calendar']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['my_calendar']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['my_calendar']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['my_calendar']['glo_nm_conexao'], $this->root . $this->path_prod, 'appointments1', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['my_calendar']['embutida']) || !$_SESSION['sc_session'][$this->sc_page]['my_calendar']['embutida'])
      {
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['my_calendar']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['my_calendar']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['my_calendar']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['my_calendar']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['my_calendar']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['my_calendar']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['my_calendar']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['my_calendar']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new my_calendar_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['my_calendar']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['my_calendar']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['my_calendar']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['my_calendar'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['my_calendar']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['my_calendar']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('my_calendar') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['my_calendar']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['my_calendar']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['my_calendar']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['my_calendar']['exit'];
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "my_calendar_erro.class.php"); 
      $this->Erro      = new my_calendar_erro();
      $this->Erro->Ini = $this->Ini;
//
      header("X-XSS-Protection: 1; mode=block");
      header("X-Frame-Options: SAMEORIGIN");
      $_SESSION['scriptcase']['my_calendar']['contr_erro'] = 'on';
 echo "<script>
   
   var sc_pathToTB = '" . $this->Ini->path_prod . "/third/jquery_plugin/thickbox/'; /* VAR com path do thickbox*/
   ...
   $(document).ready(function() {
      ...
      $('#calendar').fullCalendar({
         ...
         buttonText: {
            ...
            month: '<?php echo$this->Ini->Nm_lang['lang_per_month']; ?>' , 
		...
		events: {
         ...
         dayClick: function(date, allDay, jsEvent, view) {
			...
			if( hoje > diaClicado )
			{
				 alert('<?php echo$this->Ini->Nm_lang['lang_schedule_not_allowed']; ?>');
			}
			else
			{
				tb_show('', '../form_appointments/form_appointments.php?par_controle=0&diaClicado='+diaClicado+'&HoraIni='+HoraIni+'&sc_cal_click_date=&nmgp_outra_jan=true&nmgp_opcao=igual&nmgp_url_saida=modal&TB_iframe=true&height=550&width=800&modal=true', '');
		...
		dayRender: function(date, cell){
         ...
         eventClick: function(calEvent, jsEvent, view) {            
            ...
            tb_show('', '../form_appointments/form_appointments.php?appointments_id='+idevento+'&sc_cal_click_date=&nmgp_outra_jan=true&nmgp_url_saida=modal&TB_iframe=false&modal=false&height=550&width=800', '');
...
<form id='f_opts'>
<div id='menu-options'>	
  <input id="toggle1" type="checkbox" name="opt_status" onclick="calendar_reload();" value="1" checked>
  <label for="toggle1"><?php echo $this->Ini->Nm_lang['lang_awaiting']; ?></label>

  <input id="toggle2" type="checkbox" name="opt_status" onclick="calendar_reload();" value="2" checked>
  <label for="toggle2"><?php echo $this->Ini->Nm_lang['lang_scheduled']; ?></label>

  <input id="toggle3" type="checkbox" name="opt_status" onclick="calendar_reload();" value="3" checked>
  <label for="toggle3"><?php echo $this->Ini->Nm_lang['lang_canceled']; ?></label>
  
  <input id="toggle4" type="checkbox" name="opt_status" onclick="calendar_reload();" value="4" checked>
  <label for="toggle4"><?php echo $this->Ini->Nm_lang['lang_checkin']; ?></label>
	
  <input id="toggle5" type="checkbox" name="opt_status" onclick="calendar_reload();" value="5" checked>
  <label for="toggle5"><?php echo $this->Ini->Nm_lang['lang_concluded']; ?></label>
</div>
</form>
...
$_SESSION['scriptcase']['my_calendar']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
       if ($this->Change_Menu)
       {
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_my_calendar($nmgp_val);
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['my_calendar']['glo_nm_path_imag_temp'] . "/sc_apl_default_appointments1.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['my_calendar']['glo_nm_path_imag_temp'] . "/sc_apl_default_appointments1.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "my_calendar") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['my_calendar']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['my_calendar']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['my_calendar']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_appointments1'])) {
               $_SESSION['scriptcase']['my_calendar']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_appointments1'];
           }
       }
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['my_calendar']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['my_calendar']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['my_calendar']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "my_calendar";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'my_calendar' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['my_calendar']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['my_calendar']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['my_calendar']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['my_calendar']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['my_calendar']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('my_calendar' == $sReferer || 'my_calendar_' == substr($sReferer, 0, 12))
       {
           $_SESSION['sc_session'][$script_case_init]['my_calendar']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['my_calendar']['session_timeout']['lang'])) {
       $STR_lang = $_SESSION['scriptcase']['my_calendar']['session_timeout']['lang'];
   }
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'my_calendar')
   {
       $_SESSION['sc_session'][$script_case_init]['my_calendar']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['my_calendar']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/my_calendar_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_my_calendar($cadapar[1]);
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0;  
       ...
       { 
           $_SESSION['scriptcase']['sc_apl_seg']['my_calendar'] = "on";
       } 
       if (!$_SESSION['sc_session'][$script_case_init]['my_calendar']['opc_psq'] && !isset($_SESSION['scriptcase']['my_calendar']['session_timeout']['redir'])) 
       { 
          if (!isset($_SESSION['scriptcase']['sc_apl_seg']['my_calendar']) || $_SESSION['scriptcase']['sc_apl_seg']['my_calendar'] != "on")
          { 
              $NM_Mens_Erro = $Nm_lang['lang_errm_unth_user'];
              $nm_botao_ok = ($_SESSION['sc_session'][$script_case_init]['my_calendar']['iframe_menu']) ? false : true;
              if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
              {
                  foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
                  {
                      if (in_array("my_calendar", $apls_aba))
                      {
                          $nm_botao_ok = false;
                           break;
                      }
...
<?php
   ...
   $contr_my_calendar = new my_calendar_apl();
   $contr_my_calendar->controle();
//
   function nm_limpa_str_my_calendar(&$str)
   {
   }
?>
