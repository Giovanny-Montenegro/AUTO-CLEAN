...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["appointments1_____tabs_appointments"]))
   {
      unset($_SESSION['session_sec_aplicacao']["appointments1_____tabs_appointments"]);
   }
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']['tabs_appointments']))
   {
       unset($_SESSION['scriptcase']['sc_aba_iframe']['tabs_appointments']);
   }
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['tabs_appointments']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['tabs_appointments']['sc_outra_jan'])
   {
       $fecha_janela = true;
   }
   $fecha_modal = false;
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['tabs_appointments']['aba_saida']) && $_SESSION['sc_session'][$script_case_init]['tabs_appointments']['aba_saida'] == "modal")
   {
       unset($_SESSION['sc_session'][$script_case_init]['tabs_appointments']['aba_saida']);
       $fecha_modal = true;
   }
