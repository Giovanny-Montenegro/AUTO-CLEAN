...
SCEOT;
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['pivot_y_axys']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['pivot_y_axys']))
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['chart_combination_type']        = 'combination3d';
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['comb_field_display_type'][3] = '';

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['chart_display_values'][2] = null;
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['chart_display_values'][3] = null;


           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['summarizing_fields_order']['sc_free_group_by'][] = 2;
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['summarizing_fields_order']['sc_free_group_by'][] = 3;
       }
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['tot_geral'][1];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['tot_geral'][2];
   ...
   function buildChart()
   {
	...
	function filterChartsByGroupbyLevel() {
		...
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['pivot_orig'];
		...
		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['chart_level']) {
   ...
   function drawMatrix()
   {
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['doc_word'])
{
      ...
      { 
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['ajax_nav']) {  
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['dashboard_info']['remove_margin'] ? 'margin: 0;' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['dashboard_info']['remove_border'] ? 'border-width: 0;' : '';
          $vertical_center = '';
      ...
      $nm_saida->saida("function scChartImageExportShow(exportType) {\r\n");
          $nm_saida->saida("  scShowCombinationImage(" . count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['Labels_GB']) . ", exportType, '');\r\n");
      $nm_saida->saida("}\r\n");
...
;
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "chart_appointments_count/chart_appointments_count_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_opc=resumo&nm_cor=PB&nm_res_cons=s&nm_ini_prt_res=&nm_all_modules=chart&password=n&origem=chart&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['chart_appointments_count']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['chart_appointments_count']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'chart_appointments_count_config_pivot.php?nome_apl=chart_appointments_count&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("   }\r\n");
          ...
          $nm_saida->saida("               document.Fprint.action = \"chart_appointments_count_export_ctrl.php\";\r\n");
          $nm_saida->saida("           }\r\n");
          $nm_saida->saida("           else\r\n");
          $nm_saida->saida("           {\r\n");
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_total_price, $quebra_appointment_start_date, $quebra_current_status_id, $quebra_appointment_start_date_orig, $quebra_current_status_id_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->total_price, $this->appointment_start_date, $this->current_status_id, $this->appointment_start_date_orig,  $this->current_status_id_orig);
            }
   }
//
