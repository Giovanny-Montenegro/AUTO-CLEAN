...
// 
    ...
    $out1_img_cache = $_SESSION['scriptcase']['chart_appointments_count']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['chart_appointments_count']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['chart_appointments_count']['glo_nm_conexao'], $this->root . $this->path_prod, 'appointments1', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if (!$this->Ini || isset($_SESSION['sc_session'][$script_case_init]['chart_appointments_count']['embutida_ibase'])) 
      { 
          $this->Ini = new chart_appointments_count_ini(); 
          $this->Ini->init();
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['embutida'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['embutida_ibase'] = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['summarizing_fields_display']['sc_free_group_by'][3]['display'] = true;
      ...
      $_SESSION['sc_session'][$script_case_init]['chart_appointments_count']['skip_charts'] = (strpos(" " . $this->Ini->SC_module_export, "chart") !== false) ? false : true;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['conf_chart_level'] = "S";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['proc_pdf'] = (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['embutida'] && ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['opcao'] == "pdf_res")) ? true : false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['proc_pdf']) {
          $_SESSION['scriptcase']['proc_mobile'] = false;
      } 
...
//
      ...
      { 
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['where_orig'] = " where current_status_id <> 3";
...
//----------------------------------->
      ...
      {
          if (!isset($_SESSION['scriptcase']['chart_export_file']['chart_appointments_count']) || !isset($_SESSION['scriptcase']['chart_export_file']['chart_appointments_count'][ $_REQUEST['chart_file_md5'] ]))
          {
              echo 'error_file_not_found';
          }
          else
          {
              echo $this->Ini->path_imag_temp . '/' . $_SESSION['scriptcase']['chart_export_file']['chart_appointments_count'][ $_REQUEST['chart_file_md5'] ]['name'];
          }
          exit;
      }
      else
      if ($nmgp_opcao == "ajax_comb_file_download")
      {
          ...
          {
              $filename = $_SESSION['scriptcase']['chart_export_file']['chart_appointments_count'][ $_REQUEST['chart_file_md5'] ]['name'];
              $path     = $_SESSION['scriptcase']['chart_export_file']['chart_appointments_count'][ $_REQUEST['chart_file_md5'] ]['dir'] . $filename;
...
<?php
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['embutida'])
      {
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            elseif (is_dir($this->Ini->path_third . $dir_qpdf) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['use_pass_pdf']))
            {
            ...
            if ($this->pdf_zip == "S")
            {
                $pdf_pass = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['use_pass_pdf'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['use_pass_pdf'] : "";
            ...
            elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['use_pass_pdf']))
            {
                if (FALSE !== strpos(strtolower(php_uname()), 'windows')) 
                {
                    $dir_qpdf = "/qpdf/win/bin";
                ...
                if (is_dir($this->Ini->path_third . $dir_qpdf)) 
                {
                    ...
                    $pdf_pass  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['use_pass_pdf'];
...
SCEOT;
    ...
    {
        $jsonData = $this->outputCombinationJsonRow($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count'][$tableData], 0, $tableDef);
...
/* mantis 0019720  */
            ...
            foreach ($data['values'] as $index => $value) {
                $thisMetric = array(
                    'field' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count'][$tableDef]['field'][$index],
                    'value' => $this->outputCombinationJsonProtectNumber($value)
                );

                if ($this->jsonShowFormatted) {
                	$thisMetric['formatted'] = $this->outputCombinationJsonProtectNumber(chart_appointments_count_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count'][$tableDef]['summ'][$index], $value));
                }
                if ($this->jsonShowLabel) {
                	$thisMetric['label'] = $this->outputCombinationJsonProtectText($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count'][$tableDef]['label'][$index]);
                }
	...
	function outputCombinationXmlContent($tableDef, $tableData) {
		return "<?xml version=\"1.0\" encoding=\"{$_SESSION['scriptcase']['charset']}\" ?>\r\n" .
		       "<chart_appointments_count>\r\n" .
		       $this->outputCombinationXmlRow($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count'][$tableData], 0, $tableDef) .
		       "</chart_appointments_count>";
	...
	function outputCombinationXmlRow($rows, $level, $tableDef) {
		...
		foreach ($rows as $data) {
			...
			foreach ($data['values'] as $index => $value) {
				$aggregateLabelTag = $this->xmlLabel ? $this->outputCombinationXmlProtectTag($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count'][$tableDef]['label'][$index]) : $_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count'][$tableDef]['field'][$index];

				if ($this->xmlDisplayAsAttributes) {
					$outputData .= "<aggregate_{$aggregateLabelTag} label=\"" . $this->outputCombinationXmlProtectText($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count'][$tableDef]['label'][$index]) . "\" value=\"" . $this->outputCombinationXmlProtectNumber(chart_appointments_count_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count'][$tableDef]['summ'][$index], $value)) . "\" />\r\n";
				} else {
					$outputData .= "<aggregate_{$aggregateLabelTag}>\r\n";
					$outputData .= "<label>" . $this->outputCombinationXmlProtectText($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count'][$tableDef]['label'][$index]) . "</label>\r\n";
					$outputData .= "<value>" . $this->outputCombinationXmlProtectNumber(chart_appointments_count_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count'][$tableDef]['summ'][$index], $value)) . "</value>\r\n";
					$outputData .= "</aggregate_{$aggregateLabelTag}>\r\n";
				}
			}
	...
	function outputCombinationCsvContent($tableDef, $tableData) {
        $hasChildren = $this->outputCombinationHasChildren($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count'][$tableData]);

		if ($this->csvHeader) {
			return $this->outputCombinationCsvHeader($tableDef, $hasChildren) .
			       $this->outputCombinationCsvRow($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count'][$tableData], 0, array(), $tableDef, count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['pivot_y_axys']), $hasChildren);
		} else {
			return $this->outputCombinationCsvRow($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count'][$tableData], 0, array(), $tableDef, count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['pivot_y_axys']), $hasChildren);
		}
	...
	function outputCombinationCsvHeader($tableDef, $hasChildren) {
		...
		if ($hasChildren) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['pivot_group_by'] as $groupByName) {
				$headers[] = $groupByName;
			}
		}
		else {
			$headers[] = current($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['pivot_group_by']);
		}

		foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count'][$tableDef]['label'] as $summName) {
			$headers[] = $summName;
		}
	...
	function outputCombinationCsvRow($rows, $level, $parameters, $tableDef, $totalDepth, $hasChildren) {
		...
		foreach ($rows as $data) {
			...
			foreach ($data['values'] as $index => $value) {
				$thisRow[] = $this->outputCombinationCsvProtectNumber(chart_appointments_count_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count'][$tableDef]['summ'][$index], $value));
			}
	...
	function outputCombinationRtfContent($tableDef, $tableData) {
		...
		return "<?xml version=\"1.0\" encoding=\"UTF-8\" ?>\r\n" .
		       ...
		       $this->outputCombinationRtfRow($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count'][$tableData], 0, array(), $tableDef, count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['pivot_y_axys']), $hasChildren) .
			   "</table>\r\n" .
		       "</DOC>\r\n";
	...
	function outputCombinationRtfHeader($tableDef, $hasChildren) {
		...
		if ($hasChildren) {
			...
			$headers .= "<td>" . current($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['pivot_group_by']) . "</td>\r\n";
		}
	...
	function outputCombinationRtfRow($rows, $level, $parameters, $tableDef, $totalDepth, $hasChildren) {
		...
		foreach ($rows as $data) {
			...
			foreach ($data['values'] as $index => $value) {
				$outputData .= "<td>" . $this->outputCombinationRtfProtectNumber(chart_appointments_count_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count'][$tableDef]['summ'][$index], $value)) . "</td>\r\n";
			}
	...
	function outputCombinationXlsContent($tableDef, $tableData) {
		...
		$this->outputCombinationXlsRow($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count'][$tableData], 0, array(), $tableDef, count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['pivot_y_axys']), $hasChildren);
	...
	function outputCombinationXlsHeader($tableDef, $hasChildren) {
		...
		if ($hasChildren) {
			...
			$this->addXlsCell(array(
				'col'     => $column++,
				'row'     => $this->thisRow,
				'content' => current($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['pivot_group_by']),
				'size'    => 'auto',
				'bold'    => true,
				'align'   => 'left'
			));
		...
		foreach ($rows as $data) {
			...
			foreach ($data['values'] as $index => $value) {
				$this->addXlsCell(array(
					'col'     => $column++,
					'row'     => $this->thisRow,
					'content' => $this->outputCombinationXlsProtectNumber(chart_appointments_count_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count'][$tableDef]['summ'][$index], $value)),
					'align'   => 'right'
				));
			}
    ...
    {
        $_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['chart_export_word_css'] = isset($_POST['export_chart_bw']) && 'Y' == $_POST['export_chart_bw'] ? 'bw' : 'color';

        if (isset($_REQUEST['nmgp_cor_word'])) {
            if ('pb' == $_REQUEST['nmgp_cor_word']) {
                $_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['chart_export_word_css'] = 'bw';
            } elseif ('co' == $_REQUEST['nmgp_cor_word']) {
                $_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['chart_export_word_css'] = 'color';
            }
        }
    }
	...
	function outputCombinationWordContent($tableDef, $tableData) {
		...
		return "<html xmlns:o=\"urn:schemas-microsoft-com:office:office\" xmlns:x=\"urn:schemas-microsoft-com:office:word\" xmlns=\"http://www.w3.org/TR/REC-html40\"{$_SESSION['scriptcase']['reg_conf']['html_dir']}>\r\n" .
		       ...
		       $this->outputCombinationWordRow($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count'][$tableData], 0, array(), $tableDef, count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['pivot_y_axys']), $hasChildren) .
		       "</table>\r\n" .
		       "</body>\r\n" .
		       "</html>\r\n";
	...
	function outputCombinationWordCss() {
		if ('bw' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['chart_export_word_css']) {
			$cssFile    = "{$this->Ini->str_schema_all}_grid_bw.css";
			$cssDirFile = "{$this->Ini->str_schema_all}_grid_bw{$_SESSION['scriptcase']['reg_conf']['css_dir']}.css";
		}
		else {
	...
	function outputCombinationWordHeader($tableDef, $hasChildren) {
		...
		if ($hasChildren) {
			...
			$headers .= "<td class=\"scGridLabelFont\">" . current($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count']['pivot_group_by']) . "</td>\r\n";
		}
	...
	function outputCombinationWordRow($rows, $level, $parameters, $tableDef, $totalDepth, $hasChildren) {
		...
		foreach ($rows as $data) {
			...
			foreach ($data['values'] as $index => $value) {
				$outputData .= "<td class=\"scGridFieldOdd scGridFieldOddFont\">" . $this->outputCombinationWordProtectNumber(chart_appointments_count_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['chart_appointments_count'][$tableDef]['summ'][$index], $value)) . "</td>\r\n";
			}
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['chart_appointments_count']['glo_nm_path_imag_temp'] . "/sc_apl_default_appointments1.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['chart_appointments_count']['glo_nm_path_imag_temp'] . "/sc_apl_default_appointments1.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_appointments1'])) {
               $_SESSION['scriptcase']['chart_appointments_count']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_appointments1'];
           }
       }
   }
   ...
   if (isset($_SESSION['scriptcase']['chart_appointments_count']['session_timeout']['lang'])) {
       $STR_lang = $_SESSION['scriptcase']['chart_appointments_count']['session_timeout']['lang'];
   }
   $STR_schema_all = (isset($_SESSION['scriptcase']['str_schema_all']) && !empty($_SESSION['scriptcase']['str_schema_all'])) ? $_SESSION['scriptcase']['str_schema_all'] : "Sc9_SweetBlue/Sc9_SweetBlue";
...
// 
       ...
       { 
           $_SESSION['scriptcase']['sc_apl_seg']['chart_appointments_count'] = "on";
       } 
       if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
       { 
           $_SESSION['scriptcase']['sc_apl_seg']['chart_appointments_count'] = "on";
       } 
       if (!$_SESSION['sc_session'][$script_case_init]['chart_appointments_count']['opc_psq'] && !isset($_SESSION['scriptcase']['chart_appointments_count']['session_timeout']['redir'])) 
       { 
          if (!isset($_SESSION['scriptcase']['sc_apl_seg']['chart_appointments_count']) || $_SESSION['scriptcase']['sc_apl_seg']['chart_appointments_count'] != "on")
          { 
              $NM_Mens_Erro = $Nm_lang['lang_errm_unth_user'];
              $nm_botao_ok = ($_SESSION['sc_session'][$script_case_init]['chart_appointments_count']['iframe_menu']) ? false : true;
              ...
              if ((isset($_SESSION['sc_session'][$script_case_init]['chart_appointments_count']['embutida']) && $_SESSION['sc_session'][$script_case_init]['chart_appointments_count']['embutida']) || (isset($_SESSION['sc_session'][$script_case_init]['chart_appointments_count']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['chart_appointments_count']['embutida_form']))
              {
                   $nm_botao_ok = false;
              }
