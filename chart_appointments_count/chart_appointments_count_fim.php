...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["appointments1_____chart_appointments_count"]))
   {
      unset($_SESSION['session_sec_aplicacao']["appointments1_____chart_appointments_count"]);
   }
