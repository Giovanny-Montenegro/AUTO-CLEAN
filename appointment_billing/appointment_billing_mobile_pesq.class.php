...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "a.appointment_start_date";$Nm_datas[] = "a_appointment_start_date";$Nm_datas[] = "due_date";$Nm_numeric[] = "a_appointments_id";$Nm_numeric[] = "a_price";$Nm_numeric[] = "a_additional_charges";$Nm_numeric[] = "a_discount";$Nm_numeric[] = "a_total_price";$Nm_numeric[] = "";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_a_appointments_id_cond" name="a_appointments_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_a_appointments_id'), this, 'a_appointments_id')">
      ...
      <br><span id="id_hide_a_appointments_id"  <?php echo $str_hide_a_appointments_id?>><?php
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-a_appointments_id" id="id_ac_a_appointments_id" name="a_appointments_id_autocomp"><?php if ('' !=  $a_appointments_id) { ?><option value="<?php echo $a_appointments_id ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_a_appointments_id"  <?php echo $str_display_a_appointments_id; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_a_appointments_id_input_2" name="a_appointments_id_input_2" value="<?php echo NM_encode_input($a_appointments_id_input_2) ?>"  size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_a_appointment_start_date_cond" name="a_appointment_start_date_cond" onChange="nm_campos_between(document.getElementById('id_vis_a_appointment_start_date'), this, 'a_appointment_start_date')">
      ...
      <br><span id="id_hide_a_appointment_start_date"  <?php echo $str_hide_a_appointment_start_date?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
?>
 ...
 <br><?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_a_appointment_start_date"  <?php echo $str_display_a_appointment_start_date; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?> 
         <BR>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_c_customers_name_cond" name="c_customers_name_cond" onChange="nm_campos_between(document.getElementById('id_vis_c_customers_name'), this, 'c_customers_name')">
      ...
      <br><span id="id_hide_c_customers_name"  <?php echo $str_hide_c_customers_name?>><?php
      if ($c_customers_name != "")
      {
      $c_customers_name_look = (is_string($c_customers_name) ? substr($this->Db->qstr($c_customers_name), 1, -1) : $c_customers_name); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_c_customers_address_cond" name="c_customers_address_cond" onChange="nm_campos_between(document.getElementById('id_vis_c_customers_address'), this, 'c_customers_address')">
      ...
      <br><span id="id_hide_c_customers_address"  <?php echo $str_hide_c_customers_address?>><?php
