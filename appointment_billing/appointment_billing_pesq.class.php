...
class appointment_billing_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . appointment_billing_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . appointment_billing_pack_protect_string($Tipo_filter[0]) . "\">.." . appointment_billing_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_a_appointments_id')
      {
          $a_appointments_id = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_a_appointments_id($a_appointments_id);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_c_customers_name')
      {
          $c_customers_name = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_c_customers_name($c_customers_name);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_c_customers_address')
      {
          $c_customers_address = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_c_customers_address($c_customers_address);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_a_appointments_id($a_appointments_id)
   {
      $a_appointments_id = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $a_appointments_id);
      $a_appointments_id = substr($this->Db->qstr($a_appointments_id), 1, -1);
            $a_appointments_id_look = (is_string($a_appointments_id) ? substr($this->Db->qstr($a_appointments_id), 1, -1) : $a_appointments_id); 
      $nmgp_def_dados = array(); 
      if (isset($this->Ini->nm_bases_postgres) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct a.appointments_id from " . $this->Ini->nm_tabela . " where (a.appointments_id = " . $_SESSION['var_appointment_id'] . ") and   CAST (a.appointments_id AS TEXT)  like '%" . $a_appointments_id . "%' order by a.appointments_id"; 
      }
      elseif (isset($this->Ini->nm_bases_sybase) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct a.appointments_id from " . $this->Ini->nm_tabela . " where (a.appointments_id = " . $_SESSION['var_appointment_id'] . ") and   CAST (a.appointments_id AS VARCHAR)  like '%" . $a_appointments_id . "%' order by a.appointments_id"; 
      }
      else
      {
          $nm_comando = "select distinct a.appointments_id from " . $this->Ini->nm_tabela . " where (a.appointments_id = " . $_SESSION['var_appointment_id'] . ") and  a.appointments_id like '%" . $a_appointments_id . "%' order by a.appointments_id"; 
      }
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_c_customers_name($c_customers_name)
   {
      $c_customers_name = substr($this->Db->qstr($c_customers_name), 1, -1);
            $c_customers_name_look = (is_string($c_customers_name) ? substr($this->Db->qstr($c_customers_name), 1, -1) : $c_customers_name); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct c.customers_name from " . $this->Ini->nm_tabela . " where (a.appointments_id = " . $_SESSION['var_appointment_id'] . ") and  c.customers_name like '%" . $c_customers_name . "%' order by c.customers_name"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_c_customers_address($c_customers_address)
   {
      $c_customers_address = substr($this->Db->qstr($c_customers_address), 1, -1);
            $c_customers_address_look = (is_string($c_customers_address) ? substr($this->Db->qstr($c_customers_address), 1, -1) : $c_customers_address); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct c.customers_address from " . $this->Ini->nm_tabela . " where (a.appointments_id = " . $_SESSION['var_appointment_id'] . ") and  c.customers_address like '%" . $c_customers_address . "%' order by c.customers_address"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "a_appointments_id";$Nm_numeric[] = "a_price";$Nm_numeric[] = "a_additional_charges";$Nm_numeric[] = "a_discount";$Nm_numeric[] = "a_total_price";$Nm_numeric[] = "";
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      $Nm_datas[] = "a.appointment_start_date";$Nm_datas[] = "a_appointment_start_date";$Nm_datas[] = "due_date";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>appointment_billing/appointment_billing_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="appointment_billing_ajax_search.js"></script>
 <script type="text/javascript" src="appointment_billing_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="appointment_billing_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['appointment_billing']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['appointment_billing']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_a_appointments_id_cond#NMF#' + search_get_sel_txt('SC_a_appointments_id_cond') + '@NMF@';
  str_out += 'SC_a_appointments_id#NMF#' + search_get_text('SC_a_appointments_id') + '@NMF@';
  str_out += 'id_ac_a_appointments_id#NMF#' + search_get_title('select2-id_ac_a_appointments_id-container') + '@NMF@';
  str_out += 'SC_a_appointments_id_input_2#NMF#' + search_get_text('SC_a_appointments_id_input_2') + '@NMF@';
  str_out += 'SC_a_appointment_start_date_cond#NMF#' + search_get_sel_txt('SC_a_appointment_start_date_cond') + '@NMF@';
  str_out += 'SC_a_appointment_start_date_dia#NMF#' + search_get_sel_txt('SC_a_appointment_start_date_dia') + '@NMF@';
  str_out += 'SC_a_appointment_start_date_mes#NMF#' + search_get_sel_txt('SC_a_appointment_start_date_mes') + '@NMF@';
  str_out += 'SC_a_appointment_start_date_ano#NMF#' + search_get_sel_txt('SC_a_appointment_start_date_ano') + '@NMF@';
  str_out += 'SC_a_appointment_start_date_input_2_dia#NMF#' + search_get_sel_txt('SC_a_appointment_start_date_input_2_dia') + '@NMF@';
  str_out += 'SC_a_appointment_start_date_input_2_mes#NMF#' + search_get_sel_txt('SC_a_appointment_start_date_input_2_mes') + '@NMF@';
  str_out += 'SC_a_appointment_start_date_input_2_ano#NMF#' + search_get_sel_txt('SC_a_appointment_start_date_input_2_ano') + '@NMF@';
  str_out += 'SC_c_customers_name_cond#NMF#' + search_get_sel_txt('SC_c_customers_name_cond') + '@NMF@';
  str_out += 'SC_c_customers_name#NMF#' + search_get_text('SC_c_customers_name') + '@NMF@';
  str_out += 'id_ac_c_customers_name#NMF#' + search_get_title('select2-id_ac_c_customers_name-container') + '@NMF@';
  str_out += 'SC_c_customers_address_cond#NMF#' + search_get_sel_txt('SC_c_customers_address_cond') + '@NMF@';
  str_out += 'SC_c_customers_address#NMF#' + search_get_text('SC_c_customers_address') + '@NMF@';
  str_out += 'id_ac_c_customers_address#NMF#' + search_get_title('select2-id_ac_c_customers_address-container') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-a_appointments_id").on("focus", function() {
  }).on("blur", function() {
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      ...
      nmgp_parms: "NM_ajax_opcao?#?autocomp_a_appointments_id",
      max_itens: "10",
   ...
   $("#SC_a_appointments_id").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-c_customers_name").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_c_customers_name",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_c_customers_name").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-c_customers_address").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_c_customers_address",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_c_customers_address").val(e.params.data.id);
  });
 });
</script>
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $a_appointments_id_cond, $a_appointments_id, $a_appointments_id_input_2, $a_appointments_id_autocomp,
             $a_appointment_start_date_cond, $a_appointment_start_date, $a_appointment_start_date_dia, $a_appointment_start_date_mes, $a_appointment_start_date_ano, $a_appointment_start_date_input_2_dia, $a_appointment_start_date_input_2_mes, $a_appointment_start_date_input_2_ano,
             $c_customers_name_cond, $c_customers_name, $c_customers_name_autocomp,
             $c_customers_address_cond, $c_customers_address, $c_customers_address_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $a_appointments_id = $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['campos_busca']['a_appointments_id']; 
          $a_appointments_id_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['campos_busca']['a_appointments_id_input_2']; 
          $a_appointments_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['campos_busca']['a_appointments_id_cond']; 
          $a_appointment_start_date_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['campos_busca']['a_appointment_start_date_dia']; 
          $a_appointment_start_date_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['campos_busca']['a_appointment_start_date_mes']; 
          $a_appointment_start_date_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['campos_busca']['a_appointment_start_date_ano']; 
          $a_appointment_start_date_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['campos_busca']['a_appointment_start_date_input_2_dia']; 
          $a_appointment_start_date_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['campos_busca']['a_appointment_start_date_input_2_mes']; 
          $a_appointment_start_date_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['campos_busca']['a_appointment_start_date_input_2_ano']; 
          $a_appointment_start_date_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['campos_busca']['a_appointment_start_date_cond']; 
          $c_customers_name = $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['campos_busca']['c_customers_name']; 
          $c_customers_name_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['campos_busca']['c_customers_name_cond']; 
          $c_customers_address = $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['campos_busca']['c_customers_address']; 
          $c_customers_address_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['campos_busca']['c_customers_address_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['campos_busca']['NM_operador']; 
      } 
      if (!isset($a_appointments_id_cond) || empty($a_appointments_id_cond))
      {
         $a_appointments_id_cond = "gt";
      }
      if (!isset($a_appointment_start_date_cond) || empty($a_appointment_start_date_cond))
      {
         $a_appointment_start_date_cond = "eq";
      }
      if (!isset($c_customers_name_cond) || empty($c_customers_name_cond))
      {
         $c_customers_name_cond = "qp";
      }
      if (!isset($c_customers_address_cond) || empty($c_customers_address_cond))
      {
         $c_customers_address_cond = "qp";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_a_appointments_id = (in_array($a_appointments_id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_a_appointment_start_date = (in_array($a_appointment_start_date_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_c_customers_name = (in_array($c_customers_name_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_c_customers_address = (in_array($c_customers_address_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_a_appointments_id = ('bw' == $a_appointments_id_cond) ? $display_aberto : $display_fechado;
      $str_display_a_appointment_start_date = ('bw' == $a_appointment_start_date_cond) ? $display_aberto : $display_fechado;
      $str_display_c_customers_name = ('bw' == $c_customers_name_cond) ? $display_aberto : $display_fechado;
      $str_display_c_customers_address = ('bw' == $c_customers_address_cond) ? $display_aberto : $display_fechado;

      if (!isset($a_appointments_id) || $a_appointments_id == "")
      {
          $a_appointments_id = "";
      }
      if (isset($a_appointments_id) && !empty($a_appointments_id))
      {
         $tmp_pos = (is_string($a_appointments_id)) ? strpos($a_appointments_id, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $a_appointments_id = substr($a_appointments_id, 0, $tmp_pos);
         }
      }
      if (!isset($a_appointment_start_date) || $a_appointment_start_date == "")
      {
          $a_appointment_start_date = "";
      }
      if (isset($a_appointment_start_date) && !empty($a_appointment_start_date))
      {
         $tmp_pos = (is_string($a_appointment_start_date)) ? strpos($a_appointment_start_date, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $a_appointment_start_date = substr($a_appointment_start_date, 0, $tmp_pos);
         }
      }
      if (!isset($c_customers_name) || $c_customers_name == "")
      {
          $c_customers_name = "";
      }
      if (isset($c_customers_name) && !empty($c_customers_name))
      {
         $tmp_pos = (is_string($c_customers_name)) ? strpos($c_customers_name, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $c_customers_name = substr($c_customers_name, 0, $tmp_pos);
         }
      }
      if (!isset($c_customers_address) || $c_customers_address == "")
      {
          $c_customers_address = "";
      }
      if (isset($c_customers_address) && !empty($c_customers_address))
      {
         $tmp_pos = (is_string($c_customers_address)) ? strpos($c_customers_address, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $c_customers_address = substr($c_customers_address, 0, $tmp_pos);
         }
      }
?>
 <?php
...
?>
<?php
   if (is_file("appointment_billing_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['appointment_billing']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['appointment_billing']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_a_appointments_id_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['a_appointments_id'])) ? $this->New_label['a_appointments_id'] : "" . $this->Ini->Nm_lang['lang_appointments_fld_appointments_id'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_a_appointments_id_cond" name="a_appointments_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_a_appointments_id'), this, 'a_appointments_id')">
       <OPTION value="gt" <?php if ("gt" == $a_appointments_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $a_appointments_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $a_appointments_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $a_appointments_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_a_appointments_id" <?php echo $str_hide_a_appointments_id?> valign="top">
 ...
 $nmgp_tab_label .= "a_appointments_id?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
?>
<?php
      if ($a_appointments_id != "")
      {
      $a_appointments_id_look = (is_string($a_appointments_id) ? substr($this->Db->qstr($a_appointments_id), 1, -1) : $a_appointments_id); 
      $nmgp_def_dados = array(); 
   if (is_numeric($a_appointments_id))
   { 
      if (isset($this->Ini->nm_bases_postgres) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct a.appointments_id from " . $this->Ini->nm_tabela . " where (a.appointments_id = " . $_SESSION['var_appointment_id'] . ") and a.appointments_id = $a_appointments_id_look order by a.appointments_id"; 
      }
      elseif (isset($this->Ini->nm_bases_sybase) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct a.appointments_id from " . $this->Ini->nm_tabela . " where (a.appointments_id = " . $_SESSION['var_appointment_id'] . ") and a.appointments_id = $a_appointments_id_look order by a.appointments_id"; 
      ...
      if (isset($nmgp_def_dados[0][$a_appointments_id]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$a_appointments_id];
      }
      else
      {
            nmgp_Form_Num_Val($a_appointments_id, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $a_appointments_id;
      }
?>
<INPUT  type="text" id="SC_a_appointments_id" name="a_appointments_id" value="<?php echo NM_encode_input($a_appointments_id) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-a_appointments_id" id="id_ac_a_appointments_id" name="a_appointments_id_autocomp"><?php if ('' !=  $a_appointments_id) { ?><option value="<?php echo $a_appointments_id ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_a_appointments_id"  <?php echo $str_display_a_appointments_id; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_a_appointments_id_input_2" name="a_appointments_id_input_2" value="<?php echo NM_encode_input($a_appointments_id_input_2) ?>"  size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_a_appointment_start_date_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['a_appointment_start_date'])) ? $this->New_label['a_appointment_start_date'] : "" . $this->Ini->Nm_lang['lang_appointments_fld_appointment_start_date'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_a_appointment_start_date_cond" name="a_appointment_start_date_cond" onChange="nm_campos_between(document.getElementById('id_vis_a_appointment_start_date'), this, 'a_appointment_start_date')">
       <OPTION value="eq" <?php if ("eq" == $a_appointment_start_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="gt" <?php if ("gt" == $a_appointment_start_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $a_appointment_start_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $a_appointment_start_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_a_appointment_start_date" <?php echo $str_hide_a_appointment_start_date?> valign="top">
 ...
 $nmgp_tab_label .= "a_appointment_start_date?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
  ...
  {
?>
<span id='id_date_part_a_appointment_start_date_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_a_appointment_start_date_dia" name="a_appointment_start_date_dia" value="<?php echo NM_encode_input($a_appointment_start_date_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_a_appointment_start_date_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_a_appointment_start_date_mes" name="a_appointment_start_date_mes" value="<?php echo NM_encode_input($a_appointment_start_date_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_a_appointment_start_date_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_a_appointment_start_date_ano" name="a_appointment_start_date_ano" value="<?php echo NM_encode_input($a_appointment_start_date_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
?>
        <SPAN id="id_css_a_appointment_start_date"  class="scFilterFieldFontEven">
 <?php echo $date_format_show ?>         </SPAN>
                 </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_a_appointment_start_date"  <?php echo $str_display_a_appointment_start_date; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>
         <BR>
...
<?php
  ...
  {
?>
<span id='id_date_part_a_appointment_start_date_input_2_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_a_appointment_start_date_input_2_dia" name="a_appointment_start_date_input_2_dia" value="<?php echo NM_encode_input($a_appointment_start_date_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_a_appointment_start_date_input_2_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_a_appointment_start_date_input_2_mes" name="a_appointment_start_date_input_2_mes" value="<?php echo NM_encode_input($a_appointment_start_date_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_a_appointment_start_date_input_2_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_a_appointment_start_date_input_2_ano" name="a_appointment_start_date_input_2_ano" value="<?php echo NM_encode_input($a_appointment_start_date_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
?>
      ...
      <TD id='SC_c_customers_name_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['c_customers_name'])) ? $this->New_label['c_customers_name'] : "" . $this->Ini->Nm_lang['lang_customers_fld_customers_name'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_c_customers_name_cond" name="c_customers_name_cond" onChange="nm_campos_between(document.getElementById('id_vis_c_customers_name'), this, 'c_customers_name')">
       <OPTION value="qp" <?php if ("qp" == $c_customers_name_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $c_customers_name_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $c_customers_name_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $c_customers_name_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_c_customers_name" <?php echo $str_hide_c_customers_name?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 ...
 $nmgp_tab_label .= "c_customers_name?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $c_customers_name_look = (is_string($c_customers_name) ? substr($this->Db->qstr($c_customers_name), 1, -1) : $c_customers_name); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct c.customers_name from " . $this->Ini->nm_tabela . " where (a.appointments_id = " . $_SESSION['var_appointment_id'] . ") and c.customers_name = '$c_customers_name_look' order by c.customers_name"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$c_customers_name]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$c_customers_name];
      }
      else
      {
          $sAutocompValue = $c_customers_name;
      }
?>
<INPUT  type="text" id="SC_c_customers_name" name="c_customers_name" value="<?php echo NM_encode_input($c_customers_name) ?>"  size=50 alt="{datatype: 'text', maxLength: 300, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-c_customers_name" id="id_ac_c_customers_name" name="c_customers_name_autocomp"><?php if ('' !=  $c_customers_name) { ?><option value="<?php echo $c_customers_name ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_c_customers_address_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['c_customers_address'])) ? $this->New_label['c_customers_address'] : "" . $this->Ini->Nm_lang['lang_customers_fld_customers_address'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_c_customers_address_cond" name="c_customers_address_cond" onChange="nm_campos_between(document.getElementById('id_vis_c_customers_address'), this, 'c_customers_address')">
       <OPTION value="qp" <?php if ("qp" == $c_customers_address_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $c_customers_address_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $c_customers_address_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $c_customers_address_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_c_customers_address" <?php echo $str_hide_c_customers_address?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 ...
 $nmgp_tab_label .= "c_customers_address?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<?php
      if ($c_customers_address != "")
      {
      $c_customers_address_look = (is_string($c_customers_address) ? substr($this->Db->qstr($c_customers_address), 1, -1) : $c_customers_address); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct c.customers_address from " . $this->Ini->nm_tabela . " where (a.appointments_id = " . $_SESSION['var_appointment_id'] . ") and c.customers_address = '$c_customers_address_look' order by c.customers_address"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$c_customers_address]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$c_customers_address];
      }
      else
      {
          $sAutocompValue = $c_customers_address;
      }
?>
<INPUT  type="text" id="SC_c_customers_address" name="c_customers_address" value="<?php echo NM_encode_input($c_customers_address) ?>"  size=50 alt="{datatype: 'text', maxLength: 450, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-c_customers_address" id="id_ac_c_customers_address" name="c_customers_address_autocomp"><?php if ('' !=  $c_customers_address) { ?><option value="<?php echo $c_customers_address ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.a_appointments_id_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_a_appointments_id'), document.F1.a_appointments_id_cond, 'a_appointments_id');
   document.F1.a_appointments_id.value = "";
   document.F1.a_appointments_id_autocomp.value = "";
   $('#select2-id_ac_a_appointments_id-container').html('<?php echo $this->Val_init_a_appointments_id['desc'] ?>');;
   document.F1.a_appointments_id_input_2.value = "";
   document.F1.a_appointment_start_date_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_a_appointment_start_date'), document.F1.a_appointment_start_date_cond, 'a_appointment_start_date');
   document.F1.a_appointment_start_date_dia.value = "";
   document.F1.a_appointment_start_date_mes.value = "";
   document.F1.a_appointment_start_date_ano.value = "";
   document.F1.a_appointment_start_date_input_2_dia.value = "";
   document.F1.a_appointment_start_date_input_2_mes.value = "";
   document.F1.a_appointment_start_date_input_2_ano.value = "";
   document.F1.c_customers_name_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_c_customers_name'), document.F1.c_customers_name_cond, 'c_customers_name');
   document.F1.c_customers_name.value = "";
   document.F1.c_customers_name_autocomp.value = "";
   $('#select2-id_ac_c_customers_name-container').html('<?php echo $this->Val_init_c_customers_name['desc'] ?>');;
   document.F1.c_customers_address_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_c_customers_address'), document.F1.c_customers_address_cond, 'c_customers_address');
   document.F1.c_customers_address.value = "";
   document.F1.c_customers_address_autocomp.value = "";
   $('#select2-id_ac_c_customers_address-container').html('<?php echo $this->Val_init_c_customers_address['desc'] ?>');;
   Sc_carga_select2('all');
 }
 ...
 {
    $('#SC_a_appointment_start_date_dia').bind('change', function() {sc_appointment_billing_valida_dia(this)});
    $('#SC_a_appointment_start_date_input_2_dia').bind('change', function() {sc_appointment_billing_valida_dia(this)});
    $('#SC_a_appointment_start_date_input_2_mes').bind('change', function() {sc_appointment_billing_valida_mes(this)});
    $('#SC_a_appointment_start_date_mes').bind('change', function() {sc_appointment_billing_valida_mes(this)});
 }
 function sc_appointment_billing_valida_dia(obj)
 {
 ...
 function sc_appointment_billing_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "appointments1/appointment_billing";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "appointments1/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
          $NM_patch .= "appointment_billing/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_a_appointments_id_cond'] = 'cond';
      $tp_fields['SC_a_appointments_id'] = 'text_aut';
      $tp_fields['id_ac_a_appointments_id'] = 'select2_aut';
      $tp_fields['SC_a_appointments_id_input_2'] = 'text';
      $tp_fields['SC_a_appointment_start_date_cond'] = 'cond';
      $tp_fields['SC_a_appointment_start_date_dia'] = 'text';
      $tp_fields['SC_a_appointment_start_date_mes'] = 'text';
      $tp_fields['SC_a_appointment_start_date_ano'] = 'text';
      $tp_fields['SC_a_appointment_start_date_input_2_dia'] = 'text';
      $tp_fields['SC_a_appointment_start_date_input_2_mes'] = 'text';
      $tp_fields['SC_a_appointment_start_date_input_2_ano'] = 'text';
      $tp_fields['SC_c_customers_name_cond'] = 'cond';
      $tp_fields['SC_c_customers_name'] = 'text_aut';
      $tp_fields['id_ac_c_customers_name'] = 'select2_aut';
      $tp_fields['SC_c_customers_address_cond'] = 'cond';
      $tp_fields['SC_c_customers_address'] = 'text_aut';
      $tp_fields['id_ac_c_customers_address'] = 'select2_aut';
   ...
   {
      global $a_appointments_id_cond, $a_appointments_id, $a_appointments_id_input_2, $a_appointments_id_autocomp,
             $a_appointment_start_date_cond, $a_appointment_start_date, $a_appointment_start_date_dia, $a_appointment_start_date_mes, $a_appointment_start_date_ano, $a_appointment_start_date_input_2_dia, $a_appointment_start_date_input_2_mes, $a_appointment_start_date_input_2_ano,
             $c_customers_name_cond, $c_customers_name, $c_customers_name_autocomp,
             $c_customers_address_cond, $c_customers_address, $c_customers_address_autocomp, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($a_appointments_id_autocomp) && empty($a_appointments_id))
      {
          $a_appointments_id = $a_appointments_id_autocomp;
      }
      if (!empty($c_customers_name_autocomp) && empty($c_customers_name))
      {
          $c_customers_name = $c_customers_name_autocomp;
      }
      if (!empty($c_customers_address_autocomp) && empty($c_customers_address))
      {
          $c_customers_address = $c_customers_address_autocomp;
      }
      $a_appointments_id_cond_salva = $a_appointments_id_cond; 
      if (!isset($a_appointments_id_input_2) || $a_appointments_id_input_2 == "")
      {
          $a_appointments_id_input_2 = $a_appointments_id;
      }
      $a_appointment_start_date_cond_salva = $a_appointment_start_date_cond; 
      if (!isset($a_appointment_start_date_input_2_dia) || $a_appointment_start_date_input_2_dia == "")
      {
          $a_appointment_start_date_input_2_dia = $a_appointment_start_date_dia;
      }
      if (!isset($a_appointment_start_date_input_2_mes) || $a_appointment_start_date_input_2_mes == "")
      {
          $a_appointment_start_date_input_2_mes = $a_appointment_start_date_mes;
      }
      if (!isset($a_appointment_start_date_input_2_ano) || $a_appointment_start_date_input_2_ano == "")
      {
          $a_appointment_start_date_input_2_ano = $a_appointment_start_date_ano;
      }
      $c_customers_name_cond_salva = $c_customers_name_cond; 
      if (!isset($c_customers_name_input_2) || $c_customers_name_input_2 == "")
      {
          $c_customers_name_input_2 = $c_customers_name;
      }
      $c_customers_address_cond_salva = $c_customers_address_cond; 
      if (!isset($c_customers_address_input_2) || $c_customers_address_input_2 == "")
      {
          $c_customers_address_input_2 = $c_customers_address;
      }
      if ($a_appointments_id_cond != "in")
      {
          nm_limpa_numero($a_appointments_id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($a_appointments_id_cond != "in")
      {
          nm_limpa_numero($a_appointments_id_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['campos_busca']['a_appointments_id'] = $a_appointments_id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['campos_busca']['a_appointments_id_input_2'] = $a_appointments_id_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['campos_busca']['a_appointments_id_cond'] = $a_appointments_id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['campos_busca']['a_appointment_start_date_dia'] = $a_appointment_start_date_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['campos_busca']['a_appointment_start_date_mes'] = $a_appointment_start_date_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['campos_busca']['a_appointment_start_date_ano'] = $a_appointment_start_date_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['campos_busca']['a_appointment_start_date_input_2_dia'] = $a_appointment_start_date_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['campos_busca']['a_appointment_start_date_input_2_mes'] = $a_appointment_start_date_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['campos_busca']['a_appointment_start_date_input_2_ano'] = $a_appointment_start_date_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['campos_busca']['a_appointment_start_date_cond'] = $a_appointment_start_date_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['campos_busca']['c_customers_name'] = $c_customers_name; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['campos_busca']['c_customers_name_cond'] = $c_customers_name_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['campos_busca']['c_customers_address'] = $c_customers_address; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['campos_busca']['c_customers_address_cond'] = $c_customers_address_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['campos_busca'] = $Temp_Busca;
      }
      if ($a_appointments_id_cond != "in" && $a_appointments_id_cond != "bw" && !empty($a_appointments_id) && !is_numeric($a_appointments_id))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : " . $this->Ini->Nm_lang['lang_appointments_fld_appointments_id'] . "";
      }
      if ($a_appointments_id_cond == "bw" && ((!empty($a_appointments_id) && !is_numeric($a_appointments_id)) || (!empty($a_appointments_id_input_2) && !is_numeric($a_appointments_id_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : " . $this->Ini->Nm_lang['lang_appointments_fld_appointments_id'] . "";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['a_appointments_id'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['a_appointments_id'] = $cmp1;
      }
      else
      {
          $cmp1 = $a_appointments_id;
      ...
      $Conteudo = $a_appointments_id_input_2;
      if (strtoupper($a_appointments_id_cond) != "II" && strtoupper($a_appointments_id_cond) != "QP" && strtoupper($a_appointments_id_cond) != "NP" && strtoupper($a_appointments_id_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['a_appointments_id_input_2'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($c_customers_name != '') {
      $c_customers_name_look = (is_string($c_customers_name) ? substr($this->Db->qstr($c_customers_name), 1, -1) : $c_customers_name); 
      $nmgp_def_dados = array(); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['c_customers_name'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['c_customers_name'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['c_customers_name'] = $c_customers_name;
      }
      $nmgp_def_dados = array();
    if ($c_customers_address != '') {
      $c_customers_address_look = (is_string($c_customers_address) ? substr($this->Db->qstr($c_customers_address), 1, -1) : $c_customers_address); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['c_customers_address'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['c_customers_address'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['c_customers_address'] = $c_customers_address;
      }

      //----- $a_appointments_id
      $this->Date_part = false;
      if (isset($a_appointments_id) || $a_appointments_id_cond == "nu" || $a_appointments_id_cond == "nn" || $a_appointments_id_cond == "ep" || $a_appointments_id_cond == "ne")
      {
         $this->monta_condicao("a.appointments_id", $a_appointments_id_cond, $a_appointments_id, $a_appointments_id_input_2, "a_appointments_id", "INT", false);
      }

      //----- $a_appointment_start_date
      $this->Date_part = false;
      if ($a_appointment_start_date_cond != "bi_TP")
      {
          $a_appointment_start_date_cond = strtoupper($a_appointment_start_date_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $a_appointment_start_date_ano;
          $Dtxt .= $a_appointment_start_date_mes;
          $Dtxt .= $a_appointment_start_date_dia;
          $val[0]['ano'] = $a_appointment_start_date_ano;
          $val[0]['mes'] = $a_appointment_start_date_mes;
          $val[0]['dia'] = $a_appointment_start_date_dia;
          if ($a_appointment_start_date_cond == "BW")
          {
              $val[1]['ano'] = $a_appointment_start_date_input_2_ano;
              $val[1]['mes'] = $a_appointment_start_date_input_2_mes;
              $val[1]['dia'] = $a_appointment_start_date_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          {
              $this->nm_prep_date($val, "DT", "DATETIME", $a_appointment_start_date_cond, "", "data");
          }
          else
          {
              $this->nm_prep_date($val, "DT", "DATE", $a_appointment_start_date_cond, "", "data");
          }
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $a_appointment_start_date = $val[0];
          $this->cmp_formatado['a_appointment_start_date'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['campos_busca']['a_appointment_start_date'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['a_appointment_start_date'], "YYYY-MM-DD");
          $this->cmp_formatado['a_appointment_start_date'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          if ($a_appointment_start_date_cond == "BW")
          {
              if (!$this->Date_part) {
                  $val[1] = $this->Ini->sc_Date_Protect($val[1]);
              }
              $a_appointment_start_date_input_2     = $val[1];
              $this->cmp_formatado['a_appointment_start_date_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['campos_busca']['a_appointment_start_date_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['a_appointment_start_date_input_2'], "YYYY-MM-DD");
              $this->cmp_formatado['a_appointment_start_date_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          }
          if (!empty($Dtxt) || $a_appointment_start_date_cond == "NU" || $a_appointment_start_date_cond == "NN"|| $a_appointment_start_date_cond == "EP"|| $a_appointment_start_date_cond == "NE")
          {
              $this->monta_condicao("a.appointment_start_date", $a_appointment_start_date_cond, $a_appointment_start_date, $a_appointment_start_date_input_2, 'a_appointment_start_date', 'DATE');
          }
      }

      //----- $c_customers_name
      $this->Date_part = false;
      if (isset($c_customers_name) || $c_customers_name_cond == "nu" || $c_customers_name_cond == "nn" || $c_customers_name_cond == "ep" || $c_customers_name_cond == "ne")
      {
         $this->monta_condicao("c.customers_name", $c_customers_name_cond, $c_customers_name, "", "c_customers_name", "VARCHAR", false);
      }

      //----- $c_customers_address
      $this->Date_part = false;
      if (isset($c_customers_address) || $c_customers_address_cond == "nu" || $c_customers_address_cond == "nn" || $c_customers_address_cond == "ep" || $c_customers_address_cond == "ne")
      {
         $this->monta_condicao("c.customers_address", $c_customers_address_cond, $c_customers_address, "", "c_customers_address", "VARCHAR", false);
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_billing']['where_pesq'];
