<?php
@session_start() ;
$_SESSION['scriptcase']['appointment_billing']['sc_process_barr'] = true;
require_once('../appointment_billing/index.php');
unset($_SESSION['scriptcase']['appointment_billing']['sc_process_barr']);
$ExportCtrl = new appointment_billing_export_control;
$ExportCtrl->Export_barr();

class appointment_billing_export_control
{
