...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["appointments1_____appointment_billing"]))
   {
      unset($_SESSION['session_sec_aplicacao']["appointments1_____appointment_billing"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['appointment_billing']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['appointment_billing']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['appointment_billing']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['appointment_billing']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['appointment_billing']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>appointment_billing</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['appointment_billing']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['appointment_billing']['embutida_filho'] as $ind => $sc_init)
          {
