...
// 
    ...
    $out1_img_cache = $_SESSION['scriptcase']['grid_appointments_adm_dashboard']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['grid_appointments_adm_dashboard']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_appointments_adm_dashboard']['glo_nm_conexao'], $this->root . $this->path_prod, 'appointments1', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if (!$this->Ini || isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_adm_dashboard']['embutida_ibase'])) 
      { 
          $this->Ini = new grid_appointments_adm_dashboard_ini(); 
          $this->Ini->init();
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_dashboard']['embutida'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_dashboard']['embutida_ibase'] = true;
      }
      ...
      $_SESSION['sc_session'][$script_case_init]['grid_appointments_adm_dashboard']['skip_charts'] = (strpos(" " . $this->Ini->SC_module_export, "chart") !== false) ? false : true;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_dashboard']['conf_chart_level'] = "S";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_dashboard']['proc_pdf'] = (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_dashboard']['embutida'] && ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_dashboard']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_dashboard']['opcao'] == "pdf_res")) ? true : false;
...
//----------------------------------->
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_dashboard']['opcao'] == "json")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_dashboard']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_appointments_adm_dashboard/grid_appointments_adm_dashboard_json.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_appointments_adm_dashboard_json.class.php"); 
          } 
          $this->json  = new grid_appointments_adm_dashboard_json();
...
<?php
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_dashboard']['embutida'])
      {
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            elseif (is_dir($this->Ini->path_third . $dir_qpdf) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_dashboard']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_dashboard']['use_pass_pdf']))
            {
            ...
            if ($this->pdf_zip == "S")
            {
                $pdf_pass = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_dashboard']['use_pass_pdf'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_dashboard']['use_pass_pdf'] : "";
            ...
            elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_dashboard']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_dashboard']['use_pass_pdf']))
            {
                if (FALSE !== strpos(strtolower(php_uname()), 'windows')) 
                {
                    $dir_qpdf = "/qpdf/win/bin";
                ...
                if (is_dir($this->Ini->path_third . $dir_qpdf)) 
                {
                    ...
                    $pdf_pass  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm_dashboard']['use_pass_pdf'];
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['grid_appointments_adm_dashboard']['glo_nm_path_imag_temp'] . "/sc_apl_default_appointments1.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['grid_appointments_adm_dashboard']['glo_nm_path_imag_temp'] . "/sc_apl_default_appointments1.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_appointments1'])) {
               $_SESSION['scriptcase']['grid_appointments_adm_dashboard']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_appointments1'];
           }
       }
   }
