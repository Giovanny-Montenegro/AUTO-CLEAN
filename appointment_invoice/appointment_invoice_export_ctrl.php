<?php
@session_start() ;
$_SESSION['scriptcase']['appointment_invoice']['sc_process_barr'] = true;
require_once('../appointment_invoice/index.php');
unset($_SESSION['scriptcase']['appointment_invoice']['sc_process_barr']);
$ExportCtrl = new appointment_invoice_export_control;
$ExportCtrl->Export_barr();

class appointment_invoice_export_control
{
