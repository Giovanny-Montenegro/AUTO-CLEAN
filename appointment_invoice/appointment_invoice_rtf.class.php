...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "appointment_invoice.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['appointment_invoice']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['appointment_invoice']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_invoice']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_invoice']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_invoice']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['appointment_invoice']['rtf_name']);
      }
   ...
   function NM_export_a_appointments_id()
   {
         ...
         $this->a_appointments_id = str_replace('<', '&lt;', $this->a_appointments_id);
         $this->a_appointments_id = str_replace('>', '&gt;', $this->a_appointments_id);
         $this->Texto_tag .= "<td>" . $this->a_appointments_id . "</td>\r\n";
   }
   ...
   function NM_export_a_appointment_start_date()
   {
         ...
         $this->a_appointment_start_date = NM_charset_to_utf8($this->a_appointment_start_date);
         $this->a_appointment_start_date = str_replace('<', '&lt;', $this->a_appointment_start_date);
         $this->a_appointment_start_date = str_replace('>', '&gt;', $this->a_appointment_start_date);
         $this->Texto_tag .= "<td>" . $this->a_appointment_start_date . "</td>\r\n";
   }
   //----- c_customers_name
   function NM_export_c_customers_name()
   {
         ...
         $this->c_customers_name = str_replace('<', '&lt;', $this->c_customers_name);
         $this->c_customers_name = str_replace('>', '&gt;', $this->c_customers_name);
         $this->Texto_tag .= "<td>" . $this->c_customers_name . "</td>\r\n";
   }
   //----- c_customers_address
   function NM_export_c_customers_address()
   {
         ...
         $this->c_customers_address = str_replace('<', '&lt;', $this->c_customers_address);
         $this->c_customers_address = str_replace('>', '&gt;', $this->c_customers_address);
         $this->Texto_tag .= "<td>" . $this->c_customers_address . "</td>\r\n";
   }
   //----- c_customers_city
   function NM_export_c_customers_city()
   {
         ...
         $this->c_customers_city = str_replace('<', '&lt;', $this->c_customers_city);
         $this->c_customers_city = str_replace('>', '&gt;', $this->c_customers_city);
         $this->Texto_tag .= "<td>" . $this->c_customers_city . "</td>\r\n";
   }
   //----- c_customers_state
   function NM_export_c_customers_state()
   {
         ...
         $this->c_customers_state = str_replace('<', '&lt;', $this->c_customers_state);
         $this->c_customers_state = str_replace('>', '&gt;', $this->c_customers_state);
         $this->Texto_tag .= "<td>" . $this->c_customers_state . "</td>\r\n";
   }
   //----- c_customers_zip
   function NM_export_c_customers_zip()
   {
         ...
         $this->c_customers_zip = str_replace('<', '&lt;', $this->c_customers_zip);
         $this->c_customers_zip = str_replace('>', '&gt;', $this->c_customers_zip);
         $this->Texto_tag .= "<td>" . $this->c_customers_zip . "</td>\r\n";
   }
   //----- c_customers_phone
   function NM_export_c_customers_phone()
   {
         ...
         $this->c_customers_phone = str_replace('<', '&lt;', $this->c_customers_phone);
         $this->c_customers_phone = str_replace('>', '&gt;', $this->c_customers_phone);
         $this->Texto_tag .= "<td>" . $this->c_customers_phone . "</td>\r\n";
   }
   //----- a_price
   function NM_export_a_price()
   {
         ...
         $this->a_price = str_replace('<', '&lt;', $this->a_price);
         $this->a_price = str_replace('>', '&gt;', $this->a_price);
         $this->Texto_tag .= "<td>" . $this->a_price . "</td>\r\n";
   }
   ...
   function NM_export_a_additional_charges()
   {
         ...
         $this->a_additional_charges = str_replace('<', '&lt;', $this->a_additional_charges);
         $this->a_additional_charges = str_replace('>', '&gt;', $this->a_additional_charges);
         $this->Texto_tag .= "<td>" . $this->a_additional_charges . "</td>\r\n";
   }
   //----- a_discount
   function NM_export_a_discount()
   {
         ...
         $this->a_discount = str_replace('<', '&lt;', $this->a_discount);
         $this->a_discount = str_replace('>', '&gt;', $this->a_discount);
         $this->Texto_tag .= "<td>" . $this->a_discount . "</td>\r\n";
   }
   //----- a_total_price
   function NM_export_a_total_price()
   {
         ...
         $this->a_total_price = str_replace('<', '&lt;', $this->a_total_price);
         $this->a_total_price = str_replace('>', '&gt;', $this->a_total_price);
         $this->Texto_tag .= "<td>" . $this->a_total_price . "</td>\r\n";
   }
   //----- details
   function NM_export_details()
   {
         ...
         $this->details = str_replace('>', '&gt;', $this->details);
         $this->Texto_tag .= "<td>" . $this->details . "</td>\r\n";
   }
   ...
   function NM_export_details_att_appointments_type_id()
   {
         ...
         $this->details_att_appointments_type_id = str_replace('<', '&lt;', $this->details_att_appointments_type_id);
         $this->details_att_appointments_type_id = str_replace('>', '&gt;', $this->details_att_appointments_type_id);
         $this->Texto_tag .= "<td>" . $this->details_att_appointments_type_id . "</td>\r\n";
   }
   ...
   function NM_export_details_att_description()
   {
         ...
         $this->details_att_description = str_replace('<', '&lt;', $this->details_att_description);
         $this->details_att_description = str_replace('>', '&gt;', $this->details_att_description);
         $this->Texto_tag .= "<td>" . $this->details_att_description . "</td>\r\n";
   }
   //----- details_att_price
   function NM_export_details_att_price()
   {
         ...
         $this->details_att_price = str_replace('<', '&lt;', $this->details_att_price);
         $this->details_att_price = str_replace('>', '&gt;', $this->details_att_price);
         $this->Texto_tag .= "<td>" . $this->details_att_price . "</td>\r\n";
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['appointment_invoice']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['appointment_invoice']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
