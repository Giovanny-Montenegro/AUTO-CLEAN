<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="appointment_details_id_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['appointment_details_id_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_appointment_details"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function scForm_inline_submit(y, z) {
	Nm_Proc_Atualiz = true;
	do_ajax_form_appointment_details_submit_form(y, z);
