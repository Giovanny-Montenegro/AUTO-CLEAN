  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_appointment_details" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_appointment_details_form();
	}
...
?>
  ...
  function do_ajax_form_appointment_details_validate_appointments_type_id_(iNumLinha)
  {
    var nomeCampo_appointments_type_id_ = "appointments_type_id_" + iNumLinha;
    var var_appointments_type_id_ = scAjaxGetFieldSelect(nomeCampo_appointments_type_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointment_details_validate_appointments_type_id_(var_appointments_type_id_, iNumLinha, var_script_case_init, do_ajax_form_appointment_details_validate_appointments_type_id__cb);
  } // do_ajax_form_appointment_details_validate_appointments_type_id_

  function do_ajax_form_appointment_details_validate_appointments_type_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointment_details_validate_appointments_type_id__cb

  // ---------- Validate duration_
  function do_ajax_form_appointment_details_validate_duration_(iNumLinha)
  {
  } // do_ajax_form_appointment_details_validate_duration_

  function do_ajax_form_appointment_details_validate_duration__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointment_details_validate_duration__cb

  // ---------- Validate price_
  function do_ajax_form_appointment_details_validate_price_(iNumLinha)
  {
  } // do_ajax_form_appointment_details_validate_price_

  function do_ajax_form_appointment_details_validate_price__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointment_details_validate_price__cb

  // ---------- Validate appointment_details_id_
  function do_ajax_form_appointment_details_validate_appointment_details_id_(iNumLinha)
  {
    var nomeCampo_appointment_details_id_ = "appointment_details_id_" + iNumLinha;
    var var_appointment_details_id_ = scAjaxGetFieldHidden(nomeCampo_appointment_details_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointment_details_validate_appointment_details_id_(var_appointment_details_id_, iNumLinha, var_script_case_init, do_ajax_form_appointment_details_validate_appointment_details_id__cb);
  } // do_ajax_form_appointment_details_validate_appointment_details_id_

  function do_ajax_form_appointment_details_validate_appointment_details_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "appointment_details_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "appointment_details_id_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "appointment_details_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "appointment_details_id_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointment_details_validate_appointment_details_id__cb

  // ---------- Event onchange appointments_type_id_
  function do_ajax_form_appointment_details_event_appointments_type_id__onchange(iSeqForm)
  {
    var var_appointments_type_id_ = scAjaxGetFieldSelect("appointments_type_id_" + iSeqForm);
    var var_duration_ = scAjaxGetFieldHidden("duration_" + iSeqForm);
    var var_price_ = scAjaxGetFieldHidden("price_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_appointment_details_event_appointments_type_id__onchange(var_appointments_type_id_, var_duration_, var_price_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_appointment_details_event_appointments_type_id__onchange_cb);
  } // do_ajax_form_appointment_details_event_appointments_type_id__onchange

  function do_ajax_form_appointment_details_event_appointments_type_id__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_appointment_details_event_appointments_type_id__onchange_cb_after_alert);
  } // do_ajax_form_appointment_details_event_appointments_type_id__onchange_cb
  function do_ajax_form_appointment_details_event_appointments_type_id__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_appointment_details_event_appointments_type_id__onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_appointment_details_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_appointment_details_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_appointment_details_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_appointment_details_add_new_line_cb);
  } // do_ajax_form_appointment_details_add_new_line

  function do_ajax_form_appointment_details_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_appointment_details_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_appointment_details_backup_line(iNumLinha)
  {
    var var_appointment_details_id_ = scAjaxGetFieldHidden("appointment_details_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointment_details_backup_line(var_appointment_details_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_appointment_details_backup_line_cb);
  } // do_ajax_form_appointment_details_backup_line

  function do_ajax_form_appointment_details_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_appointment_details_backup_line_cb

  function do_ajax_form_appointment_details_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_appointment_details_cancel_insert

  function do_ajax_form_appointment_details_cancel_update(iSeqVert)
  {
    do_ajax_form_appointment_details_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_appointment_details_cancel_update

  function do_ajax_form_appointment_details_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_appointment_details_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_appointment_details_table_refresh()
  {
    var var_appointment_details_id_ = document.F2.appointment_details_id_.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_appointment_details_table_refresh(var_appointment_details_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_appointment_details_table_refresh_cb);
  } //  do_ajax_form_appointment_details_table_refresh

  function do_ajax_form_appointment_details_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.appointment_details_id_.value = scAjaxGetKeyValue("appointment_details_id_");
    ...
    scAjaxAlert(do_ajax_form_appointment_details_table_refresh_cb_after_alert);
  } // do_ajax_form_appointment_details_table_refresh_cb
  function do_ajax_form_appointment_details_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("b");
    sc_insert_open = false;
  } // do_ajax_form_appointment_details_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_appointment_details_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_appointment_details_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_appointments_type_id_ = scAjaxGetFieldSelect("appointments_type_id_" + iNumLinha);
    var var_duration_ = scAjaxGetFieldHidden("duration_" + iNumLinha);
    var var_price_ = scAjaxGetFieldHidden("price_" + iNumLinha);
    var var_appointment_details_id_ = scAjaxGetFieldHidden("appointment_details_id_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_appointment_details_submit_form(var_appointments_type_id_, var_duration_, var_price_, var_appointment_details_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_appointment_details_submit_form_cb);
  } // do_ajax_form_appointment_details_submit_form

  function do_ajax_form_appointment_details_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("appointment_details_id_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_appointment_details_submit_form_cb_after_alert);
  } // do_ajax_form_appointment_details_submit_form_cb
  function do_ajax_form_appointment_details_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_appointment_details_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_appointment_details_navigate_form()
  {
    perform_ajax_form_appointment_details_navigate_form();
  }

  function perform_ajax_form_appointment_details_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_appointment_details_cancel_insert(sc_form_appointment_details_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("appointment_details_id_" + iNavForm);
    }
    var var_appointment_details_id_ = document.F2.appointment_details_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_appointment_details_navigate_form(var_appointment_details_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_appointment_details_navigate_form_cb);
  } // do_ajax_form_appointment_details_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointment_details']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_appointment_details_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.appointment_details_id_.value = scAjaxGetKeyValue("appointment_details_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_appointment_details_navigate_form_cb_after_alert);
  } // do_ajax_form_appointment_details_navigate_form_cb
  function do_ajax_form_appointment_details_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_appointment_details_navigate_form_cb_after_alert

    function sc_form_appointment_details_get_last_line_number()
    {
    ...
    } //sc_form_appointment_details_get_last_line_number

  function sc_hide_form_appointment_details_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "appointment_details_id_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["appointments_type_id_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_appointment_details_fld_appointments_type_id'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["duration_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_appointments_type_fld_duration_displayed'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["appointment_details_id_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_appointment_details_fld_appointment_details_id'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["appointment_details_id_"][iNumLinha] = "appointment_details_id_" + iNumLinha;
    ...
    ajax_error_count["appointment_details_id_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["appointments_type_id_" + iNumLinha] = "off";
    ajax_read_only["duration_" + iNumLinha] = "off";
    ajax_read_only["price_" + iNumLinha] = "off";
    ajax_read_only["appointment_details_id_" + iNumLinha] = "on";
<?php
}
else
{
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["appointment_details_id_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    ...
    "duration_": new Array(),
    "price_": new Array(),
    "appointment_details_id_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["appointment_details_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["appointment_details_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["appointment_details_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["appointment_details_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["appointment_details_id_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['appointments_type_id_'])) ? $this->nmgp_cmp_readonly['appointments_type_id_'] : 'off';
?>
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['appointment_details_id_'])) ? $this->nmgp_cmp_readonly['appointment_details_id_'] : 'on';
?>
    scAjaxFieldRead("appointment_details_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("appointment_details_id_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["appointments_type_id_" + iRow] || "on" == ajax_error_count["duration_" + iRow] || "on" == ajax_error_count["price_" + iRow] || "on" == ajax_error_count["appointment_details_id_" + iRow]))
    {
      ...
      $("#hidden_field_data_appointment_details_id_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["appointments_type_id_" + iRow] && "off" == ajax_error_count["duration_" + iRow] && "off" == ajax_error_count["price_" + iRow] && "off" == ajax_error_count["appointment_details_id_" + iRow]))
    {
      if (bErrorRow)
      {
        ...
        ajax_error_count["appointment_details_id_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_appointment_details_id_" + iRow).removeClass("scFormErrorLine");
    }
  }
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("appointment_details_id_" == sIndex)
    {
      scAjaxSetFieldLabel(sIndex, aValue);
      updateHeaderFooter(sIndex, aValue);
