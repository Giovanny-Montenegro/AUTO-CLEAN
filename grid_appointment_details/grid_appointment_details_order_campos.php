...
<?php
   ...
   $Ord_Cmp = new grid_appointment_details_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_appointment_details_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_appointment_details']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_appointment_details']['ordem_select_orig'] = array();
   }
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['appointments_type_appointments_type_id'] = "cmp_maior_30_1";
   }
   else
   {
       $tab_def_campos['appointments_type_appointments_type_id'] = "appointments_type.appointments_type_id";
   }
   $tab_labels["appointments_type_appointments_type_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointment_details']['labels']["appointments_type_appointments_type_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointment_details']['labels']["appointments_type_appointments_type_id"] : "" . $this->Nm_lang['lang_appointment_details_fld_appointments_type_id'] . "";
   $tab_ger_campos['appointments_type_description'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['appointments_type_description'] = "appointments_type_description";
   }
   else
   {
       $tab_def_campos['appointments_type_description'] = "appointments_type.description";
   }
   $tab_labels["appointments_type_description"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointment_details']['labels']["appointments_type_description"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointment_details']['labels']["appointments_type_description"] : "" . $this->Nm_lang['lang_appointments_type_fld_description'] . "";
   $tab_ger_campos['appointments_type_duration'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['appointments_type_duration'] = "appointments_type_duration";
   }
   else
   {
       $tab_def_campos['appointments_type_duration'] = "appointments_type.duration";
   }
   $tab_labels["appointments_type_duration"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointment_details']['labels']["appointments_type_duration"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointment_details']['labels']["appointments_type_duration"] : "" . $this->Nm_lang['lang_appointments_type_fld_duration'] . "";
   $tab_ger_campos['appointments_type_price'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['appointments_type_price'] = "appointments_type_price";
   }
   else
   {
       $tab_def_campos['appointments_type_price'] = "appointments_type.price";
   }
   $tab_labels["appointments_type_price"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointment_details']['labels']["appointments_type_price"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointment_details']['labels']["appointments_type_price"] : "" . $this->Nm_lang['lang_appointments_type_fld_price'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_appointment_details']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_appointment_details']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_appointment_details']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_appointment_details']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_appointment_details']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_appointment_details']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_appointment_details']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_appointment_details']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_appointment_details']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_appointment_details']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_appointment_details']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_appointment_details']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_appointment_details_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_appointment_details']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_appointment_details']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_appointment_details']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_appointment_details']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_appointment_details']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
