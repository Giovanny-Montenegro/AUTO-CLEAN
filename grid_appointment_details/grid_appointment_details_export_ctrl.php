<?php
@session_start() ;
$_SESSION['scriptcase']['grid_appointment_details']['sc_process_barr'] = true;
require_once('../grid_appointment_details/index.php');
unset($_SESSION['scriptcase']['grid_appointment_details']['sc_process_barr']);
$ExportCtrl = new grid_appointment_details_export_control;
$ExportCtrl->Export_barr();

class grid_appointment_details_export_control
{
