<?php
@session_start() ;
$_SESSION['scriptcase']['grid_appointments']['sc_process_barr'] = true;
require_once('../grid_appointments/index.php');
unset($_SESSION['scriptcase']['grid_appointments']['sc_process_barr']);
$ExportCtrl = new grid_appointments_export_control;
$ExportCtrl->Export_barr();

class grid_appointments_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Nm_lang['lang_tbl_appointments'] ?></TITLE>
