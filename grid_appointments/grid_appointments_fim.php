...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["appointments1_____grid_appointments"]))
   {
      unset($_SESSION['session_sec_aplicacao']["appointments1_____grid_appointments"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_appointments']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_appointments']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_appointments']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_appointments']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_appointments']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_appointments']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_appointments']['embutida_filho'] as $ind => $sc_init)
          {
