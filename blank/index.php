<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['blank']['glo_nm_perfil']          = "conn_example";
...
//
   function init($Tp_init = "")
   {
      ...
      $this->nm_dt_criacao   = "20161118"; 
      $this->nm_hr_criacao   = "171907"; 
...
// 
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['blank']['sub_cons_schema_all']))
      { 
         $this->str_schema_all    = $_SESSION['sc_session'][$this->sc_page]['blank']['sub_cons_schema_all'];
         $this->str_schema_filter = $_SESSION['sc_session'][$this->sc_page]['blank']['sub_cons_schema_filter'];
      } 
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->sc_page]['blank']['dashboard_info']['under_dashboard'])
      {
        ...
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['blank']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['blank']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['blank']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['blank']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['blank']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['blank']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['blank']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['blank']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['blank']['link_info']['remove_border'] = true;
        }

      if (!isset($_SESSION['sc_session'][$this->sc_page]['blank']['responsive_chart']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blank']['responsive_chart'] = array(
              'enabled' => false,
              'active'  => false,
          );
      }
      if ($_SESSION['sc_session'][$this->sc_page]['blank']['responsive_chart']['enabled'])
      {
          $_SESSION['sc_session'][$this->sc_page]['blank']['responsive_chart']['active'] = true;
      }
      elseif ($_SESSION['sc_session'][$this->sc_page]['blank']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->sc_page]['blank']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->sc_page]['blank']['dashboard_info']['maximized'])
      {
          $_SESSION['sc_session'][$this->sc_page]['blank']['responsive_chart']['active'] = true;
      }
      else
      {
          $_SESSION['sc_session'][$this->sc_page]['blank']['responsive_chart']['active'] = false;
      }
      if ($Tp_init == "Path_sub")
      {
          return;
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['blank']['glo_nm_conexao'], $this->root . $this->path_prod, 'appointments1', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blank']['embutida']) || !$_SESSION['sc_session'][$this->sc_page]['blank']['embutida'])
      {
...
//----- 
   function controle()
   {
      ...
      {
          include_once("blank_sc_mail_image.php");
      }
      $this->nm_data = new nm_data("en_us");
...
//
    ...
    {
        $Mens_Mail = Swift_Message::newInstance("prueba 1")->setBody("puebra de mensaje")->setContentType("text/html");
    }
    else
    {
        $Mens_Mail = Swift_Message::newInstance("prueba 1")->setBody("puebra de mensaje");
    }
    ...
    $Temp_mail = explode(";", "giovanny_nahin1999@hotmail.com");
    foreach ($Temp_mail as $NM_dest)
    {
        if (!empty($NM_dest))
        {
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['blank']['glo_nm_path_imag_temp'] . "/sc_apl_default_appointments1.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['blank']['glo_nm_path_imag_temp'] . "/sc_apl_default_appointments1.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "blank") {
           ...
           if (isset($_COOKIE['sc_actual_lang_appointments1'])) {
               $_SESSION['scriptcase']['blank']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_appointments1'];
           }
       }
   }
