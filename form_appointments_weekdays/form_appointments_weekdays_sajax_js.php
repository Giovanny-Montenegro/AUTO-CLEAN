  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_appointments_weekdays" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_appointments_weekdays_form();
	}
...
?>
  ...
  // ---------- Validate id_weekday
  function do_ajax_form_appointments_weekdays_validate_id_weekday()
  {
    var nomeCampo_id_weekday = "id_weekday";
    var var_id_weekday = scAjaxGetFieldHidden(nomeCampo_id_weekday);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_weekdays_validate_id_weekday(var_id_weekday, var_script_case_init, do_ajax_form_appointments_weekdays_validate_id_weekday_cb);
  } // do_ajax_form_appointments_weekdays_validate_id_weekday

  function do_ajax_form_appointments_weekdays_validate_id_weekday_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_weekday";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_weekdays_validate_id_weekday_cb

  // ---------- Validate weekday_descr
  function do_ajax_form_appointments_weekdays_validate_weekday_descr()
  {
    var nomeCampo_weekday_descr = "weekday_descr";
    var var_weekday_descr = scAjaxGetFieldText(nomeCampo_weekday_descr);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_weekdays_validate_weekday_descr(var_weekday_descr, var_script_case_init, do_ajax_form_appointments_weekdays_validate_weekday_descr_cb);
  } // do_ajax_form_appointments_weekdays_validate_weekday_descr

  function do_ajax_form_appointments_weekdays_validate_weekday_descr_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "weekday_descr";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_weekdays_validate_weekday_descr_cb

  // ---------- Validate times
  function do_ajax_form_appointments_weekdays_validate_times()
  {
    var nomeCampo_times = "times";
    nm_pack(nomeCampo_times + '_dest', nomeCampo_times);
    var var_times = scAjaxGetFieldText(nomeCampo_times);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_weekdays_validate_times(var_times, var_script_case_init, do_ajax_form_appointments_weekdays_validate_times_cb);
  } // do_ajax_form_appointments_weekdays_validate_times

  function do_ajax_form_appointments_weekdays_validate_times_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "times";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_weekdays_validate_times_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_appointments_weekdays_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_appointments_weekdays_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_weekday = scAjaxGetFieldHidden("id_weekday");
    var var_weekday_descr = scAjaxGetFieldText("weekday_descr");
    nm_pack("times_dest", "times");
    var var_times = scAjaxGetFieldText("times", "@?@");
    ...
    scAjaxProcOn();
    x_ajax_form_appointments_weekdays_submit_form(var_id_weekday, var_weekday_descr, var_times, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_appointments_weekdays_submit_form_cb);
  } // do_ajax_form_appointments_weekdays_submit_form

  function do_ajax_form_appointments_weekdays_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_weekday");
      scAjaxHideErrorDisplay("weekday_descr");
      scAjaxHideErrorDisplay("times");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_appointments_weekdays_submit_form_cb_after_alert);
  } // do_ajax_form_appointments_weekdays_submit_form_cb
  function do_ajax_form_appointments_weekdays_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_appointments_weekdays_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_appointments_weekdays_navigate_form()
  {
    perform_ajax_form_appointments_weekdays_navigate_form();
  }

  function perform_ajax_form_appointments_weekdays_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("weekday_descr");
    scAjaxHideErrorDisplay("times");
    var var_id_weekday = document.F2.id_weekday.value;
    ...
    scAjaxProcOn();
    x_ajax_form_appointments_weekdays_navigate_form(var_id_weekday, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_appointments_weekdays_navigate_form_cb);
  } // do_ajax_form_appointments_weekdays_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments_weekdays']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_appointments_weekdays_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_weekday.value = scAjaxGetKeyValue("id_weekday");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_appointments_weekdays_navigate_form_cb_after_alert);
  } // do_ajax_form_appointments_weekdays_navigate_form_cb
  function do_ajax_form_appointments_weekdays_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_appointments_weekdays_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_appointments_weekdays_navigate_form_cb_after_alert

  function sc_hide_form_appointments_weekdays_form()
  {
  ...
  ajax_field_list[0] = "id_weekday";
  ajax_field_list[1] = "weekday_descr";
  ajax_field_list[2] = "times";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "id_weekday": {"label": "<?php echo $this->Ini->Nm_lang['lang_appointments_weekdays_fld_id_weekday'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "weekday_descr": {"label": "<?php echo $this->Ini->Nm_lang['lang_appointments_weekdays_fld_weekday_descr'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "times": {"label": "<?php echo $this->Ini->Nm_lang['lang_tbl_staff_worktime'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "id_weekday": new Array(),
    "weekday_descr": new Array(),
    "times": new Array()
  };
  ajax_field_mult["id_weekday"][1] = "id_weekday";
  ajax_field_mult["weekday_descr"][1] = "weekday_descr";
  ajax_field_mult["times"][1] = "times";

  var ajax_field_id = {
    "id_weekday": new Array("hidden_field_label_id_weekday", "hidden_field_data_id_weekday"),
    "weekday_descr": new Array("hidden_field_label_weekday_descr", "hidden_field_data_weekday_descr"),
    "times": new Array("hidden_field_label_times", "hidden_field_data_times")
  };
