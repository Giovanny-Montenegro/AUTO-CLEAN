  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_appointments_weekdays_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_appointments_weekdays_mob_form();
	}
...
?>
  ...
  // ---------- Validate id_weekday
  function do_ajax_form_appointments_weekdays_mob_validate_id_weekday()
  {
    var nomeCampo_id_weekday = "id_weekday";
    var var_id_weekday = scAjaxGetFieldHidden(nomeCampo_id_weekday);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_weekdays_mob_validate_id_weekday(var_id_weekday, var_script_case_init, do_ajax_form_appointments_weekdays_mob_validate_id_weekday_cb);
  } // do_ajax_form_appointments_weekdays_mob_validate_id_weekday

  function do_ajax_form_appointments_weekdays_mob_validate_id_weekday_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_weekdays_mob_validate_id_weekday_cb

  // ---------- Validate weekday_descr
  function do_ajax_form_appointments_weekdays_mob_validate_weekday_descr()
  {
    var nomeCampo_weekday_descr = "weekday_descr";
    var var_weekday_descr = scAjaxGetFieldText(nomeCampo_weekday_descr);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_weekdays_mob_validate_weekday_descr(var_weekday_descr, var_script_case_init, do_ajax_form_appointments_weekdays_mob_validate_weekday_descr_cb);
  } // do_ajax_form_appointments_weekdays_mob_validate_weekday_descr

  function do_ajax_form_appointments_weekdays_mob_validate_weekday_descr_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_weekdays_mob_validate_weekday_descr_cb

  // ---------- Validate times
  function do_ajax_form_appointments_weekdays_mob_validate_times()
  {
    var nomeCampo_times = "times";
    nm_pack(nomeCampo_times + '_dest', nomeCampo_times);
    var var_times = scAjaxGetFieldText(nomeCampo_times);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_weekdays_mob_validate_times(var_times, var_script_case_init, do_ajax_form_appointments_weekdays_mob_validate_times_cb);
  } // do_ajax_form_appointments_weekdays_mob_validate_times

  function do_ajax_form_appointments_weekdays_mob_validate_times_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "times";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_weekdays_mob_validate_times_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_appointments_weekdays_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_appointments_weekdays_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_appointments_weekdays_mob_submit_form(var_id_weekday, var_weekday_descr, var_times, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_appointments_weekdays_mob_submit_form_cb);
  } // do_ajax_form_appointments_weekdays_mob_submit_form

  function do_ajax_form_appointments_weekdays_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_appointments_weekdays_mob_submit_form_cb_after_alert);
  } // do_ajax_form_appointments_weekdays_mob_submit_form_cb
  function do_ajax_form_appointments_weekdays_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_appointments_weekdays_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_appointments_weekdays_mob_navigate_form()
  {
    perform_ajax_form_appointments_weekdays_mob_navigate_form();
  }

  function perform_ajax_form_appointments_weekdays_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_appointments_weekdays_mob_navigate_form(var_id_weekday, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_appointments_weekdays_mob_navigate_form_cb);
  } // do_ajax_form_appointments_weekdays_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments_weekdays_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_appointments_weekdays_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_appointments_weekdays_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_appointments_weekdays_mob_navigate_form_cb
  function do_ajax_form_appointments_weekdays_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_appointments_weekdays_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_appointments_weekdays_mob_navigate_form_cb_after_alert

  function sc_hide_form_appointments_weekdays_mob_form()
  {
