...
$this->tab_grupo[0] = "appointments1/";
if ($_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
}
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("my_calendar") . "/my_calendar_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['my_calendar']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_appointments_customer") . "/grid_appointments_customer_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_appointments_customer']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("new_request_catalog") . "/new_request_catalog_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['new_request_catalog']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_staff") . "/grid_staff_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_appointments_type") . "/form_appointments_type_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_appointments_type']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_appointments_weekdays") . "/grid_appointments_weekdays_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_appointments_weekdays']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_appointments_worktime") . "/form_appointments_worktime_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_appointments_worktime']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_unavailable_dates") . "/grid_unavailable_dates_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_unavailable_dates']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("app_retrieve_pswd") . "/app_retrieve_pswd_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_retrieve_pswd']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['app_retrieve_pswd'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
if (!isset($_SESSION['group_name'])) {$_SESSION['group_name'] = "";}
if (!isset($this->sc_temp_group_name)) {$this->sc_temp_group_name = (isset($_SESSION['group_name'])) ? $_SESSION['group_name'] : "";}
 $this->sc_temp_group_name = "";

switch ($this->sc_temp_usr_group){
		case 2:
			$this->sc_temp_group_name = $this->Nm_lang['lang_appointments_fld_staff_id'];
		  break;
		
		case 3:
			$this->sc_temp_group_name = $this->Nm_lang['lang_appointments_fld_customers_id'];
		  break;
		
		default:
			$this->sc_temp_group_name = $this->Nm_lang['lang_administrator'];
		  break;
	  }
...
$menu_menuData['data'] .= "item_1|.|" . $this->Nm_lang['lang_administrator'] . "||" . $nm_var_hint[0] . "|grp__NM__ico__NM__administrator-24 (1).png|_self|\n";
...
{
    $menu_menuData['data'] .= "item_5|..|" . $this->Nm_lang['lang_appointments_report'] . "|menu_form_php.php?sc_item_menu=item_5&sc_apl_menu=grid_appointments_adm&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[1] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['my_calendar']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['my_calendar']) == "on")
{
    $menu_menuData['data'] .= "item_6|..|" . $this->Nm_lang['lang_calendar_agenda'] . "|menu_form_php.php?sc_item_menu=item_6&sc_apl_menu=my_calendar&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[2] . "||" . $this->menu_target('_self') . "|" . "\n";
}

$menu_menuData['data'] .= "item_2|.|" . $this->Nm_lang['lang_tbl_customers'] . "||" . $nm_var_hint[3] . "|grp__NM__ico__NM__guest-24 (1).png|_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_customers']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_customers']) == "on")
{
    $menu_menuData['data'] .= "item_12|..|" . $this->Nm_lang['lang_customers_report'] . "|menu_form_php.php?sc_item_menu=item_12&sc_apl_menu=grid_customers&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[4] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_appointments_customer']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_appointments_customer']) == "on")
{
    $menu_menuData['data'] .= "item_7|..|" . $this->Nm_lang['lang_appointments_report'] . "|menu_form_php.php?sc_item_menu=item_7&sc_apl_menu=grid_appointments_customer&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[5] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['new_request_catalog']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['new_request_catalog']) == "on")
{
    $menu_menuData['data'] .= "item_8|..|" . $this->Nm_lang['lang_request_appointment'] . "|menu_form_php.php?sc_item_menu=item_8&sc_apl_menu=new_request_catalog&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[6] . "||" . $this->menu_target('_self') . "|" . "\n";
}

$menu_menuData['data'] .= "item_3|.|" . $this->Nm_lang['lang_tbl_staff'] . "||" . $nm_var_hint[7] . "|grp__NM__ico__NM__worker-24 (1).png|_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_staff']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_staff']) == "on")
{
    $menu_menuData['data'] .= "item_13|..|" . $this->Nm_lang['lang_staff_report'] . "|menu_form_php.php?sc_item_menu=item_13&sc_apl_menu=grid_staff&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[8] . "||" . $this->menu_target('_self') . "|" . "\n";
}
...
{
    $menu_menuData['data'] .= "item_15|..|" . $this->Nm_lang['lang_calendar_agenda'] . "|menu_form_php.php?sc_item_menu=item_15&sc_apl_menu=calendar_appointments_staff&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[9] . "||" . $this->menu_target('_self') . "|" . "\n";
}
...
{
    $menu_menuData['data'] .= "item_16|..|" . $this->Nm_lang['lang_appointments_report'] . "|menu_form_php.php?sc_item_menu=item_16&sc_apl_menu=grid_appointments_staff&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[10] . "||" . $this->menu_target('_self') . "|" . "\n";
}

$menu_menuData['data'] .= "item_9|.|" . $this->Nm_lang['lang_othr_smry_ppup_titl'] . "||" . $nm_var_hint[11] . "|grp__NM__ico__NM__settings-5-24 (1).png|_self|\n";
...
{
    $menu_menuData['data'] .= "item_10|..|" . $this->Nm_lang['lang_tbl_appointment_status'] . "|menu_form_php.php?sc_item_menu=item_10&sc_apl_menu=form_appointment_status&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[12] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_appointments_type']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_appointments_type']) == "on")
{
    $menu_menuData['data'] .= "item_11|..|" . $this->Nm_lang['lang_tbl_appointments_type'] . "|menu_form_php.php?sc_item_menu=item_11&sc_apl_menu=form_appointments_type&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[13] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_appointments_weekdays']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_appointments_weekdays']) == "on")
{
    $menu_menuData['data'] .= "item_26|..|" . $this->Nm_lang['lang_tbl_appointments_weekdays'] . "|menu_form_php.php?sc_item_menu=item_26&sc_apl_menu=grid_appointments_weekdays&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[14] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_appointments_worktime']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_appointments_worktime']) == "on")
{
    $menu_menuData['data'] .= "item_27|..|" . $this->Nm_lang['lang_tbl_appointments_worktime'] . "|menu_form_php.php?sc_item_menu=item_27&sc_apl_menu=form_appointments_worktime&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[15] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_unavailable_dates']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_unavailable_dates']) == "on")
{
    $menu_menuData['data'] .= "item_28|..|" . $this->Nm_lang['lang_tbl_unavailable_dates'] . "|menu_form_php.php?sc_item_menu=item_28&sc_apl_menu=grid_unavailable_dates&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[16] . "||" . $this->menu_target('_self') . "|" . "\n";
}

$menu_menuData['data'] .= "item_17|.|" . $this->Nm_lang['lang_menu_security'] . "||" . $this->Nm_lang['lang_menu_security'] . "|grp__NM__ico__NM__padlock-2-24 (1).png|_self|\n";
...
{
    $menu_menuData['data'] .= "item_18|..|" . $this->Nm_lang['lang_list_users'] . "|menu_form_php.php?sc_item_menu=item_18&sc_apl_menu=app_grid_sec_users&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_users'] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_apps']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_apps']) == "on")
{
    $menu_menuData['data'] .= "item_19|..|" . $this->Nm_lang['lang_list_apps'] . "|menu_form_php.php?sc_item_menu=item_19&sc_apl_menu=app_grid_sec_apps&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_apps'] . "||" . $this->menu_target('_self') . "|" . "\n";
}
...
{
    $menu_menuData['data'] .= "item_20|..|" . $this->Nm_lang['lang_list_groups'] . "|menu_form_php.php?sc_item_menu=item_20&sc_apl_menu=app_grid_sec_groups&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_groups'] . "||" . $this->menu_target('_self') . "|" . "\n";
}
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_retrieve_pswd']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_retrieve_pswd']) == "on")
{
    $menu_menuData['data'] .= "item_29|..|" . $this->Nm_lang['lang_retrieve_pswd'] . "|menu_form_php.php?sc_item_menu=item_29&sc_apl_menu=app_retrieve_pswd&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_retrieve_pswd'] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) == "on")
{
    $menu_menuData['data'] .= "item_24|.|" . $this->Nm_lang['lang_exit'] . "|menu_form_php.php?sc_item_menu=item_24&sc_apl_menu=app_Login&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_exit'] . "|grp__NM__ico__NM__exit-24 (1).png|" . $this->menu_target('_parent') . "|" . "\n";
}
...
$menu_menuData['data'][] = array(
    'label'    => "" . $this->Nm_lang['lang_administrator'] . "",
    'level'    => "0",
    'link'     => $str_link,
    'hint'     => "" . $nm_var_hint[0] . "",
    'id'       => "item_1",
...
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_appointments_adm']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_appointments_adm']) != "on")
{
    ...
    $menu_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_appointments_report'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[1] . "",
        'id'       => "item_5",
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_6&sc_apl_menu=my_calendar&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['my_calendar']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['my_calendar']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_calendar_agenda'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[2] . "",
        'id'       => "item_6",
...
$str_disabled = "N";
$str_link = "#";
$str_icon = "grp__NM__ico__NM__guest-24 (1).png";
$icon_aba = "";
$icon_aba_inactive = "";
if(empty($icon_aba) && isset($arr_menuicons['others']['active']))
{
...
$menu_menuData['data'][] = array(
    'label'    => "" . $this->Nm_lang['lang_tbl_customers'] . "",
    'level'    => "0",
    'link'     => $str_link,
    'hint'     => "" . $nm_var_hint[3] . "",
    'id'       => "item_2",
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_12&sc_apl_menu=grid_customers&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_customers']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_customers']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_customers_report'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[4] . "",
        'id'       => "item_12",
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_7&sc_apl_menu=grid_appointments_customer&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_appointments_customer']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_appointments_customer']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_8&sc_apl_menu=new_request_catalog&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['new_request_catalog']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['new_request_catalog']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_request_appointment'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[6] . "",
        'id'       => "item_8",
...
$menu_menuData['data'][] = array(
    'label'    => "" . $this->Nm_lang['lang_tbl_staff'] . "",
    'level'    => "0",
    'link'     => $str_link,
    'hint'     => "" . $nm_var_hint[7] . "",
    'id'       => "item_3",
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_13&sc_apl_menu=grid_staff&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_staff']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_staff']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$menu_menuData['data'][] = array(
    'label'    => "" . $this->Nm_lang['lang_othr_smry_ppup_titl'] . "",
    'level'    => "0",
    'link'     => $str_link,
    'hint'     => "" . $nm_var_hint[11] . "",
    'id'       => "item_9",
...
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_appointment_status']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_appointment_status']) != "on")
{
    ...
    $menu_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_tbl_appointment_status'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[12] . "",
        'id'       => "item_10",
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_11&sc_apl_menu=form_appointments_type&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_appointments_type']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_appointments_type']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_tbl_appointments_type'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[13] . "",
        'id'       => "item_11",
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_26&sc_apl_menu=grid_appointments_weekdays&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_appointments_weekdays']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_appointments_weekdays']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_tbl_appointments_weekdays'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[14] . "",
        'id'       => "item_26",
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_27&sc_apl_menu=form_appointments_worktime&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_appointments_worktime']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_appointments_worktime']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_tbl_appointments_worktime'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[15] . "",
        'id'       => "item_27",
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_28&sc_apl_menu=grid_unavailable_dates&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_unavailable_dates']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_unavailable_dates']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_tbl_unavailable_dates'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[16] . "",
        'id'       => "item_28",
...
$str_disabled = "N";
$str_link = "#";
$str_icon = "grp__NM__ico__NM__padlock-2-24 (1).png";
$icon_aba = "";
$icon_aba_inactive = "";
if(empty($icon_aba) && isset($arr_menuicons['others']['active']))
{
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_29&sc_apl_menu=app_retrieve_pswd&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_retrieve_pswd']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_retrieve_pswd']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_retrieve_pswd'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $this->Nm_lang['lang_retrieve_pswd'] . "",
        'id'       => "item_29",
        'icon'     => $str_icon,
        'icon_aba' => $icon_aba,
        'icon_aba_inactive' => $icon_aba_inactive,
...
<head>
 <title><?php echo $this->Nm_lang['lang_proj_title'] ?></title>
...
?>
        <td class='sc-layer-0' style='width:5%;text-align:center;'>
                        <span class='sc-layer-0-0' style='font-size: 16px;background-color: ;font-family: ;color: #000000;'>   <img src="<?php echo $path_imag_cab ?>/grp__NM__ico__NM__training-50.png" border="0"/></span><br/>

        </td>        <td class='sc-layer-2' style='width:10.44%;text-align:left;'>
                        <span class='sc-layer-2-0' style='font-size: 24px;background-color: ;font-family: Open Sans,Arial,sans-serif;;color: #ffffff;'><?php echo "" . $this->Nm_lang['lang_proj_title'] . "" ?></span><br/>
  ...
  <div class='mainmenu menu--horizontal'>
      ...
      <div class='menu__container '>
        ...
        <td class='sc-layer-1' style='width:20%;text-align:right;'>
            ...
            <span class='sc-layer-1-1' style='font-size: 14px;background-color: ;font-family: Open Sans,Arial,sans-serif;;color: #ffffff;'><?php echo "" . $this->Nm_lang['lang_logged_as'] . ": " . $_SESSION['group_name'] . "" ?></span><br/>
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['menu']['glo_nm_path_imag_temp'] . "/sc_apl_default_appointments1.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['menu']['glo_nm_path_imag_temp'] . "/sc_apl_default_appointments1.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "menu") {
        ...
        if (isset($_COOKIE['sc_actual_lang_appointments1'])) {
            $_SESSION['scriptcase']['menu']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_appointments1'];
        }
    }
}
