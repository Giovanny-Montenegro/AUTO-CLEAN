...
class grid_appointments_adm_resumo
{
   ...
   var $array_total_customers_id;
   var $array_total_appointment_start_date;
   var $array_total_appointment_start_time;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_customers_id           = array();
      $this->array_total_appointment_start_date = array();
      $this->array_total_appointment_start_time = array();
...
$_SESSION['scriptcase']['grid_appointments_adm']['contr_erro'] = 'off'; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['tot_geral'][1];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['tot_geral'][2];
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['arr_total']['staff_id'] = $this->array_total_staff_id;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['arr_total']['customers_id'] = $this->array_total_customers_id;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['arr_total']['appointment_start_date'] = $this->array_total_appointment_start_date;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['arr_total']['appointment_start_time'] = $this->array_total_appointment_start_time;
   ...
   function completeMatrix()
   {
       ...
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['json_use_label'])
       {
          ...
          $Lab_customers_id = "customers_id";
          $Lab_appointment_start_date = "appointment_start_date";
          $Lab_appointment_start_time = "appointment_start_time";
       }
       else
       {
       $Lab_staff_id = "" . $this->Ini->Nm_lang['lang_appointments_fld_staff_id'] . "";
       $Lab_customers_id = "" . $this->Ini->Nm_lang['lang_appointments_fld_customers_id'] . "";
       $Lab_appointment_start_date = "" . $this->Ini->Nm_lang['lang_appointments_fld_appointment_start_date'] . "";
       $Lab_appointment_start_time = "" . $this->Ini->Nm_lang['lang_appointments_fld_appointment_start_time'] . "";
       }
       $prep_field = array();
       $prep_field['staff_id'] = $Lab_staff_id;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['staff_id'] = $Lab_staff_id; 
       $prep_field['customers_id'] = $Lab_customers_id;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['customers_id'] = $Lab_customers_id; 
       $prep_field['appointment_start_date'] = $Lab_appointment_start_date;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['appointment_start_date'] = $Lab_appointment_start_date; 
       $prep_field['appointment_start_time'] = $Lab_appointment_start_time;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['appointment_start_time'] = $Lab_appointment_start_time; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['appointment_start_date']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['appointment_start_date'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_appointment_start_date'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['appointment_start_time']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['appointment_start_time'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_appointment_start_time'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['staff_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['staff_id'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_staff_id'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['customers_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['customers_id'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_customers_id'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['total_price']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['total_price'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_total_price'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['appointments_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['appointments_id'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_appointments_id'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['price']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['price'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_price'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['additional_charges']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['additional_charges'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_additional_charges'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['discount']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['discount'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_discount'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['appointment_end_date']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['appointment_end_date'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_appointment_end_date'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['appointment_end_time']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['appointment_end_time'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_appointment_end_time'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['current_status_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['current_status_id'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_current_status_id'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['appointment_recurrent']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['appointment_recurrent'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_appointment_recurrent'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['appointment_period']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['appointment_period'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_appointment_period'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['appointment_rating']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['appointment_rating'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_appointment_rating'] . ""; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       $this->comp_sum = array(
           ...
           3 => "Total Price(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")",
       );
       ...
       $this->comp_sum_lnk = array(
           ...
           3 => array('field' => "total_price", 'show' => true),
       );

       //-----
       $this->comp_sum_css = array(
           2 => "css___nm_count_nm___cnt",
           3 => "css_total_price_sum",
       );
      ...
      eval ($Str_gb);
       ...
       $Arr_parms['customers_id']['alin'] = "''";
       $Arr_parms['customers_id']['link'] = "S";
       $Arr_parms['appointment_start_date']['alin'] = "''";
       $Arr_parms['appointment_start_date']['link'] = "S";
       $Arr_parms['appointment_start_time']['alin'] = "''";
       $Arr_parms['appointment_start_time']['link'] = "S";
       $Arr_parms['staff_id']['fill'] = "true";
       $Arr_parms['staff_id']['order'] = "label";
       ...
       $Arr_parms['customers_id']['fill'] = "true";
       $Arr_parms['customers_id']['order'] = "label";
       $Arr_parms['customers_id']['order_start'] = 'asc';
       $Arr_parms['customers_id']['order_invert'] = 'false';
       $Arr_parms['customers_id']['order_enabled'] = 'false';
       $Arr_parms['customers_id']['order_datatype'] = 'int';
       $Arr_parms['customers_id']['rating_function'] = '';
       ...
       $Arr_parms['appointment_start_time']['fill'] = "true";
       $Arr_parms['appointment_start_time']['order'] = "label";
       $Arr_parms['appointment_start_time']['order_start'] = 'asc';
       $Arr_parms['appointment_start_time']['order_invert'] = 'false';
       $Arr_parms['appointment_start_time']['order_enabled'] = 'false';
       $Arr_parms['appointment_start_time']['order_datatype'] = 'time';
       $Arr_parms['appointment_start_time']['rating_function'] = '';
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       $prep_links_fl['customers_id'] = array(0 => 'customers_id', 1 => '');
       $prep_links_fl['appointment_start_date'] = array(0 => 'appointment_start_date', 1 => '@aspass@');
       $prep_links_fl['appointment_start_time'] = array(0 => 'appointment_start_time', 1 => '@aspass@');
       $Str_gb = "";
   ...
   function buildChart()
   {
       ...
       $prep_chart_config = array(
           ...
           '2' => array(
               'title'    => $this->getChartText(strip_tags("Total Price(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'staff_id',
               'field_y'  => $this->comp_sum_nm[3],
               'label_x'  => $this->getChartText(strip_tags($Lab_staff_id)),
               'label_y'  => $this->getChartText(strip_tags("Total Price(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
           ...
           '1' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'customers_id',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_customers_id)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           '2' => array(
           ...
           '1' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'appointment_start_time',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_appointment_start_time)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           '2' => array(
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['pivot_orig'];
		...
		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['chart_level']) {
   ...
   function drawMatrix()
   {
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['doc_word'])
{
      ...
      { 
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['ajax_nav']) {  
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_appointments_adm/grid_appointments_adm_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_opc=resumo&nm_cor=PB&nm_res_cons=s&nm_ini_prt_res=resume&nm_all_modules=grid,resume,chart&password=n&origem=res&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
   ...
   function monta_barra_top_mobile()
   {
      ...
      if ($this->nmgp_botoes['filter'] == 'on' && !$this->Ini->SC_Link_View && !$this->grid_emb_form)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpesquisa", "", "", "Rpesq_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_appointments_adm/grid_appointments_adm.php?script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&nmgp_opcao=busca&nmgp_orig_pesq=res&KeepThis=true&TB_iframe=true&height=0&width=0&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_appointments_adm']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_appointments_adm']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_appointments_adm_config_pivot.php?nome_apl=grid_appointments_adm&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_total_price, $quebra_staff_id, $quebra_customers_id, $quebra_appointment_start_date, $quebra_appointment_start_time, $quebra_staff_id_orig, $quebra_customers_id_orig, $quebra_appointment_start_date_orig, $quebra_appointment_start_time_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          ...
          $cmp_look   = "Cmp_formt";
          $cmp_orig   = "Cmp_arg";
          if (empty($sum_total_price)) {$sum_total_price = '0';}
          eval ('
          if (!isset($this->' . $arr_name . '))
          {
              $this->' . $arr_name . '[0] = 1;
              $this->' . $arr_name . '[1] = ' . $sum_total_price . ';
              $this->' . $arr_name . '[2] = 1;
          ...
          {
              $this->' . $arr_name . '[0]++;
              $this->' . $arr_name . '[1] = bcadd($this->' . $arr_name . '[1], ' . $sum_total_price . ', 10);
              $this->' . $arr_name . '[2]++;
          }
          ');
      }
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->staff_id = $rs_res->fields[2] ;  
            $this->customers_id = $rs_res->fields[3] ;  
            $this->total_price = $rs_res->fields[4] ;  
            $this->total_price =  str_replace(",", ".", $this->total_price);
            $this->appointments_id = $rs_res->fields[5] ;  
            $this->price = $rs_res->fields[6] ;  
            $this->price =  str_replace(",", ".", $this->price);
            $this->additional_charges = $rs_res->fields[7] ;  
            ...
            $this->current_status_id = $rs_res->fields[9] ;  
            $this->staff_id_orig = $this->staff_id;
            $this->customers_id_orig = $this->customers_id;
            $this->appointment_start_date_orig = $this->appointment_start_date;
            $this->appointment_start_time_orig = $this->appointment_start_time;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->total_price, $this->staff_id, $this->customers_id, $this->appointment_start_date, $this->appointment_start_time, $this->staff_id_orig,  $this->customers_id_orig,  $this->appointment_start_date_orig,  $this->appointment_start_time_orig);
            }
   }
//
