...
// 
    ...
    $out1_img_cache = $_SESSION['scriptcase']['grid_appointments_adm']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['grid_appointments_adm']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if (!$_SESSION['sc_session'][$this->sc_page]['grid_appointments_adm']['embutida'])
    {
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_appointments_adm']['dyn_search_aut_comp']['cmp'] = $_GET['field'];
          $_SESSION['sc_session'][$this->sc_page]['grid_appointments_adm']['opcao'] = $_GET['origem'];
...
<?php
      ...
      $this->sc_lig_target["A_@scinf__@scinf_form_appointments"] = '_self';
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_appointments_adm']['glo_nm_conexao'], $this->root . $this->path_prod, 'appointments1', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if (!$this->Ini || isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_adm']['embutida_ibase'])) 
      { 
          $this->Ini = new grid_appointments_adm_ini(); 
          $this->Ini->init();
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['embutida'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['embutida_ibase'] = true;
      }
       ...
       { 
           ...
           foreach ($todo as $param)
           {
                ...
                { 
                    ...
                    elseif ($cadapar[0] == "appointment_start_time")
                    {
                        $cadapar[1]  = str_replace("@aspass@", "", $cadapar[1]);
                        $Format_tst  = $this->Ini->Get_Gb_date_format('sc_free_group_by', 'appointment_start_time');
                        $Temp_arg    = $this->Ini->Get_date_arg_sum($cadapar[1], $Format_tst, $cadapar[0], true);
                        $Temp_sql    = ($Temp_arg == " is null") ? $cadapar[0] : $this->Ini->Get_sql_date_groupby($cadapar[0], $Format_tst);
                        $Temp_parms .= $Temp_sql;
                        $Temp_parms .= $Temp_arg;
      ...
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['sc_modal']))
      {
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_appointments_adm']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_appointments_adm']['label'] = "" . $this->Ini->Nm_lang['lang_appointments_report'] . "";
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['SC_Gb_date_format']['sc_free_group_by']['appointment_start_date'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['SC_Gb_date_format']['sc_free_group_by']['appointment_start_date'] = 'YYYYMMDD2';
      }
      ...
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['SC_Ind_Groupby'] == "sc_free_group_by")
      {
          ...
          $Arr_free_labels['customers_id'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_customers_id'] . "";
          $Arr_free_labels['appointment_start_date'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_appointment_start_date'] . "";
          $Arr_free_labels['appointment_start_time'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_appointment_start_time'] . "";
      ...
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['SC_Ind_Groupby'] == "status")
      {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['Labels_GB'][] = "" . $this->Ini->Nm_lang['lang_appointments_fld_current_status_id'] . "";
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['summarizing_fields_display']['sc_free_group_by']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['summarizing_fields_display']['sc_free_group_by'][2] = array('label' => "" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['summarizing_fields_order']['sc_free_group_by'][] = 2;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['summarizing_fields_display']['sc_free_group_by'][3] = array('label' => "Total Price(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['summarizing_fields_order']['sc_free_group_by'][] = 3;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['summarizing_fields_control']['sc_free_group_by']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['summarizing_fields_control']['sc_free_group_by'] = array(
               ...
               array(
                   'cmp_res' => "total_price",
                   'label' => "Total Price(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")",
                   'label_field' => "" .  $this->Ini->Nm_lang['lang_appointments_fld_total_price'] . "",
                   'options' => array(
                       array('op' => 'S', 'index' => '3', 'label' => "" . $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . "", 'abbrev' => "Sum"),
                   ),
                   'select' => "<select class=\"sc-ui-select-total_price\" onChange=\"scSummChange($(this))\"><option value=\"3\" class=\"sc-ui-select-option-S\">" . $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . "</option></select>",
               ),
           );
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['summarizing_fields_display']['status']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['summarizing_fields_display']['status'][2] = array('label' => "" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['summarizing_fields_order']['status'][] = 2;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['summarizing_fields_display']['status'][3] = array('label' => "Total Price(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['summarizing_fields_order']['status'][] = 3;
      }
      ...
      $_SESSION['sc_session'][$script_case_init]['grid_appointments_adm']['skip_charts'] = (strpos(" " . $this->Ini->SC_module_export, "chart") !== false) ? false : true;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['conf_chart_level'] = "S";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['graf_disp']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['graf_disp']        = array('Bar', 'Pie', 'Line', 'Area');
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['graf_subtitle_val'] = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['chartpallet']       = '1';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['graf_exibe_val']    = '0';
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['proc_pdf'] = (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['embutida'] && ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['opcao'] == "pdf_res")) ? true : false;
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['field_order'][] = "appointment_start_date";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['field_order'][] = "appointment_start_time";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['field_order'][] = "staff_id";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['field_order'][] = "customers_id";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['field_order'][] = "total_price";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['field_order'][] = "appointments_id";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['field_order'][] = "price";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['field_order'][] = "additional_charges";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['field_order'][] = "discount";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['usr_cmp_sel']['appointments_id'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['usr_cmp_sel']['price'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['usr_cmp_sel']['additional_charges'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['usr_cmp_sel']['discount'] = "off";
      ...
      if ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['opcao']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['opcao']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['where_orig'])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['opcao'] = "inicio";
      }
      ...
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['opcao'] == "grid")  
          { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['opc_liga']['inicial']))
          {
              ...
              $_SESSION['sc_session'][$script_case_init]['grid_appointments_adm']['orig_pesq'] = "grid";
          }
      }
...
//----------------------------------->
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['opcao'] == "json")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_appointments_adm/grid_appointments_adm_json.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_appointments_adm_json.class.php"); 
          } 
          $this->json  = new grid_appointments_adm_json();
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['opcao'] == "resumo")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['embutida'])
          { 
...
<?php
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['embutida'])
      {
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            elseif (is_dir($this->Ini->path_third . $dir_qpdf) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['use_pass_pdf']))
            {
            ...
            if ($this->pdf_zip == "S")
            {
                $pdf_pass = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['use_pass_pdf'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['use_pass_pdf'] : "";
            ...
            elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['use_pass_pdf']))
            {
                if (FALSE !== strpos(strtolower(php_uname()), 'windows')) 
                {
                    $dir_qpdf = "/qpdf/win/bin";
                ...
                if (is_dir($this->Ini->path_third . $dir_qpdf)) 
                {
                    ...
                    $pdf_pass  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['use_pass_pdf'];
...
<?php
  ...
  function close_emb()
  {
   ...
   function SC_proc_dyn_search($Parms)
   {
       ...
       $fields = array();
       $busca  = array();
       $Cmps_check_return = array('staff_id','current_status_id');
       ...
       foreach ($tmp as $cada_f)
       {
           ...
           if (in_array($fields[$ix]['field'], $Cmps_check_return))
           {
               ...
               {
                   if (trim($Cada_val) != '' && !in_array($Cada_val, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['psq_check_ret'][$fields[$ix]['field']]))
                   {
                       $Temp = ob_get_clean();
                       $this->Ini->Arr_result['htmOutput'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels'][$fields[$ix]['field']] . " : " . NM_charset_to_utf8($this->Ini->Nm_lang['lang_errm_ajax_data']);
                       $oJson = new Services_JSON();
                       echo $oJson->encode($this->Ini->Arr_result);
                       $this->close_emb();
                       exit;
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['tmp_busca'] as $ind => $dados)
      {
       ...
       foreach ($fields as $ind => $dados)
       {
           ...
           if ($dados['field'] == "staff_id" && !empty($dados['vls']))
           {
               $Label_cmp     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search_label']['staff_id'];
               ...
               $this->SC_proc_dyn_search_all($dados['cond'], $dados['vls'], "staff_id", 'N', 'INT', $Label_cmp, false);
           }
           if ($dados['field'] == "customers_id" && !empty($dados['vls']))
           {
               $Label_cmp     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search_label']['customers_id'];
               $dados['vls'][0] = $dados['vls'][0][0];
               if ($dados['cond'] == "BW")
               {
               ...
               $this->SC_proc_dyn_search_all($dados['cond'], $dados['vls'], "customers_id", 'N', 'INT', $Label_cmp, false);
           }
           if ($dados['field'] == "appointment_start_date" && !empty($dados['vls']))
           {
               $Label_cmp     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search_label']['appointment_start_date'];
               if ($dados['cond'] != "BI_TP")
               {
           ...
           if ($dados['field'] == "current_status_id" && !empty($dados['vls']))
           {
               $Label_cmp     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search_label']['current_status_id'];
               $dados['vls'][0] = $dados['vls'][0][0];
               $tmp_pos = (is_string($dados['vls'][0])) ? strpos($dados['vls'][0], "##@@") : false;
               if ($tmp_pos === false)
               {
               ...
               $this->SC_proc_dyn_search_all($dados['cond'], $dados['vls'], "current_status_id", 'N', 'INT', $Label_cmp, false);
           }
       }
   ...
   function SC_proc_interativ_search($Parms)
   {
       ...
       if (!empty($vls))
       {
           ...
           if ($prep == "" && $bol_numeric)
           {
               if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " is null";
               }
               else
               {
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['grid_appointments_adm']['glo_nm_path_imag_temp'] . "/sc_apl_default_appointments1.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['grid_appointments_adm']['glo_nm_path_imag_temp'] . "/sc_apl_default_appointments1.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_appointments1'])) {
               $_SESSION['scriptcase']['grid_appointments_adm']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_appointments1'];
           }
       }
   }
   ...
   { 
       ...
       elseif (substr($_SESSION['sc_session'][$script_case_init]['grid_appointments_adm']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['grid_appointments_adm']['opcao'] != "pdf" ) 
       {
...
// 
       if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && substr($_SESSION['sc_session'][$script_case_init]['grid_appointments_adm']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['grid_appointments_adm']['opcao'] != "pdf" ) 
       { 
