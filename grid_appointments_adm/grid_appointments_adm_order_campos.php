<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_appointments_adm']['glo_nm_path_imag_temp'] . "/sc_apl_default_appointments1.txt"))
       {
?>
...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["appointment_start_date"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['labels']["appointment_start_date"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['labels']["appointment_start_date"] : "" . $this->Nm_lang['lang_appointments_fld_appointment_start_date'] . "";
   $tab_ger_campos['appointment_start_time'] = "on";
   $tab_def_campos['appointment_start_time'] = "appointment_start_time";
   $tab_labels["appointment_start_time"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['labels']["appointment_start_time"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['labels']["appointment_start_time"] : "" . $this->Nm_lang['lang_appointments_fld_appointment_start_time'] . "";
   $tab_ger_campos['staff_id'] = "on";
   $tab_def_campos['staff_id'] = "staff_id";
   $tab_labels["staff_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['labels']["staff_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['labels']["staff_id"] : "" . $this->Nm_lang['lang_appointments_fld_staff_id'] . "";
   $tab_ger_campos['customers_id'] = "on";
   $tab_def_campos['customers_id'] = "customers_id";
   $tab_labels["customers_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['labels']["customers_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['labels']["customers_id"] : "" . $this->Nm_lang['lang_appointments_fld_customers_id'] . "";
   $tab_ger_campos['total_price'] = "on";
   $tab_def_campos['total_price'] = "total_price";
   $tab_labels["total_price"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['labels']["total_price"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['labels']["total_price"] : "" . $this->Nm_lang['lang_appointments_fld_total_price'] . "";
