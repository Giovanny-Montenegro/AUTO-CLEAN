...
<?php
   ...
   function inicializa_vars()
   {
      ...
      $this->NM_tit_val[1]     = strip_tags("Total Price(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")");
      $this->NM_ind_val[1]     = 2;
      ...
      $prep_label['customers_id'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_customers_id'] . "";
      $prep_label['appointment_start_date'] = "" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "";
      $prep_label['appointment_start_time'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_appointment_start_time'] . "";
      $x = 0;
...
<?php
   ...
   function grafico_flash_config_js()
   {
      ...
      $sUrlConfigSave = $this->Ini->path_link . "grid_appointments_adm/grid_appointments_adm_config_graf_flash.php?nome_apl=grid_appointments_adm&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us";
   ...
   function grafico_flash_config_div()
   {
      ...
      $aChartDisp        = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['graf_disp'])      && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['graf_disp']))    ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['graf_disp']      : array('Bar', 'Pie', 'Line', 'Area');
