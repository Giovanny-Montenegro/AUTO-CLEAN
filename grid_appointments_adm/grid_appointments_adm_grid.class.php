...
class grid_appointments_adm_grid
{
   ...
   var $sum_total_price;
   var $staff_id_Old;
   var $arg_sum_staff_id;
   var $Label_staff_id;
   var $sc_proc_quebra_staff_id;
   var $count_staff_id;
   var $sum_staff_id_total_price;
   var $customers_id_Old;
   var $arg_sum_customers_id;
   var $Label_customers_id;
   var $sc_proc_quebra_customers_id;
   var $count_customers_id;
   var $sum_customers_id_total_price;
   ...
   var $sum_appointment_start_date_total_price;
   var $appointment_start_time_Old;
   var $arg_sum_appointment_start_time;
   var $Label_appointment_start_time;
   var $sc_proc_quebra_appointment_start_time;
   var $count_appointment_start_time;
   var $sum_appointment_start_time_total_price;
   ...
   var $sum_current_status_id_total_price;
...
//
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search_aut_comp']))
   {
       $Cmp_select2 = array("customers_id");
       $NM_func_aut_comp = "lookup_ajax_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search_aut_comp']['cmp'];
       ...
       foreach ($nmgp_def_dados as $Ind => $Lista)
       {
          if (is_array($Lista))
          {
              foreach ($Lista as $Cod => $Valor)
              {
                  ...
                  if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search_aut_comp']['cmp'], $Cmp_select2))
                  {
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search_aut_comp']);
       exit;
   }
   ...
   $this->sc_proc_quebra_staff_id = false;
   $this->sc_proc_quebra_customers_id = false;
   $this->sc_proc_quebra_appointment_start_date = false;
   $this->sc_proc_quebra_appointment_start_time = false;
 ...
 $today = date('Y-m-d');
$sql_where = " (appointment_start_date >= ".$this->Ini->sc_Sql_Protect($today, "date")." OR current_status_id = 1) ";

$this->nm_where_dinamico = " AND ".$sql_where;
...
//
   ...
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['qt_lin_grid'] = 10;
   }   
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['SC_Ind_Groupby'] == "sc_free_group_by") 
   {
       ...
       { 
           ...
           if (!isset($Free_sql_atual['appointment_start_date']))
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['ordem_select']['appointment_start_date'] = 'asc'; 
           } 
           $Free_sql_atual = array();
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['SC_Gb_Free_sql'] as $cmp => $resto)
           {
           ...
           if (!isset($Free_sql_atual['appointment_start_time']))
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['ordem_select']['appointment_start_time'] = 'asc'; 
           } 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['SC_Ind_Groupby'] == "status") 
   {
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['ordem_quebra'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['ordem_quebra']['current_status_id']["current_status_id"] = "asc"; 
       } 
   }
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['where_orig'] = " where (1=1)";  
...
// 
   ...
   $this->arg_sum_staff_id = "";
   $this->count_staff_id = 0;
   $this->sum_staff_id_total_price = 0;
   $this->arg_sum_customers_id = "";
   $this->count_customers_id = 0;
   $this->sum_customers_id_total_price = 0;
   $this->arg_sum_appointment_start_date = "";
   $this->count_appointment_start_date = 0;
   $this->sum_appointment_start_date_total_price = 0;
   $this->arg_sum_appointment_start_time = "";
   $this->count_appointment_start_time = 0;
   $this->sum_appointment_start_time_total_price = 0;
   $this->arg_sum_current_status_id = "";
   $this->count_current_status_id = 0;
   $this->sum_current_status_id_total_price = 0;
   ...
   $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['tot_geral'][1];
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['SC_Ind_Groupby'] == "sc_free_group_by")
       {
       $this->sum_total_price = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['tot_geral'][2];
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['SC_Ind_Groupby'] == "status")
       {
       $this->sum_total_price = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['tot_geral'][2];
...
//----- 
   ...
   { 
       $nmgp_select = "SELECT str_replace (convert(char(10),appointment_start_date,102), '.', '-') + ' ' + convert(char(8),appointment_start_date,20), str_replace (convert(char(10),appointment_start_time,102), '.', '-') + ' ' + convert(char(8),appointment_start_time,20), staff_id, customers_id, total_price, appointments_id, price, additional_charges, discount, current_status_id from " . $this->Ini->nm_tabela; 
   } 
   elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
   { 
       $nmgp_select = "SELECT appointment_start_date, appointment_start_time, staff_id, customers_id, total_price, appointments_id, price, additional_charges, discount, current_status_id from " . $this->Ini->nm_tabela; 
   } 
   elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
   { 
       $nmgp_select = "SELECT convert(char(23),appointment_start_date,121), convert(char(23),appointment_start_time,121), staff_id, customers_id, total_price, appointments_id, price, additional_charges, discount, current_status_id from " . $this->Ini->nm_tabela; 
   } 
   ...
   { 
       $nmgp_select = "SELECT EXTEND(appointment_start_date, YEAR TO DAY), appointment_start_time, staff_id, customers_id, total_price, appointments_id, price, additional_charges, discount, current_status_id from " . $this->Ini->nm_tabela; 
   } 
   else 
   { 
       $nmgp_select = "SELECT appointment_start_date, appointment_start_time, staff_id, customers_id, total_price, appointments_id, price, additional_charges, discount, current_status_id from " . $this->Ini->nm_tabela; 
   ...
   { 
       ...
       $this->price = $this->rs_grid->fields[6] ;  
       $this->price =  str_replace(",", ".", $this->price);
       $this->price = (string)$this->price;
       $this->additional_charges = $this->rs_grid->fields[7] ;  
       ...
       $this->current_status_id = $this->rs_grid->fields[9] ;  
       ...
       if (!isset($this->appointment_start_time)) { $this->appointment_start_time = ""; }
       ...
       $GLOBALS["current_status_id"] = $this->rs_grid->fields[9] ;  
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['SC_Ind_Groupby'] == "sc_free_group_by")
       {
           ...
           {
               $Cmp_orig = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
               if ($Cmp_orig == "appointment_start_time")
               {
                   $Str_arg_sum = "arg_sum_" . $cmp_gb;
                   $Format_tst = $this->Ini->Get_Gb_date_format('sc_free_group_by', $cmp_gb);
                   $TP_Time = (in_array('appointment_start_time', $this->Ini->Cmp_Sql_Time)) ? "0000-00-00 " : "";
                   $this->$Str_arg_sum = $this->Ini->Get_date_arg_sum($TP_Time . $this->appointment_start_time, $Format_tst, "appointment_start_time");
               }
           }
       }
       $this->arg_sum_staff_id = ($this->staff_id == "") ? " is null " : " = " . $this->staff_id;
       $this->arg_sum_customers_id = ($this->customers_id == "") ? " is null " : " = " . $this->customers_id;
...
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['doc_word'] && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['word_return']);
       ...
       if ($this->Ini->Proc_print && $this->Ini->Export_html_zip  && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['print_return']);
           $this->pb->setTotalSteps($this->count_ger);
       }
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       { 
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['embutida']) {  
...
$nm_saida->saida("}\r\n");
       ...
       $write_css = true;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['embutida'] && !$this->Print_All && $this->NM_opcao != "print" && $this->NM_opcao != "pdf")
       {
           $write_css = false;
       }
 ...
 { 
  ...
  if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['proc_pdf_vert'])
  {
   ...
   { 
       ...
       {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
          $vertical_center = '';
       ...
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['SC_Ind_Groupby'] == "sc_free_group_by")
           {
               ...
               {
                   $groupByLabel = sprintf("staff_id", "staff_id");
...
// 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['appointment_start_date'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['appointment_start_time'])) ? $this->New_label['appointment_start_time'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['appointment_start_time'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['staff_id'])) ? $this->New_label['staff_id'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['staff_id'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['customers_id'])) ? $this->New_label['customers_id'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['customers_id'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['total_price'])) ? $this->New_label['total_price'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['total_price'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['appointments_id'])) ? $this->New_label['appointments_id'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['appointments_id'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['price'])) ? $this->New_label['price'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['price'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['additional_charges'])) ? $this->New_label['additional_charges'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['additional_charges'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['discount'])) ? $this->New_label['discount'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['discount'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['current_status_id'])) ? $this->New_label['current_status_id'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['current_status_id'] = $SC_Label; 
   ...
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       else
       {
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['lig_iframe_modal'] = "nmsc_iframe_liga_grid_appointments_adm";
           }
           $nm_saida->saida(" <TR> \r\n");
           if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['opcao'] != "pdf" && 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['opcao_print'] != "print") 
...
else
{
   ...
   $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['opcao'] == "pdf") ? "padding: 0px !important;" : "";
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['proc_pdf_vert'])
{
}
else
...
// 
   ...
   $this->Break_pag_pdf['sc_free_group_by']['staff_id'] = "S";
   $this->Break_pag_prt['sc_free_group_by']['staff_id'] = "N";
   $this->Break_pag_pdf['sc_free_group_by']['customers_id'] = "S";
   $this->Break_pag_prt['sc_free_group_by']['customers_id'] = "N";
   $this->Break_pag_pdf['sc_free_group_by']['appointment_start_date'] = "S";
   $this->Break_pag_prt['sc_free_group_by']['appointment_start_date'] = "N";
   $this->Break_pag_pdf['sc_free_group_by']['appointment_start_time'] = "S";
   $this->Break_pag_prt['sc_free_group_by']['appointment_start_time'] = "N";
   ...
   $this->SC_top       = array();
   $this->SC_bot       = array();
   $this->SC_bot[]     = "staff_id"; 
   $this->SC_top[]     = "staff_id"; 
   $this->SC_bot[]     = "customers_id"; 
   $this->SC_top[]     = "customers_id"; 
   $this->SC_bot[]     = "appointment_start_date"; 
   $this->SC_top[]     = "appointment_start_date"; 
   $this->SC_bot[]     = "appointment_start_time"; 
   $this->SC_top[]     = "appointment_start_time"; 
   ...
   {  
          ...
          if ($this->current_status_id !== $this->current_status_id_Old && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['SC_Ind_Groupby'] == "status") 
          {  
              if (isset($this->current_status_id_Old))
              {
                 $this->quebra_current_status_id_status_bot() ; 
              }
              if ($this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['doc_word'] && $this->Break_pag_prt[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['SC_Ind_Groupby']]['current_status_id'] == "S")
              {
                  $this->nm_quebra_pagina("pagina"); 
              }
              elseif (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['Page_break_PDF']['current_status_id'] == "S")
              {
                  $this->nm_quebra_pagina("pagina"); 
              }
              $this->current_status_id_Old = $this->current_status_id ; 
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['mostra_edit'] != "N"){ 
              ...
              {
                  $Parms_Edt  = "appointments_id*scin" . str_replace('"', "@aspasd@", $this->appointments_id) . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scoutnmgp_opcao*scinigual*scoutNMSC_modal*scinok*scout";
                  if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dashboard_info']['under_dashboard'] && isset($linkTarget))
                  {
                      if ('' != $Parms_Edt && '?@?' != substr($Parms_Edt, -3) && '*scout' != substr($Parms_Edt, -6))
                      {
                          $Parms_Edt .= '*scout';
                      }
                      $Parms_Edt .= 'under_dashboard*scin1*scoutdashboard_app*scin' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dashboard_info']['dashboard_app'] . '*scoutown_widget*scin' . $linkTarget . '*scoutparent_widget*scin' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dashboard_info']['own_widget'] . '*scoutcompact_mode*scin' . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dashboard_info']['compact_mode'] ? '1' : '0') . '*scoutremove_margin*scin' . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dashboard_info']['remove_margin'] ? '1' : '0') . '*scoutremove_border*scin' . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dashboard_info']['remove_border'] ? '1' : '0');
                  }
                  $Md5_Edt    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_appointments_adm@SC_par@" . md5($Parms_Edt);
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['Lig_Md5'][md5($Parms_Edt)] = $Parms_Edt;
              }
              else
              {
                  $Md5_Edt  = "appointments_id*scin" . str_replace('"', "@aspasd@", $this->appointments_id) . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scoutnmgp_opcao*scinigual*scoutNMSC_modal*scinok*scout";
              }
              $Link_Edit = nmButtonOutput($this->arr_buttons, "bform_editar", "nm_gp_submit4('" .  $this->Ini->link_form_appointments . "', '$this->nm_location',  '$Md5_Edt' , '". (isset($linkTarget) ? $linkTarget : '_self') . "', '', 'form_appointments', '" . $this->SC_ancora . "')", "nm_gp_submit4('" .  $this->Ini->link_form_appointments . "', '$this->nm_location',  '$Md5_Edt' , '". (isset($linkTarget) ? $linkTarget : '_self') . "', '', 'form_appointments', '" . $this->SC_ancora . "')", "bedit", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['mostra_edit'] == "N"){ 
   ...
   { 
       ...
       if (isset($this->current_status_id_Old) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['SC_Ind_Groupby'] == "status")
       {
           $this->quebra_current_status_id_status_bot() ; 
       }
...
function SC_grid_rightActionBar()
{
 ...
 function NM_calc_span()
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['embutida_pdf'] == "pdf")
   {
       $this->NM_colspan--;
   } 
 ...
 function quebra_staff_id_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   $this->sc_proc_quebra_appointment_start_date = false;
   $this->sc_proc_quebra_appointment_start_time = false;
   $this->sc_proc_quebra_staff_id = true; 
   $this->Tot->quebra_staff_id_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name);
   $tot_staff_id = $$Var_name_gb;
   $conteudo = $tot_staff_id[0] ;  
   $this->count_staff_id = $tot_staff_id[1];
   $this->sum_staff_id_total_price = $tot_staff_id[2];
   $Temp_cmp_quebra = array(); 
   $conteudo = NM_encode_input(sc_strip_script($this->staff_id)); 
   $this->Lookup->lookup_sc_free_group_by_staff_id($conteudo , $this->staff_id) ; 
   $Temp_cmp_quebra[0]['cmp'] = $conteudo; 
   if (isset($this->nmgp_label_quebras['staff_id']))
   {
       $Temp_cmp_quebra[0]['lab'] = $this->nmgp_label_quebras['staff_id']; 
   }
   else
   {
       $Temp_cmp_quebra[0]['lab'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_staff_id'] . ""; 
   }
   $this->$Cmps_Gb_Free = $Temp_cmp_quebra;
   $this->sc_proc_quebra_staff_id = false; 
 } 
 function quebra_customers_id_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   $Var_name_gb  = "SC_tot_" . $Cmp_Name;
   $Cmps_Gb_Free = "campos_quebra_" . $Cmp_Name;
   $Desc_Gb_Ant  = $Cmp_Name . "_ant_desc";
   ...
   $this->sc_proc_quebra_appointment_start_date = false;
   $this->sc_proc_quebra_appointment_start_time = false;
   $this->sc_proc_quebra_customers_id = true; 
   $this->Tot->quebra_customers_id_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name);
   $tot_customers_id = $$Var_name_gb;
   $conteudo = $tot_customers_id[0] ;  
   $this->count_customers_id = $tot_customers_id[1];
   $this->sum_customers_id_total_price = $tot_customers_id[2];
   $Temp_cmp_quebra = array(); 
   $conteudo = NM_encode_input(sc_strip_script($this->customers_id)); 
   $this->Lookup->lookup_sc_free_group_by_customers_id($conteudo , $this->customers_id) ; 
   $Temp_cmp_quebra[0]['cmp'] = $conteudo; 
   if (isset($this->nmgp_label_quebras['customers_id']))
   {
       $Temp_cmp_quebra[0]['lab'] = $this->nmgp_label_quebras['customers_id']; 
   }
   else
   {
       $Temp_cmp_quebra[0]['lab'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_customers_id'] . ""; 
   }
   $this->$Cmps_Gb_Free = $Temp_cmp_quebra;
   $this->sc_proc_quebra_customers_id = false; 
 } 
 function quebra_appointment_start_date_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   $this->sum_appointment_start_date_total_price = $tot_appointment_start_date[2];
   $Temp_cmp_quebra = array(); 
   $conteudo = NM_encode_input(sc_strip_script($this->appointment_start_date)); 
 ...
 function quebra_appointment_start_time_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   $Var_name_gb  = "SC_tot_" . $Cmp_Name;
   $Cmps_Gb_Free = "campos_quebra_" . $Cmp_Name;
   $Desc_Gb_Ant  = $Cmp_Name . "_ant_desc";
   ...
   $this->sc_proc_quebra_customers_id = false;
   $this->sc_proc_quebra_appointment_start_date = false;
   $this->sc_proc_quebra_appointment_start_time = true; 
   $this->Tot->quebra_appointment_start_time_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name);
   $tot_appointment_start_time = $$Var_name_gb;
   $conteudo = $tot_appointment_start_time[0] ;  
   $this->count_appointment_start_time = $tot_appointment_start_time[1];
   $this->sum_appointment_start_time_total_price = $tot_appointment_start_time[2];
   $Temp_cmp_quebra = array(); 
   $conteudo = NM_encode_input(sc_strip_script($this->appointment_start_time)); 
   $Format_tst = $this->Ini->Get_Gb_date_format('sc_free_group_by', $Cmp_Name);
   $Prefix_dat = $this->Ini->Get_Gb_prefix_date_format('sc_free_group_by', $Cmp_Name);
   ...
   $conteudo = $this->Ini->GB_date_format($TP_Time . $conteudo, $Format_tst, $Prefix_dat); 
   $Temp_cmp_quebra[0]['cmp'] = $conteudo; 
   if (isset($this->nmgp_label_quebras['appointment_start_time']))
   {
       $Temp_cmp_quebra[0]['lab'] = $this->nmgp_label_quebras['appointment_start_time']; 
   }
   else
   {
       $Temp_cmp_quebra[0]['lab'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_appointment_start_time'] . ""; 
   }
   $this->$Cmps_Gb_Free = $Temp_cmp_quebra;
   $this->sc_proc_quebra_appointment_start_time = false; 
 } 
 function quebra_current_status_id_status($current_status_id) 
 {
   ...
   $this->sum_current_status_id_total_price = $tot_current_status_id[2];
 ...
 function quebra_staff_id_sc_free_group_by_top($Cmp_Name) 
 {
   $Var_name_gb  = "SC_tot_" . $Cmp_Name;
   $Cmps_Gb_Free = "campos_quebra_" . $Cmp_Name;
   $Desc_Gb_Ant  = $Cmp_Name . "_ant_desc";
   ...
   $tot_staff_id = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['staff_id'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   static $cont_quebra_staff_id = 0; 
   $cont_quebra_staff_id++;
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_old = "";
   $nm_fecha_pdf_new = "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['rows_emb']++;
   ...
   $this->Label_staff_id = "<table>"; 
   $Cmps_gb = $this->$Cmps_Gb_Free;
   foreach ($Cmps_gb as $cada_campo) 
   { 
       $this->Label_staff_id .= "<tr>"; 
       if ($this->SC_tab_quebra > 0 && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['embutida_grid'])
       {
           $this->Label_staff_id .= "<td class=\"" . $this->css_scGridBlockLineBg . "\" style=\"width: " . $this->SC_tab_quebra . "px;\">&nbsp;</td>"; 
       }
       $this->Label_staff_id .= "<td>" . $cada_campo['lab'] . "</td><td> => </td>";
       $this->Label_staff_id .= "<td>" . $cada_campo['cmp'] . "</td>";
       $this->Label_staff_id .= "</tr>"; 
   } 
   $this->Label_staff_id .= "</table>"; 
   $nm_saida->saida("    <TR >\r\n");
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlock . "\" style=\"text-align:left;\"  style=\"text-align: left;\" NOWRAP " . "colspan=\"" . $colspan . "\"" . ">" . $nm_nivel_book_pdf . $nm_fecha_pdf_new  . $this->Label_staff_id . $nm_fecha_pdf_old . "</TD>\r\n");
   $nm_saida->saida("    </TR>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['embutida_grid'] && $this->nm_prim_linha)
   { 
       $nm_saida->saida("##NM@@"); 
 ...
 function quebra_staff_id_sc_free_group_by_bot($Cmp_Name) 
 {
   $Var_name_gb  = "SC_tot_" . $Cmp_Name;
   $Cmps_Gb_Free = "campos_quebra_" . $Cmp_Name;
   $Desc_Gb_Ant  = $Cmp_Name . "_ant_desc";
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['field_order'] as $Cada_cmp)
   {
    ...
    if ($Cada_cmp == "staff_id" && (!isset($this->NM_cmp_hidden['staff_id']) || $this->NM_cmp_hidden['staff_id'] != "off"))
    {
        $colspan++;
    }
    if ($Cada_cmp == "customers_id" && (!isset($this->NM_cmp_hidden['customers_id']) || $this->NM_cmp_hidden['customers_id'] != "off"))
    {
        $colspan++;
    }
    if ($Cada_cmp == "total_price" && (!isset($this->NM_cmp_hidden['total_price']) || $this->NM_cmp_hidden['total_price'] != "off"))
    {
      if ($colspan > 0)
      {
      ...
      $conteudo =  $tot_staff_id[2] ; 
      nmgp_Form_Num_Val($conteudo, $_SESSION['scriptcase']['reg_conf']['grup_val'], $_SESSION['scriptcase']['reg_conf']['dec_val'], "2", "S", "2", "", "V:" . $_SESSION['scriptcase']['reg_conf']['monet_f_pos'] . ":" . $_SESSION['scriptcase']['reg_conf']['monet_f_neg'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit']) ; 
       $nm_saida->saida("     <TD class=\"" . $this->css_scGridSubtotalFont . " css_total_price_sub_tot\"  NOWRAP >" . $conteudo . "</TD>\r\n");
     }
    if ($Cada_cmp == "appointments_id" && (!isset($this->NM_cmp_hidden['appointments_id']) || $this->NM_cmp_hidden['appointments_id'] != "off"))
    {
        $colspan++;
    }
    if ($Cada_cmp == "price" && (!isset($this->NM_cmp_hidden['price']) || $this->NM_cmp_hidden['price'] != "off"))
    {
        $colspan++;
    }
    if ($Cada_cmp == "additional_charges" && (!isset($this->NM_cmp_hidden['additional_charges']) || $this->NM_cmp_hidden['additional_charges'] != "off"))
    {
        $colspan++;
    }
 ...
 function quebra_customers_id_sc_free_group_by_top($Cmp_Name) 
 {
   $Var_name_gb  = "SC_tot_" . $Cmp_Name;
   $Cmps_Gb_Free = "campos_quebra_" . $Cmp_Name;
   $Desc_Gb_Ant  = $Cmp_Name . "_ant_desc";
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_customers_id = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['customers_id'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   static $cont_quebra_customers_id = 0; 
   $cont_quebra_customers_id++;
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_old = "";
   $nm_fecha_pdf_new = "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['rows_emb']++;
   ...
   $colspan = $this->NM_colspan;
   $this->Label_customers_id = "<table>"; 
   $Cmps_gb = $this->$Cmps_Gb_Free;
   foreach ($Cmps_gb as $cada_campo) 
   { 
       $this->Label_customers_id .= "<tr>"; 
       if ($this->SC_tab_quebra > 0 && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['embutida_grid'])
       {
           $this->Label_customers_id .= "<td class=\"" . $this->css_scGridBlockLineBg . "\" style=\"width: " . $this->SC_tab_quebra . "px;\">&nbsp;</td>"; 
       }
       $this->Label_customers_id .= "<td>" . $cada_campo['lab'] . "</td><td> => </td>";
       $this->Label_customers_id .= "<td>" . $cada_campo['cmp'] . "</td>";
       $this->Label_customers_id .= "</tr>"; 
   } 
   $this->Label_customers_id .= "</table>"; 
   $nm_saida->saida("    <TR >\r\n");
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlock . "\" style=\"text-align:left;\"  style=\"text-align: left;\" NOWRAP " . "colspan=\"" . $colspan . "\"" . ">" . $nm_nivel_book_pdf . $nm_fecha_pdf_new  . $this->Label_customers_id . $nm_fecha_pdf_old . "</TD>\r\n");
   $nm_saida->saida("    </TR>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['embutida_grid'] && $this->nm_prim_linha)
   { 
       $nm_saida->saida("##NM@@"); 
 ...
 function quebra_customers_id_sc_free_group_by_bot($Cmp_Name) 
 {
   $Var_name_gb  = "SC_tot_" . $Cmp_Name;
   $Cmps_Gb_Free = "campos_quebra_" . $Cmp_Name;
   $Desc_Gb_Ant  = $Cmp_Name . "_ant_desc";
 ...
 function quebra_appointment_start_date_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_appointment_start_date = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['appointment_start_date'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
 ...
 function quebra_appointment_start_time_sc_free_group_by_top($Cmp_Name) 
 {
   $Var_name_gb  = "SC_tot_" . $Cmp_Name;
   $Cmps_Gb_Free = "campos_quebra_" . $Cmp_Name;
   $Desc_Gb_Ant  = $Cmp_Name . "_ant_desc";
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_appointment_start_time = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['appointment_start_time'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   static $cont_quebra_appointment_start_time = 0; 
   $cont_quebra_appointment_start_time++;
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_old = "";
   $nm_fecha_pdf_new = "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['rows_emb']++;
   ...
   $colspan = $this->NM_colspan;
   $this->Label_appointment_start_time = "<table>"; 
   $Cmps_gb = $this->$Cmps_Gb_Free;
   foreach ($Cmps_gb as $cada_campo) 
   { 
       $this->Label_appointment_start_time .= "<tr>"; 
       if ($this->SC_tab_quebra > 0 && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['embutida_grid'])
       {
           $this->Label_appointment_start_time .= "<td class=\"" . $this->css_scGridBlockLineBg . "\" style=\"width: " . $this->SC_tab_quebra . "px;\">&nbsp;</td>"; 
       }
       $this->Label_appointment_start_time .= "<td>" . $cada_campo['lab'] . "</td><td> => </td>";
       $this->Label_appointment_start_time .= "<td>" . $cada_campo['cmp'] . "</td>";
       $this->Label_appointment_start_time .= "</tr>"; 
   } 
   $this->Label_appointment_start_time .= "</table>"; 
   $nm_saida->saida("    <TR >\r\n");
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlock . "\" style=\"text-align:left;\"  style=\"text-align: left;\" NOWRAP " . "colspan=\"" . $colspan . "\"" . ">" . $nm_nivel_book_pdf . $nm_fecha_pdf_new  . $this->Label_appointment_start_time . $nm_fecha_pdf_old . "</TD>\r\n");
   $nm_saida->saida("    </TR>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['embutida_grid'] && $this->nm_prim_linha)
   { 
       $nm_saida->saida("##NM@@"); 
 ...
 function quebra_appointment_start_time_sc_free_group_by_bot($Cmp_Name) 
 {
   $Var_name_gb  = "SC_tot_" . $Cmp_Name;
   $Cmps_Gb_Free = "campos_quebra_" . $Cmp_Name;
   $Desc_Gb_Ant  = $Cmp_Name . "_ant_desc";
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['field_order'] as $Cada_cmp)
   {
    ...
    if ($Cada_cmp == "total_price" && (!isset($this->NM_cmp_hidden['total_price']) || $this->NM_cmp_hidden['total_price'] != "off"))
    {
      ...
      $conteudo =  $tot_appointment_start_time[2] ; 
      nmgp_Form_Num_Val($conteudo, $_SESSION['scriptcase']['reg_conf']['grup_val'], $_SESSION['scriptcase']['reg_conf']['dec_val'], "2", "S", "2", "", "V:" . $_SESSION['scriptcase']['reg_conf']['monet_f_pos'] . ":" . $_SESSION['scriptcase']['reg_conf']['monet_f_neg'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit']) ; 
       $nm_saida->saida("     <TD class=\"" . $this->css_scGridSubtotalFont . " css_total_price_sub_tot\"  NOWRAP >" . $conteudo . "</TD>\r\n");
     }
    if ($Cada_cmp == "appointments_id" && (!isset($this->NM_cmp_hidden['appointments_id']) || $this->NM_cmp_hidden['appointments_id'] != "off"))
 ...
 function quebra_geral_sc_free_group_by_bot() 
 {
   ...
   $tit_lin_sumariza      =  $nm_nivel_book_pdf . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['tot_geral'][1] . ")";
   $tit_lin_sumariza_orig =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['tot_geral'][1] . ")";
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['field_order'] as $Cada_cmp)
   {
    ...
    if ($Cada_cmp == "total_price" && (!isset($this->NM_cmp_hidden['total_price']) || $this->NM_cmp_hidden['total_price'] != "off"))
    {
      ...
      nmgp_Form_Num_Val($conteudo, $_SESSION['scriptcase']['reg_conf']['grup_val'], $_SESSION['scriptcase']['reg_conf']['dec_val'], "2", "S", "2", "", "V:" . $_SESSION['scriptcase']['reg_conf']['monet_f_pos'] . ":" . $_SESSION['scriptcase']['reg_conf']['monet_f_neg'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit']) ; 
       $nm_saida->saida("     <TD class=\"" . $this->css_scGridTotalFont . " css_total_price_tot_ger\"  NOWRAP >" . $conteudo . "</TD>\r\n");
     }
    if ($Cada_cmp == "appointments_id" && (!isset($this->NM_cmp_hidden['appointments_id']) || $this->NM_cmp_hidden['appointments_id'] != "off"))
    {
       $colspan++;
...
$nm_saida->saida("    </style>\r\n");
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          if ($this->nmgp_botoes['summary'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
          {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['SC_Gb_Free_cmp']))
            { }
            else {
      ...
      if ($this->nmgp_botoes['dynsearch'] == "on" && !$this->grid_emb_form && !$this->NM_hidden_filters)
      {
          ...
          $nm_saida->saida("            <div id=\"div_dynamic_search_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bdynamicsearch", "if($('#id_dyn_search_cmd_str').html() != ''){ $('#id_dyn_search_cmd_string').toggle(); } $('#div_dyn_search').toggle(); if($( '#div_dyn_search' ).css( 'display')=='none'){ buttonunselectedDS(); }else{ buttonSelectedDS(); scrollToElement('#div_dyn_search'); }SC_carga_evt_jquery('all');SC_select2_dyn();", "if($('#id_dyn_search_cmd_str').html() != ''){ $('#id_dyn_search_cmd_string').toggle(); } $('#div_dyn_search').toggle(); if($( '#div_dyn_search' ).css( 'display')=='none'){ buttonunselectedDS(); }else{ buttonSelectedDS(); scrollToElement('#div_dyn_search'); }SC_carga_evt_jquery('all');SC_select2_dyn();", "dynamic_search_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_2", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['filter'] == "on"  && !$this->grid_emb_form && !$this->NM_hidden_filters)
      {
          ...
          $nm_saida->saida("            <div id=\"div_pesq_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
           ...
           $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpesquisa", "", "", "pesq_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_appointments_adm/grid_appointments_adm.php?script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&nmgp_opcao=busca&nmgp_orig_pesq=grid&KeepThis=true&TB_iframe=true&height=0&width=0&modal=true", "group_2", "only_text", "text_right", "", "", "", "", "", "", "");
           $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
           $NM_Gbtn = true;
      }
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dashboard_info']['under_dashboard']))
      {
         $this->nmgp_botoes['exit'] = "off"; 
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['opc_psq'])
...
$nm_saida->saida("    </style>\r\n");
      ...
      if ($this->nmgp_botoes['sel_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_2_top = true;</script>\r\n");
      ...
      $path_fields = $this->Ini->root . substr($this->Ini->path_prod, 0, $pos_path) . "/conf/fields/";
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcolumns", "scBtnSelCamposShow('" . $this->Ini->path_link . "grid_appointments_adm/grid_appointments_adm_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnSelCamposShow('" . $this->Ini->path_link . "grid_appointments_adm/grid_appointments_adm_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "selcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_2", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
   ...
   function html_dynamic_search()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search_label']['staff_id'] = (isset($this->New_label['staff_id'])) ? $this->New_label['staff_id'] : "" . $this->Ini->Nm_lang['lang_appointments_fld_staff_id'] . "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search_label']['customers_id'] = (isset($this->New_label['customers_id'])) ? $this->New_label['customers_id'] : "" . $this->Ini->Nm_lang['lang_appointments_fld_customers_id'] . "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search_label']['appointment_start_date'] = (isset($this->New_label['appointment_start_date'])) ? $this->New_label['appointment_start_date'] : "" . $this->Ini->Nm_lang['lang_appointments_fld_appointment_start_date'] . "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search_label']['current_status_id'] = (isset($this->New_label['current_status_id'])) ? $this->New_label['current_status_id'] : "" . $this->Ini->Nm_lang['lang_appointments_fld_current_status_id'] . "";
       $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
       ...
       $nm_saida->saida("     <span class=\"" . $this->css_scAppDivHeaderText . "\">\r\n");
             ...
             {
       $nm_saida->saida("                             <a href=\"#\" onclick=\"$('#id_dyn_search_cmd_string').hide();$('#div_dyn_search').show();SC_carga_evt_jquery('all');SC_select2_dyn();\" style=\"text-decoration:none\">\r\n");
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search']))
       {
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search'] as $IX => $def)
           {
               ...
               {
                   $this->Dyn_search_seq++;;
                   $this->Dyn_search_dat[$this->Dyn_search_seq] = "staff_id";
                   $lin_obj = $this->dynamic_search_staff_id($this->Dyn_search_seq, 'N', $def['opc'], $def['val']);
                   $nm_saida->saida("" . $lin_obj . "\r\n");
               }
               if ($cmp == "customers_id")
               {
                   $this->Dyn_search_seq++;;
                   $this->Dyn_search_dat[$this->Dyn_search_seq] = "customers_id";
                   $lin_obj = $this->dynamic_search_customers_id($this->Dyn_search_seq, 'N', $def['opc'], $def['val']);
                   $nm_saida->saida("" . $lin_obj . "\r\n");
               }
               ...
               if ($cmp == "current_status_id")
               {
                   $this->Dyn_search_seq++;;
                   $this->Dyn_search_dat[$this->Dyn_search_seq] = "current_status_id";
                   $lin_obj = $this->dynamic_search_current_status_id($this->Dyn_search_seq, 'N', $def['opc'], $def['val']);
                   $nm_saida->saida("" . $lin_obj . "\r\n");
               }
           }
       }
       ...
       $nm_saida->saida("                <div class='scBtnGrpText' style='cursor: pointer;' onclick=\"ajax_add_dyn_search('staff_id', 'grid')\">" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search_label']['staff_id'] . "\r\n");
       $nm_saida->saida("                </div>\r\n");
       $nm_saida->saida("            </td>\r\n");
       $nm_saida->saida("        </tr>\r\n");
       $nm_saida->saida("        <tr>\r\n");
       $nm_saida->saida("            <td class='scBtnGrpBackground'>\r\n");
       $nm_saida->saida("                <div class='scBtnGrpText' style='cursor: pointer;' onclick=\"ajax_add_dyn_search('customers_id', 'grid')\">" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search_label']['customers_id'] . "\r\n");
       $nm_saida->saida("                </div>\r\n");
       $nm_saida->saida("            </td>\r\n");
       $nm_saida->saida("        </tr>\r\n");
       $nm_saida->saida("        <tr>\r\n");
       $nm_saida->saida("            <td class='scBtnGrpBackground'>\r\n");
       $nm_saida->saida("                <div class='scBtnGrpText' style='cursor: pointer;' onclick=\"ajax_add_dyn_search('appointment_start_date', 'grid')\">" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search_label']['appointment_start_date'] . "\r\n");
       $nm_saida->saida("                </div>\r\n");
       $nm_saida->saida("            </td>\r\n");
       $nm_saida->saida("        </tr>\r\n");
       $nm_saida->saida("        <tr>\r\n");
       $nm_saida->saida("            <td class='scBtnGrpBackground'>\r\n");
       $nm_saida->saida("                <div class='scBtnGrpText' style='cursor: pointer;' onclick=\"ajax_add_dyn_search('current_status_id', 'grid')\">" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search_label']['current_status_id'] . "\r\n");
       $nm_saida->saida("                </div>\r\n");
       $nm_saida->saida("            </td>\r\n");
       $nm_saida->saida("        </tr>\r\n");
       $nm_saida->saida("      </table> \r\n");
   ...
   function dynamic_search_staff_id($ind, $ajax, $opc="", $val=array())
   {
       $this->Cmps_select2['staff_id'][] = $ind;
       $lin_obj  = "";
       $lin_obj .= "     <tr id='dyn_search_staff_id_" . $ind . "'>";
       $lin_obj .= "      <td style='border-style: none' nowrap>" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search_label']['staff_id'] . "</td>";
       $lin_obj .= "      <td style='border-style: none' >";
       if (empty($opc))
       {
           $opc = "eq";
       }
       $lin_obj .= "       <select id='dyn_search_staff_id_cond_" . $ind . "' name='cond_dyn_search_staff_id_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle; display: none'>";
       ...
       $lin_obj .= "       <span id=\"dyn_staff_id_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['psq_check_ret']['staff_id'] = array();
       $staff_id_look = (is_string($staff_id) ? substr($this->Db->qstr($staff_id), 1, -1) : $staff_id); 
       $nmgp_def_dados  = ""; 
       $nmgp_def_dados .= "?#??#?N?@?"; 
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['psq_check_ret']['staff_id'][] = trim($rs->fields[0]);
       ...
       $lin_obj .= "    <SELECT class='" . $this->css_scAppDivToolbarInput . "' id=\"dyn_search_staff_id_val_" . $ind . "\" name=\"val_dyn_search_staff_id_" . $ind . "\"  size=1 onChange=\"buttonEnable_dyn('dyn_search');\">";
       $delimitador = "##@@";
       ...
       foreach ($nm_opcoes as $nm_opcao)
       {
          if (!empty($nm_opcao))
          {
             ...
             {
                $staff_id_sel = ("S" == $nm_opc_sel) ? " selected" : "";
             }
             $lin_obj .= "       <OPTION value=\"" . NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val) . "\"" . $staff_id_sel . ">" . $nm_opc_val . "</OPTION>";
          }
       }
       $lin_obj .= "    </SELECT>";
       $lin_obj .= "       </span>";
       ...
       $lin_obj .= "       <img id='dyn_search_staff_id_close_" . $ind . "' src='" . $this->Ini->path_botoes . "/" . $this->Ini->Img_qs_clean . "' onclick=\"del_dyn_search('dyn_search_staff_id_" . $ind . "', " . $ind . ");buttonEnable_dyn('dyn_search');\">";
       $lin_obj .= "      </td>";
       $lin_obj .= "     </tr>";
       return $lin_obj;
   }
   function dynamic_search_customers_id($ind, $ajax, $opc="", $val=array())
   {
       $lin_obj  = "";
       $lin_obj .= "     <tr id='dyn_search_customers_id_" . $ind . "'>";
       $lin_obj .= "      <td style='border-style: none' nowrap>" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search_label']['customers_id'] . "</td>";
       $lin_obj .= "      <td style='border-style: none' >";
       if (empty($opc))
       {
           $opc = "eq";
       }
       $lin_obj .= "       <select id='dyn_search_customers_id_cond_" . $ind . "' name='cond_dyn_search_customers_id_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle; display: none'>";
       $selected = ($opc == "eq") ? " selected" : "";
       $lin_obj .= "        <option value='eq'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_exac'] . "</option>";
       $lin_obj .= "       </select>";
       $lin_obj .= "      </td>";
       ...
       $lin_obj .= "       <span id=\"dyn_customers_id_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $customers_id = $val_cmp;
       if ($customers_id != "")
       {
       $customers_id_look = (is_string($customers_id) ? substr($this->Db->qstr($customers_id), 1, -1) : $customers_id); 
       $nmgp_def_dados = array(); 
    if (is_numeric($customers_id))
    { 
       $nm_comando = "select customers_id, customers_name from customers where customers_id = $customers_id_look order by customers_name"; 
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
       $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       ...
       if (isset($nmgp_def_dados[0][$customers_id]))
       {
           $sAutocompValue = $nmgp_def_dados[0][$customers_id];
       }
       else
       {
       ...
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='dyn_search_customers_id_val_" . $ind . "' name='val_dyn_search_customers_id_" . $ind . "' onChange=\"buttonEnable_dyn('dyn_search');\" value=\"" . NM_encode_input($val_cmp) . "\" size=11 alt=\"{datatype: 'text', maxLength: 11, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}\" style='display: none' >";
       $lin_obj .= "     <select class='sc-ui-autocomp-customers_id " . $this->css_scAppDivToolbarInput . "' id='id_ac_customers_id" . $ind . "' name='val_dyn_search_customers_id_autocomp" . $ind . "' onChange=\"buttonEnable_dyn('dyn_search');\">";
       if ('' !=  $customers_id) {
           $lin_obj .= "     <option value='" . $customers_id . "'  selected>" . $sAutocompValue . "</option>";
       }
       $lin_obj .= "     </select>";
       $lin_obj .= "       </span>";
       $lin_obj .= "      </td>";
       $lin_obj .= "      <td style='border-style: none; cursor:pointer'>";
       $lin_obj .= "       <img id='dyn_search_customers_id_close_" . $ind . "' src='" . $this->Ini->path_botoes . "/" . $this->Ini->Img_qs_clean . "' onclick=\"del_dyn_search('dyn_search_customers_id_" . $ind . "', " . $ind . ");buttonEnable_dyn('dyn_search');\">";
       $lin_obj .= "      </td>";
       $lin_obj .= "     </tr>";
       return $lin_obj;
   }
   function dynamic_search_appointment_start_date($ind, $ajax, $opc="", $val=array())
   {
       ...
       $lin_obj .= "      <td style='border-style: none' nowrap>" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search_label']['appointment_start_date'] . "</td>";
       $lin_obj .= "      <td style='border-style: none' >";
       if (empty($opc))
       {
           $opc = "bw";
   ...
   function dynamic_search_current_status_id($ind, $ajax, $opc="", $val=array())
   {
       $this->Cmps_select2['current_status_id'][] = $ind;
       $lin_obj  = "";
       $lin_obj .= "     <tr id='dyn_search_current_status_id_" . $ind . "'>";
       $lin_obj .= "      <td style='border-style: none' nowrap>" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search_label']['current_status_id'] . "</td>";
       $lin_obj .= "      <td style='border-style: none' >";
       if (empty($opc))
       {
           $opc = "eq";
       }
       $lin_obj .= "       <select id='dyn_search_current_status_id_cond_" . $ind . "' name='cond_dyn_search_current_status_id_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle; display: none'>";
       $selected = ($opc == "eq") ? " selected" : "";
       $lin_obj .= "        <option value='eq'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_exac'] . "</option>";
       $lin_obj .= "       </select>";
       $lin_obj .= "      </td>";
       ...
       $lin_obj .= "       <span id=\"dyn_current_status_id_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['psq_check_ret']['current_status_id'] = array();
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['psq_check_ret']['current_status_id'][] = trim($rs->fields[0]);
             $nmgp_def_dados .= trim($rs->fields[1]) . "?#?"; 
             $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?"; 
             $rs->MoveNext(); 
          } 
       ...
       $lin_obj .= "    <SELECT class='" . $this->css_scAppDivToolbarInput . "' id=\"dyn_search_current_status_id_val_" . $ind . "\" name=\"val_dyn_search_current_status_id_" . $ind . "\"  size=1 onChange=\"buttonEnable_dyn('dyn_search');\">";
       $delimitador = "##@@";
       $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
       $nm_opcoes  = explode("?@?", $nm_opcoesx);
       $val = isset($val[0]) ? $val[0] : array();
          ...
          if (!empty($nm_opcao))
          {
             ...
             if (is_array($val) && !empty($val))
             {
                ...
                foreach ($val as $Dados)
                {
                    ...
                    if ($Dados === $nm_opc_cod)
                    {
                        $current_status_id_sel = " selected";
                        break;
                    }
                }
             }
             ...
             $lin_obj .= "       <OPTION value=\"" . NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val) . "\"" . $current_status_id_sel . ">" . $nm_opc_val . "</OPTION>";
          }
       }
       $lin_obj .= "    </SELECT>";
       $lin_obj .= "       </span>";
       $lin_obj .= "      </td>";
       $lin_obj .= "      <td style='border-style: none; cursor:pointer'>";
       $lin_obj .= "       <img id='dyn_search_current_status_id_close_" . $ind . "' src='" . $this->Ini->path_botoes . "/" . $this->Ini->Img_qs_clean . "' onclick=\"del_dyn_search('dyn_search_current_status_id_" . $ind . "', " . $ind . ");buttonEnable_dyn('dyn_search');\">";
       $lin_obj .= "      </td>";
       $lin_obj .= "     </tr>";
       return $lin_obj;
   }
   function lookup_ajax_customers_id($customers_id)
   {
       $customers_id = substr($this->Db->qstr($customers_id), 1, -1);
       $this->NM_case_insensitive = false;
       $customers_id_look = (is_string($customers_id) ? substr($this->Db->qstr($customers_id), 1, -1) : $customers_id); 
       $nmgp_def_dados = array(); 
      if (isset($this->Ini->nm_bases_postgres) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select customers_id, customers_name from customers where   CAST (customers_name AS TEXT)  like '%" . $customers_id . "%' order by customers_name"; 
      }
      elseif (isset($this->Ini->nm_bases_sybase) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select customers_id, customers_name from customers where   CAST (customers_name AS VARCHAR)  like '%" . $customers_id . "%' order by customers_name"; 
      }
      else
      {
          $nm_comando = "select customers_id, customers_name from customers where  customers_name like '%" . $customers_id . "%' order by customers_name"; 
      }
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
       $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
          ...
          { 
            ...
            $cmp1 = grid_appointments_adm_pack_protect_string(str_replace(array("\r", "\n"), array('', '<br />'), $cmp1));
            $cmp2 = grid_appointments_adm_pack_protect_string(str_replace(array("\r", "\n"), array('', '<br />'), $cmp2));
            $nmgp_def_dados[] = array($cmp1 => $cmp2); 
             $rs->MoveNext(); 
          } 
          $rs->Close(); 
   ...
   function JS_dynamic_search()
   {
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida("     Tab_evt_dyn_search['appointment_start_date_mes'] =  'sc_grid_appointments_adm_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_dyn_search['appointment_start_date_dia'] =  'sc_grid_appointments_adm_valida_dia(this)';\r\n");
       $nm_saida->saida("     Tab_evt_dyn_search['appointment_start_date_v2__mes'] =  'sc_grid_appointments_adm_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_dyn_search['appointment_start_date_v2__dia'] =  'sc_grid_appointments_adm_valida_dia(this)';\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['ajax_nav'])
       { 
           ...
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_dyn_search['appointment_start_date_mes']", 'value' => 'sc_grid_appointments_adm_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_dyn_search['appointment_start_date_dia']", 'value' => 'sc_grid_appointments_adm_valida_dia(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_dyn_search['appointment_start_date_v2__mes']", 'value' => 'sc_grid_appointments_adm_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_dyn_search['appointment_start_date_v2__dia']", 'value' => 'sc_grid_appointments_adm_valida_dia(this)');
       } 
       ...
       foreach ($this->Cmps_select2 as $Cmp => $Seqs)
       {
           if ($Cmp == 'staff_id')
           {
               ...
               {
                   $nm_saida->saida("         $(\"#dyn_search_staff_id_val_\" + \"" . $CadaSeqs . "\").select2(\r\n");
                   $nm_saida->saida("        {\r\n");
           ...
           if ($Cmp == 'current_status_id')
           {
               foreach ($Seqs as $CadaSeqs)
               {
                   $nm_saida->saida("         $(\"#dyn_search_current_status_id_val_\" + \"" . $CadaSeqs . "\").select2(\r\n");
                   $nm_saida->saida("        {\r\n");
                   $nm_saida->saida("          language: {\r\n");
                   $nm_saida->saida("            noResults: function() {\r\n");
                   $nm_saida->saida("              return \"" . $this->Ini->Nm_lang['lang_autocomp_notfound'] . "\";\r\n");
       ...
       $nm_saida->saida("             {\r\n");
       $nm_saida->saida("                 tmp = Tab_obj_dyn_search[i];\r\n");
       $nm_saida->saida("                 if (tmp == 'customers_id')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                      var x = i;\r\n");
       $nm_saida->saida("                        $(\".sc-ui-autocomp-customers_id\").on(\"focus\", function() {\r\n");
       ...
       $nm_saida->saida("                            field: \"customers_id\",\r\n");
       ...
       $nm_saida->saida("                         $(\"#dyn_search_customers_id_val_\" + x).val(e.params.data.id);\r\n");
       $nm_saida->saida("                        });\r\n");
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("             }\r\n");
       $nm_saida->saida("         }\r\n");
       ...
       $nm_saida->saida("                 if (Tab_obj_dyn_search[i] == 'staff_id')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                     result  = dyn_search_get_select(obj_dyn + i, '');\r\n");
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (Tab_obj_dyn_search[i] == 'customers_id')\r\n");
       $nm_saida->saida("                 {\r\n");
       ...
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (Tab_obj_dyn_search[i] == 'current_status_id')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                     result  = dyn_search_get_select(obj_dyn + i, '');\r\n");
       $nm_saida->saida("                 }\r\n");
   ...
   function html_interativ_search()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['int_search_label']['current_status_id'] = (isset($this->New_label['current_status_id'])) ? $this->New_label['current_status_id'] : '' . $this->Ini->Nm_lang['lang_appointments_fld_current_status_id'] . '';
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['int_search_sql']['current_status_id']   = "current_status_id";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['int_search_label']['staff_id'] = (isset($this->New_label['staff_id'])) ? $this->New_label['staff_id'] : '' . $this->Ini->Nm_lang['lang_appointments_fld_staff_id'] . '';
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['int_search_sql']['staff_id']   = "staff_id";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['int_search_label']['appointment_start_date'] = (isset($this->New_label['appointment_start_date'])) ? $this->New_label['appointment_start_date'] : '' . $this->Ini->Nm_lang['lang_appointments_fld_appointment_start_date'] . '';
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['int_search_sql']['appointment_start_date']   = "appointment_start_date";
   ...
   {
       $cle_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['interativ_search']["current_status_id"])) ? "" : "none";
       $exp_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['interativ_search']["current_status_id"])) ? "none" : "";
       $displ_open= false;
       ...
       $lin_obj .= $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['int_search_label']['current_status_id'];
       $lin_obj .= "              </span>";
       $lin_obj .= "          </td>";
       ...
       $lin_mult  = "";
       $disp_link = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['interativ_search']['current_status_id'])) ? "" : "none";
       ...
       {
           $bol_populate_modal_values = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['int_search_dados']['current_status_id'])?false:true);
       }
       foreach ($result as $dados => $qtd_result)
       {
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['int_search_dados']['current_status_id'][$dados] = array('val'=>$formatado,'qtd'=>$qtd_result);
           }
           if($dados == '')
           {
           ...
           $checked = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['interativ_search']['current_status_id']['val_sel']) && in_array($dados, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['interativ_search']['current_status_id']['val_sel'])) ? " checked" : "";
           $checked = " checked";
           ...
           if($bol_refin_use_modal)
           {
               $lin_obj  .= "       <a href=\"javascript:tb_show('', 'grid_appointments_adm_refin_modal.php?sc_init=" . NM_encode_input($this->Ini->sc_page) . "&cmp_modal=current_status_id&tp_obj=nn&TB_iframe=true&modal=true&height=440&width=630', '');\" class='scGridRefinedSearchVejaMaisFont'>". $this->Ini->Nm_lang['lang_othr_refinedsearch_see_more'] ."</a>";
           }
           else
           {
   ...
   {
       $cle_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['interativ_search']["staff_id"])) ? "" : "none";
       $exp_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['interativ_search']["staff_id"])) ? "none" : "";
       $displ_open= false;
       ...
       $lin_obj .= "              <span class=\"dn-expand-button\" style=\"cursor: pointer;\">";
       $lin_obj .= $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['int_search_label']['staff_id'];
       $lin_obj .= "              </span>";
       $lin_obj .= "          </td>";
       $lin_obj .= "          <td align='right'>";
       ...
       $lin_mult  = "";
       $disp_link = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['interativ_search']['staff_id'])) ? "" : "none";
       ...
       if($bol_refin_use_modal)
       {
           $bol_populate_modal_values = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['int_search_dados']['staff_id'])?false:true);
       }
       foreach ($result as $dados => $qtd_result)
       {
           $formatado = $dados;
           ...
           if($bol_refin_use_modal && $bol_populate_modal_values)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['int_search_dados']['staff_id'][$dados] = array('val'=>$formatado,'qtd'=>$qtd_result);
           }
           if($dados == '')
           {
               $formatado_exib = "" . $this->Ini->Nm_lang['lang_refine_search_empty'] . "";
           ...
           if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['interativ_search']['staff_id']))
           {
               $lin_obj  .= "        <IMG align='absmiddle' style=\"cursor: pointer; position:relative; opacity:0;\" SRC=\"" . $this->Ini->path_img_global . "/" . $this->Ini->refinedsearch_campo_close_icon . "\" BORDER=\"0\" onclick=\"nm_proc_int_search('clear_opc', 'nn','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['int_search_label']['staff_id']) . "','staff_id','id_int_search_staff_id','staff_id', '" . NM_encode_input($dados . "##@@" . $formatado) . "', 'S');\"/>";
           }
           $lin_obj  .= "        <a href=\"javascript:nm_proc_int_search('link','nn','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['int_search_label']['staff_id']) . "','staff_id','" . NM_encode_input(NM_encode_input_js($dados . "##@@" . $formatado)) . "', 'staff_id', '', 'N');\" class='scGridRefinedSearchCampoFont'>";
           $lin_obj  .= $formatado_exib;
           if(!empty($veja_mais_link))
           {
               $lin_obj  .= "            <span class='scGridRefinedSearchQuantidade'>" . $veja_mais_link . "</span>";
           ...
           $checked = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['interativ_search']['staff_id']['val_sel']) && in_array($dados, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['interativ_search']['staff_id']['val_sel'])) ? " checked" : "";
           $checked = " checked";
           ...
           if($bol_refin_use_modal)
           {
               $lin_obj  .= "       <a href=\"javascript:tb_show('', 'grid_appointments_adm_refin_modal.php?sc_init=" . NM_encode_input($this->Ini->sc_page) . "&cmp_modal=staff_id&tp_obj=nn&TB_iframe=true&modal=true&height=440&width=630', '');\" class='scGridRefinedSearchVejaMaisFont'>". $this->Ini->Nm_lang['lang_othr_refinedsearch_see_more'] ."</a>";
           }
           else
           {
           ...
           $lin_obj .= $Cod_Btn; 
           $disp_multi_btn = 'none';
           $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_apply", "nm_proc_int_search('chbx', 'nn','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['int_search_label']['staff_id']) . "','staff_id','id_int_search_staff_id','staff_id', '', 'N');", "nm_proc_int_search('chbx', 'nn','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['int_search_label']['staff_id']) . "','staff_id','id_int_search_staff_id','staff_id', '', 'N');", "app_int_search_staff_id", "", "", "display: $disp_multi_btn ;", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
           $lin_obj .= $Cod_Btn; 
   ...
   {
       $cle_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['interativ_search']["appointment_start_date"])) ? "" : "none";
       $exp_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['interativ_search']["appointment_start_date"])) ? "none" : "";
       $displ_open= false;
       ...
       $lin_obj .= "              <span class=\"dn-expand-button\" style=\"cursor: pointer;\">";
       $lin_obj .= $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['int_search_label']['appointment_start_date'];
       $lin_obj .= "              </span>";
       $lin_obj .= "          </td>";
       $lin_obj .= "          <td align='right'>";
       ...
       $lin_mult  = "";
       $disp_link = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['interativ_search']['appointment_start_date'])) ? "" : "none";
       ...
       if($bol_refin_use_modal)
       {
           $bol_populate_modal_values = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['int_search_dados']['appointment_start_date'])?false:true);
       }
       foreach ($result as $dados => $qtd_result)
       {
           $formatado = $dados;
           ...
           if($bol_refin_use_modal && $bol_populate_modal_values)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['int_search_dados']['appointment_start_date'][$dados] = array('val'=>$formatado,'qtd'=>$qtd_result);
           }
           if($dados == '')
           {
               $formatado_exib = "" . $this->Ini->Nm_lang['lang_refine_search_empty'] . "";
           ...
           if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['interativ_search']['appointment_start_date']))
           {
               $lin_obj  .= "        <IMG align='absmiddle' style=\"cursor: pointer; position:relative; opacity:0;\" SRC=\"" . $this->Ini->path_img_global . "/" . $this->Ini->refinedsearch_campo_close_icon . "\" BORDER=\"0\" onclick=\"nm_proc_int_search('clear_opc', 'dt','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['int_search_label']['appointment_start_date']) . "','appointment_start_date','id_int_search_appointment_start_date','appointment_start_date', '" . NM_encode_input($dados . "##@@" . $formatado) . "', 'S');\"/>";
           }
           $lin_obj  .= "        <a href=\"javascript:nm_proc_int_search('link','dt','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['int_search_label']['appointment_start_date']) . "','appointment_start_date','" . NM_encode_input(NM_encode_input_js($dados . "##@@" . $formatado)) . "', 'appointment_start_date', '', 'N');\" class='scGridRefinedSearchCampoFont'>";
           $lin_obj  .= $formatado_exib;
           if(!empty($veja_mais_link))
           {
               $lin_obj  .= "            <span class='scGridRefinedSearchQuantidade'>" . $veja_mais_link . "</span>";
           ...
           $checked = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['interativ_search']['appointment_start_date']['val_sel']) && in_array($dados, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['interativ_search']['appointment_start_date']['val_sel'])) ? " checked" : "";
           $checked = " checked";
           ...
           if($bol_refin_use_modal)
           {
               $lin_obj  .= "       <a href=\"javascript:tb_show('', 'grid_appointments_adm_refin_modal.php?sc_init=" . NM_encode_input($this->Ini->sc_page) . "&cmp_modal=appointment_start_date&tp_obj=dt&TB_iframe=true&modal=true&height=440&width=630', '');\" class='scGridRefinedSearchVejaMaisFont'>". $this->Ini->Nm_lang['lang_othr_refinedsearch_see_more'] ."</a>";
           }
           else
           {
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("           document.Fdoc_word.action = \"grid_appointments_adm_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("               document.Fprint.action = \"grid_appointments_adm_export_ctrl.php\";\r\n");
   $nm_saida->saida("           }\r\n");
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['campo_psq_ret']) )
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['sc_modal'])
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['iframe_ret_cap']))
         {
             ...
             $nm_saida->saida("           var Obj_Form  = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Form1 = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("           var Obj_Doc   = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form  = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Form1 = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("          var Obj_Doc   = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form  = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Form1 = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['campo_psq_ret']) . ";\r\n");
          $nm_saida->saida("          var Obj_Doc   = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
