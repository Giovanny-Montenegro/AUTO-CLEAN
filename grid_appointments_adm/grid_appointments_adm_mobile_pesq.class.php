...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_staff_id"  <?php echo $str_hide_staff_id?>>
<?php
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_customers_id"  <?php echo $str_hide_customers_id?>><?php
      if ($customers_id != "")
      {
      $customers_id_look = (is_string($customers_id) ? substr($this->Db->qstr($customers_id), 1, -1) : $customers_id); 
      $nmgp_def_dados = array(); 
