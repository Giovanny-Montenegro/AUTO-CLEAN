...
function ajax_add_dyn_search(str_field, str_origem)
{
    ...
    $.ajax({
     ...
     .done(function(jsonDyn_add) {
        ...
        if (str_field == 'staff_id')
        {
            $("#dyn_search_staff_id_val_" + Tot_obj_dyn_search).select2(
            {
              language: {
                noResults: function() {
        ...
        if (str_field == 'current_status_id')
        {
            $("#dyn_search_current_status_id_val_" + Tot_obj_dyn_search).select2(
            {
              language: {
                noResults: function() {
                  return mens_select2_notfound;
