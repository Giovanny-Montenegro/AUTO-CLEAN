...
function Sel_processa_out($sel_groupby)
{
   ...
   elseif ($sel_groupby != $groupby_atual || $Change_free_groupby)
   {
       ...
       unset($_SESSION['sc_session'][$sc_init]['grid_appointments_adm']['pivot_tabular']);
           ...
           $tab_arr_groubby_cmp['appointment_start_date'] = array('cmp' => "appointment_start_date", 'ind' => 2, 'format' => "YYYYMMDD2");
           $tab_arr_groubby_cmp['appointment_start_time'] = array('cmp' => "appointment_start_time", 'ind' => 3, 'format' => "Y");
           ...
           $tab_arr_groubby_sql[3] = array('cmp' => "appointment_start_time", 'ord' => 'asc');
...
function Sel_processa_form()
{
   ...
   $arr_campos_free['appointment_start_time'] = "" . $this->Nm_lang['lang_appointments_fld_appointment_start_time'] . "";
