...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['contr_label_graf']['current_status_id']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['contr_label_graf']['current_status_id']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['contr_label_graf']['current_status_id'];
      }
   }
