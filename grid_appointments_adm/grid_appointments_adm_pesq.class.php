...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_appointments_report'] ?></TITLE>
...
<?php
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['orig_pesq'] == "res")  
    { 
...
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_appointments_adm']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_appointments_adm']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_staff_id#NMF#' + search_get_select('SC_staff_id') + '@NMF@';
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $staff_id_cond, $staff_id,
             $customers_id_cond, $customers_id, $customers_id_autocomp,
      ...
      { 
          ...
          $current_status_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['campos_busca']['current_status_id']; 
          $current_status_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['campos_busca']['current_status_id_cond']; 
          $staff_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['campos_busca']['staff_id']; 
          $staff_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['campos_busca']['staff_id_cond']; 
          $customers_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['campos_busca']['customers_id']; 
          $customers_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['campos_busca']['customers_id_cond']; 
          $appointment_start_date_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['campos_busca']['appointment_start_date_dia']; 
          $appointment_start_date_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['campos_busca']['appointment_start_date_mes']; 
          $appointment_start_date_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['campos_busca']['appointment_start_date_ano']; 
          $appointment_start_date_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['campos_busca']['appointment_start_date_input_2_dia']; 
          $appointment_start_date_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['campos_busca']['appointment_start_date_input_2_mes']; 
          $appointment_start_date_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['campos_busca']['appointment_start_date_input_2_ano']; 
          $appointment_start_date_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['campos_busca']['appointment_start_date_cond']; 
...
?>
      ...
      <TD id='SC_staff_id_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['staff_id'])) ? $this->New_label['staff_id'] : "" . $this->Ini->Nm_lang['lang_appointments_fld_staff_id'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_staff_id_cond" name="staff_id_cond" value="eq">
...
?>
   <span id="idAjaxSelect_staff_id">
      <SELECT class="scFilterObjectEven" id="SC_staff_id" name="staff_id"  size="1">
       <OPTION value=""></OPTION>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $staff_id)
            {
                    $staff_id_sel = ($nm_opc_cod === $staff_id) ? "selected" : "";
            }
            else
            {
            ...
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $staff_id_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
?>
      ...
      <TD id='SC_customers_id_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['customers_id'])) ? $this->New_label['customers_id'] : "" . $this->Ini->Nm_lang['lang_appointments_fld_customers_id'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_customers_id_cond" name="customers_id_cond" value="eq">
...
?>
<INPUT  type="text" id="SC_customers_id" name="customers_id" value="<?php echo NM_encode_input($customers_id) ?>"  size=11 alt="{datatype: 'text', maxLength: 11, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-customers_id" id="id_ac_customers_id" name="customers_id_autocomp"><?php if ('' !=  $customers_id) { ?><option value="<?php echo $customers_id ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
       ...
       <TR valign="top">
        <TD id="id_vis_appointment_start_date"  <?php echo $str_display_appointment_start_date; ?> class="scFilterFieldFontEven">
...
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_appointments_adm']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_appointments_adm']['start'] == 'filter')
   {
?>
...
?>
 ...
 {
    if (Field == 'all' || Field == 'staff_id') {
       Sc_carga_select2_staff_id();
    }
    if (Field == 'all' || Field == 'current_status_id') {
       Sc_carga_select2_current_status_id();
    }
 }
 function Sc_carga_select2_staff_id()
 {
  $("#SC_staff_id").select2(
    {
      language: {
 ...
 function Sc_carga_select2_current_status_id()
 {
  $("#SC_current_status_id").select2(
    {
      language: {
        noResults: function() {
          return "<?php echo $this->Ini->Nm_lang['lang_autocomp_notfound'] ?>";
 ...
 {
    $('#SC_appointment_start_date_dia').bind('change', function() {sc_grid_appointments_adm_valida_dia(this)});
    $('#SC_appointment_start_date_input_2_dia').bind('change', function() {sc_grid_appointments_adm_valida_dia(this)});
    $('#SC_appointment_start_date_input_2_mes').bind('change', function() {sc_grid_appointments_adm_valida_mes(this)});
    $('#SC_appointment_start_date_mes').bind('change', function() {sc_grid_appointments_adm_valida_mes(this)});
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "appointments1/grid_appointments_adm";
   ...
   function trata_campos()
   {
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['psq_check_ret']['current_status_id'])) {
      ...
      if ($tmp_pos === false) {
          ...
          $L_lookup = substr($staff_id, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['psq_check_ret']['staff_id'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_appointments_fld_staff_id'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      ...
      $I_Dyn = 0;
      $Dyn_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['campos_busca']['current_status_id'] = $current_status_id; 
      if (is_array($current_status_id) && !empty($current_status_id))
      {
          $Dyn_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search'][$I_Dyn]['val'][0] = $current_status_id;
      }
      ...
      {
          $Dyn_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search'][$I_Dyn]['val'][0][0] = $current_status_id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['campos_busca']['current_status_id_cond'] = $current_status_id_cond_salva; 
      if ($Dyn_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search'][$I_Dyn]['cmp'] = "current_status_id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search'][$I_Dyn]['opc'] = $current_status_id_cond_salva; 
          $I_Dyn++;
      }
      $Dyn_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['campos_busca']['staff_id'] = $staff_id; 
      if (is_array($staff_id) && !empty($staff_id))
      {
          $Dyn_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search'][$I_Dyn]['val'][0] = $staff_id;
      }
      elseif ($staff_id_cond_salva == "nu" || $staff_id_cond_salva == "nn" || $staff_id_cond_salva == "ep" || $staff_id_cond_salva == "ne" || !empty($staff_id))
      {
          $Dyn_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search'][$I_Dyn]['val'][0][0] = $staff_id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['campos_busca']['staff_id_cond'] = $staff_id_cond_salva; 
      if ($Dyn_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search'][$I_Dyn]['cmp'] = "staff_id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search'][$I_Dyn]['opc'] = $staff_id_cond_salva; 
          $I_Dyn++;
      }
      $Dyn_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['campos_busca']['customers_id'] = $customers_id; 
      if (is_array($customers_id) && !empty($customers_id))
      {
          $Dyn_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search'][$I_Dyn]['val'][0] = $customers_id;
      }
      elseif ($customers_id_cond_salva == "nu" || $customers_id_cond_salva == "nn" || $customers_id_cond_salva == "ep" || $customers_id_cond_salva == "ne" || !empty($customers_id))
      {
          $Dyn_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search'][$I_Dyn]['val'][0][0] = $customers_id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['campos_busca']['customers_id_cond'] = $customers_id_cond_salva; 
      if ($Dyn_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search'][$I_Dyn]['cmp'] = "customers_id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search'][$I_Dyn]['opc'] = $customers_id_cond_salva; 
          $I_Dyn++;
      }
      $Dyn_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['campos_busca']['appointment_start_date_dia'] = $appointment_start_date_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['campos_busca']['appointment_start_date_mes'] = $appointment_start_date_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['campos_busca']['appointment_start_date_ano'] = $appointment_start_date_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['campos_busca']['appointment_start_date_input_2_dia'] = $appointment_start_date_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['campos_busca']['appointment_start_date_input_2_mes'] = $appointment_start_date_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['campos_busca']['appointment_start_date_input_2_ano'] = $appointment_start_date_input_2_ano; 
      ...
      {
          $Dyn_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search'][$I_Dyn]['val'][0][] = "D:" . $appointment_start_date_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search'][$I_Dyn]['val'][0][] = "M:" . $appointment_start_date_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search'][$I_Dyn]['val'][0][] = "Y:" . $appointment_start_date_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search'][$I_Dyn]['val'][1][] = "D:" . $appointment_start_date_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search'][$I_Dyn]['val'][1][] = "M:" . $appointment_start_date_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search'][$I_Dyn]['val'][1][] = "Y:" . $appointment_start_date_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['campos_busca']['appointment_start_date_cond'] = $appointment_start_date_cond_salva; 
      if ($Dyn_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search'][$I_Dyn]['cmp'] = "appointment_start_date"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['dyn_search'][$I_Dyn]['opc'] = $appointment_start_date_cond_salva; 
          $I_Dyn++;
      }
      ...
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : " . $this->Ini->Nm_lang['lang_appointments_fld_customers_id'] . "";
      }
      ...
      $this->cmp_formatado['staff_id'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($customers_id != '') {
      $customers_id_look = (is_string($customers_id) ? substr($this->Db->qstr($customers_id), 1, -1) : $customers_id); 
      $nmgp_def_dados = array(); 
   ...
   { 
      ...
      {
          $this->cmp_formatado['customers_id'] = $customers_id;
      }
      ...
      if (isset($staff_id))
      {
         $this->monta_condicao("staff_id", $staff_id_cond, $staff_id, "", "staff_id", "INT", false);
      }
      ...
      {
         $this->monta_condicao("customers_id", $customers_id_cond, $customers_id, "", "customers_id", "INT", false);
      }
      ...
      if ($appointment_start_date_cond != "bi_TP")
      {
          ...
          {
              $this->nm_prep_date($val, "DT", "DATETIME", $appointment_start_date_cond, "", "data");
          }
          else
          {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['campos_busca']['appointment_start_date'] = $val[0];
          ...
          if ($appointment_start_date_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['campos_busca']['appointment_start_date_input_2'] = $val[1];
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         ...
         case "staff_id" : return ('class="scFilterObjectEven"'); break;
         default       : return ("");
      }
   }
