...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["appointments1_____grid_appointments_adm"]))
   {
      unset($_SESSION['session_sec_aplicacao']["appointments1_____grid_appointments_adm"]);
   }
