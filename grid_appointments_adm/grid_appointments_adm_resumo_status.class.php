...
$_SESSION['scriptcase']['grid_appointments_adm']['contr_erro'] = 'off'; 
      ...
      {
          $this->array_total_current_status_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['arr_total']['current_status_id'];
      }
      else
      {
          $this->array_total_current_status_id = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['arr_total']['current_status_id'] = $this->array_total_current_status_id;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_adm']['labels']['current_status_id'] = $Lab_current_status_id; 
       ...
       foreach ($this->array_total_current_status_id as $i_current_status_id => $d_current_status_id) {
           if (!isset($i_current_status_id, $this->comp_label[0]) || !in_array($i_current_status_id, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_current_status_id[4] ] = $d_current_status_id[3];
               $this->comp_label[0][ $d_current_status_id[4] ] = $d_current_status_id[3];
           }
       }
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_total_price, $quebra_current_status_id, $quebra_current_status_id_orig)
   {
      //----- current_status_id
      if (!isset($this->array_total_current_status_id[$quebra_current_status_id_orig]))
      {
         ...
         $this->array_total_current_status_id[$quebra_current_status_id_orig][1] = $sum_total_price;
         $this->array_total_current_status_id[$quebra_current_status_id_orig][2] = 1;
         $this->array_total_current_status_id[$quebra_current_status_id_orig][3] = $quebra_current_status_id;
         $this->array_total_current_status_id[$quebra_current_status_id_orig][4] = $quebra_current_status_id_orig;
      }
      else
      {
         $this->array_total_current_status_id[$quebra_current_status_id_orig][0]++;
         $this->array_total_current_status_id[$quebra_current_status_id_orig][1] = bcadd($this->array_total_current_status_id[$quebra_current_status_id_orig][1], $sum_total_price, 10);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->staff_id = $this->look_staff_id ;
            $this->customers_id = $this->look_customers_id ;
            $this->current_status_id = $this->look_current_status_id ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->total_price, $this->current_status_id, $this->current_status_id_orig);
            }
   }
//
