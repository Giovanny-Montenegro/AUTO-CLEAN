<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_count_new_appointments']['glo_nm_path_imag_temp'] . "/sc_apl_default_appointments1.txt"))
       {
?>
...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["count_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_count_new_appointments']['labels']["count_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_count_new_appointments']['labels']["count_0"] : "" . $this->Nm_lang['lang_new_appointments'] . "";
