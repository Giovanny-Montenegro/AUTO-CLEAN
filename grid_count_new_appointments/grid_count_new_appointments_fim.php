...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["appointments1_____grid_count_new_appointments"]))
   {
      unset($_SESSION['session_sec_aplicacao']["appointments1_____grid_count_new_appointments"]);
   }
