...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments_mob']['where_detal']))
  {
?>  
...
{
    document.getElementById('form_appointments_mob_form0').style.width='1px';
    document.getElementById('form_appointments_mob_form0').style.height='0px';
    document.getElementById('form_appointments_mob_form0').style.display='none';
    document.getElementById('form_appointments_mob_form0').style.overflow='scroll';
    document.getElementById('form_appointments_mob_form1').style.width='1px';
    document.getElementById('form_appointments_mob_form1').style.height='0px';
    document.getElementById('form_appointments_mob_form1').style.display='none';
    document.getElementById('form_appointments_mob_form1').style.overflow='scroll';
    document.getElementById('form_appointments_mob_form2').style.width='1px';
    document.getElementById('form_appointments_mob_form2').style.height='0px';
    document.getElementById('form_appointments_mob_form2').style.display='none';
    document.getElementById('form_appointments_mob_form2').style.overflow='scroll';
<?php
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments_mob']['pdf_view']) {
?>
...
?>
   ...
   if ("form_appointments_mob_form1" == N_pagina) {
   ...
   if ("form_appointments_mob_form2" == N_pagina) {
