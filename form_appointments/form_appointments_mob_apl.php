...
//----- 
   function ini_controle()
   {
      ...
      {
          if (isset($this->NM_ajax_info['param']['additional_charges']))
          {
              $this->additional_charges = $this->NM_ajax_info['param']['additional_charges'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['details']))
          {
              $this->details = $this->NM_ajax_info['param']['details'];
          }
          if (isset($this->NM_ajax_info['param']['discount']))
          {
              $this->discount = $this->NM_ajax_info['param']['discount'];
          }
          if (isset($this->NM_ajax_info['param']['hist']))
          {
              $this->hist = $this->NM_ajax_info['param']['hist'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['staff_id']))
          {
              $this->staff_id = $this->NM_ajax_info['param']['staff_id'];
          }
      ...
      { 
          ...
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_appointments_mob']['total']))
          {
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_appointments_mob']['form_appointment_details_mob_script_case_init'] ]['form_appointment_details_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_appointments_mob']['form_appointment_details_mob_script_case_init'] ]['form_appointment_details_mob']['total']);
          }
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments_mob']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_appointments_mob']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_appointments_mob']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - " . $this->Ini->Nm_lang['lang_tbl_appointments'] . "";
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments_mob']['form_appointment_details_mob_script_case_init'] ]['form_appointment_details_mob']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments_mob']['form_appointment_details_mob_script_case_init'] ]['form_appointment_details_mob']['embutida_proc'] = true;
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_appointments_mob']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_appointments_mob']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      if (isset($this->staff_id)) { $this->nm_limpa_alfa($this->staff_id); }
      if (isset($this->customers_id)) { $this->nm_limpa_alfa($this->customers_id); }
      if (isset($this->price)) { $this->nm_limpa_alfa($this->price); }
      if (isset($this->additional_charges)) { $this->nm_limpa_alfa($this->additional_charges); }
      ...
      if (isset($this->details)) { $this->nm_limpa_alfa($this->details); }
      if (isset($this->hist)) { $this->nm_limpa_alfa($this->hist); }
      $Campos_Crit       = "";
      $Campos_erro       = "";
      $Campos_Falta      = array();
      $Campos_Erros      = array();
...
//
      ...
      {
          if ('validate_staff_id' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'staff_id');
          }
          ...
          if ('validate_additional_charges' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'additional_charges');
          }
          ...
          if ('validate_details' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'details');
          }
          if ('validate_hist' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'hist');
          }
      ...
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6))
      {
          ...
          if ('event_appointment_start_date_onchange' == $this->NM_ajax_opcao)
          {
              $this->appointment_start_date_onChange();
          }
...
<HEAD>
 <TITLE><?php echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - " . $this->Ini->Nm_lang['lang_tbl_appointments'] . "") ?></TITLE>
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'staff_id' == $filtro)) || (is_array($filtro) && in_array('staff_id', $filtro)))
        $this->ValidateField_staff_id($Campos_Crit, $Campos_Falta, $Campos_Erros);
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'additional_charges' == $filtro)) || (is_array($filtro) && in_array('additional_charges', $filtro)))
        $this->ValidateField_additional_charges($Campos_Crit, $Campos_Falta, $Campos_Erros);
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'details' == $filtro)) || (is_array($filtro) && in_array('details', $filtro)))
        $this->ValidateField_details($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!is_array($filtro) && ('' == $filtro || 'hist' == $filtro)) || (is_array($filtro) && in_array('hist', $filtro)))
        $this->ValidateField_hist($Campos_Crit, $Campos_Falta, $Campos_Erros);
//-- converter datas   
          $this->nm_converte_datas();
//---
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    ...
    $original_staff_id = $this->staff_id;
}
  $this->chk_available();
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    ...
    if (($original_staff_id != $this->staff_id || (isset($bFlagRead_staff_id) && $bFlagRead_staff_id)))
    {
        $this->ajax_return_values_staff_id(true);
    }
}
$_SESSION['scriptcase']['form_appointments_mob']['contr_erro'] = 'off'; 
      }
    ...
    function ValidateField_staff_id(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->staff_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments_mob']['Lookup_staff_id']) && !in_array($this->staff_id, $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments_mob']['Lookup_staff_id']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($Campos_Erros['staff_id']))
                   {
                       $Campos_Erros['staff_id'] = array();
                   }
                   $Campos_Erros['staff_id'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($this->NM_ajax_info['errList']['staff_id']) || !is_array($this->NM_ajax_info['errList']['staff_id']))
                   {
                       $this->NM_ajax_info['errList']['staff_id'] = array();
                   }
                   $this->NM_ajax_info['errList']['staff_id'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
               }
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'staff_id';
    ...
    } // ValidateField_staff_id

    function ValidateField_customers_id(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->customers_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments_mob']['Lookup_customers_id']) && !in_array($this->customers_id, $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments_mob']['Lookup_customers_id']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_appointment_start_date(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments_mob']['php_cmp_required']['appointment_start_date']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments_mob']['php_cmp_required']['appointment_start_date'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_appointment_start_time(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      {
          ...
          { 
              ...
              { 
                  $hasError = true;
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_appointments_fld_appointment_start_time'] . "; " ; 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments_mob']['php_cmp_required']['appointment_start_time']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments_mob']['php_cmp_required']['appointment_start_time'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_price(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              { 
                  $hasError = true;
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_appointments_fld_price'] . ": " . $this->Ini->Nm_lang['lang_errm_size']; 
              ...
              if ($teste_validade->Valor($this->price, 4, 2, -0, 999999, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_appointments_fld_price'] . "; " ; 
                  if (!isset($Campos_Erros['price']))
                  {
                      $Campos_Erros['price'] = array();
                  }
    ...
    function ValidateField_additional_charges(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      ...
      if (!empty($this->field_config['additional_charges']['symbol_dec']))
      {
          ...
          if ('.' == substr($this->additional_charges, 0, 1))
          {
              if ('' == str_replace('0', '', substr($this->additional_charges, 1)))
              {
                  $this->additional_charges = '';
              }
              else
              {
                  $this->additional_charges = '0' . $this->additional_charges;
              }
          }
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          { 
              $iTestSize = 7;
              if (strlen($this->additional_charges) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_appointments_fld_additional_charges'] . ": " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['additional_charges']))
                  {
                      $Campos_Erros['additional_charges'] = array();
                  }
                  $Campos_Erros['additional_charges'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['additional_charges']) || !is_array($this->NM_ajax_info['errList']['additional_charges']))
                  {
                      $this->NM_ajax_info['errList']['additional_charges'] = array();
                  }
                  $this->NM_ajax_info['errList']['additional_charges'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->additional_charges, 4, 2, -0, 999999, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_appointments_fld_additional_charges'] . "; " ; 
                  if (!isset($Campos_Erros['additional_charges']))
                  {
                      $Campos_Erros['additional_charges'] = array();
                  }
                  $Campos_Erros['additional_charges'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['additional_charges']) || !is_array($this->NM_ajax_info['errList']['additional_charges']))
                  {
                      $this->NM_ajax_info['errList']['additional_charges'] = array();
                  }
                  $this->NM_ajax_info['errList']['additional_charges'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
        if ($hasError) {
    ...
    } // ValidateField_additional_charges
    ...
    function ValidateField_discount(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              { 
                  $hasError = true;
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_appointments_fld_discount'] . ": " . $this->Ini->Nm_lang['lang_errm_size']; 
              ...
              if ($teste_validade->Valor($this->discount, 4, 2, -0, 999999, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_appointments_fld_discount'] . "; " ; 
                  if (!isset($Campos_Erros['discount']))
                  {
                      $Campos_Erros['discount'] = array();
                  }
    ...
    function ValidateField_details(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir") 
    ...
    } // ValidateField_details

    function ValidateField_hist(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir") 
   ...
   function nm_formatar_campos($format_fields = array())
   {
     ...
     $this->formatado = true;
      ...
      if ('' !== $this->additional_charges || (!empty($format_fields) && isset($format_fields['additional_charges'])))
      {
          nmgp_Form_Num_Val($this->additional_charges, $this->field_config['additional_charges']['symbol_grp'], $this->field_config['additional_charges']['symbol_dec'], "2", "S", $this->field_config['additional_charges']['format_neg'], "", "", "-", $this->field_config['additional_charges']['symbol_fmt']) ; 
      }
...
//
   ...
   {
          $this->ajax_return_values_staff_id();
          ...
          $this->ajax_return_values_additional_charges();
          $this->ajax_return_values_discount();
          $this->ajax_return_values_total_price();
          $this->ajax_return_values_details();
          $this->ajax_return_values_hist();
          ...
          //----- staff_id
   function ajax_return_values_staff_id($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("staff_id", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->staff_id);
              $aLookup = array();
              $this->_tmp_lookup_staff_id = $this->staff_id;

 
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments_mob']['Lookup_staff_id']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments_mob']['Lookup_staff_id'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments_mob']['Lookup_staff_id']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments_mob']['Lookup_staff_id'] = array(); 
}
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments_mob']['Lookup_staff_id'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"staff_id\"";
          if (isset($this->NM_ajax_info['select_html']['staff_id']) && !empty($this->NM_ajax_info['select_html']['staff_id']))
          {
              $sSelComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['staff_id']);
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->staff_id == $sValue)
                  {
                      $this->_tmp_lookup_staff_id = $sLabel;
                  }
          ...
          $aLookup  = $sLookup;
          $this->NM_ajax_info['fldList']['staff_id'] = array(
                       'row'    => '',
               'type'    => 'select',
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['staff_id']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['staff_id']['valList'][$i] = form_appointments_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['staff_id']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['staff_id']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['staff_id']['labList'] = $aLabel;
          }
   }
   ...
   function ajax_return_values_customers_id($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("customers_id", $this->nmgp_refresh_fields)) || $bForce)
          {
              ...
              $aLookup = array();
              $this->_tmp_lookup_customers_id = $this->customers_id;

 
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments_mob']['Lookup_customers_id']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments_mob']['Lookup_customers_id'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments_mob']['Lookup_customers_id']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments_mob']['Lookup_customers_id'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments_mob']['Lookup_customers_id'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"customers_id\"";
          if (isset($this->NM_ajax_info['select_html']['customers_id']) && !empty($this->NM_ajax_info['select_html']['customers_id']))
          {
              $sSelComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['customers_id']);
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->customers_id == $sValue)
                  {
                      $this->_tmp_lookup_customers_id = $sLabel;
                  }
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['customers_id']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['customers_id']['valList'][$i] = form_appointments_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['customers_id']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['customers_id']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['customers_id']['labList'] = $aLabel;
          }
   }
...
else
{
   ...
   function ajax_return_values_price($bForce = false)
   {
          ...
          //----- additional_charges
   function ajax_return_values_additional_charges($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("additional_charges", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->additional_charges);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['additional_charges'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
   ...
   function ajax_return_values_total_price($bForce = false)
   {
          ...
          //----- details
   function ajax_return_values_details($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("details", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->details);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['details'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
          ...
          //----- hist
   function ajax_return_values_hist($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("hist", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->hist);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['hist'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
...
$_SESSION['scriptcase']['form_appointments_mob']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "incluir") 
      {
          ...
          if ($this->details == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->details = "null"; 
              $NM_val_null[] = "details";
          } 
          ...
          if ($this->hist == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->hist = "null"; 
              $NM_val_null[] = "hist";
          } 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "staff_id = $this->staff_id, customers_id = $this->customers_id, price = $this->price, additional_charges = $this->additional_charges, discount = $this->discount, total_price = $this->total_price, appointment_start_date = #$this->appointment_start_date#, appointment_start_time = #$this->appointment_start_time#, appointment_end_date = #$this->appointment_end_date#, appointment_end_time = #$this->appointment_end_time#, current_status_id = $this->current_status_id"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
                  $SC_fields_update[] = "staff_id = $this->staff_id, customers_id = $this->customers_id, price = $this->price, additional_charges = $this->additional_charges, discount = $this->discount, total_price = $this->total_price, appointment_start_date = " . $this->Ini->date_delim . $this->appointment_start_date . $this->Ini->date_delim1 . ", appointment_start_time = " . $this->Ini->date_delim . $this->appointment_start_time . $this->Ini->date_delim1 . ", appointment_end_date = " . $this->Ini->date_delim . $this->appointment_end_date . $this->Ini->date_delim1 . ", appointment_end_time = " . $this->Ini->date_delim . $this->appointment_end_time . $this->Ini->date_delim1 . ", current_status_id = $this->current_status_id"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['staff_id'])) { $this->staff_id = $NM_val_form['staff_id']; }
              elseif (isset($this->staff_id)) { $this->nm_limpa_alfa($this->staff_id); }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['additional_charges'])) { $this->additional_charges = $NM_val_form['additional_charges']; }
              elseif (isset($this->additional_charges)) { $this->nm_limpa_alfa($this->additional_charges); }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['details'])) { $this->details = $NM_val_form['details']; }
              elseif (isset($this->details)) { $this->nm_limpa_alfa($this->details); }
              if     (isset($NM_val_form) && isset($NM_val_form['hist'])) { $this->hist = $NM_val_form['hist']; }
              elseif (isset($this->hist)) { $this->nm_limpa_alfa($this->hist); }
              ...
              $this->nmgp_refresh_fields = array_diff(array('staff_id', 'customers_id', 'current_status_id', 'appointment_start_date', 'appointment_start_time', 'appointment_end_date', 'appointment_end_time', 'price', 'additional_charges', 'discount', 'total_price', 'details', 'hist'), $aDoNotUpdate);
              $this->ajax_return_values();
...
$hist_desc =  $this->Ini->Nm_lang['lang_appointment_updated'] ." ".
"<br/>". $this->Ini->Nm_lang['lang_appointments_fld_current_status_id'] .": ".$dsstatus.
"<br/>". $this->Ini->Nm_lang['lang_appointments_fld_appointment_start_date'] .": ".$this->appointment_start_date  . " - ".$this->appointment_start_time .
"<br/>". $this->Ini->Nm_lang['lang_appointments_fld_total_price'] .": ".$this->total_price .
"<br/>". $this->Ini->Nm_lang['lang_appointments_fld_customers_id'] .": ".$dscustomername.
...
//-- 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['embutida_parms'] = "var_appointment_id*scin" . $this->nmgp_dados_form['appointments_id'] . "*scout";
  }
...
$original_additional_charges = $this->additional_charges;
$original_discount = $this->discount;

$this->upd_price();

$modificado_total_price = $this->total_price;
$modificado_price = $this->price;
$modificado_additional_charges = $this->additional_charges;
$modificado_discount = $this->discount;
$this->nm_formatar_campos('total_price', 'price', 'additional_charges', 'discount');
if ($original_total_price !== $modificado_total_price || isset($this->nmgp_cmp_readonly['total_price']) || (isset($bFlagRead_total_price) && $bFlagRead_total_price))
{
    $this->ajax_return_values_total_price(true);
}
if ($original_price !== $modificado_price || isset($this->nmgp_cmp_readonly['price']) || (isset($bFlagRead_price) && $bFlagRead_price))
{
    $this->ajax_return_values_price(true);
}
if ($original_additional_charges !== $modificado_additional_charges || isset($this->nmgp_cmp_readonly['additional_charges']) || (isset($bFlagRead_additional_charges) && $bFlagRead_additional_charges))
{
    $this->ajax_return_values_additional_charges(true);
}
...
function appointment_start_date_onChange()
{
$_SESSION['scriptcase']['form_appointments_mob']['contr_erro'] = 'on';
...
$this->nm_formatar_campos('price', 'appointment_end_date', 'appointment_start_date', 'appointment_start_time', 'appointment_end_time');
if ($original_price !== $modificado_price || isset($this->nmgp_cmp_readonly['price']) || (isset($bFlagRead_price) && $bFlagRead_price))
{
    $this->ajax_return_values_price(true);
}
...
{
	$this->nm_mens_alert[] = 'OK!'; $this->nm_params_alert[] = array(); if ($this->NM_ajax_flag) { $this->sc_ajax_alert('OK!'); }}
$_SESSION['scriptcase']['form_appointments_mob']['contr_erro'] = 'off';
}
...
<?php
        ...
        include_once("form_appointments_mob_form1.php");
        include_once("form_appointments_mob_form2.php");
        $this->hideFormPages();
 }
...
else
{
   ...
   function Form_lookup_customers_id()
   {
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments_mob']['Lookup_customers_id']))
{
...
else
{
   ...
   function SC_lookup_customers_id($condicao, $campo)
   {
       ...
       $campo_orig = $campo;
       $campo  = substr($this->Db->qstr($campo), 1, -1);
       $nm_comando = "SELECT customers_name, customers_id FROM customers WHERE (#cmp_icustomers_name#cmp_f#cmp_apos LIKE '%#arg_i" . $campo . "#arg_f%'#arg_apos)" ; 
       if ($condicao == "ii")
       {
           $nm_comando = str_replace("LIKE '%#arg_i" . $campo . "#arg_f%'", "LIKE '#arg_i" . $campo . "#arg_f%'", $nm_comando);
       }
...
<?php
  exit;
    ...
    function getButtonIds($buttonName) {
        switch ($buttonName) {
            ...
            case "help":
                ...
                break;
            case "exit":
                return array("sc_b_sai_b.sc-unique-btn-4", "sc_b_sai_b.sc-unique-btn-6", "sc_b_sai_b.sc-unique-btn-7", "sc_b_sai_b.sc-unique-btn-5");
                break;
        }
    ...
    function displayAppHeader()
    {
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['mostra_cab']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['mostra_cab'] == "N") {
            return;
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments_mob']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments_mob']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments_mob']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments_mob']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments_mob']['link_info']['compact_mode']) {
            return;
        }
?>
...
<div class="scFormHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    ...
    <div class="scFormHeaderFont" style="float: right;"><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - " . $this->Ini->Nm_lang['lang_tbl_appointments'] . ""; } else { echo "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - " . $this->Ini->Nm_lang['lang_tbl_appointments'] . ""; } ?></div>
