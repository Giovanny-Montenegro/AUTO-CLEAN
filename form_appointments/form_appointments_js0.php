...
{
    document.getElementById('form_appointments_form0').style.width='1px';
    document.getElementById('form_appointments_form0').style.height='0px';
    document.getElementById('form_appointments_form0').style.display='none';
    document.getElementById('form_appointments_form0').style.overflow='scroll';
    document.getElementById('form_appointments_form1').style.width='1px';
    document.getElementById('form_appointments_form1').style.height='0px';
    document.getElementById('form_appointments_form1').style.display='none';
    document.getElementById('form_appointments_form1').style.overflow='scroll';
    document.getElementById('form_appointments_form2').style.width='1px';
    document.getElementById('form_appointments_form2').style.height='0px';
    document.getElementById('form_appointments_form2').style.display='none';
    document.getElementById('form_appointments_form2').style.overflow='scroll';
<?php
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments']['pdf_view']) {
?>
...
?>
   ...
   if ("form_appointments_form1" == N_pagina) {
   ...
   if ("form_appointments_form2" == N_pagina) {
