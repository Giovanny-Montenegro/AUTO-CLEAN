...
else
{
    ...
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments_mob']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments_mob']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
...
<script type="text/javascript">
var pag_ativa = "form_appointments_mob_form0";
</script>
<ul class="scTabLine sc-ui-page-tab-line">
<?php
    $this->tabCssClass = array(
        'form_appointments_mob_form0' => array(
            'title' => "{lang_appointment_info}",
            'class' => empty($nmgp_num_form) || $nmgp_num_form == "form_appointments_mob_form0" ? "scTabActive" : "scTabInactive",
        ),
        'form_appointments_mob_form1' => array(
            'title' => "{lang_service_details}",
            'class' => $nmgp_num_form == "form_appointments_mob_form1" ? "scTabActive" : "scTabInactive",
        ),
        'form_appointments_mob_form2' => array(
            'title' => "{lang_history}",
            'class' => $nmgp_num_form == "form_appointments_mob_form2" ? "scTabActive" : "scTabInactive",
        ),
    );
    if (!empty($this->Ini->nm_hidden_pages)) {
        foreach ($this->Ini->nm_hidden_pages as $pageName => $pageStatus) {
            if ('{lang_appointment_info}' == $pageName && 'off' == $pageStatus) {
                $this->tabCssClass['form_appointments_mob_form0']['class'] = 'scTabInactive';
            }
            if ('{lang_service_details}' == $pageName && 'off' == $pageStatus) {
                $this->tabCssClass['form_appointments_mob_form1']['class'] = 'scTabInactive';
            }
            if ('{lang_history}' == $pageName && 'off' == $pageStatus) {
                $this->tabCssClass['form_appointments_mob_form2']['class'] = 'scTabInactive';
            }
        }
...
?>
<?php
    $css_celula = $this->tabCssClass["form_appointments_mob_form0"]['class'];
?>
   <li id="id_form_appointments_mob_form0" class="<?php echo $css_celula; ?> sc-form-page sc-tab-click" data-tab-name="form_appointments_mob_form0">
     <?php echo $this->Ini->Nm_lang['lang_appointment_info']; ?>
   </li>
<?php
    $css_celula = $this->tabCssClass["form_appointments_mob_form1"]['class'];
?>
   <li id="id_form_appointments_mob_form1" class="<?php echo $css_celula; ?> sc-form-page sc-tab-click" data-tab-name="form_appointments_mob_form1">
     <?php echo $this->Ini->Nm_lang['lang_service_details']; ?>
   </li>
<?php
    $css_celula = $this->tabCssClass["form_appointments_mob_form2"]['class'];
?>
   <li id="id_form_appointments_mob_form2" class="<?php echo $css_celula; ?> sc-form-page sc-tab-click" data-tab-name="form_appointments_mob_form2">
...
<div id="form_appointments_mob_form0" style='display: none; width: 1px; height: 0px; overflow: scroll'>
