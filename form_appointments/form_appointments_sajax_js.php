...
?>
  ...
  // ---------- Validate staff_id
  function do_ajax_form_appointments_validate_staff_id()
  {
    var nomeCampo_staff_id = "staff_id";
    var var_staff_id = scAjaxGetFieldSelect(nomeCampo_staff_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_validate_staff_id(var_staff_id, var_script_case_init, do_ajax_form_appointments_validate_staff_id_cb);
  } // do_ajax_form_appointments_validate_staff_id

  function do_ajax_form_appointments_validate_staff_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_validate_staff_id_cb

  // ---------- Validate customers_id
  function do_ajax_form_appointments_validate_customers_id()
  {
    var nomeCampo_customers_id = "customers_id";
    var var_customers_id = scAjaxGetFieldSelect(nomeCampo_customers_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_validate_customers_id(var_customers_id, var_script_case_init, do_ajax_form_appointments_validate_customers_id_cb);
  } // do_ajax_form_appointments_validate_customers_id

  function do_ajax_form_appointments_validate_customers_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_validate_customers_id_cb
  ...
  function do_ajax_form_appointments_validate_appointment_end_date()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_validate_appointment_end_date(var_appointment_end_date, var_script_case_init, do_ajax_form_appointments_validate_appointment_end_date_cb);
  } // do_ajax_form_appointments_validate_appointment_end_date

  function do_ajax_form_appointments_validate_appointment_end_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_validate_appointment_end_date_cb
  ...
  // ---------- Validate price
  function do_ajax_form_appointments_validate_price()
  {
    var nomeCampo_price = "price";
    var var_price = scAjaxGetFieldHidden(nomeCampo_price);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_validate_price(var_price, var_script_case_init, do_ajax_form_appointments_validate_price_cb);
  } // do_ajax_form_appointments_validate_price

  function do_ajax_form_appointments_validate_price_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "price";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_validate_price_cb

  // ---------- Validate additional_charges
  function do_ajax_form_appointments_validate_additional_charges()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_validate_additional_charges(var_additional_charges, var_script_case_init, do_ajax_form_appointments_validate_additional_charges_cb);
  } // do_ajax_form_appointments_validate_additional_charges

  function do_ajax_form_appointments_validate_additional_charges_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_validate_additional_charges_cb

  // ---------- Validate discount
  function do_ajax_form_appointments_validate_discount()
  {
    var nomeCampo_discount = "discount";
    var var_discount = scAjaxGetFieldText(nomeCampo_discount);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_validate_discount(var_discount, var_script_case_init, do_ajax_form_appointments_validate_discount_cb);
  } // do_ajax_form_appointments_validate_discount

  function do_ajax_form_appointments_validate_discount_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_validate_discount_cb

  // ---------- Validate total_price
  function do_ajax_form_appointments_validate_total_price()
  {
    var nomeCampo_total_price = "total_price";
    var var_total_price = scAjaxGetFieldHidden(nomeCampo_total_price);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_validate_total_price(var_total_price, var_script_case_init, do_ajax_form_appointments_validate_total_price_cb);
  } // do_ajax_form_appointments_validate_total_price

  function do_ajax_form_appointments_validate_total_price_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_validate_total_price_cb

  // ---------- Validate details
  function do_ajax_form_appointments_validate_details()
  {
    var nomeCampo_details = "details";
    var var_details = scAjaxGetFieldText(nomeCampo_details);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_validate_details(var_details, var_script_case_init, do_ajax_form_appointments_validate_details_cb);
  } // do_ajax_form_appointments_validate_details

  function do_ajax_form_appointments_validate_details_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "details";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_validate_details_cb

  // ---------- Validate hist
  function do_ajax_form_appointments_validate_hist()
  {
    var nomeCampo_hist = "hist";
    var var_hist = scAjaxGetFieldText(nomeCampo_hist);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_validate_hist(var_hist, var_script_case_init, do_ajax_form_appointments_validate_hist_cb);
  } // do_ajax_form_appointments_validate_hist

  function do_ajax_form_appointments_validate_hist_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "hist";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_validate_hist_cb

  // ---------- Event onchange additional_charges
  function do_ajax_form_appointments_event_additional_charges_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_appointments_event_additional_charges_onchange(var_total_price, var_price, var_additional_charges, var_discount, var_script_case_init, do_ajax_form_appointments_event_additional_charges_onchange_cb);
  } // do_ajax_form_appointments_event_additional_charges_onchange

  function do_ajax_form_appointments_event_additional_charges_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "additional_charges";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_appointments_event_additional_charges_onchange_cb_after_alert);
  } // do_ajax_form_appointments_event_additional_charges_onchange_cb
  function do_ajax_form_appointments_event_additional_charges_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_appointments_event_additional_charges_onchange_cb_after_alert

  // ---------- Event onchange appointment_start_date
  function do_ajax_form_appointments_event_appointment_start_date_onchange()
  {
    var var_price = scAjaxGetFieldHidden("price");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_appointments_event_appointment_start_date_onchange(var_price, var_appointment_end_date, var_appointment_start_date, var_appointment_start_time, var_appointment_end_time, var_script_case_init, do_ajax_form_appointments_event_appointment_start_date_onchange_cb);
  } // do_ajax_form_appointments_event_appointment_start_date_onchange

  function do_ajax_form_appointments_event_appointment_start_date_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "appointment_start_date";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_appointments_event_appointment_start_date_onchange_cb_after_alert);
  } // do_ajax_form_appointments_event_appointment_start_date_onchange_cb
  function do_ajax_form_appointments_event_appointment_start_date_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_appointments_event_appointment_start_date_onchange_cb_after_alert

  // ---------- Event onchange appointment_start_time
  function do_ajax_form_appointments_event_appointment_start_time_onchange()
  {
    var var_price = scAjaxGetFieldHidden("price");
    var var_appointment_end_date = scAjaxGetFieldText("appointment_end_date");
    var var_appointment_start_date = scAjaxGetFieldText("appointment_start_date");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_appointments_event_appointment_start_time_onchange(var_price, var_appointment_end_date, var_appointment_start_date, var_appointment_start_time, var_appointment_end_time, var_script_case_init, do_ajax_form_appointments_event_appointment_start_time_onchange_cb);
  } // do_ajax_form_appointments_event_appointment_start_time_onchange

  function do_ajax_form_appointments_event_appointment_start_time_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "appointment_start_time";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_appointments_event_appointment_start_time_onchange_cb_after_alert);
  } // do_ajax_form_appointments_event_appointment_start_time_onchange_cb
  function do_ajax_form_appointments_event_appointment_start_time_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_appointments_event_appointment_start_time_onchange_cb_after_alert

  // ---------- Event onchange discount
  function do_ajax_form_appointments_event_discount_onchange()
  {
    var var_total_price = scAjaxGetFieldHidden("total_price");
    var var_price = scAjaxGetFieldHidden("price");
    var var_additional_charges = scAjaxGetFieldText("additional_charges");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_appointments_event_discount_onchange(var_total_price, var_price, var_additional_charges, var_discount, var_script_case_init, do_ajax_form_appointments_event_discount_onchange_cb);
  } // do_ajax_form_appointments_event_discount_onchange

  function do_ajax_form_appointments_event_discount_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "discount";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_appointments_event_discount_onchange_cb_after_alert);
  } // do_ajax_form_appointments_event_discount_onchange_cb
  function do_ajax_form_appointments_event_discount_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_appointments_event_discount_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_appointments_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_appointments_submit_form(var_staff_id, var_customers_id, var_current_status_id, var_appointment_start_date, var_appointment_start_time, var_appointment_end_date, var_appointment_end_time, var_price, var_additional_charges, var_discount, var_total_price, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_appointments_submit_form_cb);
...
?>
  ...
  var scStatusDetail = {};
  scStatusDetail["form_appointment_details"] = "off";
  ...
  function perform_ajax_form_appointments_navigate_form()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_appointment_details"] = "on";
...
?>
  function do_ajax_form_appointments_navigate_form_cb(sResp)
  {
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_appointment_details"] && "nmsc_iframe_liga_form_appointment_details" != scMasterDetailIframe["nmsc_iframe_liga_form_appointment_details"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_appointment_details"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_appointment_details').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_appointment_details').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_appointment_details').style.display = "none";
    }
...
?>
  ...
  {
    if ("off" == scStatusDetail["form_appointment_details"] && "off" == scStatusDetail["grid_appointments_history"])
    {
      return true;
    }
    return false;
