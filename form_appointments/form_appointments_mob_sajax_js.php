...
?>
  ...
  // ---------- Validate staff_id
  function do_ajax_form_appointments_mob_validate_staff_id()
  {
    var nomeCampo_staff_id = "staff_id";
    var var_staff_id = scAjaxGetFieldSelect(nomeCampo_staff_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_mob_validate_staff_id(var_staff_id, var_script_case_init, do_ajax_form_appointments_mob_validate_staff_id_cb);
  } // do_ajax_form_appointments_mob_validate_staff_id

  function do_ajax_form_appointments_mob_validate_staff_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "staff_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_mob_validate_staff_id_cb

  // ---------- Validate customers_id
  function do_ajax_form_appointments_mob_validate_customers_id()
  {
    var nomeCampo_customers_id = "customers_id";
    var var_customers_id = scAjaxGetFieldSelect(nomeCampo_customers_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_mob_validate_customers_id(var_customers_id, var_script_case_init, do_ajax_form_appointments_mob_validate_customers_id_cb);
  } // do_ajax_form_appointments_mob_validate_customers_id

  function do_ajax_form_appointments_mob_validate_customers_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_mob_validate_customers_id_cb
  ...
  function do_ajax_form_appointments_mob_validate_appointment_end_date()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_mob_validate_appointment_end_date(var_appointment_end_date, var_script_case_init, do_ajax_form_appointments_mob_validate_appointment_end_date_cb);
  } // do_ajax_form_appointments_mob_validate_appointment_end_date

  function do_ajax_form_appointments_mob_validate_appointment_end_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_mob_validate_appointment_end_date_cb
  ...
  // ---------- Validate price
  function do_ajax_form_appointments_mob_validate_price()
  {
    var nomeCampo_price = "price";
    var var_price = scAjaxGetFieldHidden(nomeCampo_price);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_mob_validate_price(var_price, var_script_case_init, do_ajax_form_appointments_mob_validate_price_cb);
  } // do_ajax_form_appointments_mob_validate_price

  function do_ajax_form_appointments_mob_validate_price_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "price";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_mob_validate_price_cb

  // ---------- Validate additional_charges
  function do_ajax_form_appointments_mob_validate_additional_charges()
  {
    var nomeCampo_additional_charges = "additional_charges";
    var var_additional_charges = scAjaxGetFieldText(nomeCampo_additional_charges);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_mob_validate_additional_charges(var_additional_charges, var_script_case_init, do_ajax_form_appointments_mob_validate_additional_charges_cb);
  } // do_ajax_form_appointments_mob_validate_additional_charges

  function do_ajax_form_appointments_mob_validate_additional_charges_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_mob_validate_additional_charges_cb

  // ---------- Validate discount
  function do_ajax_form_appointments_mob_validate_discount()
  {
    var nomeCampo_discount = "discount";
    var var_discount = scAjaxGetFieldText(nomeCampo_discount);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_mob_validate_discount(var_discount, var_script_case_init, do_ajax_form_appointments_mob_validate_discount_cb);
  } // do_ajax_form_appointments_mob_validate_discount

  function do_ajax_form_appointments_mob_validate_discount_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_mob_validate_discount_cb

  // ---------- Validate total_price
  function do_ajax_form_appointments_mob_validate_total_price()
  {
    var nomeCampo_total_price = "total_price";
    var var_total_price = scAjaxGetFieldHidden(nomeCampo_total_price);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_mob_validate_total_price(var_total_price, var_script_case_init, do_ajax_form_appointments_mob_validate_total_price_cb);
  } // do_ajax_form_appointments_mob_validate_total_price

  function do_ajax_form_appointments_mob_validate_total_price_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "total_price";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_mob_validate_total_price_cb

  // ---------- Validate details
  function do_ajax_form_appointments_mob_validate_details()
  {
    var nomeCampo_details = "details";
    var var_details = scAjaxGetFieldText(nomeCampo_details);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_mob_validate_details(var_details, var_script_case_init, do_ajax_form_appointments_mob_validate_details_cb);
  } // do_ajax_form_appointments_mob_validate_details

  function do_ajax_form_appointments_mob_validate_details_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "details";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_mob_validate_details_cb

  // ---------- Validate hist
  function do_ajax_form_appointments_mob_validate_hist()
  {
    var nomeCampo_hist = "hist";
    var var_hist = scAjaxGetFieldText(nomeCampo_hist);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_mob_validate_hist(var_hist, var_script_case_init, do_ajax_form_appointments_mob_validate_hist_cb);
  } // do_ajax_form_appointments_mob_validate_hist

  function do_ajax_form_appointments_mob_validate_hist_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "hist";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_mob_validate_hist_cb

  // ---------- Event onchange additional_charges
  function do_ajax_form_appointments_mob_event_additional_charges_onchange()
  {
    var var_total_price = scAjaxGetFieldHidden("total_price");
    var var_price = scAjaxGetFieldHidden("price");
    var var_additional_charges = scAjaxGetFieldText("additional_charges");
    var var_discount = scAjaxGetFieldText("discount");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_appointments_mob_event_additional_charges_onchange(var_total_price, var_price, var_additional_charges, var_discount, var_script_case_init, do_ajax_form_appointments_mob_event_additional_charges_onchange_cb);
  } // do_ajax_form_appointments_mob_event_additional_charges_onchange

  function do_ajax_form_appointments_mob_event_additional_charges_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "additional_charges";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_appointments_mob_event_additional_charges_onchange_cb_after_alert);
  } // do_ajax_form_appointments_mob_event_additional_charges_onchange_cb
  function do_ajax_form_appointments_mob_event_additional_charges_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_appointments_mob_event_additional_charges_onchange_cb_after_alert

  // ---------- Event onchange appointment_start_date
  function do_ajax_form_appointments_mob_event_appointment_start_date_onchange()
  {
    var var_price = scAjaxGetFieldHidden("price");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_appointments_mob_event_appointment_start_date_onchange(var_price, var_appointment_end_date, var_appointment_start_date, var_appointment_start_time, var_appointment_end_time, var_script_case_init, do_ajax_form_appointments_mob_event_appointment_start_date_onchange_cb);
  } // do_ajax_form_appointments_mob_event_appointment_start_date_onchange

  function do_ajax_form_appointments_mob_event_appointment_start_date_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "appointment_start_date";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_appointments_mob_event_appointment_start_date_onchange_cb_after_alert);
  } // do_ajax_form_appointments_mob_event_appointment_start_date_onchange_cb
  function do_ajax_form_appointments_mob_event_appointment_start_date_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_appointments_mob_event_appointment_start_date_onchange_cb_after_alert

  // ---------- Event onchange appointment_start_time
  function do_ajax_form_appointments_mob_event_appointment_start_time_onchange()
  {
    var var_price = scAjaxGetFieldHidden("price");
    var var_appointment_end_date = scAjaxGetFieldText("appointment_end_date");
    var var_appointment_start_date = scAjaxGetFieldText("appointment_start_date");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_appointments_mob_event_appointment_start_time_onchange(var_price, var_appointment_end_date, var_appointment_start_date, var_appointment_start_time, var_appointment_end_time, var_script_case_init, do_ajax_form_appointments_mob_event_appointment_start_time_onchange_cb);
  } // do_ajax_form_appointments_mob_event_appointment_start_time_onchange

  function do_ajax_form_appointments_mob_event_appointment_start_time_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "appointment_start_time";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_appointments_mob_event_appointment_start_time_onchange_cb_after_alert);
  } // do_ajax_form_appointments_mob_event_appointment_start_time_onchange_cb
  function do_ajax_form_appointments_mob_event_appointment_start_time_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_appointments_mob_event_appointment_start_time_onchange_cb_after_alert

  // ---------- Event onchange discount
  function do_ajax_form_appointments_mob_event_discount_onchange()
  {
    var var_total_price = scAjaxGetFieldHidden("total_price");
    var var_price = scAjaxGetFieldHidden("price");
    var var_additional_charges = scAjaxGetFieldText("additional_charges");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_appointments_mob_event_discount_onchange(var_total_price, var_price, var_additional_charges, var_discount, var_script_case_init, do_ajax_form_appointments_mob_event_discount_onchange_cb);
  } // do_ajax_form_appointments_mob_event_discount_onchange

  function do_ajax_form_appointments_mob_event_discount_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "discount";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_appointments_mob_event_discount_onchange_cb_after_alert);
  } // do_ajax_form_appointments_mob_event_discount_onchange_cb
  function do_ajax_form_appointments_mob_event_discount_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_appointments_mob_event_discount_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_appointments_mob_submit_form()
  {
    ...
    scAjaxHideMessage();
    var var_staff_id = scAjaxGetFieldSelect("staff_id");
    var var_customers_id = scAjaxGetFieldSelect("customers_id");
    ...
    scAjaxProcOn();
    x_ajax_form_appointments_mob_submit_form(var_staff_id, var_customers_id, var_current_status_id, var_appointment_start_date, var_appointment_start_time, var_appointment_end_date, var_appointment_end_time, var_price, var_additional_charges, var_discount, var_total_price, var_appointments_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_appointments_mob_submit_form_cb);
  ...
  function do_ajax_form_appointments_mob_submit_form_cb(sResp)
  {
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("staff_id");
      ...
      scAjaxHideErrorDisplay("appointment_end_date");
      scAjaxHideErrorDisplay("appointment_end_time");
      scAjaxHideErrorDisplay("price");
      scAjaxHideErrorDisplay("additional_charges");
      scAjaxHideErrorDisplay("discount");
      scAjaxHideErrorDisplay("total_price");
      scAjaxHideErrorDisplay("details");
      scAjaxHideErrorDisplay("hist");
      scLigEditLookupCall();
<?php
...
?>
  ...
  var scStatusDetail = {};
  scStatusDetail["form_appointment_details_mob"] = "off";
  scStatusDetail["grid_appointments_history"] = "off";
  ...
  function perform_ajax_form_appointments_mob_navigate_form()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_appointment_details_mob"] = "on";
    scStatusDetail["grid_appointments_history"] = "on";
...
?>
  function do_ajax_form_appointments_mob_navigate_form_cb(sResp)
  {
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_appointment_details_mob"] && "nmsc_iframe_liga_form_appointment_details_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_appointment_details_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_appointment_details_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_appointment_details_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_appointment_details_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_appointment_details_mob').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_grid_appointments_history"] && "nmsc_iframe_liga_grid_appointments_history" != scMasterDetailIframe["nmsc_iframe_liga_grid_appointments_history"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_grid_appointments_history"]);
    }
    else {
        if (oResp["navSummary"].reg_tot != 0) {
            document.getElementById('nmsc_iframe_liga_grid_appointments_history').contentWindow.nm_move('apl_detalhe', true);
        }
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
...
?>
  ...
  {
    if ("off" == scStatusDetail["form_appointment_details_mob"] && "off" == scStatusDetail["grid_appointments_history"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "staff_id";
  ajax_field_list[1] = "customers_id";
  ajax_field_list[2] = "current_status_id";
  ajax_field_list[3] = "appointment_start_date";
  ajax_field_list[4] = "appointment_start_time";
  ajax_field_list[5] = "appointment_end_date";
  ajax_field_list[6] = "appointment_end_time";
  ajax_field_list[7] = "price";
  ajax_field_list[8] = "additional_charges";
  ajax_field_list[9] = "discount";
  ajax_field_list[10] = "total_price";
  ajax_field_list[11] = "details";
  ajax_field_list[12] = "hist";
  ...
  var ajax_error_list = {
    "staff_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_appointments_fld_staff_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "customers_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_appointments_fld_customers_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "appointment_start_date": {"label": "<?php echo $this->Ini->Nm_lang['lang_appointments_fld_appointment_start_date'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "appointment_start_time": {"label": "<?php echo $this->Ini->Nm_lang['lang_appointments_fld_appointment_start_time'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "appointment_end_date": {"label": "<?php echo $this->Ini->Nm_lang['lang_appointments_fld_appointment_end_date'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "appointment_end_time": {"label": "<?php echo $this->Ini->Nm_lang['lang_appointments_fld_appointment_end_time'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "price": {"label": "<?php echo $this->Ini->Nm_lang['lang_appointments_fld_price'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "additional_charges": {"label": "<?php echo $this->Ini->Nm_lang['lang_appointments_fld_additional_charges'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "discount": {"label": "<?php echo $this->Ini->Nm_lang['lang_appointments_fld_discount'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "total_price": {"label": "<?php echo $this->Ini->Nm_lang['lang_appointments_fld_total_price'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "details": {"label": "details", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "hist": {"label": "hist", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "price": new Array(),
    "additional_charges": new Array(),
    "discount": new Array(),
    "total_price": new Array(),
    "details": new Array(),
    "hist": new Array()
  };
  ajax_field_mult["staff_id"][1] = "staff_id";
  ...
  ajax_field_mult["additional_charges"][1] = "additional_charges";
  ajax_field_mult["discount"][1] = "discount";
  ajax_field_mult["total_price"][1] = "total_price";
  ajax_field_mult["details"][1] = "details";
  ajax_field_mult["hist"][1] = "hist";

  var ajax_field_id = {
    "staff_id": new Array("hidden_field_label_staff_id", "hidden_field_data_staff_id"),
    ...
    "additional_charges": new Array("hidden_field_label_additional_charges", "hidden_field_data_additional_charges"),
    "discount": new Array("hidden_field_label_discount", "hidden_field_data_discount"),
    "total_price": new Array("hidden_field_label_total_price", "hidden_field_data_total_price"),
    "details": new Array("hidden_field_label_details", "hidden_field_data_details"),
    "hist": new Array("hidden_field_label_hist", "hidden_field_data_hist")
  };
