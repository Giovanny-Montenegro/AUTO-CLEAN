...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_customers_mob_form();
	}
...
?>
  ...
  function do_ajax_form_customers_mob_validate_customers_id()
  {
    var nomeCampo_customers_id = "customers_id";
    var var_customers_id = scAjaxGetFieldHidden(nomeCampo_customers_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customers_mob_validate_customers_id(var_customers_id, var_script_case_init, do_ajax_form_customers_mob_validate_customers_id_cb);
  } // do_ajax_form_customers_mob_validate_customers_id

  function do_ajax_form_customers_mob_validate_customers_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "customers_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customers_mob_validate_customers_id_cb

  // ---------- Validate customers_name
  function do_ajax_form_customers_mob_validate_customers_name()
  {
    var nomeCampo_customers_name = "customers_name";
    var var_customers_name = scAjaxGetFieldText(nomeCampo_customers_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customers_mob_validate_customers_name(var_customers_name, var_script_case_init, do_ajax_form_customers_mob_validate_customers_name_cb);
  } // do_ajax_form_customers_mob_validate_customers_name

  function do_ajax_form_customers_mob_validate_customers_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "customers_name";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customers_mob_validate_customers_name_cb

  // ---------- Validate customers_email
  function do_ajax_form_customers_mob_validate_customers_email()
  {
    var nomeCampo_customers_email = "customers_email";
    var var_customers_email = scAjaxGetFieldText(nomeCampo_customers_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customers_mob_validate_customers_email(var_customers_email, var_script_case_init, do_ajax_form_customers_mob_validate_customers_email_cb);
  } // do_ajax_form_customers_mob_validate_customers_email

  function do_ajax_form_customers_mob_validate_customers_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "customers_email";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customers_mob_validate_customers_email_cb

  // ---------- Validate customers_phone
  function do_ajax_form_customers_mob_validate_customers_phone()
  {
    var nomeCampo_customers_phone = "customers_phone";
    var var_customers_phone = scAjaxGetFieldText(nomeCampo_customers_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customers_mob_validate_customers_phone(var_customers_phone, var_script_case_init, do_ajax_form_customers_mob_validate_customers_phone_cb);
  } // do_ajax_form_customers_mob_validate_customers_phone

  function do_ajax_form_customers_mob_validate_customers_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "customers_phone";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customers_mob_validate_customers_phone_cb

  // ---------- Validate customers_country
  function do_ajax_form_customers_mob_validate_customers_country()
  {
    var nomeCampo_customers_country = "customers_country";
    var var_customers_country = scAjaxGetFieldSelect(nomeCampo_customers_country);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customers_mob_validate_customers_country(var_customers_country, var_script_case_init, do_ajax_form_customers_mob_validate_customers_country_cb);
  } // do_ajax_form_customers_mob_validate_customers_country

  function do_ajax_form_customers_mob_validate_customers_country_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "customers_country";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customers_mob_validate_customers_country_cb

  // ---------- Validate customers_state
  function do_ajax_form_customers_mob_validate_customers_state()
  {
    var nomeCampo_customers_state = "customers_state";
    var var_customers_state = scAjaxGetFieldSelect(nomeCampo_customers_state);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customers_mob_validate_customers_state(var_customers_state, var_script_case_init, do_ajax_form_customers_mob_validate_customers_state_cb);
  } // do_ajax_form_customers_mob_validate_customers_state

  function do_ajax_form_customers_mob_validate_customers_state_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "customers_state";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customers_mob_validate_customers_state_cb

  // ---------- Validate customers_city
  function do_ajax_form_customers_mob_validate_customers_city()
  {
    var nomeCampo_customers_city = "customers_city";
    var var_customers_city = scAjaxGetFieldSelect(nomeCampo_customers_city);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customers_mob_validate_customers_city(var_customers_city, var_script_case_init, do_ajax_form_customers_mob_validate_customers_city_cb);
  } // do_ajax_form_customers_mob_validate_customers_city

  function do_ajax_form_customers_mob_validate_customers_city_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "customers_city";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customers_mob_validate_customers_city_cb

  // ---------- Validate customers_address
  function do_ajax_form_customers_mob_validate_customers_address()
  {
    var nomeCampo_customers_address = "customers_address";
    var var_customers_address = scAjaxGetFieldText(nomeCampo_customers_address);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customers_mob_validate_customers_address(var_customers_address, var_script_case_init, do_ajax_form_customers_mob_validate_customers_address_cb);
  } // do_ajax_form_customers_mob_validate_customers_address

  function do_ajax_form_customers_mob_validate_customers_address_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "customers_address";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customers_mob_validate_customers_address_cb

  // ---------- Validate customers_zip
  function do_ajax_form_customers_mob_validate_customers_zip()
  {
    var nomeCampo_customers_zip = "customers_zip";
    var var_customers_zip = scAjaxGetFieldText(nomeCampo_customers_zip);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customers_mob_validate_customers_zip(var_customers_zip, var_script_case_init, do_ajax_form_customers_mob_validate_customers_zip_cb);
  } // do_ajax_form_customers_mob_validate_customers_zip

  function do_ajax_form_customers_mob_validate_customers_zip_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "customers_zip";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customers_mob_validate_customers_zip_cb

  // ---------- Validate sec_users_login
  function do_ajax_form_customers_mob_validate_sec_users_login()
  {
    var nomeCampo_sec_users_login = "sec_users_login";
    var var_sec_users_login = scAjaxGetFieldText(nomeCampo_sec_users_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customers_mob_validate_sec_users_login(var_sec_users_login, var_script_case_init, do_ajax_form_customers_mob_validate_sec_users_login_cb);
  } // do_ajax_form_customers_mob_validate_sec_users_login

  function do_ajax_form_customers_mob_validate_sec_users_login_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customers_mob_validate_sec_users_login_cb

  // ---------- Validate pswd
  function do_ajax_form_customers_mob_validate_pswd()
  {
    var nomeCampo_pswd = "pswd";
    var var_pswd = scAjaxGetFieldText(nomeCampo_pswd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customers_mob_validate_pswd(var_pswd, var_script_case_init, do_ajax_form_customers_mob_validate_pswd_cb);
  } // do_ajax_form_customers_mob_validate_pswd

  function do_ajax_form_customers_mob_validate_pswd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pswd";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customers_mob_validate_pswd_cb

  // ---------- Validate confirm_pswd
  function do_ajax_form_customers_mob_validate_confirm_pswd()
  {
    var nomeCampo_confirm_pswd = "confirm_pswd";
    var var_confirm_pswd = scAjaxGetFieldText(nomeCampo_confirm_pswd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customers_mob_validate_confirm_pswd(var_confirm_pswd, var_script_case_init, do_ajax_form_customers_mob_validate_confirm_pswd_cb);
  } // do_ajax_form_customers_mob_validate_confirm_pswd

  function do_ajax_form_customers_mob_validate_confirm_pswd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customers_mob_validate_confirm_pswd_cb

  // ---------- Refresh customers_country
  function do_ajax_form_customers_mob_refresh_customers_country()
  {
    var var_customers_country = scAjaxGetFieldSelect("customers_country");
    var var_nmgp_refresh_fields = "customers_state";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_customers_mob_refresh_customers_country(var_customers_country, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_customers_mob_refresh_customers_country_cb);
  } // do_ajax_form_customers_mob_refresh_customers_country

  function do_ajax_form_customers_mob_refresh_customers_country_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    do_ajax_form_customers_mob_refresh_customers_state();
    scAjaxShowDebug();
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customers_mob_refresh_customers_country_cb

  // ---------- Refresh customers_state
  function do_ajax_form_customers_mob_refresh_customers_state()
  {
    var var_customers_state = scAjaxGetFieldSelect("customers_state");
    var var_nmgp_refresh_fields = "customers_city";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_customers_mob_refresh_customers_state(var_customers_state, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_customers_mob_refresh_customers_state_cb);
  } // do_ajax_form_customers_mob_refresh_customers_state

  function do_ajax_form_customers_mob_refresh_customers_state_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customers_mob_refresh_customers_state_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_customers_mob_submit_form()
  {
    ...
    scAjaxHideMessage();
    var var_customers_id = scAjaxGetFieldHidden("customers_id");
    var var_customers_name = scAjaxGetFieldText("customers_name");
    var var_customers_email = scAjaxGetFieldText("customers_email");
    var var_customers_phone = scAjaxGetFieldText("customers_phone");
    var var_customers_country = scAjaxGetFieldSelect("customers_country");
    var var_customers_state = scAjaxGetFieldSelect("customers_state");
    var var_customers_city = scAjaxGetFieldSelect("customers_city");
    var var_customers_address = scAjaxGetFieldText("customers_address");
    var var_customers_zip = scAjaxGetFieldText("customers_zip");
    ...
    scAjaxProcOn();
    x_ajax_form_customers_mob_submit_form(var_customers_id, var_customers_name, var_customers_email, var_customers_phone, var_customers_country, var_customers_state, var_customers_city, var_customers_address, var_customers_zip, var_sec_users_login, var_pswd, var_confirm_pswd, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_customers_mob_submit_form_cb);
  ...
  function do_ajax_form_customers_mob_submit_form_cb(sResp)
  {
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("customers_id");
      scAjaxHideErrorDisplay("customers_name");
      scAjaxHideErrorDisplay("customers_email");
      scAjaxHideErrorDisplay("customers_phone");
      scAjaxHideErrorDisplay("customers_country");
      scAjaxHideErrorDisplay("customers_state");
      scAjaxHideErrorDisplay("customers_city");
      scAjaxHideErrorDisplay("customers_address");
      scAjaxHideErrorDisplay("customers_zip");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_customers_mob_submit_form_cb_after_alert);
  } // do_ajax_form_customers_mob_submit_form_cb
  function do_ajax_form_customers_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_customers_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_customers_mob_navigate_form()
  {
    perform_ajax_form_customers_mob_navigate_form();
  }

  function perform_ajax_form_customers_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("pswd");
    scAjaxHideErrorDisplay("confirm_pswd");
    var var_customers_id = document.F2.customers_id.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_customers_mob_navigate_form(var_customers_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_customers_mob_navigate_form_cb);
  } // do_ajax_form_customers_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_customers_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_customers_mob_navigate_form_cb(sResp)
  {
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.customers_id.value = scAjaxGetKeyValue("customers_id");
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_customers_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_customers_mob_navigate_form_cb
  function do_ajax_form_customers_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
?>
  ...
  } // do_ajax_form_customers_mob_navigate_form_cb_after_alert

  function sc_hide_form_customers_mob_form()
  {
  ...
  ajax_field_list[0] = "customers_id";
  ajax_field_list[1] = "customers_name";
  ajax_field_list[2] = "customers_email";
  ajax_field_list[3] = "customers_phone";
  ajax_field_list[4] = "customers_country";
  ajax_field_list[5] = "customers_state";
  ajax_field_list[6] = "customers_city";
  ajax_field_list[7] = "customers_address";
  ajax_field_list[8] = "customers_zip";
  ajax_field_list[9] = "sec_users_login";
  ajax_field_list[10] = "pswd";
  ajax_field_list[11] = "confirm_pswd";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "customers_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_customers_fld_customers_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "customers_name": {"label": "<?php echo $this->Ini->Nm_lang['lang_customers_fld_customers_name'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "customers_email": {"label": "<?php echo $this->Ini->Nm_lang['lang_customers_fld_customers_email'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "customers_phone": {"label": "<?php echo $this->Ini->Nm_lang['lang_customers_fld_customers_phone'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "customers_country": {"label": "<?php echo $this->Ini->Nm_lang['lang_customers_fld_customers_country'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "customers_state": {"label": "<?php echo $this->Ini->Nm_lang['lang_customers_fld_customers_state'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "customers_city": {"label": "<?php echo $this->Ini->Nm_lang['lang_customers_fld_customers_city'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "customers_address": {"label": "<?php echo $this->Ini->Nm_lang['lang_customers_fld_customers_address'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "customers_zip": {"label": "<?php echo $this->Ini->Nm_lang['lang_customers_fld_customers_zip'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sec_users_login": {"label": "<?php echo $this->Ini->Nm_lang['lang_customers_fld_sec_users_login'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "customers_id": new Array(),
    "customers_name": new Array(),
    "customers_email": new Array(),
    "customers_phone": new Array(),
    "customers_country": new Array(),
    "customers_state": new Array(),
    "customers_city": new Array(),
    "customers_address": new Array(),
    "customers_zip": new Array(),
    "sec_users_login": new Array(),
    "pswd": new Array(),
    "confirm_pswd": new Array()
  };
  ajax_field_mult["customers_id"][1] = "customers_id";
  ajax_field_mult["customers_name"][1] = "customers_name";
  ajax_field_mult["customers_email"][1] = "customers_email";
  ajax_field_mult["customers_phone"][1] = "customers_phone";
  ajax_field_mult["customers_country"][1] = "customers_country";
  ajax_field_mult["customers_state"][1] = "customers_state";
  ajax_field_mult["customers_city"][1] = "customers_city";
  ajax_field_mult["customers_address"][1] = "customers_address";
  ajax_field_mult["customers_zip"][1] = "customers_zip";
  ajax_field_mult["sec_users_login"][1] = "sec_users_login";
  ajax_field_mult["pswd"][1] = "pswd";
  ajax_field_mult["confirm_pswd"][1] = "confirm_pswd";

  var ajax_field_id = {
    "customers_id": new Array("hidden_field_label_customers_id", "hidden_field_data_customers_id"),
    "customers_name": new Array("hidden_field_label_customers_name", "hidden_field_data_customers_name"),
    "customers_email": new Array("hidden_field_label_customers_email", "hidden_field_data_customers_email"),
    "customers_phone": new Array("hidden_field_label_customers_phone", "hidden_field_data_customers_phone"),
    "customers_country": new Array("hidden_field_label_customers_country", "hidden_field_data_customers_country"),
    "customers_state": new Array("hidden_field_label_customers_state", "hidden_field_data_customers_state"),
    "customers_city": new Array("hidden_field_label_customers_city", "hidden_field_data_customers_city"),
    "customers_address": new Array("hidden_field_label_customers_address", "hidden_field_data_customers_address"),
    "customers_zip": new Array("hidden_field_label_customers_zip", "hidden_field_data_customers_zip"),
  ...
  var ajax_read_only = {
    ...
    "customers_email": "off",
    "customers_phone": "off",
    "customers_country": "off",
    "customers_state": "off",
    "customers_city": "off",
    "customers_address": "off",
    "customers_zip": "off",
    "sec_users_login": "off",
    "pswd": "off",
    "confirm_pswd": "off"
