...
?>
  ...
  function do_ajax_form_customers_validate_customers_id()
  {
    var nomeCampo_customers_id = "customers_id";
    var var_customers_id = scAjaxGetFieldHidden(nomeCampo_customers_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customers_validate_customers_id(var_customers_id, var_script_case_init, do_ajax_form_customers_validate_customers_id_cb);
  } // do_ajax_form_customers_validate_customers_id

  function do_ajax_form_customers_validate_customers_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customers_validate_customers_id_cb

  // ---------- Validate customers_name
  function do_ajax_form_customers_validate_customers_name()
  {
    var nomeCampo_customers_name = "customers_name";
    var var_customers_name = scAjaxGetFieldText(nomeCampo_customers_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customers_validate_customers_name(var_customers_name, var_script_case_init, do_ajax_form_customers_validate_customers_name_cb);
  } // do_ajax_form_customers_validate_customers_name

  function do_ajax_form_customers_validate_customers_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customers_validate_customers_name_cb

  // ---------- Validate customers_email
  function do_ajax_form_customers_validate_customers_email()
  {
    var nomeCampo_customers_email = "customers_email";
    var var_customers_email = scAjaxGetFieldText(nomeCampo_customers_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customers_validate_customers_email(var_customers_email, var_script_case_init, do_ajax_form_customers_validate_customers_email_cb);
  } // do_ajax_form_customers_validate_customers_email

  function do_ajax_form_customers_validate_customers_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customers_validate_customers_email_cb

  // ---------- Validate customers_phone
  function do_ajax_form_customers_validate_customers_phone()
  {
    var nomeCampo_customers_phone = "customers_phone";
    var var_customers_phone = scAjaxGetFieldText(nomeCampo_customers_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customers_validate_customers_phone(var_customers_phone, var_script_case_init, do_ajax_form_customers_validate_customers_phone_cb);
  } // do_ajax_form_customers_validate_customers_phone

  function do_ajax_form_customers_validate_customers_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customers_validate_customers_phone_cb

  // ---------- Validate customers_country
  function do_ajax_form_customers_validate_customers_country()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customers_validate_customers_country(var_customers_country, var_script_case_init, do_ajax_form_customers_validate_customers_country_cb);
  } // do_ajax_form_customers_validate_customers_country

  function do_ajax_form_customers_validate_customers_country_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customers_validate_customers_country_cb

  // ---------- Validate customers_state
  function do_ajax_form_customers_validate_customers_state()
  {
    var nomeCampo_customers_state = "customers_state";
    var var_customers_state = scAjaxGetFieldSelect(nomeCampo_customers_state);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customers_validate_customers_state(var_customers_state, var_script_case_init, do_ajax_form_customers_validate_customers_state_cb);
  } // do_ajax_form_customers_validate_customers_state

  function do_ajax_form_customers_validate_customers_state_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customers_validate_customers_state_cb

  // ---------- Validate customers_city
  function do_ajax_form_customers_validate_customers_city()
  {
    var nomeCampo_customers_city = "customers_city";
    var var_customers_city = scAjaxGetFieldSelect(nomeCampo_customers_city);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customers_validate_customers_city(var_customers_city, var_script_case_init, do_ajax_form_customers_validate_customers_city_cb);
  } // do_ajax_form_customers_validate_customers_city

  function do_ajax_form_customers_validate_customers_city_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customers_validate_customers_city_cb

  // ---------- Validate customers_address
  function do_ajax_form_customers_validate_customers_address()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customers_validate_customers_address(var_customers_address, var_script_case_init, do_ajax_form_customers_validate_customers_address_cb);
  } // do_ajax_form_customers_validate_customers_address

  function do_ajax_form_customers_validate_customers_address_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customers_validate_customers_address_cb

  // ---------- Validate customers_zip
  function do_ajax_form_customers_validate_customers_zip()
  {
    var nomeCampo_customers_zip = "customers_zip";
    var var_customers_zip = scAjaxGetFieldText(nomeCampo_customers_zip);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customers_validate_customers_zip(var_customers_zip, var_script_case_init, do_ajax_form_customers_validate_customers_zip_cb);
  } // do_ajax_form_customers_validate_customers_zip

  function do_ajax_form_customers_validate_customers_zip_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customers_validate_customers_zip_cb

  // ---------- Validate sec_users_login
  function do_ajax_form_customers_validate_sec_users_login()
  {
    var nomeCampo_sec_users_login = "sec_users_login";
    var var_sec_users_login = scAjaxGetFieldText(nomeCampo_sec_users_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customers_validate_sec_users_login(var_sec_users_login, var_script_case_init, do_ajax_form_customers_validate_sec_users_login_cb);
  } // do_ajax_form_customers_validate_sec_users_login

  function do_ajax_form_customers_validate_sec_users_login_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customers_validate_sec_users_login_cb

  // ---------- Validate pswd
  function do_ajax_form_customers_validate_pswd()
  {
    var nomeCampo_pswd = "pswd";
    var var_pswd = scAjaxGetFieldText(nomeCampo_pswd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customers_validate_pswd(var_pswd, var_script_case_init, do_ajax_form_customers_validate_pswd_cb);
  } // do_ajax_form_customers_validate_pswd

  function do_ajax_form_customers_validate_pswd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pswd";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customers_validate_pswd_cb

  // ---------- Validate confirm_pswd
  function do_ajax_form_customers_validate_confirm_pswd()
  {
    var nomeCampo_confirm_pswd = "confirm_pswd";
    var var_confirm_pswd = scAjaxGetFieldText(nomeCampo_confirm_pswd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customers_validate_confirm_pswd(var_confirm_pswd, var_script_case_init, do_ajax_form_customers_validate_confirm_pswd_cb);
  } // do_ajax_form_customers_validate_confirm_pswd

  function do_ajax_form_customers_validate_confirm_pswd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customers_validate_confirm_pswd_cb

  // ---------- Refresh customers_country
  function do_ajax_form_customers_refresh_customers_country()
  {
    var var_customers_country = scAjaxGetFieldSelect("customers_country");
    var var_nmgp_refresh_fields = "customers_state";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_customers_refresh_customers_country(var_customers_country, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_customers_refresh_customers_country_cb);
  } // do_ajax_form_customers_refresh_customers_country

  function do_ajax_form_customers_refresh_customers_country_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    do_ajax_form_customers_refresh_customers_state();
    scAjaxShowDebug();
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customers_refresh_customers_country_cb

  // ---------- Refresh customers_state
  function do_ajax_form_customers_refresh_customers_state()
  {
    var var_customers_state = scAjaxGetFieldSelect("customers_state");
    var var_nmgp_refresh_fields = "customers_city";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_customers_refresh_customers_state(var_customers_state, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_customers_refresh_customers_state_cb);
  } // do_ajax_form_customers_refresh_customers_state

  function do_ajax_form_customers_refresh_customers_state_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customers_refresh_customers_state_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_customers_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_customers_submit_form(var_customers_id, var_customers_name, var_customers_email, var_customers_phone, var_customers_country, var_customers_state, var_customers_city, var_customers_address, var_customers_zip, var_sec_users_login, var_pswd, var_confirm_pswd, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_customers_submit_form_cb);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_customers_submit_form_cb_after_alert);
  } // do_ajax_form_customers_submit_form_cb
  function do_ajax_form_customers_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_customers_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_customers_navigate_form()
  {
    perform_ajax_form_customers_navigate_form();
  }

  function perform_ajax_form_customers_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_customers_navigate_form(var_customers_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_customers_navigate_form_cb);
  } // do_ajax_form_customers_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_customers']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_customers_navigate_form_cb(sResp)
  {
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_customers_navigate_form_cb_after_alert);
  } // do_ajax_form_customers_navigate_form_cb
  function do_ajax_form_customers_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
?>
  ...
  } // do_ajax_form_customers_navigate_form_cb_after_alert

  function sc_hide_form_customers_form()
  {
