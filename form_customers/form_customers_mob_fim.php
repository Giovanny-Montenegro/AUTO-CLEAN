...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["appointments1_____form_customers"]))
   {
      unset($_SESSION['session_sec_aplicacao']["appointments1_____form_customers"]);
   }
   ...
   if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_customers_mob']))
   {
      ...
      unset($_SESSION['sc_session'][$script_case_init]['form_customers_mob']['sc_max_reg']);
   }
   $fecha_janela = false;
   ...
   if (isset($_SESSION['sc_session'][$script_case_init]['form_customers_mob']['nm_run_menu']) && $_SESSION['sc_session'][$script_case_init]['form_customers_mob']['nm_run_menu'] == 2)
   {
       $fecha_janela   = true;
       $fecha_aba_menu = true;
   }
   if ((isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_customers_mob']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['form_customers_mob']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_customers_mob']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['form_customers_mob']['sc_modal'])
       {
           ...
           {
               if (isset($_SESSION['sc_session'][$script_case_init]['form_customers']['lig_iframe_modal']))
               {
                   $iframe_master = $_SESSION['sc_session'][$script_case_init]['form_customers']['lig_iframe_modal'];
                   ...
                   unset($_SESSION['sc_session'][$script_case_init]['form_customers']['lig_iframe_modal']);
               }
               else
               {
       ...
       if (isset($_SESSION['sc_session'][$script_case_init]['form_customers']['lig_iframe_modal']))
       {
           $Save_modal = $_SESSION['sc_session'][$script_case_init]['form_customers']['lig_iframe_modal'];
           nm_limpa_arr_session();
           $_SESSION['sc_session'][$script_case_init]['form_customers']['lig_iframe_modal'] = $Save_modal;
       }
       else
       {
           nm_limpa_arr_session();
...
?>
   ...
   { 
       parent.del_aba_td('form_customers_mob');
   } 
   else 
   { 
