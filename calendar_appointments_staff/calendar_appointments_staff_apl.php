...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff']['sc_modal']))
      {
      ...
      $_SESSION['scriptcase']['error_icon']['calendar_appointments_staff']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff']['where_orig'] = " where (staff_id = " . $_SESSION['glo_staff_id'] . ")";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff']['where_pesq'] = " where (staff_id = " . $_SESSION['glo_staff_id'] . ")";
      ...
      {
          $this->nmgp_botoes['btn_customer'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff']['botoes']['btn_customer'];
          $this->nmgp_botoes['btn_service_details'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff']['botoes']['btn_service_details'];
      }
...
//
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['calendar_appointments_staff']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['calendar_appointments_staff']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
...
//
      ...
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff']['dados_select']['customers_id']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->customers_id = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff']['dados_select']['customers_id'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff']['dados_select']['appointment_start_date']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->appointment_start_date = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff']['dados_select']['appointment_start_date'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff']['dados_select']['appointment_start_time']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->appointment_start_time = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff']['dados_select']['appointment_start_time'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff']['dados_select']['price']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->price = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff']['dados_select']['price'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff']['dados_select']['total_price']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->total_price = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff']['dados_select']['total_price'];
          } 
...
//---
    ...
    function ValidateField_customers_id(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->customers_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff']['Lookup_customers_id']) && !in_array($this->customers_id, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff']['Lookup_customers_id']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['customers_id']['valList'][$i] = calendar_appointments_staff_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
{
    tb_show('', 'calendar_appointments_staff.php?nmgp_opcao=importGoogle&nmgp_outra_jan=true&script_case_init=". $this->form_encode_input($this->Ini->sc_page) ."&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=150&width=400', '');
}
function mobileMenuExportClick()
{
    tb_show('', 'calendar_appointments_staff.php?nmgp_opcao=exportGoogle&nmgp_outra_jan=true&script_case_init=". $this->form_encode_input($this->Ini->sc_page) ."&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=280&width=450', '');
}
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff']['where_filter_form'] . " and ((staff_id = " . $_SESSION['glo_staff_id'] . ")) and (" . $comando . ")";
      }
      else
      {
...
<?php
  exit;
    ...
    function getButtonIds($buttonName) {
        switch ($buttonName) {
            case "btn_customer":
                return array("sc_btn_customer_top.");
                break;
            case "btn_service_details":
                return array("sc_btn_service_details_top.");
                break;
            case "update":
