...
?>
  ...
  function do_ajax_calendar_appointments_staff_mob_validate_customers_id()
  {
    var nomeCampo_customers_id = "customers_id";
    var var_customers_id = scAjaxGetFieldSelect(nomeCampo_customers_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_staff_mob_validate_customers_id(var_customers_id, var_script_case_init, do_ajax_calendar_appointments_staff_mob_validate_customers_id_cb);
  } // do_ajax_calendar_appointments_staff_mob_validate_customers_id

  function do_ajax_calendar_appointments_staff_mob_validate_customers_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_staff_mob_validate_customers_id_cb
  ...
  function do_ajax_calendar_appointments_staff_mob_validate_additional_charges()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_staff_mob_validate_additional_charges(var_additional_charges, var_script_case_init, do_ajax_calendar_appointments_staff_mob_validate_additional_charges_cb);
  } // do_ajax_calendar_appointments_staff_mob_validate_additional_charges

  function do_ajax_calendar_appointments_staff_mob_validate_additional_charges_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_staff_mob_validate_additional_charges_cb

  // ---------- Validate discount
  function do_ajax_calendar_appointments_staff_mob_validate_discount()
  {
    var nomeCampo_discount = "discount";
    var var_discount = scAjaxGetFieldText(nomeCampo_discount);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_staff_mob_validate_discount(var_discount, var_script_case_init, do_ajax_calendar_appointments_staff_mob_validate_discount_cb);
  } // do_ajax_calendar_appointments_staff_mob_validate_discount

  function do_ajax_calendar_appointments_staff_mob_validate_discount_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_staff_mob_validate_discount_cb

  // ---------- Validate price
  function do_ajax_calendar_appointments_staff_mob_validate_price()
  {
    var nomeCampo_price = "price";
    var var_price = scAjaxGetFieldText(nomeCampo_price);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_staff_mob_validate_price(var_price, var_script_case_init, do_ajax_calendar_appointments_staff_mob_validate_price_cb);
  } // do_ajax_calendar_appointments_staff_mob_validate_price

  function do_ajax_calendar_appointments_staff_mob_validate_price_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "price";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_staff_mob_validate_price_cb

  // ---------- Validate total_price
  function do_ajax_calendar_appointments_staff_mob_validate_total_price()
  {
    var nomeCampo_total_price = "total_price";
    var var_total_price = scAjaxGetFieldText(nomeCampo_total_price);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_appointments_staff_mob_validate_total_price(var_total_price, var_script_case_init, do_ajax_calendar_appointments_staff_mob_validate_total_price_cb);
  } // do_ajax_calendar_appointments_staff_mob_validate_total_price

  function do_ajax_calendar_appointments_staff_mob_validate_total_price_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_appointments_staff_mob_validate_total_price_cb

  // ---------- Event onchange additional_charges
  function do_ajax_calendar_appointments_staff_mob_event_additional_charges_onchange()
  {
    var var_total_price = scAjaxGetFieldText("total_price");
    ...
    scAjaxProcOn(true);
    x_ajax_calendar_appointments_staff_mob_event_additional_charges_onchange(var_total_price, var_price, var_additional_charges, var_discount, var_script_case_init, do_ajax_calendar_appointments_staff_mob_event_additional_charges_onchange_cb);
  } // do_ajax_calendar_appointments_staff_mob_event_additional_charges_onchange

  function do_ajax_calendar_appointments_staff_mob_event_additional_charges_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "additional_charges";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_calendar_appointments_staff_mob_event_additional_charges_onchange_cb_after_alert);
  } // do_ajax_calendar_appointments_staff_mob_event_additional_charges_onchange_cb
  function do_ajax_calendar_appointments_staff_mob_event_additional_charges_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_calendar_appointments_staff_mob_event_additional_charges_onchange_cb_after_alert

  // ---------- Event onchange discount
  function do_ajax_calendar_appointments_staff_mob_event_discount_onchange()
  {
    var var_total_price = scAjaxGetFieldText("total_price");
    var var_price = scAjaxGetFieldText("price");
    var var_additional_charges = scAjaxGetFieldText("additional_charges");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_calendar_appointments_staff_mob_event_discount_onchange(var_total_price, var_price, var_additional_charges, var_discount, var_script_case_init, do_ajax_calendar_appointments_staff_mob_event_discount_onchange_cb);
  } // do_ajax_calendar_appointments_staff_mob_event_discount_onchange

  function do_ajax_calendar_appointments_staff_mob_event_discount_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "discount";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_calendar_appointments_staff_mob_event_discount_onchange_cb_after_alert);
  } // do_ajax_calendar_appointments_staff_mob_event_discount_onchange_cb
  function do_ajax_calendar_appointments_staff_mob_event_discount_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_calendar_appointments_staff_mob_event_discount_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_calendar_appointments_staff_mob_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_calendar_appointments_staff_mob_submit_form(var_current_status_id, var_customers_id, var_appointment_start_date, var_appointment_start_time, var_additional_charges, var_discount, var_price, var_total_price, var_appointments_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_calendar_appointments_staff_mob_submit_form_cb);
...
?>
  ...
  ajax_field_list[2] = "appointment_start_date";
  ajax_field_list[3] = "appointment_start_time";
  ajax_field_list[4] = "additional_charges";
  ajax_field_list[5] = "discount";
  ajax_field_list[6] = "price";
  ajax_field_list[7] = "total_price";
