...
else
{
    ...
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['btn_disabled']['btn_customer']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['btn_disabled']['btn_customer']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['btn_label']['btn_customer']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['btn_label']['btn_customer']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['btn_label']['btn_customer'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['btn_disabled']['btn_service_details']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['btn_disabled']['btn_service_details']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['btn_label']['btn_service_details']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['btn_label']['btn_service_details']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['btn_label']['btn_service_details'];
        }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_customers_id_line" id="hidden_field_data_customers_id" style="<?php echo $sStyleHidden_customers_id; ?>"> <span class="scFormLabelOddFormat css_customers_id_label" style=""><span id="id_label_customers_id"><?php echo $this->nm_new_label['customers_id']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_additional_charges_line" id="hidden_field_data_additional_charges" style="<?php echo $sStyleHidden_additional_charges; ?>"> <span class="scFormLabelOddFormat css_additional_charges_label" style=""><span id="id_label_additional_charges"><?php echo $this->nm_new_label['additional_charges']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_discount_line" id="hidden_field_data_discount" style="<?php echo $sStyleHidden_discount; ?>"> <span class="scFormLabelOddFormat css_discount_label" style=""><span id="id_label_discount"><?php echo $this->nm_new_label['discount']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_total_price_line" id="hidden_field_data_total_price" style="<?php echo $sStyleHidden_total_price; ?>"> <span class="scFormLabelOddFormat css_total_price_label" style=""><span id="id_label_total_price"><?php echo $this->nm_new_label['total_price']; ?></span></span><br>
