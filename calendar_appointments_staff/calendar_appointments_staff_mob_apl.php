...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->var_old_price) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['var_old_price'] = $this->var_old_price;
      }
      ...
      if (isset($_POST["var_old_price"]) && isset($this->var_old_price)) 
      {
          $_SESSION['var_old_price'] = $this->var_old_price;
      }
      ...
      if (isset($_GET["var_old_price"]) && isset($this->var_old_price)) 
      {
          $_SESSION['var_old_price'] = $this->var_old_price;
      }
      ...
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['sc_modal']))
      {
      ...
      $_SESSION['scriptcase']['error_icon']['calendar_appointments_staff_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['where_orig'] = " where (staff_id = " . $_SESSION['glo_staff_id'] . ")";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['where_pesq'] = " where (staff_id = " . $_SESSION['glo_staff_id'] . ")";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['dados_form']))
      {
          ...
          if ($this->nmgp_opcao == "incluir" && $this->nmgp_dados_form['price'] != "null"){$this->price = $this->nmgp_dados_form['price'];} 
          if ($this->nmgp_opcao == "incluir" && $this->nmgp_dados_form['total_price'] != "null"){$this->total_price = $this->nmgp_dados_form['total_price'];} 
      ...
      {
          $this->nmgp_botoes['btn_customer'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['botoes']['btn_customer'];
          $this->nmgp_botoes['btn_service_details'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['botoes']['btn_service_details'];
      }
...
//
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['calendar_appointments_staff_mob']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['calendar_appointments_staff_mob']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
...
//
      ...
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['dados_select']['customers_id']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->customers_id = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['dados_select']['customers_id'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['dados_select']['appointment_start_date']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->appointment_start_date = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['dados_select']['appointment_start_date'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['dados_select']['appointment_start_time']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->appointment_start_time = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['dados_select']['appointment_start_time'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['dados_select']['price']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->price = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['dados_select']['price'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['dados_select']['total_price']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->total_price = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['dados_select']['total_price'];
          } 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
      ...
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "customers_id";
      ...
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "additional_charges";
      ...
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "discount";
      ...
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "price";
      ...
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "total_price";
...
//---
    ...
    function ValidateField_customers_id(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->customers_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_customers_id']) && !in_array($this->customers_id, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_customers_id']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_customers_id']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_customers_id'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_customers_id']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_customers_id'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['Lookup_customers_id'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['customers_id']['valList'][$i] = calendar_appointments_staff_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
if (!isset($this->sc_temp_var_old_price)) {$this->sc_temp_var_old_price = (isset($_SESSION['var_old_price'])) ? $_SESSION['var_old_price'] : "";}
  $this->sc_temp_var_old_price = $this->total_price ;
...
if (isset($this->sc_temp_var_old_price)) { $_SESSION['var_old_price'] = $this->sc_temp_var_old_price;}
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
...
$_SESSION['scriptcase']['calendar_appointments_staff_mob']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          { 
              ...
              $this->nmgp_refresh_fields = array_diff(array('current_status_id', 'customers_id', 'appointment_start_date', 'appointment_start_time', 'additional_charges', 'discount', 'price', 'total_price'), $aDoNotUpdate);
              $this->ajax_return_values();
...
if (!isset($this->sc_temp_var_old_price)) {$this->sc_temp_var_old_price = (isset($_SESSION['var_old_price'])) ? $_SESSION['var_old_price'] : "";}
  $sql_emails = "SELECT
   ...
   staff.staff_email
FROM
   ((appointments INNER JOIN customers ON appointments.customers_id = customers.customers_id)
...
$hist_desc =  $this->Ini->Nm_lang['lang_appointment_updated'] ." <br />";

if( $this->sc_temp_var_old_price != $this->total_price  ){
	$hist_desc .=  $this->Ini->Nm_lang['lang_price_changed'] .": ".$this->sc_temp_var_old_price ." -> ". $this->total_price .".";
	$today = date('Y-m-d');
...
//---------- 
      ...
      { 
          ...
          $aWhere = array();
          $aWhere[] = "(staff_id = " . $_SESSION['glo_staff_id'] . ")";
...
{
    tb_show('', 'calendar_appointments_staff_mob.php?nmgp_opcao=importGoogle&nmgp_outra_jan=true&script_case_init=". $this->form_encode_input($this->Ini->sc_page) ."&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=150&width=400', '');
}
function mobileMenuExportClick()
{
    tb_show('', 'calendar_appointments_staff_mob.php?nmgp_opcao=exportGoogle&nmgp_outra_jan=true&script_case_init=". $this->form_encode_input($this->Ini->sc_page) ."&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=280&width=450', '');
}
...
<?php
       ...
       while ($oRs && !$oRs->EOF)
       {
           ...
           foreach ($aSelect as $sFldName => $sFldSql)
           {
               if ('title' == $sFldName || 'description' == $sFldName)
               {
                   ...
                   $this->current_status_id = $aEvent['title'];
                   $this->ajax_return_values_current_status_id(true);
                   $aEvent['title'] = $this->_tmp_lookup_current_status_id;
               }
               else
               {
   ...
   function calendarFetchSelect($googleInfo = false)
   {
       ...
       $aSelect['title'] = "current_status_id";

       $aSelect['description'] = "customers_id";
   ...
   function calendarWhere($sId, $bRecur = false, $bPrintCalendar = false, $filter = null)
   {
       ...
       $cWhere[] = "(staff_id = " . $_SESSION['glo_staff_id'] . ")";
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_appointments_staff_mob']['where_filter_form'] . " and ((staff_id = " . $_SESSION['glo_staff_id'] . ")) and (" . $comando . ")";
      }
      else
      {
          $sc_where = " where (staff_id = " . $_SESSION['glo_staff_id'] . ") and (" . $comando . ")";
      }
...
<?php
  exit;
    ...
    function getButtonIds($buttonName) {
        switch ($buttonName) {
            case "btn_customer":
                return array("sc_btn_customer_top.", "sc_btn_customer_top.");
                break;
            case "btn_service_details":
                return array("sc_btn_service_details_top.", "sc_btn_service_details_top.");
                break;
            case "update":
                return array("sc_b_upd_b.sc-unique-btn-1", "sc_b_upd_t.sc-unique-btn-5");
                break;
            case "help":
                return array("sc_b_hlp_t");
                break;
            case "exit":
                return array("sc_b_sai_b.sc-unique-btn-2", "sc_b_sai_b.sc-unique-btn-4", "sc_b_sai_t.sc-unique-btn-6", "sc_b_sai_t.sc-unique-btn-8", "sc_b_sai_b.sc-unique-btn-3", "sc_b_sai_t.sc-unique-btn-7");
                break;
        }
