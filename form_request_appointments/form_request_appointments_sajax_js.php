  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_request_appointments" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_request_appointments_form();
	}
...
?>
  ...
  function do_ajax_form_request_appointments_validate_appointment_start_date()
  {
    ...
    setTimeout(function() {
      var var_appointment_start_date = scAjaxGetFieldText(nomeCampo_appointment_start_date);
      x_ajax_form_request_appointments_validate_appointment_start_date(var_appointment_start_date, var_script_case_init, do_ajax_form_request_appointments_validate_appointment_start_date_cb);
    }, 200);
  } // do_ajax_form_request_appointments_validate_appointment_start_date

  function do_ajax_form_request_appointments_validate_appointment_start_date_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_request_appointments_validate_appointment_start_date_cb

  // ---------- Validate appointment_start_time
  function do_ajax_form_request_appointments_validate_appointment_start_time()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_request_appointments_validate_appointment_start_time(var_appointment_start_time, var_script_case_init, do_ajax_form_request_appointments_validate_appointment_start_time_cb);
  } // do_ajax_form_request_appointments_validate_appointment_start_time

  function do_ajax_form_request_appointments_validate_appointment_start_time_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_request_appointments_validate_appointment_start_time_cb

  // ---------- Validate appointment_end_date
  function do_ajax_form_request_appointments_validate_appointment_end_date()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_request_appointments_validate_appointment_end_date(var_appointment_end_date, var_script_case_init, do_ajax_form_request_appointments_validate_appointment_end_date_cb);
  } // do_ajax_form_request_appointments_validate_appointment_end_date

  function do_ajax_form_request_appointments_validate_appointment_end_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_request_appointments_validate_appointment_end_date_cb

  // ---------- Validate appointment_end_time
  function do_ajax_form_request_appointments_validate_appointment_end_time()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_request_appointments_validate_appointment_end_time(var_appointment_end_time, var_script_case_init, do_ajax_form_request_appointments_validate_appointment_end_time_cb);
  } // do_ajax_form_request_appointments_validate_appointment_end_time

  function do_ajax_form_request_appointments_validate_appointment_end_time_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_request_appointments_validate_appointment_end_time_cb

  // ---------- Validate total_price
  function do_ajax_form_request_appointments_validate_total_price()
  {
    var nomeCampo_total_price = "total_price";
    var var_total_price = scAjaxGetFieldHidden(nomeCampo_total_price);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_request_appointments_validate_total_price(var_total_price, var_script_case_init, do_ajax_form_request_appointments_validate_total_price_cb);
  } // do_ajax_form_request_appointments_validate_total_price

  function do_ajax_form_request_appointments_validate_total_price_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_request_appointments_validate_total_price_cb

  // ---------- Validate services
  function do_ajax_form_request_appointments_validate_services()
  {
    var nomeCampo_services = "services";
    var var_services = scAjaxGetFieldText(nomeCampo_services);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_request_appointments_validate_services(var_services, var_script_case_init, do_ajax_form_request_appointments_validate_services_cb);
  } // do_ajax_form_request_appointments_validate_services

  function do_ajax_form_request_appointments_validate_services_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_request_appointments_validate_services_cb

  // ---------- Validate dayofweek
  function do_ajax_form_request_appointments_validate_dayofweek()
  {
    var nomeCampo_dayofweek = "dayofweek";
    var var_dayofweek = scAjaxGetFieldText(nomeCampo_dayofweek);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_request_appointments_validate_dayofweek(var_dayofweek, var_script_case_init, do_ajax_form_request_appointments_validate_dayofweek_cb);
  } // do_ajax_form_request_appointments_validate_dayofweek

  function do_ajax_form_request_appointments_validate_dayofweek_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_request_appointments_validate_dayofweek_cb

  // ---------- Event onchange appointment_start_time
  function do_ajax_form_request_appointments_event_appointment_start_time_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_request_appointments_event_appointment_start_time_onchange(var_appointment_end_date, var_appointment_start_date, var_appointment_start_time, var_appointment_end_time, var_script_case_init, do_ajax_form_request_appointments_event_appointment_start_time_onchange_cb);
  } // do_ajax_form_request_appointments_event_appointment_start_time_onchange

  function do_ajax_form_request_appointments_event_appointment_start_time_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "appointment_start_time";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_request_appointments_event_appointment_start_time_onchange_cb_after_alert);
  } // do_ajax_form_request_appointments_event_appointment_start_time_onchange_cb
  function do_ajax_form_request_appointments_event_appointment_start_time_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_request_appointments_event_appointment_start_time_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_request_appointments_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_request_appointments_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_appointment_start_date = scAjaxGetFieldText("appointment_start_date");
    ...
    scAjaxProcOn();
    x_ajax_form_request_appointments_submit_form(var_appointment_start_date, var_appointment_start_time, var_appointment_end_date, var_appointment_end_time, var_total_price, var_dayofweek, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_request_appointments_submit_form_cb);
  } // do_ajax_form_request_appointments_submit_form

  function do_ajax_form_request_appointments_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_request_appointments_submit_form_cb_after_alert);
  } // do_ajax_form_request_appointments_submit_form_cb
  function do_ajax_form_request_appointments_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_request_appointments_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_appointment_details"] = "off";

  function do_ajax_form_request_appointments_navigate_form()
  {
    perform_ajax_form_request_appointments_navigate_form();
  }

  function perform_ajax_form_request_appointments_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_form_request_appointments_navigate_form(var_appointments_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_request_appointments_navigate_form_cb);
  } // do_ajax_form_request_appointments_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_request_appointments_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_request_appointments_navigate_form_cb_after_alert);
  } // do_ajax_form_request_appointments_navigate_form_cb
  function do_ajax_form_request_appointments_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_request_appointments_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_request_appointments_navigate_form_cb_after_alert

  function sc_hide_form_request_appointments_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_appointment_details"])
    {
      return true;
    }
    return false;
