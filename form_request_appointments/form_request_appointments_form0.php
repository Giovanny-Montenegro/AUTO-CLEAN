...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2-4.0.6/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_request_appointments/form_request_appointments_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_request_appointments_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_request_appointments_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['link_info']['remove_border']) {
...
<?php
 include_once("form_request_appointments_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_request_appointments'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_request_appointments'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['btn_label']['update'];
        }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_appointment_start_date_label" id="hidden_field_label_appointment_start_date" style="<?php echo $sStyleHidden_appointment_start_date; ?>"><span id="id_label_appointment_start_date"><?php echo $this->nm_new_label['appointment_start_date']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['php_cmp_required']['appointment_start_date']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['php_cmp_required']['appointment_start_date'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_appointment_start_date_line" id="hidden_field_data_appointment_start_date" style="<?php echo $sStyleHidden_appointment_start_date; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_appointment_start_date_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_appointment_start_time_label" id="hidden_field_label_appointment_start_time" style="<?php echo $sStyleHidden_appointment_start_time; ?>"><span id="id_label_appointment_start_time"><?php echo $this->nm_new_label['appointment_start_time']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['php_cmp_required']['appointment_start_time']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['php_cmp_required']['appointment_start_time'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_appointment_end_date_line" id="hidden_field_data_appointment_end_date" style="<?php echo $sStyleHidden_appointment_end_date; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_appointment_end_date_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_total_price_line" id="hidden_field_data_total_price" style="<?php echo $sStyleHidden_total_price; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_total_price_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="total_price" value="<?php echo $this->form_encode_input($total_price); ?>"><span id="id_ajax_label_total_price"><?php echo nl2br($total_price); ?></span>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_services'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_services'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['form_appointment_details_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_services'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['form_appointment_details_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['form_appointment_details_script_case_init'] ]['form_appointment_details']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['form_appointment_details_script_case_init'] ]['form_appointment_details']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['form_appointment_details_script_case_init'] ]['form_appointment_details']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['form_appointment_details_script_case_init'] ]['form_appointment_details']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['form_appointment_details_script_case_init'] ]['form_appointment_details']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['form_appointment_details_script_case_init'] ]['form_appointment_details']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['form_appointment_details_script_case_init'] ]['form_appointment_details']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['form_appointment_details_script_case_init'] ]['form_appointment_details']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['form_appointment_details_script_case_init'] ]['form_appointment_details']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['form_appointment_details_script_case_init'] ]['form_appointment_details']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['form_appointment_details_script_case_init'] ]['form_appointment_details']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['form_appointment_details_script_case_init'] ]['form_appointment_details']['embutida_liga_tp_pag'] = 'parcial';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['form_appointment_details_script_case_init'] ]['form_appointment_details']['embutida_parms'] = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['form_appointment_details_script_case_init'] ]['form_request_appointments']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_request_appointments_empty.htm' : $this->Ini->link_form_appointment_details_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y';
if (isset($this->Ini->sc_lig_target['C_@scinf_services']) && 'nmsc_iframe_liga_form_appointment_details' != $this->Ini->sc_lig_target['C_@scinf_services'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_services'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['form_appointment_details_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_appointment_details"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="450px" name="nmsc_iframe_liga_form_appointment_details"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['btn_label']['exit'];
        }
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_request_appointments");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_request_appointments");
 parent.scAjaxDetailHeight("form_request_appointments", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_request_appointments']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
