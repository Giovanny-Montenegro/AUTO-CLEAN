...
//-- ajax metodos ---
      ...
      if ($this->NM_ajax_opcao == 'autocomp_customers_phone')
      {
          $customers_phone = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_customers_phone($customers_phone);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_customers_id')
      {
          $customers_id = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_customers_id($customers_id);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_customers_name')
      {
          $customers_name = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_customers_name($customers_name);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_customers_email')
      {
          $customers_email = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_customers_email($customers_email);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_customers_phone($customers_phone)
   {
      $customers_phone = substr($this->Db->qstr($customers_phone), 1, -1);
            $customers_phone_look = (is_string($customers_phone) ? substr($this->Db->qstr($customers_phone), 1, -1) : $customers_phone); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct customers_phone from " . $this->Ini->nm_tabela . " where  customers_phone like '%" . $customers_phone . "%' order by customers_phone"; 
      unset($cmp1,$cmp2);
   ...
   {
      $customers_id = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $customers_id);
      ...
      {
          $nm_comando = "select distinct customers_id from " . $this->Ini->nm_tabela . " where   CAST (customers_id AS TEXT)  like '%" . $customers_id . "%' order by customers_id"; 
      }
      elseif (isset($this->Ini->nm_bases_sybase) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct customers_id from " . $this->Ini->nm_tabela . " where   CAST (customers_id AS VARCHAR)  like '%" . $customers_id . "%' order by customers_id"; 
      }
      else
      {
          $nm_comando = "select distinct customers_id from " . $this->Ini->nm_tabela . " where  customers_id like '%" . $customers_id . "%' order by customers_id"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function lookup_ajax_customers_name($customers_name)
   {
      $customers_name = substr($this->Db->qstr($customers_name), 1, -1);
            $customers_name_look = (is_string($customers_name) ? substr($this->Db->qstr($customers_name), 1, -1) : $customers_name); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct customers_name from " . $this->Ini->nm_tabela . " where  customers_name like '%" . $customers_name . "%' order by customers_name"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_customers_email($customers_email)
   {
      $customers_email = substr($this->Db->qstr($customers_email), 1, -1);
            $customers_email_look = (is_string($customers_email) ? substr($this->Db->qstr($customers_email), 1, -1) : $customers_email); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct customers_email from " . $this->Ini->nm_tabela . " where  customers_email like '%" . $customers_email . "%' order by customers_email"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_customers_report'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_customers/grid_customers_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<script type="text/javascript" src="grid_customers_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_customers']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_customers']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_customers_phone_cond#NMF#' + search_get_sel_txt('SC_customers_phone_cond') + '@NMF@';
  str_out += 'SC_customers_phone#NMF#' + search_get_text('SC_customers_phone') + '@NMF@';
  str_out += 'id_ac_customers_phone#NMF#' + search_get_title('select2-id_ac_customers_phone-container') + '@NMF@';
  str_out += 'SC_customers_id_cond#NMF#' + search_get_sel_txt('SC_customers_id_cond') + '@NMF@';
  str_out += 'SC_customers_id#NMF#' + search_get_text('SC_customers_id') + '@NMF@';
  str_out += 'id_ac_customers_id#NMF#' + search_get_title('select2-id_ac_customers_id-container') + '@NMF@';
  str_out += 'SC_customers_id_input_2#NMF#' + search_get_text('SC_customers_id_input_2') + '@NMF@';
  str_out += 'SC_customers_name_cond#NMF#' + search_get_sel_txt('SC_customers_name_cond') + '@NMF@';
  str_out += 'SC_customers_name#NMF#' + search_get_text('SC_customers_name') + '@NMF@';
  str_out += 'id_ac_customers_name#NMF#' + search_get_title('select2-id_ac_customers_name-container') + '@NMF@';
  str_out += 'SC_customers_email_cond#NMF#' + search_get_sel_txt('SC_customers_email_cond') + '@NMF@';
  str_out += 'SC_customers_email#NMF#' + search_get_text('SC_customers_email') + '@NMF@';
  str_out += 'id_ac_customers_email#NMF#' + search_get_title('select2-id_ac_customers_email-container') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-customers_id").on("focus", function() {
  }).on("blur", function() {
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      ...
      nmgp_parms: "NM_ajax_opcao?#?autocomp_customers_id",
      max_itens: "10",
   ...
   $("#SC_customers_id").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-customers_name").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_customers_name",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_customers_name").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-customers_email").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_customers_email",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_customers_email").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-customers_phone").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_customers_phone",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_customers_phone").val(e.params.data.id);
  });
 });
</script>
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $customers_phone_cond, $customers_phone, $customers_phone_autocomp,
             $customers_id_cond, $customers_id, $customers_id_input_2, $customers_id_autocomp,
             $customers_name_cond, $customers_name, $customers_name_autocomp,
             $customers_email_cond, $customers_email, $customers_email_autocomp,
      ...
      { 
          ...
          $customers_phone = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers']['campos_busca']['customers_phone']; 
          $customers_phone_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers']['campos_busca']['customers_phone_cond']; 
          $customers_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers']['campos_busca']['customers_id']; 
          $customers_id_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers']['campos_busca']['customers_id_input_2']; 
          $customers_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers']['campos_busca']['customers_id_cond']; 
          $customers_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers']['campos_busca']['customers_name']; 
          $customers_name_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers']['campos_busca']['customers_name_cond']; 
          $customers_email = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers']['campos_busca']['customers_email']; 
          $customers_email_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers']['campos_busca']['customers_email_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers']['campos_busca']['NM_operador']; 
      } 
      if (!isset($customers_phone_cond) || empty($customers_phone_cond))
      {
         $customers_phone_cond = "qp";
      }
      if (!isset($customers_id_cond) || empty($customers_id_cond))
      {
         $customers_id_cond = "gt";
      }
      if (!isset($customers_name_cond) || empty($customers_name_cond))
      {
         $customers_name_cond = "qp";
      }
      if (!isset($customers_email_cond) || empty($customers_email_cond))
      {
         $customers_email_cond = "qp";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_customers_phone = (in_array($customers_phone_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_customers_id = (in_array($customers_id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_customers_name = (in_array($customers_name_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_customers_email = (in_array($customers_email_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_customers_phone = ('bw' == $customers_phone_cond) ? $display_aberto : $display_fechado;
      $str_display_customers_id = ('bw' == $customers_id_cond) ? $display_aberto : $display_fechado;
      $str_display_customers_name = ('bw' == $customers_name_cond) ? $display_aberto : $display_fechado;
      $str_display_customers_email = ('bw' == $customers_email_cond) ? $display_aberto : $display_fechado;

      if (!isset($customers_phone) || $customers_phone == "")
      {
          $customers_phone = "";
      }
      if (isset($customers_phone) && !empty($customers_phone))
      {
         $tmp_pos = (is_string($customers_phone)) ? strpos($customers_phone, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $customers_phone = substr($customers_phone, 0, $tmp_pos);
         }
      }
      ...
      if (!isset($customers_name) || $customers_name == "")
      {
          $customers_name = "";
      }
      if (isset($customers_name) && !empty($customers_name))
      {
         $tmp_pos = (is_string($customers_name)) ? strpos($customers_name, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $customers_name = substr($customers_name, 0, $tmp_pos);
         }
      }
      if (!isset($customers_email) || $customers_email == "")
      {
          $customers_email = "";
      }
      if (isset($customers_email) && !empty($customers_email))
      {
         $tmp_pos = (is_string($customers_email)) ? strpos($customers_email, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $customers_email = substr($customers_email, 0, $tmp_pos);
         }
      }
?>
 <?php
...
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_customers_phone_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['customers_phone'])) ? $this->New_label['customers_phone'] : "" . $this->Ini->Nm_lang['lang_customers_fld_customers_phone'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_customers_phone_cond" name="customers_phone_cond" onChange="nm_campos_between(document.getElementById('id_vis_customers_phone'), this, 'customers_phone')">
       <OPTION value="qp" <?php if ("qp" == $customers_phone_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $customers_phone_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $customers_phone_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $customers_phone_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_customers_phone" <?php echo $str_hide_customers_phone?> valign="top">
 ...
 $nmgp_tab_label .= "customers_phone?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<?php
      ...
      $customers_phone_look = (is_string($customers_phone) ? substr($this->Db->qstr($customers_phone), 1, -1) : $customers_phone); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct customers_phone from " . $this->Ini->nm_tabela . " where customers_phone = '$customers_phone_look' order by customers_phone"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$customers_phone]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$customers_phone];
      }
      else
      {
          $sAutocompValue = $customers_phone;
      }
?>
<INPUT  type="text" id="SC_customers_phone" name="customers_phone" value="<?php echo NM_encode_input($customers_phone) ?>"  size=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-customers_phone" id="id_ac_customers_phone" name="customers_phone_autocomp"><?php if ('' !=  $customers_phone) { ?><option value="<?php echo $customers_phone ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_customers_id_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['customers_id'])) ? $this->New_label['customers_id'] : "" . $this->Ini->Nm_lang['lang_customers_fld_customers_id'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_customers_id_cond" name="customers_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_customers_id'), this, 'customers_id')">
       <OPTION value="gt" <?php if ("gt" == $customers_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $customers_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $customers_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $customers_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_customers_id" <?php echo $str_hide_customers_id?> valign="top">
 ...
 $nmgp_tab_label .= "customers_id?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
   ...
   { 
      if (isset($this->Ini->nm_bases_postgres) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct customers_id from " . $this->Ini->nm_tabela . " where customers_id = $customers_id_look order by customers_id"; 
      }
      elseif (isset($this->Ini->nm_bases_sybase) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct customers_id from " . $this->Ini->nm_tabela . " where customers_id = $customers_id_look order by customers_id"; 
      ...
      {
            nmgp_Form_Num_Val($customers_id, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $customers_id;
      }
?>
<INPUT  type="text" id="SC_customers_id" name="customers_id" value="<?php echo NM_encode_input($customers_id) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-customers_id" id="id_ac_customers_id" name="customers_id_autocomp"><?php if ('' !=  $customers_id) { ?><option value="<?php echo $customers_id ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_customers_id"  <?php echo $str_display_customers_id; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_customers_id_input_2" name="customers_id_input_2" value="<?php echo NM_encode_input($customers_id_input_2) ?>"  size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_customers_name_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['customers_name'])) ? $this->New_label['customers_name'] : "" . $this->Ini->Nm_lang['lang_customers_fld_customers_name'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_customers_name_cond" name="customers_name_cond" onChange="nm_campos_between(document.getElementById('id_vis_customers_name'), this, 'customers_name')">
       <OPTION value="qp" <?php if ("qp" == $customers_name_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $customers_name_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $customers_name_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $customers_name_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_customers_name" <?php echo $str_hide_customers_name?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 ...
 $nmgp_tab_label .= "customers_name?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $customers_name_look = (is_string($customers_name) ? substr($this->Db->qstr($customers_name), 1, -1) : $customers_name); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct customers_name from " . $this->Ini->nm_tabela . " where customers_name = '$customers_name_look' order by customers_name"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$customers_name]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$customers_name];
      }
      else
      {
          $sAutocompValue = $customers_name;
      }
?>
<INPUT  type="text" id="SC_customers_name" name="customers_name" value="<?php echo NM_encode_input($customers_name) ?>"  size=50 alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-customers_name" id="id_ac_customers_name" name="customers_name_autocomp"><?php if ('' !=  $customers_name) { ?><option value="<?php echo $customers_name ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_customers_email_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['customers_email'])) ? $this->New_label['customers_email'] : "" . $this->Ini->Nm_lang['lang_customers_fld_customers_email'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_customers_email_cond" name="customers_email_cond" onChange="nm_campos_between(document.getElementById('id_vis_customers_email'), this, 'customers_email')">
       <OPTION value="qp" <?php if ("qp" == $customers_email_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $customers_email_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $customers_email_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $customers_email_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_customers_email" <?php echo $str_hide_customers_email?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 ...
 $nmgp_tab_label .= "customers_email?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $customers_email_look = (is_string($customers_email) ? substr($this->Db->qstr($customers_email), 1, -1) : $customers_email); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct customers_email from " . $this->Ini->nm_tabela . " where customers_email = '$customers_email_look' order by customers_email"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$customers_email]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$customers_email];
      }
      else
      {
          $sAutocompValue = $customers_email;
      }
?>
<INPUT  type="text" id="SC_customers_email" name="customers_email" value="<?php echo NM_encode_input($customers_email) ?>"  size=50 alt="{datatype: 'text', maxLength: 60, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-customers_email" id="id_ac_customers_email" name="customers_email_autocomp"><?php if ('' !=  $customers_email) { ?><option value="<?php echo $customers_email ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.customers_phone_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_customers_phone'), document.F1.customers_phone_cond, 'customers_phone');
   document.F1.customers_phone.value = "";
   document.F1.customers_phone_autocomp.value = "";
   $('#select2-id_ac_customers_phone-container').html('<?php echo $this->Val_init_customers_phone['desc'] ?>');;
   document.F1.customers_id_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_customers_id'), document.F1.customers_id_cond, 'customers_id');
   document.F1.customers_id.value = "";
   document.F1.customers_id_autocomp.value = "";
   $('#select2-id_ac_customers_id-container').html('<?php echo $this->Val_init_customers_id['desc'] ?>');;
   document.F1.customers_id_input_2.value = "";
   document.F1.customers_name_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_customers_name'), document.F1.customers_name_cond, 'customers_name');
   document.F1.customers_name.value = "";
   document.F1.customers_name_autocomp.value = "";
   $('#select2-id_ac_customers_name-container').html('<?php echo $this->Val_init_customers_name['desc'] ?>');;
   document.F1.customers_email_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_customers_email'), document.F1.customers_email_cond, 'customers_email');
   document.F1.customers_email.value = "";
   document.F1.customers_email_autocomp.value = "";
   $('#select2-id_ac_customers_email-container').html('<?php echo $this->Val_init_customers_email['desc'] ?>');;
   Sc_carga_select2('all');
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "appointments1/grid_customers";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_customers_phone_cond'] = 'cond';
      $tp_fields['SC_customers_phone'] = 'text_aut';
      $tp_fields['id_ac_customers_phone'] = 'select2_aut';
      $tp_fields['SC_customers_id_cond'] = 'cond';
      $tp_fields['SC_customers_id'] = 'text_aut';
      $tp_fields['id_ac_customers_id'] = 'select2_aut';
      $tp_fields['SC_customers_id_input_2'] = 'text';
      $tp_fields['SC_customers_name_cond'] = 'cond';
      $tp_fields['SC_customers_name'] = 'text_aut';
      $tp_fields['id_ac_customers_name'] = 'select2_aut';
      $tp_fields['SC_customers_email_cond'] = 'cond';
      $tp_fields['SC_customers_email'] = 'text_aut';
      $tp_fields['id_ac_customers_email'] = 'select2_aut';
   ...
   {
      global $customers_phone_cond, $customers_phone, $customers_phone_autocomp,
             $customers_id_cond, $customers_id, $customers_id_input_2, $customers_id_autocomp,
             $customers_name_cond, $customers_name, $customers_name_autocomp,
             $customers_email_cond, $customers_email, $customers_email_autocomp, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($customers_phone_autocomp) && empty($customers_phone))
      {
          $customers_phone = $customers_phone_autocomp;
      }
      if (!empty($customers_id_autocomp) && empty($customers_id))
      {
          $customers_id = $customers_id_autocomp;
      }
      if (!empty($customers_name_autocomp) && empty($customers_name))
      {
          $customers_name = $customers_name_autocomp;
      }
      if (!empty($customers_email_autocomp) && empty($customers_email))
      {
          $customers_email = $customers_email_autocomp;
      }
      $customers_phone_cond_salva = $customers_phone_cond; 
      if (!isset($customers_phone_input_2) || $customers_phone_input_2 == "")
      {
          $customers_phone_input_2 = $customers_phone;
      }
      $customers_id_cond_salva = $customers_id_cond; 
      if (!isset($customers_id_input_2) || $customers_id_input_2 == "")
      {
          $customers_id_input_2 = $customers_id;
      }
      $customers_name_cond_salva = $customers_name_cond; 
      if (!isset($customers_name_input_2) || $customers_name_input_2 == "")
      {
          $customers_name_input_2 = $customers_name;
      }
      $customers_email_cond_salva = $customers_email_cond; 
      if (!isset($customers_email_input_2) || $customers_email_input_2 == "")
      {
          $customers_email_input_2 = $customers_email;
      }
      if ($customers_id_cond != "in")
      {
          nm_limpa_numero($customers_id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($customers_id_cond != "in")
      {
          nm_limpa_numero($customers_id_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers']['campos_busca']['customers_phone'] = $customers_phone; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers']['campos_busca']['customers_phone_cond'] = $customers_phone_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers']['campos_busca']['customers_id'] = $customers_id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers']['campos_busca']['customers_id_input_2'] = $customers_id_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers']['campos_busca']['customers_id_cond'] = $customers_id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers']['campos_busca']['customers_name'] = $customers_name; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers']['campos_busca']['customers_name_cond'] = $customers_name_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers']['campos_busca']['customers_email'] = $customers_email; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers']['campos_busca']['customers_email_cond'] = $customers_email_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers']['dyn_search']  = array(); 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customers']['campos_busca'] = $Temp_Busca;
      }
      if ($customers_id_cond != "in" && $customers_id_cond != "bw" && !empty($customers_id) && !is_numeric($customers_id))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : " . $this->Ini->Nm_lang['lang_customers_fld_customers_id'] . "";
      }
      if ($customers_id_cond == "bw" && ((!empty($customers_id) && !is_numeric($customers_id)) || (!empty($customers_id_input_2) && !is_numeric($customers_id_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : " . $this->Ini->Nm_lang['lang_customers_fld_customers_id'] . "";
      }
      if (!empty($this->Campos_Mens_erro)) 
    ...
    if ($customers_phone != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['customers_phone'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['customers_phone'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['customers_phone'] = $customers_phone;
      }
      $nmgp_def_dados = array();
    if ($customers_id != '') {
      $customers_id_look = (is_string($customers_id) ? substr($this->Db->qstr($customers_id), 1, -1) : $customers_id); 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['customers_id'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['customers_id'] = $cmp1;
      }
      else
      {
          $cmp1 = $customers_id;
      ...
      $Conteudo = $customers_id_input_2;
      if (strtoupper($customers_id_cond) != "II" && strtoupper($customers_id_cond) != "QP" && strtoupper($customers_id_cond) != "NP" && strtoupper($customers_id_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['customers_id_input_2'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($customers_name != '') {
      $customers_name_look = (is_string($customers_name) ? substr($this->Db->qstr($customers_name), 1, -1) : $customers_name); 
      $nmgp_def_dados = array(); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['customers_name'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['customers_name'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['customers_name'] = $customers_name;
      }
      $nmgp_def_dados = array();
    if ($customers_email != '') {
      $customers_email_look = (is_string($customers_email) ? substr($this->Db->qstr($customers_email), 1, -1) : $customers_email); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['customers_email'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['customers_email'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['customers_email'] = $customers_email;
      }

      //----- $customers_phone
      $this->Date_part = false;
      if (isset($customers_phone) || $customers_phone_cond == "nu" || $customers_phone_cond == "nn" || $customers_phone_cond == "ep" || $customers_phone_cond == "ne")
      {
         $this->monta_condicao("customers_phone", $customers_phone_cond, $customers_phone, "", "customers_phone", "VARCHAR", false);
      }

      //----- $customers_id
      $this->Date_part = false;
      if (isset($customers_id) || $customers_id_cond == "nu" || $customers_id_cond == "nn" || $customers_id_cond == "ep" || $customers_id_cond == "ne")
      {
         $this->monta_condicao("customers_id", $customers_id_cond, $customers_id, $customers_id_input_2, "customers_id", "INT", false);
      }

      //----- $customers_name
      $this->Date_part = false;
      if (isset($customers_name) || $customers_name_cond == "nu" || $customers_name_cond == "nn" || $customers_name_cond == "ep" || $customers_name_cond == "ne")
      {
         $this->monta_condicao("customers_name", $customers_name_cond, $customers_name, "", "customers_name", "VARCHAR", false);
      }

      //----- $customers_email
      $this->Date_part = false;
      if (isset($customers_email) || $customers_email_cond == "nu" || $customers_email_cond == "nn" || $customers_email_cond == "ep" || $customers_email_cond == "ne")
      {
         $this->monta_condicao("customers_email", $customers_email_cond, $customers_email, "", "customers_email", "VARCHAR", false);
      }
   }
