...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "customers_id";$Nm_numeric[] = "customers_id";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_customers_phone_cond" name="customers_phone_cond" onChange="nm_campos_between(document.getElementById('id_vis_customers_phone'), this, 'customers_phone')">
      ...
      <br><span id="id_hide_customers_phone"  <?php echo $str_hide_customers_phone?>><?php
      if ($customers_phone != "")
      {
      $customers_phone_look = (is_string($customers_phone) ? substr($this->Db->qstr($customers_phone), 1, -1) : $customers_phone); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_customers_id_cond" name="customers_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_customers_id'), this, 'customers_id')">
      ...
      <br><span id="id_hide_customers_id"  <?php echo $str_hide_customers_id?>><?php
      if ($customers_id != "")
      {
      $customers_id_look = (is_string($customers_id) ? substr($this->Db->qstr($customers_id), 1, -1) : $customers_id); 
      $nmgp_def_dados = array(); 
...
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-customers_id" id="id_ac_customers_id" name="customers_id_autocomp"><?php if ('' !=  $customers_id) { ?><option value="<?php echo $customers_id ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_customers_id"  <?php echo $str_display_customers_id; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_customers_id_input_2" name="customers_id_input_2" value="<?php echo NM_encode_input($customers_id_input_2) ?>"  size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectEven">         </SPAN>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_customers_name_cond" name="customers_name_cond" onChange="nm_campos_between(document.getElementById('id_vis_customers_name'), this, 'customers_name')">
      ...
      <br><span id="id_hide_customers_name"  <?php echo $str_hide_customers_name?>><?php
      if ($customers_name != "")
      {
      $customers_name_look = (is_string($customers_name) ? substr($this->Db->qstr($customers_name), 1, -1) : $customers_name); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_customers_email_cond" name="customers_email_cond" onChange="nm_campos_between(document.getElementById('id_vis_customers_email'), this, 'customers_email')">
      ...
      <br><span id="id_hide_customers_email"  <?php echo $str_hide_customers_email?>><?php
      if ($customers_email != "")
      {
      $customers_email_look = (is_string($customers_email) ? substr($this->Db->qstr($customers_email), 1, -1) : $customers_email); 
      $nmgp_def_dados = array(); 
