...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_customers']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_customers']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['customers_id'] = "customers_id";
   $tab_labels["customers_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customers']['labels']["customers_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_customers']['labels']["customers_id"] : "" . $this->Nm_lang['lang_customers_fld_customers_id'] . "";
   $tab_ger_campos['customers_name'] = "on";
   $tab_def_campos['customers_name'] = "customers_name";
   $tab_labels["customers_name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customers']['labels']["customers_name"])) ? $_SESSION['sc_session'][$sc_init]['grid_customers']['labels']["customers_name"] : "" . $this->Nm_lang['lang_customers_fld_customers_name'] . "";
   $tab_ger_campos['customers_email'] = "on";
   $tab_def_campos['customers_email'] = "customers_email";
   $tab_labels["customers_email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customers']['labels']["customers_email"])) ? $_SESSION['sc_session'][$sc_init]['grid_customers']['labels']["customers_email"] : "" . $this->Nm_lang['lang_customers_fld_customers_email'] . "";
   $tab_ger_campos['customers_phone'] = "on";
   $tab_def_campos['customers_phone'] = "customers_phone";
   $tab_labels["customers_phone"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customers']['labels']["customers_phone"])) ? $_SESSION['sc_session'][$sc_init]['grid_customers']['labels']["customers_phone"] : "" . $this->Nm_lang['lang_customers_fld_customers_phone'] . "";
   $tab_ger_campos['customers_address'] = "on";
   $tab_def_campos['customers_address'] = "customers_address";
   $tab_labels["customers_address"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customers']['labels']["customers_address"])) ? $_SESSION['sc_session'][$sc_init]['grid_customers']['labels']["customers_address"] : "" . $this->Nm_lang['lang_customers_fld_customers_address'] . "";
   $tab_ger_campos['customers_city'] = "on";
   $tab_def_campos['customers_city'] = "customers_city";
   $tab_labels["customers_city"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customers']['labels']["customers_city"])) ? $_SESSION['sc_session'][$sc_init]['grid_customers']['labels']["customers_city"] : "" . $this->Nm_lang['lang_customers_fld_customers_city'] . "";
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_customers']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_customers']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_customers']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_customers']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_customers_report'] ?></TITLE>
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_customers']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_customers']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_customers']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_customers']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_customers']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
