...
<?php
     ...
     if (!function_exists("NM_is_utf8"))
     {
      ...
      $Sel_Cmp = new grid_customers_sel_cmp($bol_sel_campos_include); 
...
function Sel_cmp_process()
{
   ...
   function Sel_cmp_init_fields()
   {
      ...
      if ($this->restore)
      {
          if (isset($_SESSION['sc_session'][$this->sc_init]['grid_customers']['usr_cmp_sel_orig']) && !empty($_SESSION['sc_session'][$this->sc_init]['grid_customers']['usr_cmp_sel_orig']))
          {
              foreach ($_SESSION['sc_session'][$this->sc_init]['grid_customers']['usr_cmp_sel_orig'] as $NM_cada_field => $NM_cada_opc)
              {
...
function Sel_processa_out()
{
   ...
   {
       $_SESSION['sc_session'][$this->sc_init]['grid_customers']['export_sel_columns']['field_order'] = $_SESSION['sc_session'][$this->sc_init]['grid_customers']['field_order'];
       $_SESSION['sc_session'][$this->sc_init]['grid_customers']['export_sel_columns']['usr_cmp_sel'] = $_SESSION['sc_session'][$this->sc_init]['grid_customers']['usr_cmp_sel'];
   }
...
<?php
   ...
   if ($this->restore && isset($_SESSION['sc_session'][$this->sc_init]['grid_customers']['field_order_orig']))
   {
       foreach ($_SESSION['sc_session'][$this->sc_init]['grid_customers']['field_order_orig'] as $NM_cada_field)
       {
...
?>
                        <li class="sc_ui_litem <?php echo $str_class; ?>" id="sc_id_itemsel_<?php echo NM_encode_input($NM_cada_field); ?>"><?php echo $_SESSION['sc_session'][$this->sc_init]['grid_customers']['labels'][$NM_cada_field]; ?></li>
<?php
           }
       }
   }
   ...
   if (!$this->restore && isset($_SESSION['sc_session'][$this->sc_init]['grid_customers']['field_order']))
   {
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$this->sc_init]['grid_customers']['usr_cmp_sel']) && isset($_SESSION['sc_session'][$this->sc_init]['grid_customers']['usr_cmp_sel_orig']) && $_SESSION['sc_session'][$this->sc_init]['grid_customers']['usr_cmp_sel'] != $_SESSION['sc_session'][$this->sc_init]['grid_customers']['usr_cmp_sel_orig']) {
      $disp_rest = "";
  }
  else {
      $order_orig = array();
      $order_atu  = array();
      foreach ($_SESSION['sc_session'][$this->sc_init]['grid_customers']['field_order_orig'] as $ix => $cmp) {
          if (!isset($_SESSION['sc_session'][$this->sc_init]['grid_customers']['usr_cmp_sel_orig'][$cmp]) || $_SESSION['sc_session'][$this->sc_init]['grid_customers']['usr_cmp_sel_orig'][$cmp] != "off") {
              $order_orig[] = $cmp;
          }
      }
      foreach ($_SESSION['sc_session'][$this->sc_init]['grid_customers']['field_order'] as $ix => $cmp) {
          if (!isset($_SESSION['sc_session'][$this->sc_init]['grid_customers']['usr_cmp_sel'][$cmp]) || $_SESSION['sc_session'][$this->sc_init]['grid_customers']['usr_cmp_sel'][$cmp] != "off") {
              $order_atu[] = $cmp;
          }
      }
