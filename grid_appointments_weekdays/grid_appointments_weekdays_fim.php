...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["appointments1_____grid_appointments_weekdays"]))
   {
      unset($_SESSION['session_sec_aplicacao']["appointments1_____grid_appointments_weekdays"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_appointments_weekdays'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_weekdays']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_appointments_weekdays']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_weekdays']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_appointments_weekdays']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_appointments_weekdays']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_appointments_weekdays</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_weekdays']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_appointments_weekdays']['embutida_filho'] as $ind => $sc_init)
          {
