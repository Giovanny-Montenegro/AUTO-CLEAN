...
<?php
   ...
   $Ord_Cmp = new grid_appointments_weekdays_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_appointments_weekdays_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_appointments_weekdays']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_appointments_weekdays']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['id_weekday'] = "id_weekday";
   $tab_labels["id_weekday"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_weekdays']['labels']["id_weekday"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_weekdays']['labels']["id_weekday"] : "" . $this->Nm_lang['lang_appointments_weekdays_fld_id_weekday'] . "";
   $tab_ger_campos['weekday_descr'] = "on";
   $tab_def_campos['weekday_descr'] = "weekday_descr";
   $tab_labels["weekday_descr"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_weekdays']['labels']["weekday_descr"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_weekdays']['labels']["weekday_descr"] : "" . $this->Nm_lang['lang_appointments_weekdays_fld_weekday_descr'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_weekdays']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_appointments_weekdays']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_appointments_weekdays']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_appointments_weekdays']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_appointments_weekdays']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_appointments_weekdays']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_appointments_weekdays']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_appointments_weekdays']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_weekdays']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_appointments_weekdays']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_appointments_weekdays']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_appointments_weekdays']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_appointments_weekdays_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_weekdays']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_appointments_weekdays']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_weekdays']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_appointments_weekdays']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_appointments_weekdays']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
