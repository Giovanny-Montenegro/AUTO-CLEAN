...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["appointments1_____app_grid_sec_groups"]))
   {
      unset($_SESSION['session_sec_aplicacao']["appointments1_____app_grid_sec_groups"]);
   }
