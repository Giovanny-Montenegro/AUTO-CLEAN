<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_staff']['glo_nm_path_imag_temp'] . "/sc_apl_default_appointments1.txt"))
       {
?>
...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["staff_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_staff']['labels']["staff_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_staff']['labels']["staff_id"] : "" . $this->Nm_lang['lang_staff_fld_staff_id'] . "";
   $tab_ger_campos['staff_name'] = "on";
   $tab_def_campos['staff_name'] = "staff_name";
   $tab_labels["staff_name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_staff']['labels']["staff_name"])) ? $_SESSION['sc_session'][$sc_init]['grid_staff']['labels']["staff_name"] : "" . $this->Nm_lang['lang_staff_fld_staff_name'] . "";
   $tab_ger_campos['staff_email'] = "on";
   $tab_def_campos['staff_email'] = "staff_email";
   $tab_labels["staff_email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_staff']['labels']["staff_email"])) ? $_SESSION['sc_session'][$sc_init]['grid_staff']['labels']["staff_email"] : "" . $this->Nm_lang['lang_staff_fld_staff_email'] . "";
   $tab_ger_campos['staff_phone'] = "on";
   $tab_def_campos['staff_phone'] = "staff_phone";
   $tab_labels["staff_phone"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_staff']['labels']["staff_phone"])) ? $_SESSION['sc_session'][$sc_init]['grid_staff']['labels']["staff_phone"] : "" . $this->Nm_lang['lang_staff_fld_staff_phone'] . "";
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_staff_report'] ?></TITLE>
