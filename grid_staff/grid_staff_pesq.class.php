...
class grid_staff_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_staff_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_staff_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_staff_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_staff_phone')
      {
          $staff_phone = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_staff_phone($staff_phone);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_staff_id')
      {
          $staff_id = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_staff_id($staff_id);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_staff_name')
      {
          $staff_name = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_staff_name($staff_name);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_staff_email')
      {
          $staff_email = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_staff_email($staff_email);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_staff_phone($staff_phone)
   {
      $staff_phone = substr($this->Db->qstr($staff_phone), 1, -1);
            $staff_phone_look = (is_string($staff_phone) ? substr($this->Db->qstr($staff_phone), 1, -1) : $staff_phone); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct staff_phone from " . $this->Ini->nm_tabela . " where  staff_phone like '%" . $staff_phone . "%' order by staff_phone"; 
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_staff_id($staff_id)
   {
      $staff_id = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $staff_id);
      $staff_id = substr($this->Db->qstr($staff_id), 1, -1);
      ...
      {
          $nm_comando = "select distinct staff_id from " . $this->Ini->nm_tabela . " where   CAST (staff_id AS TEXT)  like '%" . $staff_id . "%' order by staff_id"; 
      }
      elseif (isset($this->Ini->nm_bases_sybase) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct staff_id from " . $this->Ini->nm_tabela . " where   CAST (staff_id AS VARCHAR)  like '%" . $staff_id . "%' order by staff_id"; 
      }
      else
      {
          $nm_comando = "select distinct staff_id from " . $this->Ini->nm_tabela . " where  staff_id like '%" . $staff_id . "%' order by staff_id"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function lookup_ajax_staff_name($staff_name)
   {
      $staff_name = substr($this->Db->qstr($staff_name), 1, -1);
            $staff_name_look = (is_string($staff_name) ? substr($this->Db->qstr($staff_name), 1, -1) : $staff_name); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct staff_name from " . $this->Ini->nm_tabela . " where  staff_name like '%" . $staff_name . "%' order by staff_name"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_staff_email($staff_email)
   {
      $staff_email = substr($this->Db->qstr($staff_email), 1, -1);
            $staff_email_look = (is_string($staff_email) ? substr($this->Db->qstr($staff_email), 1, -1) : $staff_email); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct staff_email from " . $this->Ini->nm_tabela . " where  staff_email like '%" . $staff_email . "%' order by staff_email"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_staff_report'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_staff/grid_staff_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_staff_ajax_search.js"></script>
 <script type="text/javascript" src="grid_staff_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_staff_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_staff']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_staff']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_staff_phone_cond#NMF#' + search_get_sel_txt('SC_staff_phone_cond') + '@NMF@';
  str_out += 'SC_staff_phone#NMF#' + search_get_text('SC_staff_phone') + '@NMF@';
  str_out += 'id_ac_staff_phone#NMF#' + search_get_title('select2-id_ac_staff_phone-container') + '@NMF@';
  str_out += 'SC_staff_id_cond#NMF#' + search_get_sel_txt('SC_staff_id_cond') + '@NMF@';
  str_out += 'SC_staff_id#NMF#' + search_get_text('SC_staff_id') + '@NMF@';
  str_out += 'id_ac_staff_id#NMF#' + search_get_title('select2-id_ac_staff_id-container') + '@NMF@';
  str_out += 'SC_staff_id_input_2#NMF#' + search_get_text('SC_staff_id_input_2') + '@NMF@';
  str_out += 'SC_staff_name_cond#NMF#' + search_get_sel_txt('SC_staff_name_cond') + '@NMF@';
  str_out += 'SC_staff_name#NMF#' + search_get_text('SC_staff_name') + '@NMF@';
  str_out += 'id_ac_staff_name#NMF#' + search_get_title('select2-id_ac_staff_name-container') + '@NMF@';
  str_out += 'SC_staff_email_cond#NMF#' + search_get_sel_txt('SC_staff_email_cond') + '@NMF@';
  str_out += 'SC_staff_email#NMF#' + search_get_text('SC_staff_email') + '@NMF@';
  str_out += 'id_ac_staff_email#NMF#' + search_get_title('select2-id_ac_staff_email-container') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-staff_id").on("focus", function() {
  }).on("blur", function() {
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      ...
      nmgp_parms: "NM_ajax_opcao?#?autocomp_staff_id",
      max_itens: "10",
   ...
   $("#SC_staff_id").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-staff_name").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_staff_name",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_staff_name").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-staff_email").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_staff_email",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_staff_email").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-staff_phone").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_staff_phone",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_staff_phone").val(e.params.data.id);
  });
 });
</script>
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $staff_phone_cond, $staff_phone, $staff_phone_autocomp,
             $staff_id_cond, $staff_id, $staff_id_input_2, $staff_id_autocomp,
             $staff_name_cond, $staff_name, $staff_name_autocomp,
             $staff_email_cond, $staff_email, $staff_email_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $staff_phone = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['campos_busca']['staff_phone']; 
          $staff_phone_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['campos_busca']['staff_phone_cond']; 
          $staff_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['campos_busca']['staff_id']; 
          $staff_id_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['campos_busca']['staff_id_input_2']; 
          $staff_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['campos_busca']['staff_id_cond']; 
          $staff_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['campos_busca']['staff_name']; 
          $staff_name_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['campos_busca']['staff_name_cond']; 
          $staff_email = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['campos_busca']['staff_email']; 
          $staff_email_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['campos_busca']['staff_email_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['campos_busca']['NM_operador']; 
      } 
      if (!isset($staff_phone_cond) || empty($staff_phone_cond))
      {
         $staff_phone_cond = "qp";
      }
      if (!isset($staff_id_cond) || empty($staff_id_cond))
      {
         $staff_id_cond = "gt";
      }
      if (!isset($staff_name_cond) || empty($staff_name_cond))
      {
         $staff_name_cond = "qp";
      }
      if (!isset($staff_email_cond) || empty($staff_email_cond))
      {
         $staff_email_cond = "qp";
      }
      ...
      $str_hide_staff_phone = (in_array($staff_phone_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_staff_id = (in_array($staff_id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_staff_name = (in_array($staff_name_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_staff_email = (in_array($staff_email_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_staff_phone = ('bw' == $staff_phone_cond) ? $display_aberto : $display_fechado;
      $str_display_staff_id = ('bw' == $staff_id_cond) ? $display_aberto : $display_fechado;
      $str_display_staff_name = ('bw' == $staff_name_cond) ? $display_aberto : $display_fechado;
      $str_display_staff_email = ('bw' == $staff_email_cond) ? $display_aberto : $display_fechado;

      if (!isset($staff_phone) || $staff_phone == "")
      {
          $staff_phone = "";
      }
      if (isset($staff_phone) && !empty($staff_phone))
      {
         $tmp_pos = (is_string($staff_phone)) ? strpos($staff_phone, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $staff_phone = substr($staff_phone, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = (is_string($staff_name)) ? strpos($staff_name, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $staff_name = substr($staff_name, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = (is_string($staff_email)) ? strpos($staff_email, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $staff_email = substr($staff_email, 0, $tmp_pos);
         }
      }
?>
 <?php
...
?>
<?php
   if (is_file("grid_staff_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_staff']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_staff']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_staff_phone_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['staff_phone'])) ? $this->New_label['staff_phone'] : "" . $this->Ini->Nm_lang['lang_staff_fld_staff_phone'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_staff_phone_cond" name="staff_phone_cond" onChange="nm_campos_between(document.getElementById('id_vis_staff_phone'), this, 'staff_phone')">
       <OPTION value="qp" <?php if ("qp" == $staff_phone_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $staff_phone_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $staff_phone_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $staff_phone_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_staff_phone" <?php echo $str_hide_staff_phone?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['staff_phone'])) ? $this->New_label['staff_phone'] : "" . $this->Ini->Nm_lang['lang_staff_fld_staff_phone'] . "";
 $nmgp_tab_label .= "staff_phone?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<?php
      ...
      $staff_phone_look = (is_string($staff_phone) ? substr($this->Db->qstr($staff_phone), 1, -1) : $staff_phone); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct staff_phone from " . $this->Ini->nm_tabela . " where staff_phone = '$staff_phone_look' order by staff_phone"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$staff_phone]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$staff_phone];
      }
      else
      {
          $sAutocompValue = $staff_phone;
      }
?>
<INPUT  type="text" id="SC_staff_phone" name="staff_phone" value="<?php echo NM_encode_input($staff_phone) ?>"  size=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-staff_phone" id="id_ac_staff_phone" name="staff_phone_autocomp"><?php if ('' !=  $staff_phone) { ?><option value="<?php echo $staff_phone ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_staff_id_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['staff_id'])) ? $this->New_label['staff_id'] : "" . $this->Ini->Nm_lang['lang_staff_fld_staff_id'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_staff_id_cond" name="staff_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_staff_id'), this, 'staff_id')">
       <OPTION value="gt" <?php if ("gt" == $staff_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $staff_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $staff_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $staff_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_staff_id" <?php echo $str_hide_staff_id?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['staff_id'])) ? $this->New_label['staff_id'] : "" . $this->Ini->Nm_lang['lang_staff_fld_staff_id'] . "";
 $nmgp_tab_label .= "staff_id?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
   ...
   { 
      if (isset($this->Ini->nm_bases_postgres) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct staff_id from " . $this->Ini->nm_tabela . " where staff_id = $staff_id_look order by staff_id"; 
      }
      elseif (isset($this->Ini->nm_bases_sybase) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct staff_id from " . $this->Ini->nm_tabela . " where staff_id = $staff_id_look order by staff_id"; 
      ...
      if (isset($nmgp_def_dados[0][$staff_id]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$staff_id];
      }
      else
      {
            nmgp_Form_Num_Val($staff_id, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $staff_id;
      }
?>
<INPUT  type="text" id="SC_staff_id" name="staff_id" value="<?php echo NM_encode_input($staff_id) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-staff_id" id="id_ac_staff_id" name="staff_id_autocomp"><?php if ('' !=  $staff_id) { ?><option value="<?php echo $staff_id ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_staff_id"  <?php echo $str_display_staff_id; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_staff_id_input_2" name="staff_id_input_2" value="<?php echo NM_encode_input($staff_id_input_2) ?>"  size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_staff_name_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['staff_name'])) ? $this->New_label['staff_name'] : "" . $this->Ini->Nm_lang['lang_staff_fld_staff_name'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_staff_name_cond" name="staff_name_cond" onChange="nm_campos_between(document.getElementById('id_vis_staff_name'), this, 'staff_name')">
       <OPTION value="qp" <?php if ("qp" == $staff_name_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $staff_name_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $staff_name_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $staff_name_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_staff_name" <?php echo $str_hide_staff_name?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['staff_name'])) ? $this->New_label['staff_name'] : "" . $this->Ini->Nm_lang['lang_staff_fld_staff_name'] . "";
 $nmgp_tab_label .= "staff_name?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $staff_name_look = (is_string($staff_name) ? substr($this->Db->qstr($staff_name), 1, -1) : $staff_name); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct staff_name from " . $this->Ini->nm_tabela . " where staff_name = '$staff_name_look' order by staff_name"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$staff_name]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$staff_name];
      }
      else
      {
          $sAutocompValue = $staff_name;
      }
?>
<INPUT  type="text" id="SC_staff_name" name="staff_name" value="<?php echo NM_encode_input($staff_name) ?>"  size=50 alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-staff_name" id="id_ac_staff_name" name="staff_name_autocomp"><?php if ('' !=  $staff_name) { ?><option value="<?php echo $staff_name ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_staff_email_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['staff_email'])) ? $this->New_label['staff_email'] : "" . $this->Ini->Nm_lang['lang_staff_fld_staff_email'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_staff_email_cond" name="staff_email_cond" onChange="nm_campos_between(document.getElementById('id_vis_staff_email'), this, 'staff_email')">
       <OPTION value="qp" <?php if ("qp" == $staff_email_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $staff_email_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $staff_email_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $staff_email_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_staff_email" <?php echo $str_hide_staff_email?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['staff_email'])) ? $this->New_label['staff_email'] : "" . $this->Ini->Nm_lang['lang_staff_fld_staff_email'] . "";
 $nmgp_tab_label .= "staff_email?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $staff_email_look = (is_string($staff_email) ? substr($this->Db->qstr($staff_email), 1, -1) : $staff_email); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct staff_email from " . $this->Ini->nm_tabela . " where staff_email = '$staff_email_look' order by staff_email"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$staff_email]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$staff_email];
      }
      else
      {
          $sAutocompValue = $staff_email;
      }
?>
<INPUT  type="text" id="SC_staff_email" name="staff_email" value="<?php echo NM_encode_input($staff_email) ?>"  size=50 alt="{datatype: 'text', maxLength: 60, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-staff_email" id="id_ac_staff_email" name="staff_email_autocomp"><?php if ('' !=  $staff_email) { ?><option value="<?php echo $staff_email ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.staff_phone_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_staff_phone'), document.F1.staff_phone_cond, 'staff_phone');
   document.F1.staff_phone.value = "";
   document.F1.staff_phone_autocomp.value = "";
   $('#select2-id_ac_staff_phone-container').html('<?php echo $this->Val_init_staff_phone['desc'] ?>');;
   document.F1.staff_id_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_staff_id'), document.F1.staff_id_cond, 'staff_id');
   document.F1.staff_id.value = "";
   document.F1.staff_id_autocomp.value = "";
   $('#select2-id_ac_staff_id-container').html('<?php echo $this->Val_init_staff_id['desc'] ?>');;
   document.F1.staff_id_input_2.value = "";
   document.F1.staff_name_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_staff_name'), document.F1.staff_name_cond, 'staff_name');
   document.F1.staff_name.value = "";
   document.F1.staff_name_autocomp.value = "";
   $('#select2-id_ac_staff_name-container').html('<?php echo $this->Val_init_staff_name['desc'] ?>');;
   document.F1.staff_email_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_staff_email'), document.F1.staff_email_cond, 'staff_email');
   document.F1.staff_email.value = "";
   document.F1.staff_email_autocomp.value = "";
   $('#select2-id_ac_staff_email-container').html('<?php echo $this->Val_init_staff_email['desc'] ?>');;
   Sc_carga_select2('all');
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "appointments1/grid_staff";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_staff_phone_cond'] = 'cond';
      $tp_fields['SC_staff_phone'] = 'text_aut';
      $tp_fields['id_ac_staff_phone'] = 'select2_aut';
      $tp_fields['SC_staff_id_cond'] = 'cond';
      $tp_fields['SC_staff_id'] = 'text_aut';
      $tp_fields['id_ac_staff_id'] = 'select2_aut';
      $tp_fields['SC_staff_id_input_2'] = 'text';
      $tp_fields['SC_staff_name_cond'] = 'cond';
      $tp_fields['SC_staff_name'] = 'text_aut';
      $tp_fields['id_ac_staff_name'] = 'select2_aut';
      $tp_fields['SC_staff_email_cond'] = 'cond';
      $tp_fields['SC_staff_email'] = 'text_aut';
      $tp_fields['id_ac_staff_email'] = 'select2_aut';
   ...
   {
      global $staff_phone_cond, $staff_phone, $staff_phone_autocomp,
             $staff_id_cond, $staff_id, $staff_id_input_2, $staff_id_autocomp,
             $staff_name_cond, $staff_name, $staff_name_autocomp,
             $staff_email_cond, $staff_email, $staff_email_autocomp, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($staff_phone_autocomp) && empty($staff_phone))
      {
          $staff_phone = $staff_phone_autocomp;
      }
      if (!empty($staff_id_autocomp) && empty($staff_id))
      {
          $staff_id = $staff_id_autocomp;
      }
      if (!empty($staff_name_autocomp) && empty($staff_name))
      {
          $staff_name = $staff_name_autocomp;
      }
      if (!empty($staff_email_autocomp) && empty($staff_email))
      {
          $staff_email = $staff_email_autocomp;
      }
      $staff_phone_cond_salva = $staff_phone_cond; 
      if (!isset($staff_phone_input_2) || $staff_phone_input_2 == "")
      {
          $staff_phone_input_2 = $staff_phone;
      }
      $staff_id_cond_salva = $staff_id_cond; 
      if (!isset($staff_id_input_2) || $staff_id_input_2 == "")
      {
          $staff_id_input_2 = $staff_id;
      }
      $staff_name_cond_salva = $staff_name_cond; 
      if (!isset($staff_name_input_2) || $staff_name_input_2 == "")
      {
          $staff_name_input_2 = $staff_name;
      }
      $staff_email_cond_salva = $staff_email_cond; 
      if (!isset($staff_email_input_2) || $staff_email_input_2 == "")
      {
          $staff_email_input_2 = $staff_email;
      }
      if ($staff_id_cond != "in")
      {
          nm_limpa_numero($staff_id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($staff_id_cond != "in")
      {
          nm_limpa_numero($staff_id_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['campos_busca']['staff_phone'] = $staff_phone; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['campos_busca']['staff_phone_cond'] = $staff_phone_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['campos_busca']['staff_id'] = $staff_id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['campos_busca']['staff_id_input_2'] = $staff_id_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['campos_busca']['staff_id_cond'] = $staff_id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['campos_busca']['staff_name'] = $staff_name; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['campos_busca']['staff_name_cond'] = $staff_name_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['campos_busca']['staff_email'] = $staff_email; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['campos_busca']['staff_email_cond'] = $staff_email_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['campos_busca'] = $Temp_Busca;
      }
      if ($staff_id_cond != "in" && $staff_id_cond != "bw" && !empty($staff_id) && !is_numeric($staff_id))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : " . $this->Ini->Nm_lang['lang_staff_fld_staff_id'] . "";
      }
      if ($staff_id_cond == "bw" && ((!empty($staff_id) && !is_numeric($staff_id)) || (!empty($staff_id_input_2) && !is_numeric($staff_id_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : " . $this->Ini->Nm_lang['lang_staff_fld_staff_id'] . "";
      }
      if (!empty($this->Campos_Mens_erro)) 
    ...
    if ($staff_phone != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['staff_phone'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['staff_phone'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['staff_phone'] = $staff_phone;
      }
      $nmgp_def_dados = array();
    if ($staff_id != '') {
      $staff_id_look = (is_string($staff_id) ? substr($this->Db->qstr($staff_id), 1, -1) : $staff_id); 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['staff_id'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['staff_id'] = $cmp1;
      }
      else
      {
          $cmp1 = $staff_id;
      ...
      $Conteudo = $staff_id_input_2;
      if (strtoupper($staff_id_cond) != "II" && strtoupper($staff_id_cond) != "QP" && strtoupper($staff_id_cond) != "NP" && strtoupper($staff_id_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['staff_id_input_2'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($staff_name != '') {
      $staff_name_look = (is_string($staff_name) ? substr($this->Db->qstr($staff_name), 1, -1) : $staff_name); 
      $nmgp_def_dados = array(); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['staff_name'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['staff_name'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['staff_name'] = $staff_name;
      }
      $nmgp_def_dados = array();
    if ($staff_email != '') {
      $staff_email_look = (is_string($staff_email) ? substr($this->Db->qstr($staff_email), 1, -1) : $staff_email); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['staff_email'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['staff_email'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['staff_email'] = $staff_email;
      }

      //----- $staff_phone
      $this->Date_part = false;
      if (isset($staff_phone) || $staff_phone_cond == "nu" || $staff_phone_cond == "nn" || $staff_phone_cond == "ep" || $staff_phone_cond == "ne")
      {
         $this->monta_condicao("staff_phone", $staff_phone_cond, $staff_phone, "", "staff_phone", "VARCHAR", false);
      }

      //----- $staff_id
      $this->Date_part = false;
      if (isset($staff_id) || $staff_id_cond == "nu" || $staff_id_cond == "nn" || $staff_id_cond == "ep" || $staff_id_cond == "ne")
      {
         $this->monta_condicao("staff_id", $staff_id_cond, $staff_id, $staff_id_input_2, "staff_id", "INT", false);
      }

      //----- $staff_name
      $this->Date_part = false;
      if (isset($staff_name) || $staff_name_cond == "nu" || $staff_name_cond == "nn" || $staff_name_cond == "ep" || $staff_name_cond == "ne")
      {
         $this->monta_condicao("staff_name", $staff_name_cond, $staff_name, "", "staff_name", "VARCHAR", false);
      }

      //----- $staff_email
      $this->Date_part = false;
      if (isset($staff_email) || $staff_email_cond == "nu" || $staff_email_cond == "nn" || $staff_email_cond == "ep" || $staff_email_cond == "ne")
      {
         $this->monta_condicao("staff_email", $staff_email_cond, $staff_email, "", "staff_email", "VARCHAR", false);
      }
   }
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['where_pesq_fast'] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['fast_search']);
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['where_pesq'];
