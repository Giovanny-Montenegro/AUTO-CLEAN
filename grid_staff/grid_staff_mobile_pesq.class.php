...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "staff_id";$Nm_numeric[] = "staff_id";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_staff_phone_cond" name="staff_phone_cond" onChange="nm_campos_between(document.getElementById('id_vis_staff_phone'), this, 'staff_phone')">
      ...
      <br><span id="id_hide_staff_phone"  <?php echo $str_hide_staff_phone?>><?php
      if ($staff_phone != "")
      {
      $staff_phone_look = (is_string($staff_phone) ? substr($this->Db->qstr($staff_phone), 1, -1) : $staff_phone); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_staff_id_cond" name="staff_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_staff_id'), this, 'staff_id')">
      ...
      <br><span id="id_hide_staff_id"  <?php echo $str_hide_staff_id?>><?php
      if ($staff_id != "")
      {
      $staff_id_look = (is_string($staff_id) ? substr($this->Db->qstr($staff_id), 1, -1) : $staff_id); 
      $nmgp_def_dados = array(); 
...
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-staff_id" id="id_ac_staff_id" name="staff_id_autocomp"><?php if ('' !=  $staff_id) { ?><option value="<?php echo $staff_id ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_staff_id"  <?php echo $str_display_staff_id; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_staff_id_input_2" name="staff_id_input_2" value="<?php echo NM_encode_input($staff_id_input_2) ?>"  size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectEven">         </SPAN>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_staff_name_cond" name="staff_name_cond" onChange="nm_campos_between(document.getElementById('id_vis_staff_name'), this, 'staff_name')">
      ...
      <br><span id="id_hide_staff_name"  <?php echo $str_hide_staff_name?>><?php
      if ($staff_name != "")
      {
      $staff_name_look = (is_string($staff_name) ? substr($this->Db->qstr($staff_name), 1, -1) : $staff_name); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_staff_email_cond" name="staff_email_cond" onChange="nm_campos_between(document.getElementById('id_vis_staff_email'), this, 'staff_email')">
      ...
      <br><span id="id_hide_staff_email"  <?php echo $str_hide_staff_email?>><?php
      if ($staff_email != "")
      {
      $staff_email_look = (is_string($staff_email) ? substr($this->Db->qstr($staff_email), 1, -1) : $staff_email); 
      $nmgp_def_dados = array(); 
