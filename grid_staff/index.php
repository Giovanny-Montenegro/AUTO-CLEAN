<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['grid_staff']['glo_nm_perfil']          = "conn_example";
   $_SESSION['scriptcase']['grid_staff']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['grid_staff']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['grid_staff']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['grid_staff']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['grid_staff']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['grid_staff']['glo_nm_path_doc']        = "";
...
<?php
      ...
      if (is_file($this->root . $this->path_link . "_lib/friendly_url/form_staff_ini.txt"))
      {
          $Friendly = file($this->root . $this->path_link . "_lib/friendly_url/form_staff_ini.txt");
          if (isset($Friendly[0]) && !empty($Friendly[0]))
          {
              $Tmp_apl_lig = trim($Friendly[0]);
          }
      }
      if (is_file($this->root . $this->path_link . $Tmp_apl_lig . "/form_staff_ini.txt"))
      {
          $L_md5 = file($this->root . $this->path_link . $Tmp_apl_lig . "/form_staff_ini.txt");
      ...
      $this->sc_lig_target["A_@scinf__@scinf_form_staff"] = '';
      ...
      $this->link_form_staff =  $this->sc_protocolo . $this->server . $this->path_link . "" . SC_dir_app_name('form_staff') . "/" ; 
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_staff']['glo_nm_conexao'], $this->root . $this->path_prod, 'appointments1', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['sc_modal']))
      {
          ...
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_staff']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('grid_staff') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_staff']['label'] = "" . $this->Ini->Nm_lang['lang_staff_report'] . "";
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['SC_Gb_date_format'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['SC_Gb_date_format'] = array();
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['SC_All_Groupby'] = array('sc_free_total' => 'grid');
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['SC_Groupby_hide'])) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['SC_Groupby_hide'] = array();
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['SC_Ind_Groupby'])) 
      { 
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['SC_All_Groupby'] as $Ind => $Tp)
          {
              if (!in_array($Ind, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['SC_Groupby_hide'])) 
              { 
                  break;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['SC_Ind_Groupby'] = $Ind;
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['Labels_GB'] = array();
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['SC_Ind_Groupby'] == "sc_free_total")
      {
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['dados_orig_gb']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['dados_orig_gb'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['dados_orig_gb']['all']['SC_Ind_Groupby'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['SC_Ind_Groupby']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['dados_orig_gb']['all']['SC_Ind_Groupby'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['SC_Ind_Groupby'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['SC_Gb_Free_cmp']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['SC_Gb_Free_cmp'];
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['dados_orig_gb']['res']['summarizing_fields_display'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['dados_orig_gb']['res']['summarizing_fields_order']   = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['dados_orig_gb']['res']['summarizing_fields_control'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['dados_orig_gb']['res']['pivot_x_axys']               = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['summarizing_fields_display']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['dados_orig_gb']['res']['summarizing_fields_display'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['summarizing_fields_display'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['summarizing_fields_order']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['dados_orig_gb']['res']['summarizing_fields_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['summarizing_fields_order'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['summarizing_fields_control']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['dados_orig_gb']['res']['summarizing_fields_control'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['summarizing_fields_control'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['pivot_x_axys']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['dados_orig_gb']['res']['pivot_x_axys'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['pivot_x_axys'];
          }
      }
      $this->Ini->Apl_resumo  = "grid_staff_resumo_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['SC_Ind_Groupby'] . ".class.php"; 
      $this->Ini->Apl_grafico = "grid_staff_grafico_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['SC_Ind_Groupby'] . ".class.php"; 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['pdf_det'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['opcao'] = 'pdf';
          $_SESSION['sc_session'][$script_case_init]['grid_staff']['opc_pdf']['pdf_zip'] = (isset($Det_pdf_zip) && !empty($Det_pdf_zip)) ? $Det_pdf_zip : "N";
          if ($Det_use_pass_pdf != "__APL__")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['use_pass_pdf'] = $Det_use_pass_pdf;
          } 
          $nmgp_opcao = 'pdf';
      }
      if ($nmgp_opcao == 'pdf')
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['field_order'][] = "staff_id";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['field_order'][] = "staff_name";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['field_order'][] = "staff_email";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['field_order'][] = "staff_phone";
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['opc_liga']['inicial']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['opc_liga']['inicial'];
              $_SESSION['sc_session'][$script_case_init]['grid_staff']['orig_pesq'] = "grid";
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['det_print'] = "";
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['opcao'] == "det_print")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['opcao']     = "detalhe";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['det_print'] = "print";
          if (!empty($nmgp_password)) {
          ...
          {
              $this->Ini->Export_img_zip = true;
              $nm_arquivo_html = "/sc_grid_staff_det_" . session_id() . ".html";
              $nm_saida->seta_arquivo($this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_html);
          }
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['opcao'] == "fast_search")  
      { 
          $this->SC_fast_search($GLOBALS["nmgp_fast_search"], $GLOBALS["nmgp_cond_fast_search"], $GLOBALS["nmgp_arg_fast_search"]);
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['where_pesq_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['where_pesq'])
          { 
...
//----------------------------------->
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['opcao'] == "xls_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_staff/grid_staff_res_xls.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_staff_res_xls.class.php"); 
          } 
          $this->xls  = new grid_staff_res_xls();
          $this->prep_modulos("xls");
          $this->xls->monta_xls();
      }
      else
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['opcao'] == "xml_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_staff/grid_staff_res_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_staff_res_xml.class.php"); 
          } 
          $this->xml  = new grid_staff_res_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['opcao'] == "csv_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_staff/grid_staff_res_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_staff_res_csv.class.php"); 
          } 
          $this->csv  = new grid_staff_res_csv();
          $this->prep_modulos("csv");
          $this->csv->monta_csv();
      }
      else   
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['opcao'] == "rtf_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_staff/grid_staff_res_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_staff_res_rtf.class.php"); 
          } 
          $this->rtf  = new grid_staff_res_rtf();
          $this->prep_modulos("rtf");
          $this->rtf->monta_rtf();
      }
      else
      ...
      { 
          ...
          { 
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['dashboard_refresh_after_chart'])) {
      ...
      { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['opcao'] == "detalhe" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['pdf_det'])  
          { 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['embutida'])
              { 
                  require_once($this->Ini->path_embutida . "grid_staff/grid_staff_det.class.php"); 
              } 
              else 
              { 
                  require_once($this->Ini->path_aplicacao . "grid_staff_det.class.php"); 
              } 
              $this->det  = new grid_staff_det();
  ...
  function close_emb()
  {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      if (empty($data_search)) 
      {
          $tmp_cmd = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['where_pesq_fast'] = "";
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['where_orig'])) 
          {
              $tmp_cmd = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['where_orig']; 
          }
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['where_pesq_filtro'])) 
          {
              if (!empty($tmp_cmd)) 
              {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['where_pesq_filtro'] . ")"; 
              }
              else
              {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['where_pesq_filtro'] . ")"; 
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['where_pesq'] = $tmp_cmd;
      ...
      foreach ($fields as $field) {
          ...
          {
              $this->SC_monta_condicao($comando, "staff_id", $arg_search, str_replace(",", ".", $data_search));
          }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['where_pesq_fast'] = $comando;
      $tmp_cmd = "";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['where_orig'])) 
      {
          $tmp_cmd = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['where_orig']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['where_pesq'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['fast_search'][0] = $in_fields;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff']['fast_search'][2] = $sv_data;
   }
...
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_staff_report'] ?> :: Doc</TITLE>
...
<?php
 ...
 $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff'][$path_doc_md5][0] = $nm_arquivo_pdf_det;
 $_SESSION['sc_session'][$this->Ini->sc_page]['grid_staff'][$path_doc_md5][1] = "grid_staff_det.pdf";
?>
 <link rel="shortcut icon" href="../_lib/img/sys__NM__img__NM__1402365182_app_type_car_dealer_512px_GREY.png">
  <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_all ?>_export.css" /> 
  <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_all ?>_export<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['grid_staff']['glo_nm_path_imag_temp'] . "/sc_apl_default_appointments1.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['grid_staff']['glo_nm_path_imag_temp'] . "/sc_apl_default_appointments1.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_appointments1'])) {
               $_SESSION['scriptcase']['grid_staff']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_appointments1'];
           }
       }
   }
   ...
   elseif (false === strpos($_SERVER['HTTP_REFERER'], '/grid_staff/'))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_staff']['initialize'] = true;
   }
   else
   ...
   if (isset($_SESSION['scriptcase']['grid_staff']['session_timeout']['lang'])) {
       $STR_lang = $_SESSION['scriptcase']['grid_staff']['session_timeout']['lang'];
   }
   $STR_schema_all = (isset($_SESSION['scriptcase']['str_schema_all']) && !empty($_SESSION['scriptcase']['str_schema_all'])) ? $_SESSION['scriptcase']['str_schema_all'] : "Sc9_SweetBlue/Sc9_SweetBlue";
   ...
   { 
       ...
       if ($_SESSION['sc_session'][$script_case_init]['grid_staff']['opcao'] == "detalhe" && isset($nmgp_chave_det))  
       { 
           $_SESSION['sc_session'][$script_case_init]['grid_staff']['chave_det'] = $nmgp_chave_det;
           $_SESSION['sc_session'][$script_case_init]['grid_staff']['cmp_acum']  = $nmgp_parm_acum;
       }   
       if (isset($Sc_seq_det))  
       { 
           $_SESSION['sc_session'][$script_case_init]['grid_staff']['Sc_seq_det'] = $Sc_seq_det;
       } 
...
// 
       ...
       if (!$_SESSION['sc_session'][$script_case_init]['grid_staff']['opc_psq'] && !isset($_SESSION['scriptcase']['grid_staff']['session_timeout']['redir'])) 
       { 
          if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_staff']) || $_SESSION['scriptcase']['sc_apl_seg']['grid_staff'] != "on")
          { 
              $NM_Mens_Erro = $Nm_lang['lang_errm_unth_user'];
              $nm_botao_ok = ($_SESSION['sc_session'][$script_case_init]['grid_staff']['iframe_menu']) ? false : true;
              ...
              if ((isset($_SESSION['sc_session'][$script_case_init]['grid_staff']['embutida']) && $_SESSION['sc_session'][$script_case_init]['grid_staff']['embutida']) || (isset($_SESSION['sc_session'][$script_case_init]['grid_staff']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['grid_staff']['embutida_form']))
              {
                   $nm_botao_ok = false;
              }
