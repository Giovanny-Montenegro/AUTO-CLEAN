...
// 
    ...
    $out1_img_cache = $_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_conexao'], $this->root . $this->path_prod, 'appointments1', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if (!$this->Ini || isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['embutida_ibase'])) 
      { 
          $this->Ini = new grid_appointments_staff_ini(); 
          $this->Ini->init();
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida_ibase'] = true;
      }
      ...
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['sc_modal']))
      {
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_appointments_staff']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_appointments_staff']['label'] = "" . $this->Ini->Nm_lang['lang_appointments_report'] . "";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_All_Groupby'] = array('status' => 'all', 'sc_free_group_by' => 'all');
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Gb_Free_cmp']  = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Gb_Free_sql']  = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Gb_Free_orig'] = array();
      }
      ...
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Ind_Groupby'] == "sc_free_group_by")
      {
          ...
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Gb_Free_cmp'] as $Field => $Label)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['Labels_GB'][] = $Arr_free_labels[$Field];
          }
      }
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Ind_Groupby'] == "status")
      {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['summarizing_fields_display']['sc_free_group_by']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['summarizing_fields_display']['sc_free_group_by'][2] = array('label' => "" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['summarizing_fields_order']['sc_free_group_by'][] = 2;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['summarizing_fields_control']['sc_free_group_by']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['summarizing_fields_control']['sc_free_group_by'] = array(
               array(
                   'cmp_res' => "NM_Count",
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['summarizing_fields_display']['status'][2] = array('label' => "" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "", 'display' => true);
      ...
      $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['skip_charts'] = (strpos(" " . $this->Ini->SC_module_export, "chart") !== false) ? false : true;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['pdf_det'] = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['conf_chart_level'] = "S";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['proc_pdf'] = (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'] && ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "pdf_res")) ? true : false;
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['field_order'][] = "lig";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['field_order'][] = "appointments_id";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['field_order'][] = "customers_id";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['field_order'][] = "total_price";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['field_order'][] = "staff_id";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['field_order'][] = "price";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['field_order'][] = "additional_charges";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['field_order'][] = "discount";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['usr_cmp_sel']['staff_id'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['usr_cmp_sel']['price'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['usr_cmp_sel']['additional_charges'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['usr_cmp_sel']['discount'] = "off";
      ...
      if ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['where_orig'])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] = "inicio";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_appointments_staff']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_appointments_staff']['start'] == 'filter')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "grid")  
          { 
...
//----------------------------------->
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "json")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_appointments_staff/grid_appointments_staff_json.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_appointments_staff_json.class.php"); 
          } 
          $this->json  = new grid_appointments_staff_json();
...
<?php
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['embutida'])
      {
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            elseif (is_dir($this->Ini->path_third . $dir_qpdf) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['use_pass_pdf']))
            {
            ...
            if ($this->pdf_zip == "S")
            {
                $pdf_pass = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['use_pass_pdf'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['use_pass_pdf'] : "";
            ...
            elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['use_pass_pdf']))
            {
                if (FALSE !== strpos(strtolower(php_uname()), 'windows')) 
                {
                    $dir_qpdf = "/qpdf/win/bin";
                ...
                if (is_dir($this->Ini->path_third . $dir_qpdf)) 
                {
                    ...
                    $pdf_pass  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['use_pass_pdf'];
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      foreach ($fields as $field) {
          ...
          if ($field == "SC_all_Cmp" || $field == "customers_id") 
          {
              ...
              {
                  $this->SC_monta_condicao($comando, "customers_id", $arg_search, $data_lookup, "INTEGER", false);
              }
          }
          ...
          {
              $this->SC_monta_condicao($comando, "appointment_start_date", $arg_search, $data_search, "TEXT", false);
          }
          if ($field == "SC_all_Cmp" || $field == "appointment_start_time") 
          {
              $this->SC_monta_condicao($comando, "appointment_start_time", $arg_search, $data_search, "TEXT", false);
          }
          if ($field == "SC_all_Cmp" || $field == "appointment_end_date") 
          {
              $this->SC_monta_condicao($comando, "appointment_end_date", $arg_search, $data_search, "TEXT", false);
          }
          if ($field == "SC_all_Cmp" || $field == "appointment_end_time") 
          {
              $this->SC_monta_condicao($comando, "appointment_end_time", $arg_search, $data_search, "TEXT", false);
          }
          if ($field == "SC_all_Cmp" || $field == "current_status_id") 
          {
              ...
              if (is_array($data_lookup) && !empty($data_lookup)) 
              {
                  $this->SC_monta_condicao($comando, "current_status_id", $arg_search, $data_lookup, "INTEGER", false);
              }
          }
          if ($field == "SC_all_Cmp" || $field == "appointment_recurrent") 
          {
              $this->SC_monta_condicao($comando, "appointment_recurrent", $arg_search, $data_search, "TEXT", false);
          }
          if ($field == "SC_all_Cmp" || $field == "appointment_period") 
          {
              $this->SC_monta_condicao($comando, "appointment_period", $arg_search, $data_search, "TEXT", false);
          }
   ...
   function SC_proc_interativ_search($Parms)
   {
       ...
       if (!empty($vls))
       {
           ...
           if ($prep == "" && $bol_numeric)
           {
               ...
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " is null";
               }
               else
               {
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_path_imag_temp'] . "/sc_apl_default_appointments1.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_path_imag_temp'] . "/sc_apl_default_appointments1.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_appointments1'])) {
               $_SESSION['scriptcase']['grid_appointments_staff']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_appointments1'];
           }
       }
   }
   ...
   { 
       ...
       elseif (substr($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['opcao'] != "pdf" ) 
       {
...
// 
       if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && substr($_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['grid_appointments_staff']['opcao'] != "pdf" ) 
       { 
