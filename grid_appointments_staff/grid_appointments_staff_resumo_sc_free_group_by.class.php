...
SCEOT;
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['tot_geral'][1];
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['arr_total']['customers_id'] = $this->array_total_customers_id;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['labels']['current_status_id'] = $Lab_current_status_id; 
       $prep_field['customers_id'] = $Lab_customers_id;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['labels']['customers_id'] = $Lab_customers_id; 
       $prep_field['appointment_start_date'] = $Lab_appointment_start_date;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['labels']['appointment_start_date'] = $Lab_appointment_start_date; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['labels']['lig']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['labels']['lig'] = ""; 
       }
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['labels']['appointment_start_date'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_appointment_start_date'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['labels']['appointment_start_time']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['labels']['appointment_start_time'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_appointment_start_time'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['labels']['customers_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['labels']['customers_id'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_customers_id'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['labels']['total_price']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['labels']['total_price'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_total_price'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['labels']['fld_info']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['labels']['fld_info'] = "INFO"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['labels']['staff_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['labels']['staff_id'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_staff_id'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['labels']['price']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['labels']['price'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_price'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['labels']['additional_charges']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['labels']['additional_charges'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_additional_charges'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['labels']['discount']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['labels']['discount'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_discount'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['labels']['appointment_end_date']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['labels']['appointment_end_date'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_appointment_end_date'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['labels']['appointment_end_time']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['labels']['appointment_end_time'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_appointment_end_time'] . ""; 
       }
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['labels']['appointment_rating']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['labels']['appointment_rating'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_appointment_rating'] . ""; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Arr_parms['current_status_id']['order_datatype'] = 'integer';
       ...
       $Arr_parms['customers_id']['order_datatype'] = 'integer';
       ...
       $Arr_parms['appointment_start_date']['order_datatype'] = 'text';
       ...
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
   ...
   function drawMatrix()
   {
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['doc_word'])
{
      ...
      { 
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['ajax_nav']) {  
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_appointments_staff/grid_appointments_staff_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_cor=AM&nm_res_cons=s&nm_ini_word_res=&nm_all_modules=grid&password=n&origem=res&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_appointments_staff/grid_appointments_staff_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_opc=resumo&nm_cor=PB&nm_res_cons=s&nm_ini_prt_res=&nm_all_modules=grid&password=n&origem=res&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
             $this->nm_btn_exist['groupby'][] = "sel_groupby_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_appointments_staff/grid_appointments_staff_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_appointments_staff/grid_appointments_staff_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
      }
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_appointments_staff']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_appointments_staff_config_pivot.php?nome_apl=grid_appointments_staff&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Gb_Free_cmp']))
      {
   ...
   //---- 
   function adiciona_registro($quebra_current_status_id, $quebra_customers_id, $quebra_appointment_start_date, $quebra_current_status_id_orig, $quebra_customers_id_orig, $quebra_appointment_start_date_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_staff']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->current_status_id, $this->customers_id, $this->appointment_start_date, $this->current_status_id_orig,  $this->customers_id_orig,  $this->appointment_start_date_orig);
            }
   }
//
