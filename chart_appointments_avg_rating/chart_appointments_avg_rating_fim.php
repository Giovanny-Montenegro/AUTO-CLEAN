...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["appointments1_____chart_appointments_avg_rating"]))
   {
      unset($_SESSION['session_sec_aplicacao']["appointments1_____chart_appointments_avg_rating"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_appointments_avg_rating']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['chart_appointments_avg_rating']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_appointments_avg_rating']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['chart_appointments_avg_rating']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['chart_appointments_avg_rating']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>chart_appointments_avg_rating</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['chart_appointments_avg_rating']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['chart_appointments_avg_rating']['embutida_filho'] as $ind => $sc_init)
          {
