<?php
@session_start() ;
$_SESSION['scriptcase']['new_request_catalog']['sc_process_barr'] = true;
require_once('../new_request_catalog/index.php');
unset($_SESSION['scriptcase']['new_request_catalog']['sc_process_barr']);
$ExportCtrl = new new_request_catalog_export_control;
$ExportCtrl->Export_barr();

class new_request_catalog_export_control
{
