...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["appointments1_____new_request_catalog"]))
   {
      unset($_SESSION['session_sec_aplicacao']["appointments1_____new_request_catalog"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['new_request_catalog']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['new_request_catalog']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['new_request_catalog']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['new_request_catalog']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['new_request_catalog']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>new_request_catalog</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['new_request_catalog']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['new_request_catalog']['embutida_filho'] as $ind => $sc_init)
          {
