<?php
@session_start() ;
$_SESSION['scriptcase']['grid_appointments_customer']['sc_process_barr'] = true;
require_once('../grid_appointments_customer/index.php');
unset($_SESSION['scriptcase']['grid_appointments_customer']['sc_process_barr']);
$ExportCtrl = new grid_appointments_customer_export_control;
$ExportCtrl->Export_barr();

class grid_appointments_customer_export_control
{
