...
<?php
   ...
   $Ord_Cmp = new grid_appointments_customer_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_appointments_customer_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_appointments_customer']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_appointments_customer']['ordem_select_orig'] = array();
   }
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['lig'] = "lig";
   }
   else
   {
       $tab_def_campos['lig'] = "";
   }
   $tab_labels["lig"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_customer']['labels']["lig"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_customer']['labels']["lig"] : "";
   $tab_ger_campos['appointments_id'] = "on";
   $tab_def_campos['appointments_id'] = "appointments_id";
   $tab_labels["appointments_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_customer']['labels']["appointments_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_customer']['labels']["appointments_id"] : "" . $this->Nm_lang['lang_appointments_fld_appointments_id'] . "";
   $tab_ger_campos['appointment_start_date'] = "on";
   $tab_def_campos['appointment_start_date'] = "appointment_start_date";
   $tab_labels["appointment_start_date"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_customer']['labels']["appointment_start_date"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_customer']['labels']["appointment_start_date"] : "" . $this->Nm_lang['lang_appointments_fld_appointment_start_date'] . "";
   $tab_ger_campos['appointment_start_time'] = "on";
   $tab_def_campos['appointment_start_time'] = "appointment_start_time";
   $tab_labels["appointment_start_time"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_customer']['labels']["appointment_start_time"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_customer']['labels']["appointment_start_time"] : "" . $this->Nm_lang['lang_appointments_fld_appointment_start_time'] . "";
   $tab_ger_campos['staff_id'] = "on";
   $tab_def_campos['staff_id'] = "staff_id";
   $tab_labels["staff_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_customer']['labels']["staff_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_customer']['labels']["staff_id"] : "" . $this->Nm_lang['lang_appointments_fld_staff_id'] . "";
   $tab_ger_campos['total_price'] = "on";
   $tab_def_campos['total_price'] = "total_price";
   $tab_labels["total_price"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_customer']['labels']["total_price"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_customer']['labels']["total_price"] : "" . $this->Nm_lang['lang_appointments_fld_total_price'] . "";
   $tab_ger_campos['appointment_rating'] = "on";
   $tab_def_campos['appointment_rating'] = "appointment_rating";
   $tab_labels["appointment_rating"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_customer']['labels']["appointment_rating"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_customer']['labels']["appointment_rating"] : "" . $this->Nm_lang['lang_appointments_fld_appointment_rating'] . "";
   $tab_ger_campos['lig'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_customer']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_appointments_customer']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_appointments_customer']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_appointments_customer']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_appointments_customer']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_appointments_customer']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_appointments_customer']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_appointments_customer']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_customer']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_appointments_customer']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_appointments_customer']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_appointments_customer']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_appointments_customer_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_customer']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_appointments_customer']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_customer']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_appointments_customer']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_appointments_customer']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
