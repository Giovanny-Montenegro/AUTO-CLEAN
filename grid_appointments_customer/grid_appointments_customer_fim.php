...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["appointments1_____grid_appointments_customer"]))
   {
      unset($_SESSION['session_sec_aplicacao']["appointments1_____grid_appointments_customer"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_customer']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_appointments_customer']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_customer']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_appointments_customer']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_appointments_customer']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_appointments_customer</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_customer']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_appointments_customer']['embutida_filho'] as $ind => $sc_init)
          {
