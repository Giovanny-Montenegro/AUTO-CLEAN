...
class grid_appointments_customer_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
...
SCEOT;
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_appointments_customer']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_appointments_customer']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['where_resumo'] = "";
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['contr_total_geral'] == "OK")
      {
          $this->array_total_current_status_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['arr_total']['current_status_id'];
      }
      else
      {
          $this->array_total_current_status_id = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['tot_geral'][1];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['arr_total']['current_status_id'] = $this->array_total_current_status_id;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['json_use_label'])
       {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['labels']['lig']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['labels']['lig'] = ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['labels']['appointments_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['labels']['appointments_id'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_appointments_id'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['labels']['appointment_start_date']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['labels']['appointment_start_date'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_appointment_start_date'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['labels']['appointment_start_time']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['labels']['appointment_start_time'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_appointment_start_time'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['labels']['staff_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['labels']['staff_id'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_staff_id'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['labels']['total_price']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['labels']['total_price'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_total_price'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['labels']['fld_info']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['labels']['fld_info'] = "fld_info"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['labels']['appointment_rating']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['labels']['appointment_rating'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_appointment_rating'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['labels']['customers_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['labels']['customers_id'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_customers_id'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['labels']['price']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['labels']['price'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_price'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['labels']['additional_charges']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['labels']['additional_charges'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_additional_charges'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['labels']['discount']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['labels']['discount'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_discount'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['labels']['appointment_end_date']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['labels']['appointment_end_date'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_appointment_end_date'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['labels']['appointment_end_time']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['labels']['appointment_end_time'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_appointment_end_time'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['labels']['current_status_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['labels']['current_status_id'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_current_status_id'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['labels']['appointment_recurrent']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['labels']['appointment_recurrent'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_appointment_recurrent'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['labels']['appointment_period']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['labels']['appointment_period'] = "" . $this->Ini->Nm_lang['lang_appointments_fld_appointment_period'] . ""; 
       }
       //-----
       $this->comp_field_nm = array(
           'current_status_id' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['summarizing_fields_order']['status']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['summarizing_fields_order']['status'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['summarizing_fields_order']['status'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['summarizing_fields_display']['status'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['summarizing_fields_display']['status'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['summarizing_fields_display']['status'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['summarizing_fields_display']['status'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['summarizing_fields_display']['status'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['summarizing_fields_display']['status'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['summarizing_fields_display']['status'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_appointments_customer@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialOrderFA = '';
                       ...
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new grid_appointments_customer_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['doc_word'])
{
      ...
      { 
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['ajax_nav']) {  
...
$nm_saida->saida("    </style>\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_appointments_customer_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_appointments_customer_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_appointments_customer_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_appointments_customer/grid_appointments_customer_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['embutida'])
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_appointments_customer/grid_appointments_customer_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_cor=AM&nm_res_cons=s&nm_ini_word_res=&nm_all_modules=grid&password=n&origem=res&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_appointments_customer/grid_appointments_customer_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_opc=resumo&nm_cor=PB&nm_res_cons=s&nm_ini_prt_res=&nm_all_modules=grid&password=n&origem=res&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_appointments_customer_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_appointments_customer']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_appointments_customer']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_appointments_customer_config_pivot.php?nome_apl=grid_appointments_customer&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("          document.Fres_pdf.action = \"grid_appointments_customer_iframe.php\";\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_appointments_customer_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_appointments_customer/grid_appointments_customer_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $appointments_id = (isset($Busca_temp['appointments_id'])) ? $Busca_temp['appointments_id'] : ""; 
          $tmp_pos = (is_string($appointments_id)) ? strpos($appointments_id, "##@@") : false;
          if ($tmp_pos !== false && !is_array($appointments_id))
          {
              $appointments_id = substr($appointments_id, 0, $tmp_pos);
          }
          $appointments_id_2 = (isset($Busca_temp['appointments_id_input_2'])) ? $Busca_temp['appointments_id_input_2'] : ""; 
          $staff_id = (isset($Busca_temp['staff_id'])) ? $Busca_temp['staff_id'] : ""; 
          $tmp_pos = (is_string($staff_id)) ? strpos($staff_id, "##@@") : false;
          if ($tmp_pos !== false && !is_array($staff_id))
          {
              $staff_id = substr($staff_id, 0, $tmp_pos);
          }
          $staff_id_2 = (isset($Busca_temp['staff_id_input_2'])) ? $Busca_temp['staff_id_input_2'] : ""; 
          $customers_id = (isset($Busca_temp['customers_id'])) ? $Busca_temp['customers_id'] : ""; 
          $tmp_pos = (is_string($customers_id)) ? strpos($customers_id, "##@@") : false;
          if ($tmp_pos !== false && !is_array($customers_id))
          {
              $customers_id = substr($customers_id, 0, $tmp_pos);
          }
          $customers_id_2 = (isset($Busca_temp['customers_id_input_2'])) ? $Busca_temp['customers_id_input_2'] : ""; 
          $price = (isset($Busca_temp['price'])) ? $Busca_temp['price'] : ""; 
          $tmp_pos = (is_string($price)) ? strpos($price, "##@@") : false;
          if ($tmp_pos !== false && !is_array($price))
          {
   ...
   //---- 
   function adiciona_registro($quebra_current_status_id, $quebra_current_status_id_orig)
   {
      //----- current_status_id
      if (!isset($this->array_total_current_status_id[$quebra_current_status_id_orig]))
      {
         ...
         $this->array_total_current_status_id[$quebra_current_status_id_orig][1] = 1;
      ...
      else
      {
         ...
         $this->array_total_current_status_id[$quebra_current_status_id_orig][2]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
       ...
       $this->appointments_id = $Busca_temp['appointments_id']; 
       $this->appointments_id = (isset($Busca_temp['appointments_id'])) ? $Busca_temp['appointments_id'] : ""; 
       $tmp_pos = (is_string($this->appointments_id)) ? strpos($this->appointments_id, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->appointments_id))
       {
       ...
       $appointments_id_2 = (isset($Busca_temp['appointments_id_input_2'])) ? $Busca_temp['appointments_id_input_2'] : ""; 
       $this->appointments_id_2 = $appointments_id_2; 
       $this->staff_id = $Busca_temp['staff_id']; 
       $this->staff_id = (isset($Busca_temp['staff_id'])) ? $Busca_temp['staff_id'] : ""; 
       $tmp_pos = (is_string($this->staff_id)) ? strpos($this->staff_id, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->staff_id))
       {
       ...
       $staff_id_2 = (isset($Busca_temp['staff_id_input_2'])) ? $Busca_temp['staff_id_input_2'] : ""; 
       $this->staff_id_2 = $staff_id_2; 
       $this->customers_id = $Busca_temp['customers_id']; 
       $this->customers_id = (isset($Busca_temp['customers_id'])) ? $Busca_temp['customers_id'] : ""; 
       $tmp_pos = (is_string($this->customers_id)) ? strpos($this->customers_id, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->customers_id))
       {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->appointment_start_date = $rs_res->fields[1] ;  
            $this->appointment_start_time = $rs_res->fields[2] ;  
            $this->staff_id = $rs_res->fields[3] ;  
            $this->total_price = $rs_res->fields[4] ;  
            $this->total_price =  str_replace(",", ".", $this->total_price);
            $this->appointment_rating = $rs_res->fields[5] ;  
            $this->customers_id = $rs_res->fields[6] ;  
            $this->price = $rs_res->fields[7] ;  
            $this->price =  str_replace(",", ".", $this->price);
            $this->additional_charges = $rs_res->fields[8] ;  
            $this->additional_charges =  str_replace(",", ".", $this->additional_charges);
            $this->discount = $rs_res->fields[9] ;  
            $this->discount =  str_replace(",", ".", $this->discount);
            $this->current_status_id = $rs_res->fields[10] ;  
...
$_SESSION['scriptcase']['grid_appointments_customer']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->current_status_id, $this->current_status_id_orig);
            }
   }
//
