...
class grid_appointments_customer_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_appointments_customer.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['rtf_name']);
      }
...
$_SESSION['scriptcase']['grid_appointments_customer']['contr_erro'] = 'off'; 
   ...
   function NM_export_lig()
   {
         ...
         $this->lig = str_replace('<', '&lt;', $this->lig);
         $this->lig = str_replace('>', '&gt;', $this->lig);
         $this->Texto_tag .= "<td>" . $this->lig . "</td>\r\n";
   }
   //----- appointments_id
   ...
   function NM_export_staff_id()
   {
         ...
         $this->look_staff_id = str_replace('<', '&lt;', $this->look_staff_id);
         $this->look_staff_id = str_replace('>', '&gt;', $this->look_staff_id);
         $this->Texto_tag .= "<td>" . $this->look_staff_id . "</td>\r\n";
   }
   //----- total_price
   ...
   function NM_export_appointment_rating()
   {
         ...
         $this->appointment_rating = str_replace('<', '&lt;', $this->appointment_rating);
         $this->appointment_rating = str_replace('>', '&gt;', $this->appointment_rating);
         $this->Texto_tag .= "<td>" . $this->appointment_rating . "</td>\r\n";
   }
   //----- customers_id
   function NM_export_customers_id()
   {
         ...
         $this->customers_id = str_replace('<', '&lt;', $this->customers_id);
         $this->customers_id = str_replace('>', '&gt;', $this->customers_id);
         $this->Texto_tag .= "<td>" . $this->customers_id . "</td>\r\n";
   }
   //----- price
   ...
   function NM_export_additional_charges()
   {
         ...
         $this->additional_charges = str_replace('<', '&lt;', $this->additional_charges);
         $this->additional_charges = str_replace('>', '&gt;', $this->additional_charges);
         $this->Texto_tag .= "<td>" . $this->additional_charges . "</td>\r\n";
   }
   //----- discount
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_appointments_report'] ?> :: RTF</TITLE>
