...
class grid_appointments_customer_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_appointments_customer']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_appointments_customer']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang , $staff_id, $current_status_id;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['where_pesq']; 
      } 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_customer']['contr_total_geral'] = "OK";
   } 

   //-----  current_status_id
   function quebra_current_status_id_status($current_status_id, $arg_sum_current_status_id) 
   {
      global $tot_current_status_id, $staff_id, $current_status_id;
