<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="appointments_type_id_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['appointments_type_id_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_appointments_type"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function scForm_inline_submit(y, z) {
	Nm_Proc_Atualiz = true;
	do_ajax_form_appointments_type_submit_form(y, z);
