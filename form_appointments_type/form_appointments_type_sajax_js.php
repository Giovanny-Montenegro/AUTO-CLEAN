  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_appointments_type" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_appointments_type_form();
	}
...
?>
  ...
  // ---------- Validate appointments_type_id_
  function do_ajax_form_appointments_type_validate_appointments_type_id_(iNumLinha)
  {
    var nomeCampo_appointments_type_id_ = "appointments_type_id_" + iNumLinha;
    var var_appointments_type_id_ = scAjaxGetFieldHidden(nomeCampo_appointments_type_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_type_validate_appointments_type_id_(var_appointments_type_id_, iNumLinha, var_script_case_init, do_ajax_form_appointments_type_validate_appointments_type_id__cb);
  } // do_ajax_form_appointments_type_validate_appointments_type_id_

  function do_ajax_form_appointments_type_validate_appointments_type_id__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "appointments_type_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "appointments_type_id_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "appointments_type_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "appointments_type_id_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_type_validate_appointments_type_id__cb

  // ---------- Validate description_
  function do_ajax_form_appointments_type_validate_description_(iNumLinha)
  {
    var nomeCampo_description_ = "description_" + iNumLinha;
    var var_description_ = scAjaxGetFieldText(nomeCampo_description_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_type_validate_description_(var_description_, iNumLinha, var_script_case_init, do_ajax_form_appointments_type_validate_description__cb);
  } // do_ajax_form_appointments_type_validate_description_

  function do_ajax_form_appointments_type_validate_description__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_type_validate_description__cb

  // ---------- Validate duration_displayed_
  function do_ajax_form_appointments_type_validate_duration_displayed_(iNumLinha)
  {
    var nomeCampo_duration_displayed_ = "duration_displayed_" + iNumLinha;
    var var_duration_displayed_ = scAjaxGetFieldText(nomeCampo_duration_displayed_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_type_validate_duration_displayed_(var_duration_displayed_, iNumLinha, var_script_case_init, do_ajax_form_appointments_type_validate_duration_displayed__cb);
  } // do_ajax_form_appointments_type_validate_duration_displayed_

  function do_ajax_form_appointments_type_validate_duration_displayed__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "duration_displayed_" + iLineNumber;
    }
    else
    {
      sFieldValid = "duration_displayed_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "duration_displayed_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "duration_displayed_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_type_validate_duration_displayed__cb

  // ---------- Validate duration_type_
  function do_ajax_form_appointments_type_validate_duration_type_(iNumLinha)
  {
    var nomeCampo_duration_type_ = "duration_type_" + iNumLinha;
    var var_duration_type_ = scAjaxGetFieldSelect(nomeCampo_duration_type_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_type_validate_duration_type_(var_duration_type_, iNumLinha, var_script_case_init, do_ajax_form_appointments_type_validate_duration_type__cb);
  } // do_ajax_form_appointments_type_validate_duration_type_

  function do_ajax_form_appointments_type_validate_duration_type__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "duration_type_" + iLineNumber;
    }
    else
    {
      sFieldValid = "duration_type_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "duration_type_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "duration_type_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_type_validate_duration_type__cb

  // ---------- Validate duration_
  function do_ajax_form_appointments_type_validate_duration_(iNumLinha)
  {
    var nomeCampo_duration_ = "duration_" + iNumLinha;
    var var_duration_ = scAjaxGetFieldHidden(nomeCampo_duration_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_type_validate_duration_(var_duration_, iNumLinha, var_script_case_init, do_ajax_form_appointments_type_validate_duration__cb);
  } // do_ajax_form_appointments_type_validate_duration_

  function do_ajax_form_appointments_type_validate_duration__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "duration_" + iLineNumber;
    }
    else
    {
      sFieldValid = "duration_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "duration_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "duration_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_type_validate_duration__cb

  // ---------- Validate price_
  function do_ajax_form_appointments_type_validate_price_(iNumLinha)
  {
    var nomeCampo_price_ = "price_" + iNumLinha;
    var var_price_ = scAjaxGetFieldText(nomeCampo_price_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_type_validate_price_(var_price_, iNumLinha, var_script_case_init, do_ajax_form_appointments_type_validate_price__cb);
  } // do_ajax_form_appointments_type_validate_price_

  function do_ajax_form_appointments_type_validate_price__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_type_validate_price__cb

  // ---------- Validate activated_
  function do_ajax_form_appointments_type_validate_activated_(iNumLinha)
  {
    var nomeCampo_activated_ = "activated_" + iNumLinha;
    var var_activated_ = scAjaxGetFieldCheckbox(nomeCampo_activated_, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_type_validate_activated_(var_activated_, iNumLinha, var_script_case_init, do_ajax_form_appointments_type_validate_activated__cb);
  } // do_ajax_form_appointments_type_validate_activated_

  function do_ajax_form_appointments_type_validate_activated__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "activated_" + iLineNumber;
    }
    else
    {
      sFieldValid = "activated_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "activated_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "activated_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_type_validate_activated__cb

  // ---------- Event onchange duration_displayed_
  function do_ajax_form_appointments_type_event_duration_displayed__onchange(iSeqForm)
  {
    var var_duration_type_ = scAjaxGetFieldSelect("duration_type_" + iSeqForm);
    var var_duration_ = scAjaxGetFieldHidden("duration_" + iSeqForm);
    var var_duration_displayed_ = scAjaxGetFieldText("duration_displayed_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_appointments_type_event_duration_displayed__onchange(var_duration_type_, var_duration_, var_duration_displayed_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_appointments_type_event_duration_displayed__onchange_cb);
  } // do_ajax_form_appointments_type_event_duration_displayed__onchange

  function do_ajax_form_appointments_type_event_duration_displayed__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_appointments_type_event_duration_displayed__onchange_cb_after_alert);
  } // do_ajax_form_appointments_type_event_duration_displayed__onchange_cb
  function do_ajax_form_appointments_type_event_duration_displayed__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_appointments_type_event_duration_displayed__onchange_cb_after_alert

  // ---------- Event onchange duration_type_
  function do_ajax_form_appointments_type_event_duration_type__onchange(iSeqForm)
  {
    var var_duration_type_ = scAjaxGetFieldSelect("duration_type_" + iSeqForm);
    var var_duration_ = scAjaxGetFieldHidden("duration_" + iSeqForm);
    var var_duration_displayed_ = scAjaxGetFieldText("duration_displayed_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_appointments_type_event_duration_type__onchange(var_duration_type_, var_duration_, var_duration_displayed_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_appointments_type_event_duration_type__onchange_cb);
  } // do_ajax_form_appointments_type_event_duration_type__onchange

  function do_ajax_form_appointments_type_event_duration_type__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_appointments_type_event_duration_type__onchange_cb_after_alert);
  } // do_ajax_form_appointments_type_event_duration_type__onchange_cb
  function do_ajax_form_appointments_type_event_duration_type__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_appointments_type_event_duration_type__onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_appointments_type_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_appointments_type_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_appointments_type_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_appointments_type_add_new_line_cb);
  } // do_ajax_form_appointments_type_add_new_line

  function do_ajax_form_appointments_type_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_appointments_type_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_appointments_type_backup_line(iNumLinha)
  {
    var var_appointments_type_id_ = scAjaxGetFieldHidden("appointments_type_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_type_backup_line(var_appointments_type_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_appointments_type_backup_line_cb);
  } // do_ajax_form_appointments_type_backup_line

  function do_ajax_form_appointments_type_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_appointments_type_backup_line_cb

  function do_ajax_form_appointments_type_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_appointments_type_cancel_insert

  function do_ajax_form_appointments_type_cancel_update(iSeqVert)
  {
    do_ajax_form_appointments_type_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_appointments_type_cancel_update

  function do_ajax_form_appointments_type_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_appointments_type_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_appointments_type_table_refresh()
  {
    var var_appointments_type_id_ = document.F2.appointments_type_id_.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_appointments_type_table_refresh(var_appointments_type_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_appointments_type_table_refresh_cb);
  } //  do_ajax_form_appointments_type_table_refresh

  function do_ajax_form_appointments_type_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.appointments_type_id_.value = scAjaxGetKeyValue("appointments_type_id_");
    ...
    scAjaxAlert(do_ajax_form_appointments_type_table_refresh_cb_after_alert);
  } // do_ajax_form_appointments_type_table_refresh_cb
  function do_ajax_form_appointments_type_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_appointments_type_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_appointments_type_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_appointments_type_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_duration_displayed_ = scAjaxGetFieldText("duration_displayed_" + iNumLinha);
    var var_duration_type_ = scAjaxGetFieldSelect("duration_type_" + iNumLinha);
    var var_duration_ = scAjaxGetFieldHidden("duration_" + iNumLinha);
    var var_price_ = scAjaxGetFieldText("price_" + iNumLinha);
    var var_activated_ = scAjaxGetFieldCheckbox("activated_" + iNumLinha, ";");
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_appointments_type_submit_form(var_appointments_type_id_, var_description_, var_duration_displayed_, var_duration_type_, var_duration_, var_price_, var_activated_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_appointments_type_submit_form_cb);
  } // do_ajax_form_appointments_type_submit_form

  function do_ajax_form_appointments_type_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("appointments_type_id_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("description_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("duration_displayed_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("duration_type_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("duration_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("price_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("activated_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_appointments_type_submit_form_cb_after_alert);
  } // do_ajax_form_appointments_type_submit_form_cb
  function do_ajax_form_appointments_type_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_appointments_type_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_appointments_type_navigate_form()
  {
    perform_ajax_form_appointments_type_navigate_form();
  }

  function perform_ajax_form_appointments_type_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_appointments_type_cancel_insert(sc_form_appointments_type_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("appointments_type_id_" + iNavForm);
      scAjaxHideErrorDisplay("description_" + iNavForm);
      scAjaxHideErrorDisplay("duration_displayed_" + iNavForm);
      scAjaxHideErrorDisplay("duration_type_" + iNavForm);
      scAjaxHideErrorDisplay("duration_" + iNavForm);
      scAjaxHideErrorDisplay("price_" + iNavForm);
      scAjaxHideErrorDisplay("activated_" + iNavForm);
    }
    var var_appointments_type_id_ = document.F2.appointments_type_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_appointments_type_navigate_form(var_appointments_type_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_appointments_type_navigate_form_cb);
  } // do_ajax_form_appointments_type_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments_type']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_appointments_type_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.appointments_type_id_.value = scAjaxGetKeyValue("appointments_type_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_appointments_type_navigate_form_cb_after_alert);
  } // do_ajax_form_appointments_type_navigate_form_cb
  function do_ajax_form_appointments_type_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_appointments_type_navigate_form_cb_after_alert

    function sc_form_appointments_type_get_last_line_number()
    {
    ...
    } //sc_form_appointments_type_get_last_line_number

  function sc_hide_form_appointments_type_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "appointments_type_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "description_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "duration_displayed_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "duration_type_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "duration_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "price_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "activated_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["appointments_type_id_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_appointments_type_fld_appointments_type_id'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["description_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_appointments_type_fld_description'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["duration_displayed_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_appointments_type_fld_duration_displayed'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["duration_type_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_appointments_type_fld_duration_type'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["duration_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_appointments_type_fld_duration'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["price_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_appointments_type_fld_price'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["activated_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_appointments_type_fld_activated'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["appointments_type_id_"][iNumLinha] = "appointments_type_id_" + iNumLinha;
    ajax_field_mult["description_"][iNumLinha] = "description_" + iNumLinha;
    ajax_field_mult["duration_displayed_"][iNumLinha] = "duration_displayed_" + iNumLinha;
    ajax_field_mult["duration_type_"][iNumLinha] = "duration_type_" + iNumLinha;
    ajax_field_mult["duration_"][iNumLinha] = "duration_" + iNumLinha;
    ajax_field_mult["price_"][iNumLinha] = "price_" + iNumLinha;
    ajax_field_mult["activated_"][iNumLinha] = "activated_" + iNumLinha;
    ajax_field_id["appointments_type_id_" + iNumLinha] = new Array("hidden_field_label_appointments_type_id_", "hidden_field_data_appointments_type_id_" + iNumLinha);
    ajax_field_id["description_" + iNumLinha] = new Array("hidden_field_label_description_", "hidden_field_data_description_" + iNumLinha);
    ajax_field_id["duration_displayed_" + iNumLinha] = new Array("hidden_field_label_duration_displayed_", "hidden_field_data_duration_displayed_" + iNumLinha);
    ajax_field_id["duration_type_" + iNumLinha] = new Array("hidden_field_label_duration_type_", "hidden_field_data_duration_type_" + iNumLinha);
    ajax_field_id["duration_" + iNumLinha] = new Array("hidden_field_label_duration_", "hidden_field_data_duration_" + iNumLinha);
    ajax_field_id["price_" + iNumLinha] = new Array("hidden_field_label_price_", "hidden_field_data_price_" + iNumLinha);
    ajax_field_id["activated_" + iNumLinha] = new Array("hidden_field_label_activated_", "hidden_field_data_activated_" + iNumLinha);
    ajax_error_count["appointments_type_id_" + iNumLinha] = "off";
    ajax_error_count["description_" + iNumLinha] = "off";
    ajax_error_count["duration_displayed_" + iNumLinha] = "off";
    ajax_error_count["duration_type_" + iNumLinha] = "off";
    ajax_error_count["duration_" + iNumLinha] = "off";
    ajax_error_count["price_" + iNumLinha] = "off";
    ajax_error_count["activated_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["appointments_type_id_" + iNumLinha] = "on";
    ajax_read_only["description_" + iNumLinha] = "off";
    ajax_read_only["duration_displayed_" + iNumLinha] = "off";
    ajax_read_only["duration_type_" + iNumLinha] = "off";
    ajax_read_only["duration_" + iNumLinha] = "off";
    ajax_read_only["price_" + iNumLinha] = "off";
    ajax_read_only["activated_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["duration_displayed_" + iNumLinha] = "on";
    ajax_read_only["duration_type_" + iNumLinha] = "on";
    ajax_read_only["duration_" + iNumLinha] = "on";
    ajax_read_only["price_" + iNumLinha] = "on";
    ajax_read_only["activated_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["appointments_type_id_" + iNumLinha] = null;
    ajax_error_list["description_" + iNumLinha] = null;
    ajax_error_list["duration_displayed_" + iNumLinha] = null;
    ajax_error_list["duration_type_" + iNumLinha] = null;
    ajax_error_list["duration_" + iNumLinha] = null;
    ajax_error_list["price_" + iNumLinha] = null;
    ajax_error_list["activated_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "appointments_type_id_": new Array(),
    "description_": new Array(),
    "duration_displayed_": new Array(),
    "duration_type_": new Array(),
    "duration_": new Array(),
    "price_": new Array(),
    "activated_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["appointments_type_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["appointments_type_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["appointments_type_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["appointments_type_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["appointments_type_id_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["duration_displayed_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["duration_displayed_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["duration_displayed_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["duration_displayed_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["duration_displayed_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["duration_type_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["duration_type_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["duration_type_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["duration_type_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["duration_type_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["duration_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["duration_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["duration_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["duration_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["duration_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["activated_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["activated_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["activated_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["activated_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["activated_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['appointments_type_id_'])) ? $this->nmgp_cmp_readonly['appointments_type_id_'] : 'on';
?>
    scAjaxFieldRead("appointments_type_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['duration_displayed_'])) ? $this->nmgp_cmp_readonly['duration_displayed_'] : 'off';
?>
    scAjaxFieldRead("duration_displayed_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['duration_type_'])) ? $this->nmgp_cmp_readonly['duration_type_'] : 'off';
?>
    scAjaxFieldRead("duration_type_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['duration_'])) ? $this->nmgp_cmp_readonly['duration_'] : 'off';
?>
    scAjaxFieldRead("duration_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['activated_'])) ? $this->nmgp_cmp_readonly['activated_'] : 'off';
?>
    scAjaxFieldRead("activated_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("appointments_type_id_" + iSeq, "on");
    scAjaxFieldRead("description_" + iSeq, "on");
    scAjaxFieldRead("duration_displayed_" + iSeq, "on");
    scAjaxFieldRead("duration_type_" + iSeq, "on");
    scAjaxFieldRead("duration_" + iSeq, "on");
    scAjaxFieldRead("price_" + iSeq, "on");
    scAjaxFieldRead("activated_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["appointments_type_id_" + iRow] || "on" == ajax_error_count["description_" + iRow] || "on" == ajax_error_count["duration_displayed_" + iRow] || "on" == ajax_error_count["duration_type_" + iRow] || "on" == ajax_error_count["duration_" + iRow] || "on" == ajax_error_count["price_" + iRow] || "on" == ajax_error_count["activated_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_appointments_type_id_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_description_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_duration_displayed_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_duration_type_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_duration_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_price_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_activated_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["appointments_type_id_" + iRow] && "off" == ajax_error_count["description_" + iRow] && "off" == ajax_error_count["duration_displayed_" + iRow] && "off" == ajax_error_count["duration_type_" + iRow] && "off" == ajax_error_count["duration_" + iRow] && "off" == ajax_error_count["price_" + iRow] && "off" == ajax_error_count["activated_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["appointments_type_id_" + iRow] = "off";
        ajax_error_count["description_" + iRow] = "off";
        ajax_error_count["duration_displayed_" + iRow] = "off";
        ajax_error_count["duration_type_" + iRow] = "off";
        ajax_error_count["duration_" + iRow] = "off";
        ajax_error_count["price_" + iRow] = "off";
        ajax_error_count["activated_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_appointments_type_id_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_description_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_duration_displayed_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_duration_type_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_duration_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_price_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_activated_" + iRow).removeClass("scFormErrorLine");
    }
  }
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("appointments_type_id_" == sIndex)
    {
