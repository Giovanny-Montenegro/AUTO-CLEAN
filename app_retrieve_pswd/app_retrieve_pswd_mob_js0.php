...
function lookup_login(campo)
{
   ...
   jsrsExecute("<?php  echo $this->Ini->path_link . SC_dir_app_name('app_retrieve_pswd_mob')?>/app_retrieve_pswd_mob.php?script_case_init=<?php echo $this->form_encode_input($this->Ini->sc_page); ?>&nmgp_opcao=lookup", recebe_login, "login", dados, false);
}
