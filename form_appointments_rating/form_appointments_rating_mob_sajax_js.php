  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_appointments_rating_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_appointments_rating_mob_form();
	}
...
?>
  ...
  // ---------- Validate appointment_rating
  function do_ajax_form_appointments_rating_mob_validate_appointment_rating()
  {
    var nomeCampo_appointment_rating = "appointment_rating";
    var var_appointment_rating = scAjaxGetFieldRadio(nomeCampo_appointment_rating);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_appointments_rating_mob_validate_appointment_rating(var_appointment_rating, var_script_case_init, do_ajax_form_appointments_rating_mob_validate_appointment_rating_cb);
  } // do_ajax_form_appointments_rating_mob_validate_appointment_rating

  function do_ajax_form_appointments_rating_mob_validate_appointment_rating_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "appointment_rating";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_appointments_rating_mob_validate_appointment_rating_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_appointments_rating_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_appointments_rating_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_appointment_rating = scAjaxGetFieldRadio("appointment_rating");
    ...
    scAjaxProcOn();
    x_ajax_form_appointments_rating_mob_submit_form(var_appointment_rating, var_appointments_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_appointments_rating_mob_submit_form_cb);
  } // do_ajax_form_appointments_rating_mob_submit_form

  function do_ajax_form_appointments_rating_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("appointment_rating");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_appointments_rating_mob_submit_form_cb_after_alert);
  } // do_ajax_form_appointments_rating_mob_submit_form_cb
  function do_ajax_form_appointments_rating_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_appointments_rating_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_appointments_rating_mob_navigate_form()
  {
    perform_ajax_form_appointments_rating_mob_navigate_form();
  }

  function perform_ajax_form_appointments_rating_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_appointments_rating_mob_navigate_form(var_appointments_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_appointments_rating_mob_navigate_form_cb);
  } // do_ajax_form_appointments_rating_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_appointments_rating_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_appointments_rating_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_appointments_rating_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_appointments_rating_mob_navigate_form_cb
  function do_ajax_form_appointments_rating_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_appointments_rating_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_appointments_rating_mob_navigate_form_cb_after_alert

  function sc_hide_form_appointments_rating_mob_form()
  {
  ...
  ajax_field_list[0] = "appointment_rating";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "appointment_rating": {"label": "<?php echo $this->Ini->Nm_lang['lang_appointments_fld_appointment_rating'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "appointment_rating": new Array()
  };
  ajax_field_mult["appointment_rating"][1] = "appointment_rating";

  var ajax_field_id = {
    "appointment_rating": new Array("hidden_field_label_appointment_rating", "hidden_field_data_appointment_rating")
  };

  var ajax_read_only = {
    "appointment_rating": "off"
  };
