...
class grid_unavailable_dates_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_unavailable_dates_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_unavailable_dates_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_unavailable_dates_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_unavailable_dates_id')
      {
          $unavailable_dates_id = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_unavailable_dates_id($unavailable_dates_id);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_unavailable_dates_id($unavailable_dates_id)
   {
      $unavailable_dates_id = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $unavailable_dates_id);
      $unavailable_dates_id = substr($this->Db->qstr($unavailable_dates_id), 1, -1);
            $unavailable_dates_id_look = (is_string($unavailable_dates_id) ? substr($this->Db->qstr($unavailable_dates_id), 1, -1) : $unavailable_dates_id); 
      $nmgp_def_dados = array(); 
      if (isset($this->Ini->nm_bases_postgres) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct unavailable_dates_id from " . $this->Ini->nm_tabela . " where   CAST (unavailable_dates_id AS TEXT)  like '%" . $unavailable_dates_id . "%' order by unavailable_dates_id"; 
      }
      elseif (isset($this->Ini->nm_bases_sybase) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct unavailable_dates_id from " . $this->Ini->nm_tabela . " where   CAST (unavailable_dates_id AS VARCHAR)  like '%" . $unavailable_dates_id . "%' order by unavailable_dates_id"; 
      }
      else
      {
          $nm_comando = "select distinct unavailable_dates_id from " . $this->Ini->nm_tabela . " where  unavailable_dates_id like '%" . $unavailable_dates_id . "%' order by unavailable_dates_id"; 
      }
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_title($title)
   {
      $title = substr($this->Db->qstr($title), 1, -1);
            $title_look = (is_string($title) ? substr($this->Db->qstr($title), 1, -1) : $title); 
      $nmgp_def_dados = array(); 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         $nome_sum = "unavailable_dates.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_unavailable_dates'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_unavailable_dates/grid_unavailable_dates_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_unavailable_dates_ajax_search.js"></script>
 <script type="text/javascript" src="grid_unavailable_dates_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_unavailable_dates_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_unavailable_dates']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_unavailable_dates']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_unavailable_dates_id_cond#NMF#' + search_get_sel_txt('SC_unavailable_dates_id_cond') + '@NMF@';
  str_out += 'SC_unavailable_dates_id#NMF#' + search_get_text('SC_unavailable_dates_id') + '@NMF@';
  str_out += 'id_ac_unavailable_dates_id#NMF#' + search_get_title('select2-id_ac_unavailable_dates_id-container') + '@NMF@';
  str_out += 'SC_unavailable_dates_id_input_2#NMF#' + search_get_text('SC_unavailable_dates_id_input_2') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  ...
  $(".sc-ui-autocomp-unavailable_dates_id").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_unavailable_dates_id",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_unavailable_dates_id").val(e.params.data.id);
  });
 });
</script>
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $start_time_cond, $start_time, $start_time_hor, $start_time_min, $start_time_seg,
             $unavailable_dates_id_cond, $unavailable_dates_id, $unavailable_dates_id_input_2, $unavailable_dates_id_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $start_time_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']['start_time_hor']; 
          $start_time_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']['start_time_min']; 
          $start_time_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']['start_time_seg']; 
          $start_time_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']['start_time_cond']; 
          $unavailable_dates_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']['unavailable_dates_id']; 
          $unavailable_dates_id_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']['unavailable_dates_id_input_2']; 
          $unavailable_dates_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']['unavailable_dates_id_cond']; 
          $title = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']['title']; 
          $title_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']['title_cond']; 
          $start_date_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']['start_date_dia']; 
          $start_date_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']['start_date_mes']; 
          $start_date_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']['start_date_ano']; 
          $start_date_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']['start_date_input_2_dia']; 
          $start_date_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']['start_date_input_2_mes']; 
          $start_date_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']['start_date_input_2_ano']; 
          $start_date_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']['start_date_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']['NM_operador']; 
      } 
      if (!isset($start_time_cond) || empty($start_time_cond))
      {
         $start_time_cond = "eq";
      }
      if (!isset($unavailable_dates_id_cond) || empty($unavailable_dates_id_cond))
      {
         $unavailable_dates_id_cond = "gt";
      }
      ...
      $str_hide_unavailable_dates_id = (in_array($unavailable_dates_id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_display_unavailable_dates_id = ('bw' == $unavailable_dates_id_cond) ? $display_aberto : $display_fechado;
      ...
      {
         $tmp_pos = (is_string($start_time)) ? strpos($start_time, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
      ...
      if (!isset($unavailable_dates_id) || $unavailable_dates_id == "")
      {
          $unavailable_dates_id = "";
      }
      if (isset($unavailable_dates_id) && !empty($unavailable_dates_id))
      {
         $tmp_pos = (is_string($unavailable_dates_id)) ? strpos($unavailable_dates_id, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $unavailable_dates_id = substr($unavailable_dates_id, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = (is_string($title)) ? strpos($title, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
      ...
      {
         $tmp_pos = (is_string($start_date)) ? strpos($start_date, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
...
?>
<?php
   if (is_file("grid_unavailable_dates_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_unavailable_dates']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_unavailable_dates']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_start_time_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['start_time'])) ? $this->New_label['start_time'] : "" . $this->Ini->Nm_lang['lang_unavailable_dates_fld_start_time'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_start_time_cond" name="start_time_cond" onChange="nm_campos_between(document.getElementById('id_vis_start_time'), this, 'start_time')">
       <OPTION value="eq" <?php if ("eq" == $start_time_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $start_time_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $start_time_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $start_time_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
...
?>
        <SPAN id="id_css_start_time"  class="scFilterFieldFontOdd">
 <?php echo $date_format_show ?>         </SPAN>
      ...
      <TD id='SC_unavailable_dates_id_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['unavailable_dates_id'])) ? $this->New_label['unavailable_dates_id'] : "" . $this->Ini->Nm_lang['lang_unavailable_dates_fld_unavailable_dates_id'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_unavailable_dates_id_cond" name="unavailable_dates_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_unavailable_dates_id'), this, 'unavailable_dates_id')">
       <OPTION value="gt" <?php if ("gt" == $unavailable_dates_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $unavailable_dates_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $unavailable_dates_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $unavailable_dates_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_unavailable_dates_id" <?php echo $str_hide_unavailable_dates_id?> valign="top">
 ...
 $nmgp_tab_label .= "unavailable_dates_id?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<?php
      if ($unavailable_dates_id != "")
      {
      $unavailable_dates_id_look = (is_string($unavailable_dates_id) ? substr($this->Db->qstr($unavailable_dates_id), 1, -1) : $unavailable_dates_id); 
      $nmgp_def_dados = array(); 
   if (is_numeric($unavailable_dates_id))
   { 
      if (isset($this->Ini->nm_bases_postgres) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct unavailable_dates_id from " . $this->Ini->nm_tabela . " where unavailable_dates_id = $unavailable_dates_id_look order by unavailable_dates_id"; 
      }
      elseif (isset($this->Ini->nm_bases_sybase) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct unavailable_dates_id from " . $this->Ini->nm_tabela . " where unavailable_dates_id = $unavailable_dates_id_look order by unavailable_dates_id"; 
      ...
      if (isset($nmgp_def_dados[0][$unavailable_dates_id]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$unavailable_dates_id];
      }
      else
      {
            nmgp_Form_Num_Val($unavailable_dates_id, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $unavailable_dates_id;
      }
?>
<INPUT  type="text" id="SC_unavailable_dates_id" name="unavailable_dates_id" value="<?php echo NM_encode_input($unavailable_dates_id) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-unavailable_dates_id" id="id_ac_unavailable_dates_id" name="unavailable_dates_id_autocomp"><?php if ('' !=  $unavailable_dates_id) { ?><option value="<?php echo $unavailable_dates_id ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_unavailable_dates_id"  <?php echo $str_display_unavailable_dates_id; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_unavailable_dates_id_input_2" name="unavailable_dates_id_input_2" value="<?php echo NM_encode_input($unavailable_dates_id_input_2) ?>"  size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_title_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['title'])) ? $this->New_label['title'] : "" . $this->Ini->Nm_lang['lang_unavailable_dates_fld_title'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
...
?>
<INPUT  type="text" id="SC_title" name="title" value="<?php echo NM_encode_input($title) ?>"  size=50 alt="{datatype: 'text', maxLength: 60, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-title" id="id_ac_title" name="title_autocomp"><?php if ('' !=  $title) { ?><option value="<?php echo $title ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_start_date_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['start_date'])) ? $this->New_label['start_date'] : "" . $this->Ini->Nm_lang['lang_unavailable_dates_fld_start_date'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_start_date_cond" name="start_date_cond" onChange="nm_campos_between(document.getElementById('id_vis_start_date'), this, 'start_date')">
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_start_date_dia" name="start_date_dia" value="<?php echo NM_encode_input($start_date_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_start_date_mes" name="start_date_mes" value="<?php echo NM_encode_input($start_date_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_start_date_ano" name="start_date_ano" value="<?php echo NM_encode_input($start_date_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
?>
        <SPAN id="id_css_start_date"  class="scFilterFieldFontEven">
 <?php echo $date_format_show ?>         </SPAN>
                 </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_start_date"  <?php echo $str_display_start_date; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>
         <BR>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_start_date_input_2_dia" name="start_date_input_2_dia" value="<?php echo NM_encode_input($start_date_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_start_date_input_2_mes" name="start_date_input_2_mes" value="<?php echo NM_encode_input($start_date_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_start_date_input_2_ano" name="start_date_input_2_ano" value="<?php echo NM_encode_input($start_date_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.unavailable_dates_id_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_unavailable_dates_id'), document.F1.unavailable_dates_id_cond, 'unavailable_dates_id');
   document.F1.unavailable_dates_id.value = "";
   document.F1.unavailable_dates_id_autocomp.value = "";
   $('#select2-id_ac_unavailable_dates_id-container').html('<?php echo $this->Val_init_unavailable_dates_id['desc'] ?>');;
   document.F1.unavailable_dates_id_input_2.value = "";
   ...
   $('#select2-id_ac_title-container').html('<?php echo $this->Val_init_title['desc'] ?>');;
 ...
 {
    $('#SC_start_date_dia').bind('change', function() {sc_grid_unavailable_dates_valida_dia(this)});
    $('#SC_start_date_input_2_dia').bind('change', function() {sc_grid_unavailable_dates_valida_dia(this)});
    $('#SC_start_date_input_2_mes').bind('change', function() {sc_grid_unavailable_dates_valida_mes(this)});
    $('#SC_start_date_mes').bind('change', function() {sc_grid_unavailable_dates_valida_mes(this)});
    $('#SC_start_time_hor').bind('change', function() {sc_grid_unavailable_dates_valida_hora(this)});
    $('#SC_start_time_min').bind('change', function() {sc_grid_unavailable_dates_valida_min(this)});
    $('#SC_start_time_seg').bind('change', function() {sc_grid_unavailable_dates_valida_seg(this)});
 }
 function sc_grid_unavailable_dates_valida_hora(obj)
 {
 ...
 function sc_grid_unavailable_dates_valida_min(obj)
 {
 ...
 function sc_grid_unavailable_dates_valida_seg(obj)
 {
     if (obj.value != "" && (obj.value < 0 || obj.value > 59))
     {
 ...
 function sc_grid_unavailable_dates_valida_dia(obj)
 {
 ...
 function sc_grid_unavailable_dates_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "appointments1/grid_unavailable_dates";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_unavailable_dates/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_unavailable_dates_id_cond'] = 'cond';
      $tp_fields['SC_unavailable_dates_id'] = 'text_aut';
      $tp_fields['id_ac_unavailable_dates_id'] = 'select2_aut';
      $tp_fields['SC_unavailable_dates_id_input_2'] = 'text';
   ...
   {
      global $start_time_cond, $start_time, $start_time_hor, $start_time_min, $start_time_seg,
             $unavailable_dates_id_cond, $unavailable_dates_id, $unavailable_dates_id_input_2, $unavailable_dates_id_autocomp,
             $title_cond, $title, $title_autocomp,
             $start_date_cond, $start_date, $start_date_dia, $start_date_mes, $start_date_ano, $start_date_input_2_dia, $start_date_input_2_mes, $start_date_input_2_ano, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($unavailable_dates_id_autocomp) && empty($unavailable_dates_id))
      {
          $unavailable_dates_id = $unavailable_dates_id_autocomp;
      }
      ...
      $unavailable_dates_id_cond_salva = $unavailable_dates_id_cond; 
      if (!isset($unavailable_dates_id_input_2) || $unavailable_dates_id_input_2 == "")
      {
          $unavailable_dates_id_input_2 = $unavailable_dates_id;
      }
      ...
      if ($unavailable_dates_id_cond != "in")
      {
          nm_limpa_numero($unavailable_dates_id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($unavailable_dates_id_cond != "in")
      {
          nm_limpa_numero($unavailable_dates_id_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']['start_time_hor'] = $start_time_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']['start_time_min'] = $start_time_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']['start_time_seg'] = $start_time_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']['start_time_cond'] = $start_time_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']['unavailable_dates_id'] = $unavailable_dates_id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']['unavailable_dates_id_input_2'] = $unavailable_dates_id_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']['unavailable_dates_id_cond'] = $unavailable_dates_id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']['title'] = $title; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']['title_cond'] = $title_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']['start_date_dia'] = $start_date_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']['start_date_mes'] = $start_date_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']['start_date_ano'] = $start_date_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']['start_date_input_2_dia'] = $start_date_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']['start_date_input_2_mes'] = $start_date_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']['start_date_input_2_ano'] = $start_date_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']['start_date_cond'] = $start_date_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca'] = $Temp_Busca;
      }
      if ($unavailable_dates_id_cond != "in" && $unavailable_dates_id_cond != "bw" && !empty($unavailable_dates_id) && !is_numeric($unavailable_dates_id))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : " . $this->Ini->Nm_lang['lang_unavailable_dates_fld_unavailable_dates_id'] . "";
      }
      if ($unavailable_dates_id_cond == "bw" && ((!empty($unavailable_dates_id) && !is_numeric($unavailable_dates_id)) || (!empty($unavailable_dates_id_input_2) && !is_numeric($unavailable_dates_id_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : " . $this->Ini->Nm_lang['lang_unavailable_dates_fld_unavailable_dates_id'] . "";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['unavailable_dates_id'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['unavailable_dates_id'] = $cmp1;
      }
      else
      {
          $cmp1 = $unavailable_dates_id;
      ...
      $Conteudo = $unavailable_dates_id_input_2;
      if (strtoupper($unavailable_dates_id_cond) != "II" && strtoupper($unavailable_dates_id_cond) != "QP" && strtoupper($unavailable_dates_id_cond) != "NP" && strtoupper($unavailable_dates_id_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['unavailable_dates_id_input_2'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($title != '') {
      $title_look = (is_string($title) ? substr($this->Db->qstr($title), 1, -1) : $title); 
      $nmgp_def_dados = array(); 
      ...
      if ($start_time_cond != "bi_TP")
      {
          ...
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "HH", "TIME", $start_time_cond, "", "hora");
          $start_time = $val[0];
          $this->cmp_formatado['start_time'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']['start_time'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['start_time'], "HH:II:SS");
          $this->cmp_formatado['start_time'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("HH", "his"));
          if ($start_time_cond == "BW")
          {
              $start_time_input_2     = $val[1];
              $this->cmp_formatado['start_time_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']['start_time_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['start_time_input_2'], "HH:II:SS");
              $this->cmp_formatado['start_time_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("HH", "his"));
          }
          if (!empty($Dtxt) || $start_time_cond == "NU" || $start_time_cond == "NN"|| $start_time_cond == "EP"|| $start_time_cond == "NE")
          {
              $this->monta_condicao("start_time", $start_time_cond, $start_time, $start_time_input_2, 'start_time', 'TIME');
          }
      }

      //----- $unavailable_dates_id
      $this->Date_part = false;
      if (isset($unavailable_dates_id) || $unavailable_dates_id_cond == "nu" || $unavailable_dates_id_cond == "nn" || $unavailable_dates_id_cond == "ep" || $unavailable_dates_id_cond == "ne")
      {
         $this->monta_condicao("unavailable_dates_id", $unavailable_dates_id_cond, $unavailable_dates_id, $unavailable_dates_id_input_2, "unavailable_dates_id", "INT", false);
      }
      ...
      {
         $this->monta_condicao("title", $title_cond, $title, "", "title", "VARCHAR", false);
      }
      ...
      if ($start_date_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']['start_date'] = $val[0];
          ...
          if ($start_date_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']['start_date_input_2'] = $val[1];
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_unavailable_dates']['cond_pesq'] .= $this->NM_operador;
