...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["appointments1_____grid_unavailable_dates"]))
   {
      unset($_SESSION['session_sec_aplicacao']["appointments1_____grid_unavailable_dates"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_unavailable_dates'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_unavailable_dates']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_unavailable_dates']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_unavailable_dates']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_unavailable_dates']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_unavailable_dates']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_unavailable_dates</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_unavailable_dates']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_unavailable_dates']['embutida_filho'] as $ind => $sc_init)
          {
