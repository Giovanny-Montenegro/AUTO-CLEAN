...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "start_date";$Nm_datas[] = "start_time";$Nm_datas[] = "end_date";$Nm_datas[] = "end_time";$Nm_numeric[] = "unavailable_dates_id";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_start_time_cond" name="start_time_cond" onChange="nm_campos_between(document.getElementById('id_vis_start_time'), this, 'start_time')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_unavailable_dates_id_cond" name="unavailable_dates_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_unavailable_dates_id'), this, 'unavailable_dates_id')">
      ...
      <br><span id="id_hide_unavailable_dates_id"  <?php echo $str_hide_unavailable_dates_id?>><?php
...
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-unavailable_dates_id" id="id_ac_unavailable_dates_id" name="unavailable_dates_id_autocomp"><?php if ('' !=  $unavailable_dates_id) { ?><option value="<?php echo $unavailable_dates_id ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_unavailable_dates_id"  <?php echo $str_display_unavailable_dates_id; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_unavailable_dates_id_input_2" name="unavailable_dates_id_input_2" value="<?php echo NM_encode_input($unavailable_dates_id_input_2) ?>"  size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectEven">         </SPAN>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_start_date_cond" name="start_date_cond" onChange="nm_campos_between(document.getElementById('id_vis_start_date'), this, 'start_date')">
...
?>
 ...
 <br><?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_start_date"  <?php echo $str_display_start_date; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?> 
         <BR>
