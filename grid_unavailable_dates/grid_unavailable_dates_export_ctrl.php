<?php
@session_start() ;
$_SESSION['scriptcase']['grid_unavailable_dates']['sc_process_barr'] = true;
require_once('../grid_unavailable_dates/index.php');
unset($_SESSION['scriptcase']['grid_unavailable_dates']['sc_process_barr']);
$ExportCtrl = new grid_unavailable_dates_export_control;
$ExportCtrl->Export_barr();

class grid_unavailable_dates_export_control
{
