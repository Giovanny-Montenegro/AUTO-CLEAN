...
<?php
   ...
   $Ord_Cmp = new grid_unavailable_dates_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_unavailable_dates_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_unavailable_dates']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_unavailable_dates']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["title"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_unavailable_dates']['labels']["title"])) ? $_SESSION['sc_session'][$sc_init]['grid_unavailable_dates']['labels']["title"] : "" . $this->Nm_lang['lang_unavailable_dates_fld_title'] . "";
   $tab_ger_campos['start_date'] = "on";
   $tab_def_campos['start_date'] = "start_date";
   $tab_labels["start_date"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_unavailable_dates']['labels']["start_date"])) ? $_SESSION['sc_session'][$sc_init]['grid_unavailable_dates']['labels']["start_date"] : "" . $this->Nm_lang['lang_unavailable_dates_fld_start_date'] . "";
   $tab_ger_campos['start_time'] = "on";
   $tab_def_campos['start_time'] = "start_time";
   $tab_labels["start_time"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_unavailable_dates']['labels']["start_time"])) ? $_SESSION['sc_session'][$sc_init]['grid_unavailable_dates']['labels']["start_time"] : "" . $this->Nm_lang['lang_unavailable_dates_fld_start_time'] . "";
   $tab_ger_campos['end_date'] = "on";
   $tab_def_campos['end_date'] = "end_date";
   $tab_labels["end_date"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_unavailable_dates']['labels']["end_date"])) ? $_SESSION['sc_session'][$sc_init]['grid_unavailable_dates']['labels']["end_date"] : "" . $this->Nm_lang['lang_unavailable_dates_fld_end_date'] . "";
   $tab_ger_campos['end_time'] = "on";
   $tab_def_campos['end_time'] = "end_time";
   $tab_labels["end_time"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_unavailable_dates']['labels']["end_time"])) ? $_SESSION['sc_session'][$sc_init]['grid_unavailable_dates']['labels']["end_time"] : "" . $this->Nm_lang['lang_unavailable_dates_fld_end_time'] . "";
   $tab_ger_campos['yearly'] = "on";
   $tab_def_campos['yearly'] = "yearly";
   $tab_labels["yearly"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_unavailable_dates']['labels']["yearly"])) ? $_SESSION['sc_session'][$sc_init]['grid_unavailable_dates']['labels']["yearly"] : "" . $this->Nm_lang['lang_unavailable_dates_fld_yearly'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_unavailable_dates']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_unavailable_dates']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_unavailable_dates']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_unavailable_dates']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_unavailable_dates']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_unavailable_dates']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_unavailable_dates']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_unavailable_dates']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_unavailable_dates']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_unavailable_dates']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_unavailable_dates']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_unavailable_dates']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_unavailable_dates_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_unavailable_dates']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_unavailable_dates']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_unavailable_dates']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_unavailable_dates']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_unavailable_dates']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
