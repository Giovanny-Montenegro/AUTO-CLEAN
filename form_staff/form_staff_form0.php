...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_staff']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_staff']['run_iframe']) ? 'margin: 2px;' : '';
...
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_staff_id_label" id="hidden_field_label_staff_id" style="<?php echo $sStyleHidden_staff_id; ?>"><span id="id_label_staff_id"><?php echo $this->nm_new_label['staff_id']; ?></span></TD>
    <TD class="scFormDataOdd css_staff_id_line" id="hidden_field_data_staff_id" style="<?php echo $sStyleHidden_staff_id; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_staff_id_line" style="vertical-align: top;padding: 0px"><span id="id_read_on_staff_id" class="css_staff_id_line" style="<?php echo $sStyleReadLab_staff_id; ?>"><?php echo $this->form_format_readonly("staff_id", $this->form_encode_input($this->staff_id)); ?></span><span id="id_read_off_staff_id" class="css_read_off_staff_id" style="<?php echo $sStyleReadInp_staff_id; ?>"><input type="hidden" name="staff_id" value="<?php echo $this->form_encode_input($staff_id) . "\">"?><span id="id_ajax_label_staff_id"><?php echo nl2br($staff_id); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_staff_name_label" id="hidden_field_label_staff_name" style="<?php echo $sStyleHidden_staff_name; ?>"><span id="id_label_staff_name"><?php echo $this->nm_new_label['staff_name']; ?></span></TD>
    <TD class="scFormDataOdd css_staff_name_line" id="hidden_field_data_staff_name" style="<?php echo $sStyleHidden_staff_name; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_staff_name_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_staff_email_label" id="hidden_field_label_staff_email" style="<?php echo $sStyleHidden_staff_email; ?>"><span id="id_label_staff_email"><?php echo $this->nm_new_label['staff_email']; ?></span></TD>
    <TD class="scFormDataOdd css_staff_email_line" id="hidden_field_data_staff_email" style="<?php echo $sStyleHidden_staff_email; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_staff_email_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_staff_phone_label" id="hidden_field_label_staff_phone" style="<?php echo $sStyleHidden_staff_phone; ?>"><span id="id_label_staff_phone"><?php echo $this->nm_new_label['staff_phone']; ?></span></TD>
    <TD class="scFormDataOdd css_staff_phone_line" id="hidden_field_data_staff_phone" style="<?php echo $sStyleHidden_staff_phone; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_staff_phone_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_sec_users_login_label" id="hidden_field_label_sec_users_login" style="<?php echo $sStyleHidden_sec_users_login; ?>"><span id="id_label_sec_users_login"><?php echo $this->nm_new_label['sec_users_login']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_staff']['php_cmp_required']['sec_users_login']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_staff']['php_cmp_required']['sec_users_login'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_staff']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_worktime'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_staff']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_worktime'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_staff']['form_staff_worktime_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_staff']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_worktime'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_staff']['form_staff_worktime_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_staff']['form_staff_worktime_script_case_init'] ]['form_staff_worktime']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_staff']['form_staff_worktime_script_case_init'] ]['form_staff_worktime']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_staff']['form_staff_worktime_script_case_init'] ]['form_staff_worktime']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_staff']['form_staff_worktime_script_case_init'] ]['form_staff_worktime']['embutida_multi'] = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_staff']['form_staff_worktime_script_case_init'] ]['form_staff_worktime']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_staff']['form_staff_worktime_script_case_init'] ]['form_staff_worktime']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_staff']['form_staff_worktime_script_case_init'] ]['form_staff_worktime']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_staff']['form_staff_worktime_script_case_init'] ]['form_staff_worktime']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_staff']['form_staff_worktime_script_case_init'] ]['form_staff_worktime']['embutida_liga_grid_edit'] = '';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_staff']['form_staff_worktime_script_case_init'] ]['form_staff_worktime']['embutida_liga_grid_edit_link'] = '';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_staff']['form_staff_worktime_script_case_init'] ]['form_staff_worktime']['embutida_liga_qtd_reg'] = '7';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_staff']['form_staff_worktime_script_case_init'] ]['form_staff_worktime']['embutida_liga_tp_pag'] = 'parcial';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_staff']['form_staff_worktime_script_case_init'] ]['form_staff_worktime']['embutida_parms'] = "var_staff_id*scin" . $this->nmgp_dados_form['staff_id'] . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_staff']['form_staff_worktime_script_case_init'] ]['form_staff']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_staff_empty.htm' : $this->Ini->link_form_staff_worktime_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y';
if (isset($this->Ini->sc_lig_target['C_@scinf_worktime']) && 'nmsc_iframe_liga_form_staff_worktime' != $this->Ini->sc_lig_target['C_@scinf_worktime'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_staff']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_worktime'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_staff']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_staff']['form_staff_worktime_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_staff_worktime"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="100%" name="nmsc_iframe_liga_form_staff_worktime"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
