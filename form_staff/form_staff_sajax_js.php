...
?>
  ...
  // ---------- Validate staff_id
  function do_ajax_form_staff_validate_staff_id()
  {
    var nomeCampo_staff_id = "staff_id";
    var var_staff_id = scAjaxGetFieldHidden(nomeCampo_staff_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_staff_validate_staff_id(var_staff_id, var_script_case_init, do_ajax_form_staff_validate_staff_id_cb);
  } // do_ajax_form_staff_validate_staff_id

  function do_ajax_form_staff_validate_staff_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_staff_validate_staff_id_cb

  // ---------- Validate staff_name
  function do_ajax_form_staff_validate_staff_name()
  {
    var nomeCampo_staff_name = "staff_name";
    var var_staff_name = scAjaxGetFieldText(nomeCampo_staff_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_staff_validate_staff_name(var_staff_name, var_script_case_init, do_ajax_form_staff_validate_staff_name_cb);
  } // do_ajax_form_staff_validate_staff_name

  function do_ajax_form_staff_validate_staff_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_staff_validate_staff_name_cb

  // ---------- Validate staff_email
  function do_ajax_form_staff_validate_staff_email()
  {
    var nomeCampo_staff_email = "staff_email";
    var var_staff_email = scAjaxGetFieldText(nomeCampo_staff_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_staff_validate_staff_email(var_staff_email, var_script_case_init, do_ajax_form_staff_validate_staff_email_cb);
  } // do_ajax_form_staff_validate_staff_email

  function do_ajax_form_staff_validate_staff_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_staff_validate_staff_email_cb

  // ---------- Validate staff_phone
  function do_ajax_form_staff_validate_staff_phone()
  {
    var nomeCampo_staff_phone = "staff_phone";
    var var_staff_phone = scAjaxGetFieldText(nomeCampo_staff_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_staff_validate_staff_phone(var_staff_phone, var_script_case_init, do_ajax_form_staff_validate_staff_phone_cb);
  } // do_ajax_form_staff_validate_staff_phone

  function do_ajax_form_staff_validate_staff_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_staff_validate_staff_phone_cb

  // ---------- Validate sec_users_login
  function do_ajax_form_staff_validate_sec_users_login()
  {
    var nomeCampo_sec_users_login = "sec_users_login";
    var var_sec_users_login = scAjaxGetFieldText(nomeCampo_sec_users_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_staff_validate_sec_users_login(var_sec_users_login, var_script_case_init, do_ajax_form_staff_validate_sec_users_login_cb);
  } // do_ajax_form_staff_validate_sec_users_login

  function do_ajax_form_staff_validate_sec_users_login_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_staff_validate_sec_users_login_cb

  // ---------- Validate pswd
  function do_ajax_form_staff_validate_pswd()
  {
    var nomeCampo_pswd = "pswd";
    var var_pswd = scAjaxGetFieldText(nomeCampo_pswd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_staff_validate_pswd(var_pswd, var_script_case_init, do_ajax_form_staff_validate_pswd_cb);
  } // do_ajax_form_staff_validate_pswd

  function do_ajax_form_staff_validate_pswd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pswd";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_staff_validate_pswd_cb

  // ---------- Validate confirm_pswd
  function do_ajax_form_staff_validate_confirm_pswd()
  {
    var nomeCampo_confirm_pswd = "confirm_pswd";
    var var_confirm_pswd = scAjaxGetFieldText(nomeCampo_confirm_pswd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_staff_validate_confirm_pswd(var_confirm_pswd, var_script_case_init, do_ajax_form_staff_validate_confirm_pswd_cb);
  } // do_ajax_form_staff_validate_confirm_pswd

  function do_ajax_form_staff_validate_confirm_pswd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_staff_validate_confirm_pswd_cb

  // ---------- Validate worktime
  function do_ajax_form_staff_validate_worktime()
  {
    var nomeCampo_worktime = "worktime";
    var var_worktime = scAjaxGetFieldText(nomeCampo_worktime);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_staff_validate_worktime(var_worktime, var_script_case_init, do_ajax_form_staff_validate_worktime_cb);
  } // do_ajax_form_staff_validate_worktime

  function do_ajax_form_staff_validate_worktime_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_staff_validate_worktime_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_staff_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_staff_submit_form(var_staff_id, var_staff_name, var_staff_email, var_staff_phone, var_sec_users_login, var_pswd, var_confirm_pswd, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_staff_submit_form_cb);
...
?>
  ...
  var scStatusDetail = {};
  scStatusDetail["form_staff_worktime"] = "off";
  ...
  function perform_ajax_form_staff_navigate_form()
  {
    ...
    scAjaxProcOn();
    scStatusDetail["form_staff_worktime"] = "on";
    x_ajax_form_staff_navigate_form(var_staff_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_staff_navigate_form_cb);
...
?>
  function do_ajax_form_staff_navigate_form_cb(sResp)
  {
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_staff_worktime"] && "nmsc_iframe_liga_form_staff_worktime" != scMasterDetailIframe["nmsc_iframe_liga_form_staff_worktime"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_staff_worktime"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_staff_worktime').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_staff_worktime').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_staff_worktime').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
...
?>
  ...
  {
    if ("off" == scStatusDetail["form_staff_worktime"])
    {
      return true;
    }
    return false;
