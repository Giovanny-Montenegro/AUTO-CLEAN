...
?>
  ...
  // ---------- Validate staff_id
  function do_ajax_form_staff_mob_validate_staff_id()
  {
    var nomeCampo_staff_id = "staff_id";
    var var_staff_id = scAjaxGetFieldHidden(nomeCampo_staff_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_staff_mob_validate_staff_id(var_staff_id, var_script_case_init, do_ajax_form_staff_mob_validate_staff_id_cb);
  } // do_ajax_form_staff_mob_validate_staff_id

  function do_ajax_form_staff_mob_validate_staff_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_staff_mob_validate_staff_id_cb

  // ---------- Validate staff_name
  function do_ajax_form_staff_mob_validate_staff_name()
  {
    var nomeCampo_staff_name = "staff_name";
    var var_staff_name = scAjaxGetFieldText(nomeCampo_staff_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_staff_mob_validate_staff_name(var_staff_name, var_script_case_init, do_ajax_form_staff_mob_validate_staff_name_cb);
  } // do_ajax_form_staff_mob_validate_staff_name

  function do_ajax_form_staff_mob_validate_staff_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "staff_name";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_staff_mob_validate_staff_name_cb

  // ---------- Validate staff_email
  function do_ajax_form_staff_mob_validate_staff_email()
  {
    var nomeCampo_staff_email = "staff_email";
    var var_staff_email = scAjaxGetFieldText(nomeCampo_staff_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_staff_mob_validate_staff_email(var_staff_email, var_script_case_init, do_ajax_form_staff_mob_validate_staff_email_cb);
  } // do_ajax_form_staff_mob_validate_staff_email

  function do_ajax_form_staff_mob_validate_staff_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "staff_email";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_staff_mob_validate_staff_email_cb

  // ---------- Validate staff_phone
  function do_ajax_form_staff_mob_validate_staff_phone()
  {
    var nomeCampo_staff_phone = "staff_phone";
    var var_staff_phone = scAjaxGetFieldText(nomeCampo_staff_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_staff_mob_validate_staff_phone(var_staff_phone, var_script_case_init, do_ajax_form_staff_mob_validate_staff_phone_cb);
  } // do_ajax_form_staff_mob_validate_staff_phone

  function do_ajax_form_staff_mob_validate_staff_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "staff_phone";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_staff_mob_validate_staff_phone_cb

  // ---------- Validate sec_users_login
  function do_ajax_form_staff_mob_validate_sec_users_login()
  {
    var nomeCampo_sec_users_login = "sec_users_login";
    var var_sec_users_login = scAjaxGetFieldText(nomeCampo_sec_users_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_staff_mob_validate_sec_users_login(var_sec_users_login, var_script_case_init, do_ajax_form_staff_mob_validate_sec_users_login_cb);
  } // do_ajax_form_staff_mob_validate_sec_users_login

  function do_ajax_form_staff_mob_validate_sec_users_login_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_staff_mob_validate_sec_users_login_cb

  // ---------- Validate pswd
  function do_ajax_form_staff_mob_validate_pswd()
  {
    var nomeCampo_pswd = "pswd";
    var var_pswd = scAjaxGetFieldText(nomeCampo_pswd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_staff_mob_validate_pswd(var_pswd, var_script_case_init, do_ajax_form_staff_mob_validate_pswd_cb);
  } // do_ajax_form_staff_mob_validate_pswd

  function do_ajax_form_staff_mob_validate_pswd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pswd";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_staff_mob_validate_pswd_cb

  // ---------- Validate confirm_pswd
  function do_ajax_form_staff_mob_validate_confirm_pswd()
  {
    var nomeCampo_confirm_pswd = "confirm_pswd";
    var var_confirm_pswd = scAjaxGetFieldText(nomeCampo_confirm_pswd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_staff_mob_validate_confirm_pswd(var_confirm_pswd, var_script_case_init, do_ajax_form_staff_mob_validate_confirm_pswd_cb);
  } // do_ajax_form_staff_mob_validate_confirm_pswd

  function do_ajax_form_staff_mob_validate_confirm_pswd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_staff_mob_validate_confirm_pswd_cb

  // ---------- Validate worktime
  function do_ajax_form_staff_mob_validate_worktime()
  {
    var nomeCampo_worktime = "worktime";
    var var_worktime = scAjaxGetFieldText(nomeCampo_worktime);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_staff_mob_validate_worktime(var_worktime, var_script_case_init, do_ajax_form_staff_mob_validate_worktime_cb);
  } // do_ajax_form_staff_mob_validate_worktime

  function do_ajax_form_staff_mob_validate_worktime_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "worktime";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_staff_mob_validate_worktime_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_staff_mob_submit_form()
  {
    ...
    scAjaxHideMessage();
    var var_staff_id = scAjaxGetFieldHidden("staff_id");
    var var_staff_name = scAjaxGetFieldText("staff_name");
    var var_staff_email = scAjaxGetFieldText("staff_email");
    var var_staff_phone = scAjaxGetFieldText("staff_phone");
    ...
    scAjaxProcOn();
    x_ajax_form_staff_mob_submit_form(var_staff_id, var_staff_name, var_staff_email, var_staff_phone, var_sec_users_login, var_pswd, var_confirm_pswd, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_staff_mob_submit_form_cb);
  ...
  function do_ajax_form_staff_mob_submit_form_cb(sResp)
  {
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("staff_name");
      scAjaxHideErrorDisplay("staff_email");
      scAjaxHideErrorDisplay("staff_phone");
      scAjaxHideErrorDisplay("sec_users_login");
      scAjaxHideErrorDisplay("pswd");
      scAjaxHideErrorDisplay("confirm_pswd");
      scAjaxHideErrorDisplay("worktime");
      scLigEditLookupCall();
<?php
...
?>
  ...
  var scStatusDetail = {};
  scStatusDetail["form_staff_worktime_mob"] = "off";
  ...
  function perform_ajax_form_staff_mob_navigate_form()
  {
    ...
    scAjaxHideErrorDisplay("confirm_pswd");
    scAjaxHideErrorDisplay("worktime");
    var var_staff_id = document.F2.staff_id.value;
    ...
    scAjaxProcOn();
    scStatusDetail["form_staff_worktime_mob"] = "on";
    x_ajax_form_staff_mob_navigate_form(var_staff_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_staff_mob_navigate_form_cb);
...
?>
  function do_ajax_form_staff_mob_navigate_form_cb(sResp)
  {
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.staff_id.value = scAjaxGetKeyValue("staff_id");
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_staff_worktime_mob"] && "nmsc_iframe_liga_form_staff_worktime_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_staff_worktime_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_staff_worktime_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_staff_worktime_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_staff_worktime_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_staff_worktime_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
...
?>
  ...
  {
    if ("off" == scStatusDetail["form_staff_worktime_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[1] = "staff_name";
  ajax_field_list[2] = "staff_email";
  ajax_field_list[3] = "staff_phone";
  ajax_field_list[4] = "sec_users_login";
  ajax_field_list[5] = "pswd";
  ajax_field_list[6] = "confirm_pswd";
  ajax_field_list[7] = "worktime";
  ...
  var ajax_error_list = {
    "staff_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_staff_fld_staff_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "staff_name": {"label": "<?php echo $this->Ini->Nm_lang['lang_staff_fld_staff_name'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "staff_email": {"label": "<?php echo $this->Ini->Nm_lang['lang_staff_fld_staff_email'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "staff_phone": {"label": "<?php echo $this->Ini->Nm_lang['lang_staff_fld_staff_phone'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sec_users_login": {"label": "<?php echo $this->Ini->Nm_lang['lang_staff_fld_sec_users_login'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "worktime": {"label": "worktime", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "staff_id": new Array(),
    "staff_name": new Array(),
    "staff_email": new Array(),
    "staff_phone": new Array(),
  ...
  ajax_field_mult["staff_name"][1] = "staff_name";
  ajax_field_mult["staff_email"][1] = "staff_email";
  ajax_field_mult["staff_phone"][1] = "staff_phone";
  ajax_field_mult["sec_users_login"][1] = "sec_users_login";
  ajax_field_mult["pswd"][1] = "pswd";
  ajax_field_mult["confirm_pswd"][1] = "confirm_pswd";
  ajax_field_mult["worktime"][1] = "worktime";

  var ajax_field_id = {
    "staff_id": new Array("hidden_field_label_staff_id", "hidden_field_data_staff_id"),
    "staff_name": new Array("hidden_field_label_staff_name", "hidden_field_data_staff_name"),
    "staff_email": new Array("hidden_field_label_staff_email", "hidden_field_data_staff_email"),
    "staff_phone": new Array("hidden_field_label_staff_phone", "hidden_field_data_staff_phone"),
    ...
    "worktime": new Array("hidden_field_label_worktime", "hidden_field_data_worktime")
  };
