<form name="F2" method=post 
               ...
               target="_self"> 
<input type="hidden" name="staff_id" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['staff_id']); ?>">
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_staff_mob']['where_detal']))
  {
?>  
