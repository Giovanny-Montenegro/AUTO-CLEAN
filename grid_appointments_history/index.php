...
// 
    ...
    $out1_img_cache = $_SESSION['scriptcase']['grid_appointments_history']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['grid_appointments_history']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_appointments_history']['glo_nm_conexao'], $this->root . $this->path_prod, 'appointments1', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
   ...
   function controle($linhas = 0)
   {
      ...
      { 
          ...
          if (isset($var_appointment_id) && isset($NM_contr_var_session) && $NM_contr_var_session == "Yes") 
          {
              ...
              nm_limpa_str_grid_appointments_history($_SESSION["var_appointment_id"]);
          }
      } 
      if ($Parms_form_pdf)
      { 
      ...
      if (!$this->Ini || isset($_SESSION['sc_session'][$script_case_init]['grid_appointments_history']['embutida_ibase'])) 
      { 
          $this->Ini = new grid_appointments_history_ini(); 
          $this->Ini->init();
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['embutida'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['embutida_ibase'] = true;
      }
      ...
      $_SESSION['sc_session'][$script_case_init]['grid_appointments_history']['skip_charts'] = (strpos(" " . $this->Ini->SC_module_export, "chart") !== false) ? false : true;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['pdf_det'] = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['conf_chart_level'] = "S";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['proc_pdf'] = (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['embutida'] && ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['opcao'] == "pdf_res")) ? true : false;
...
//
      ...
      { 
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['where_orig'] = " where (appointments_id = " . $_SESSION['var_appointment_id'] . ")";
...
//----------------------------------->
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['opcao'] == "json")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_appointments_history/grid_appointments_history_json.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_appointments_history_json.class.php"); 
          } 
          $this->json  = new grid_appointments_history_json();
...
<?php
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['embutida'])
      {
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            elseif (is_dir($this->Ini->path_third . $dir_qpdf) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['use_pass_pdf']))
            {
            ...
            if ($this->pdf_zip == "S")
            {
                $pdf_pass = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['use_pass_pdf'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['use_pass_pdf'] : "";
            ...
            elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['use_pass_pdf']))
            {
                if (FALSE !== strpos(strtolower(php_uname()), 'windows')) 
                {
                    $dir_qpdf = "/qpdf/win/bin";
                ...
                if (is_dir($this->Ini->path_third . $dir_qpdf)) 
                {
                    ...
                    $pdf_pass  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_appointments_history']['use_pass_pdf'];
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['grid_appointments_history']['glo_nm_path_imag_temp'] . "/sc_apl_default_appointments1.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['grid_appointments_history']['glo_nm_path_imag_temp'] . "/sc_apl_default_appointments1.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_appointments1'])) {
               $_SESSION['scriptcase']['grid_appointments_history']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_appointments1'];
           }
       }
   }
   ...
   { 
       ...
       if (isset($var_appointment_id) && isset($NM_contr_var_session) && $NM_contr_var_session == "Yes") 
       {
           nm_limpa_str_grid_appointments_history($var_appointment_id);
           $_SESSION['var_appointment_id'] = $var_appointment_id;
       }
