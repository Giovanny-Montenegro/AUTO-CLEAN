<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_appointments_history']['glo_nm_path_imag_temp'] . "/sc_apl_default_appointments1.txt"))
       {
?>
...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["appointments_history_descr"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_appointments_history']['labels']["appointments_history_descr"])) ? $_SESSION['sc_session'][$sc_init]['grid_appointments_history']['labels']["appointments_history_descr"] : "" . $this->Nm_lang['lang_appointments_history_fld_appointments_history_descr'] . "";
