...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['home']['glo_nm_conexao'], $this->root . $this->path_prod, 'appointments1', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
   ...
   function controle()
   {
      ...
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['home']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['home']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['home']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['home']['label'] = "" . $this->Ini->Nm_lang['lang_appointments_report'] . "";
...
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('calendar_appointments_staff') . "/", $this->nm_location, "glo_staff_id?#?" . NM_encode_input($this->sc_temp_glo_staff_id) . "?@?","_self", 440, 630, "ret_self");
 ...
 if (!isset($this->Campos_Mens_erro) || empty($this->Campos_Mens_erro))
 {
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('grid_appointments_customer') . "/", $this->nm_location, "glo_customer_id?#?" . NM_encode_input($this->sc_temp_glo_customer_id) . "?@?","_self", 440, 630, "ret_self");
 };
	break;
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['home']['glo_nm_path_imag_temp'] . "/sc_apl_default_appointments1.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['home']['glo_nm_path_imag_temp'] . "/sc_apl_default_appointments1.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "home") {
           ...
           if (isset($_COOKIE['sc_actual_lang_appointments1'])) {
               $_SESSION['scriptcase']['home']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_appointments1'];
           }
       }
   }
   ...
   {
       nm_limpa_str_home($usr_group);
       $_SESSION['usr_group'] = $usr_group;
   }
   if (isset($glo_staff_id) && isset($NM_contr_var_session) && $NM_contr_var_session == "Yes") 
   {
       nm_limpa_str_home($glo_staff_id);
       $_SESSION['glo_staff_id'] = $glo_staff_id;
   }
   if (isset($glo_customer_id) && isset($NM_contr_var_session) && $NM_contr_var_session == "Yes") 
   {
       nm_limpa_str_home($glo_customer_id);
   ...
   if (isset($_POST["glo_customer_id"])) 
   {
       ...
       nm_limpa_str_home($_SESSION["glo_customer_id"]);
   }
