...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_old_pswd_label" id="hidden_field_label_old_pswd" style="<?php echo $sStyleHidden_old_pswd; ?>"><span id="id_label_old_pswd"><?php echo $this->nm_new_label['old_pswd']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_change_pswd']['php_cmp_required']['old_pswd']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_change_pswd']['php_cmp_required']['old_pswd'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
