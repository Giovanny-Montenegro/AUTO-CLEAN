   ...
   function ini_controle()
   {
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_form_edit_users_mob']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_form_edit_users_mob']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - " . $this->Ini->Nm_lang['lang_list_users'] . "";
      ...
      $this->nm_new_label['is_active'] = '' . $this->Ini->Nm_lang['lang_sec_users_fld_active'] . '';
   ...
   function Recupera_Nome_Campo($campo) 
   {
       switch($campo)
       {
           ...
           case 'groups':
               ...
               break;
           case 'is_active':
               return "" . $this->Ini->Nm_lang['lang_sec_users_fld_active'] . "";
               break;
...
$_SESSION['scriptcase']['app_form_edit_users_mob']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "incluir") 
      {
          ...
          if ($this->is_active == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->is_active = "null"; 
              $NM_val_null[] = "is_active";
          } 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "name = '$this->name', email = '$this->email', is_active = '$this->is_active'"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
             ...
             { 
              ...
              $this->nmgp_refresh_fields = array_diff(array('login', 'pswd', 'confirm_pswd', 'name', 'email', 'groups', 'is_active'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (login, pswd, name, email, is_active, activation_code, priv_admin) VALUES ('$this->login', '$this->pswd', '$this->name', '$this->email', '$this->is_active', '$this->activation_code', '$this->priv_admin')"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
...
$mail_smtp_user   = 'gnahinmsandoval@gmail.com';                   
$mail_smtp_pass   = 'uvkdwjknrbffopzl';			
$mail_from        = 'Auto Clean<gnahinmsandoval@gmail.com>';          
    ...
    function getButtonIds($buttonName) {
        switch ($buttonName) {
            case "help":
                ...
                break;
            case "exit":
                return array("sc_b_sai_t.sc-unique-btn-1", "sc_b_sai_t.sc-unique-btn-3", "sc_b_sai_t.sc-unique-btn-8", "sc_b_sai_t.sc-unique-btn-10", "sc_b_sai_t.sc-unique-btn-2", "sc_b_sai_t.sc-unique-btn-9");
                break;
            case "new":
