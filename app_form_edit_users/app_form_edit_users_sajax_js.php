...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_app_form_edit_users_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_app_form_edit_users_submit_form(var_login, var_pswd, var_confirm_pswd, var_name, var_email, var_groups, var_is_active, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_form_edit_users_submit_form_cb);
...
?>
  ...
  ajax_field_list[5] = "groups";
  ajax_field_list[6] = "is_active";
  ...
  var ajax_error_list = {
    ...
    "is_active": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_users_fld_active'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
