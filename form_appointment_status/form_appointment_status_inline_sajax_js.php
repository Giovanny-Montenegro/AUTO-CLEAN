...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_appointment_status_inline_submit_form()
  {
    ...
    scAjaxHideMessage();
    var var_appointment_status_id_ = scAjaxGetFieldHidden("appointment_status_id_");
    ...
    scAjaxProcOn();
    x_ajax_form_appointment_status_inline_submit_form(var_appointment_status_id_, var_appointment_status_descr_, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_appointment_status_inline_submit_form_cb);
...
?>
  ...
  ajax_field_list[0] = "appointment_status_id_";
  ajax_field_list[1] = "appointment_status_descr_";
  ...
  var ajax_field_id = {
    "appointment_status_id_": new Array("hidden_field_label_appointment_status_id_", "hidden_field_data_appointment_status_id_"),
