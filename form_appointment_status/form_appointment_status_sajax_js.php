...
?>
    x_ajax_form_appointment_status_submit_form(var_appointment_status_id_, var_appointment_status_descr_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_appointment_status_submit_form_cb);
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    ajax_field_id["appointment_status_id_" + iNumLinha] = new Array("hidden_field_label_appointment_status_id_", "hidden_field_data_appointment_status_id_" + iNumLinha);
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["appointment_status_id_" + iRow] || "on" == ajax_error_count["appointment_status_descr_" + iRow]))
    {
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["appointment_status_id_" + iRow] && "off" == ajax_error_count["appointment_status_descr_" + iRow]))
    {
      if (bErrorRow)
      {
