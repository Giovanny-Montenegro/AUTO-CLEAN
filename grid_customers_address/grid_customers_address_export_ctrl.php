<?php
@session_start() ;
$_SESSION['scriptcase']['grid_customers_address']['sc_process_barr'] = true;
require_once('../grid_customers_address/index.php');
unset($_SESSION['scriptcase']['grid_customers_address']['sc_process_barr']);
$ExportCtrl = new grid_customers_address_export_control;
$ExportCtrl->Export_barr();

class grid_customers_address_export_control
{
