<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_customers_address']['glo_nm_path_imag_temp'] . "/sc_apl_default_appointments1.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_customers_address_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_customers_address_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_customers_address']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_customers_address']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['customers_name'] = "on";
   $tab_def_campos['customers_name'] = "customers_name";
   $tab_labels["customers_name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customers_address']['labels']["customers_name"])) ? $_SESSION['sc_session'][$sc_init]['grid_customers_address']['labels']["customers_name"] : "" . $this->Nm_lang['lang_customers_fld_customers_name'] . "";
   $tab_ger_campos['customers_phone'] = "on";
   $tab_def_campos['customers_phone'] = "customers_phone";
   $tab_labels["customers_phone"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customers_address']['labels']["customers_phone"])) ? $_SESSION['sc_session'][$sc_init]['grid_customers_address']['labels']["customers_phone"] : "" . $this->Nm_lang['lang_customers_fld_customers_phone'] . "";
   $tab_ger_campos['customers_email'] = "on";
   $tab_def_campos['customers_email'] = "customers_email";
   $tab_labels["customers_email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customers_address']['labels']["customers_email"])) ? $_SESSION['sc_session'][$sc_init]['grid_customers_address']['labels']["customers_email"] : "" . $this->Nm_lang['lang_customers_fld_customers_email'] . "";
   $tab_ger_campos['customers_country'] = "on";
   $tab_def_campos['customers_country'] = "customers_country";
   $tab_labels["customers_country"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customers_address']['labels']["customers_country"])) ? $_SESSION['sc_session'][$sc_init]['grid_customers_address']['labels']["customers_country"] : "" . $this->Nm_lang['lang_customers_fld_customers_country'] . "";
   $tab_ger_campos['customers_address'] = "on";
   $tab_def_campos['customers_address'] = "customers_address";
   $tab_labels["customers_address"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customers_address']['labels']["customers_address"])) ? $_SESSION['sc_session'][$sc_init]['grid_customers_address']['labels']["customers_address"] : "" . $this->Nm_lang['lang_customers_fld_customers_address'] . "";
   $tab_ger_campos['customers_state'] = "on";
   $tab_def_campos['customers_state'] = "customers_state";
   $tab_labels["customers_state"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customers_address']['labels']["customers_state"])) ? $_SESSION['sc_session'][$sc_init]['grid_customers_address']['labels']["customers_state"] : "" . $this->Nm_lang['lang_customers_fld_customers_state'] . "";
   $tab_ger_campos['customers_city'] = "on";
   $tab_def_campos['customers_city'] = "customers_city";
   $tab_labels["customers_city"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customers_address']['labels']["customers_city"])) ? $_SESSION['sc_session'][$sc_init]['grid_customers_address']['labels']["customers_city"] : "" . $this->Nm_lang['lang_customers_fld_customers_city'] . "";
   $tab_ger_campos['customers_zip'] = "on";
   $tab_def_campos['customers_zip'] = "customers_zip";
   $tab_labels["customers_zip"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customers_address']['labels']["customers_zip"])) ? $_SESSION['sc_session'][$sc_init]['grid_customers_address']['labels']["customers_zip"] : "" . $this->Nm_lang['lang_customers_fld_customers_zip'] . "";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_customers_address']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_customers_address']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_customers_address']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_customers_address']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_customers_address']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_customers_address']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_customers_address']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_customers_address']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_customers_address']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_customers_address']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_customers_address']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_customers_address']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_customers_address']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_customers_address']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_customers_address']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_customer_info'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_customers_address_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_customers_address']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_customers_address']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_customers_address']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_customers_address']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_customers_address']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
