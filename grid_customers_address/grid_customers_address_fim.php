...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["appointments1_____grid_customers_address"]))
   {
      unset($_SESSION['session_sec_aplicacao']["appointments1_____grid_customers_address"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_customers_address']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_customers_address']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_customers_address']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_customers_address']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_customers_address']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_customers_address</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_customers_address']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_customers_address']['embutida_filho'] as $ind => $sc_init)
          {
