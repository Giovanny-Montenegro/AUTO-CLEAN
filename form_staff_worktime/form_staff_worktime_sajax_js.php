  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_staff_worktime" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_staff_worktime_form();
	}
...
?>
  ...
  // ---------- Validate week_day_
  function do_ajax_form_staff_worktime_validate_week_day_(iNumLinha)
  {
    var nomeCampo_week_day_ = "week_day_" + iNumLinha;
    var var_week_day_ = scAjaxGetFieldSelect(nomeCampo_week_day_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_staff_worktime_validate_week_day_(var_week_day_, iNumLinha, var_script_case_init, do_ajax_form_staff_worktime_validate_week_day__cb);
  } // do_ajax_form_staff_worktime_validate_week_day_

  function do_ajax_form_staff_worktime_validate_week_day__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "week_day_" + iLineNumber;
    }
    else
    {
      sFieldValid = "week_day_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "week_day_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "week_day_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_staff_worktime_validate_week_day__cb

  // ---------- Validate start_time_
  function do_ajax_form_staff_worktime_validate_start_time_(iNumLinha)
  {
    var nomeCampo_start_time_ = "start_time_" + iNumLinha;
    var var_start_time_ = scAjaxGetFieldText(nomeCampo_start_time_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_staff_worktime_validate_start_time_(var_start_time_, iNumLinha, var_script_case_init, do_ajax_form_staff_worktime_validate_start_time__cb);
  } // do_ajax_form_staff_worktime_validate_start_time_

  function do_ajax_form_staff_worktime_validate_start_time__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "start_time_" + iLineNumber;
    }
    else
    {
      sFieldValid = "start_time_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "start_time_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "start_time_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_staff_worktime_validate_start_time__cb

  // ---------- Validate end_time_
  function do_ajax_form_staff_worktime_validate_end_time_(iNumLinha)
  {
    var nomeCampo_end_time_ = "end_time_" + iNumLinha;
    var var_end_time_ = scAjaxGetFieldText(nomeCampo_end_time_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_staff_worktime_validate_end_time_(var_end_time_, iNumLinha, var_script_case_init, do_ajax_form_staff_worktime_validate_end_time__cb);
  } // do_ajax_form_staff_worktime_validate_end_time_

  function do_ajax_form_staff_worktime_validate_end_time__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "end_time_" + iLineNumber;
    }
    else
    {
      sFieldValid = "end_time_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "end_time_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "end_time_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_staff_worktime_validate_end_time__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_staff_worktime_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_staff_worktime_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_staff_worktime_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_staff_worktime_add_new_line_cb);
  } // do_ajax_form_staff_worktime_add_new_line

  function do_ajax_form_staff_worktime_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_staff_worktime_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_staff_worktime_backup_line(iNumLinha)
  {
    var var_staff_worktime_id_ = scAjaxGetFieldText("staff_worktime_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_staff_worktime_backup_line(var_staff_worktime_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_staff_worktime_backup_line_cb);
  } // do_ajax_form_staff_worktime_backup_line

  function do_ajax_form_staff_worktime_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_staff_worktime_backup_line_cb

  function do_ajax_form_staff_worktime_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_staff_worktime_cancel_insert

  function do_ajax_form_staff_worktime_cancel_update(iSeqVert)
  {
    do_ajax_form_staff_worktime_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_staff_worktime_cancel_update

  function do_ajax_form_staff_worktime_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_staff_worktime_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_staff_worktime_table_refresh()
  {
    var var_staff_worktime_id_ = document.F2.staff_worktime_id_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_staff_worktime_table_refresh(var_staff_worktime_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_staff_worktime_table_refresh_cb);
  } //  do_ajax_form_staff_worktime_table_refresh

  function do_ajax_form_staff_worktime_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.staff_worktime_id_.value = scAjaxGetKeyValue("staff_worktime_id_");
    ...
    scAjaxAlert(do_ajax_form_staff_worktime_table_refresh_cb_after_alert);
  } // do_ajax_form_staff_worktime_table_refresh_cb
  function do_ajax_form_staff_worktime_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("b");
    sc_insert_open = false;
  } // do_ajax_form_staff_worktime_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_staff_worktime_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_staff_worktime_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_week_day_ = scAjaxGetFieldSelect("week_day_" + iNumLinha);
    var var_start_time_ = scAjaxGetFieldText("start_time_" + iNumLinha);
    var var_end_time_ = scAjaxGetFieldText("end_time_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_staff_worktime_submit_form(var_week_day_, var_start_time_, var_end_time_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_staff_worktime_submit_form_cb);
  } // do_ajax_form_staff_worktime_submit_form

  function do_ajax_form_staff_worktime_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("week_day_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("start_time_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("end_time_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_staff_worktime_submit_form_cb_after_alert);
  } // do_ajax_form_staff_worktime_submit_form_cb
  function do_ajax_form_staff_worktime_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_staff_worktime_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_staff_worktime_navigate_form()
  {
    perform_ajax_form_staff_worktime_navigate_form();
  }

  function perform_ajax_form_staff_worktime_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    {
      scAjaxHideErrorDisplay("week_day_" + iNavForm);
      scAjaxHideErrorDisplay("start_time_" + iNavForm);
      scAjaxHideErrorDisplay("end_time_" + iNavForm);
    }
    var var_staff_worktime_id_ = document.F2.staff_worktime_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_staff_worktime_navigate_form(var_staff_worktime_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_staff_worktime_navigate_form_cb);
  } // do_ajax_form_staff_worktime_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_staff_worktime']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_staff_worktime_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.staff_worktime_id_.value = scAjaxGetKeyValue("staff_worktime_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_staff_worktime_navigate_form_cb_after_alert);
  } // do_ajax_form_staff_worktime_navigate_form_cb
  function do_ajax_form_staff_worktime_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_staff_worktime_navigate_form_cb_after_alert

    function sc_form_staff_worktime_get_last_line_number()
    {
    ...
    } //sc_form_staff_worktime_get_last_line_number

  function sc_hide_form_staff_worktime_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "week_day_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "start_time_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "end_time_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["week_day_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_staff_worktime_fld_week_day'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["start_time_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_staff_worktime_fld_start_time'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["end_time_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_staff_worktime_fld_end_time'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["week_day_"][iNumLinha] = "week_day_" + iNumLinha;
    ajax_field_mult["start_time_"][iNumLinha] = "start_time_" + iNumLinha;
    ajax_field_mult["end_time_"][iNumLinha] = "end_time_" + iNumLinha;
    ajax_field_id["week_day_" + iNumLinha] = new Array("hidden_field_label_week_day_", "hidden_field_data_week_day_" + iNumLinha);
    ajax_field_id["start_time_" + iNumLinha] = new Array("hidden_field_label_start_time_", "hidden_field_data_start_time_" + iNumLinha);
    ajax_field_id["end_time_" + iNumLinha] = new Array("hidden_field_label_end_time_", "hidden_field_data_end_time_" + iNumLinha);
    ajax_error_count["week_day_" + iNumLinha] = "off";
    ajax_error_count["start_time_" + iNumLinha] = "off";
    ajax_error_count["end_time_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["week_day_" + iNumLinha] = "off";
    ajax_read_only["start_time_" + iNumLinha] = "off";
    ajax_read_only["end_time_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["week_day_" + iNumLinha] = "on";
    ajax_read_only["start_time_" + iNumLinha] = "on";
    ajax_read_only["end_time_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["week_day_" + iNumLinha] = null;
    ajax_error_list["start_time_" + iNumLinha] = null;
    ajax_error_list["end_time_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["week_day_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["week_day_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["week_day_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["week_day_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["week_day_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["start_time_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["start_time_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["start_time_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["start_time_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["start_time_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["end_time_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["end_time_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["end_time_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["end_time_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["end_time_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['week_day_'])) ? $this->nmgp_cmp_readonly['week_day_'] : 'off';
?>
    scAjaxFieldRead("week_day_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['start_time_'])) ? $this->nmgp_cmp_readonly['start_time_'] : 'off';
?>
    scAjaxFieldRead("start_time_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['end_time_'])) ? $this->nmgp_cmp_readonly['end_time_'] : 'off';
?>
    scAjaxFieldRead("end_time_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("week_day_" + iSeq, "on");
    scAjaxFieldRead("start_time_" + iSeq, "on");
    scAjaxFieldRead("end_time_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["week_day_" + iRow] || "on" == ajax_error_count["start_time_" + iRow] || "on" == ajax_error_count["end_time_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_week_day_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_start_time_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_end_time_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["week_day_" + iRow] && "off" == ajax_error_count["start_time_" + iRow] && "off" == ajax_error_count["end_time_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["week_day_" + iRow] = "off";
        ajax_error_count["start_time_" + iRow] = "off";
        ajax_error_count["end_time_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_week_day_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_start_time_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_end_time_" + iRow).removeClass("scFormErrorLine");
    }
  }
