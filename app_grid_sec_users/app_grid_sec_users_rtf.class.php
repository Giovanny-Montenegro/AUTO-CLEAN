...
function actionBar_getStateHide($buttonName)
{
   ...
   function NM_export_is_active()
   {
         ...
         $this->is_active = str_replace('<', '&lt;', $this->is_active);
         $this->is_active = str_replace('>', '&gt;', $this->is_active);
         $this->Texto_tag .= "<td>" . $this->is_active . "</td>\r\n";
   }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_list_users'] ?> :: RTF</TITLE>
