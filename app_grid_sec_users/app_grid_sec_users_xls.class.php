...
function actionBar_getStateHide($buttonName)
{
   ...
   { 
      ...
      { 
          ...
          $SC_Label = (isset($this->New_label['is_active'])) ? $this->New_label['is_active'] : ""; 
   ...
   function NM_export_is_active()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->is_active = html_entity_decode($this->is_active, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->is_active = strip_tags($this->is_active);
         $this->is_active = NM_charset_to_utf8($this->is_active);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->is_active, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->is_active, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- login
   ...
   function NM_sub_cons_is_active()
   {
         ...
         $this->is_active = strip_tags($this->is_active);
         $this->is_active = NM_charset_to_utf8($this->is_active);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->is_active;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_list_users'] ?> :: Excel</TITLE>
