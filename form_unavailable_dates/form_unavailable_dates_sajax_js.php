  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_unavailable_dates" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_unavailable_dates_form();
	}
...
?>
  ...
  function do_ajax_form_unavailable_dates_validate_unavailable_dates_id()
  {
    ...
    x_ajax_form_unavailable_dates_validate_unavailable_dates_id(var_unavailable_dates_id, var_script_case_init, do_ajax_form_unavailable_dates_validate_unavailable_dates_id_cb);
  } // do_ajax_form_unavailable_dates_validate_unavailable_dates_id

  function do_ajax_form_unavailable_dates_validate_unavailable_dates_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_unavailable_dates_validate_unavailable_dates_id_cb

  // ---------- Validate title
  function do_ajax_form_unavailable_dates_validate_title()
  {
    var nomeCampo_title = "title";
    var var_title = scAjaxGetFieldText(nomeCampo_title);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_unavailable_dates_validate_title(var_title, var_script_case_init, do_ajax_form_unavailable_dates_validate_title_cb);
  } // do_ajax_form_unavailable_dates_validate_title

  function do_ajax_form_unavailable_dates_validate_title_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "title";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_unavailable_dates_validate_title_cb

  // ---------- Validate start_date
  function do_ajax_form_unavailable_dates_validate_start_date()
  {
    var nomeCampo_start_date = "start_date";
    var var_start_date = scAjaxGetFieldText(nomeCampo_start_date);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_unavailable_dates_validate_start_date(var_start_date, var_script_case_init, do_ajax_form_unavailable_dates_validate_start_date_cb);
  } // do_ajax_form_unavailable_dates_validate_start_date

  function do_ajax_form_unavailable_dates_validate_start_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_unavailable_dates_validate_start_date_cb

  // ---------- Validate start_time
  function do_ajax_form_unavailable_dates_validate_start_time()
  {
    var nomeCampo_start_time = "start_time";
    var var_start_time = scAjaxGetFieldText(nomeCampo_start_time);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_unavailable_dates_validate_start_time(var_start_time, var_script_case_init, do_ajax_form_unavailable_dates_validate_start_time_cb);
  } // do_ajax_form_unavailable_dates_validate_start_time

  function do_ajax_form_unavailable_dates_validate_start_time_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_unavailable_dates_validate_start_time_cb

  // ---------- Validate end_date
  function do_ajax_form_unavailable_dates_validate_end_date()
  {
    var nomeCampo_end_date = "end_date";
    var var_end_date = scAjaxGetFieldText(nomeCampo_end_date);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_unavailable_dates_validate_end_date(var_end_date, var_script_case_init, do_ajax_form_unavailable_dates_validate_end_date_cb);
  } // do_ajax_form_unavailable_dates_validate_end_date

  function do_ajax_form_unavailable_dates_validate_end_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_unavailable_dates_validate_end_date_cb

  // ---------- Validate end_time
  function do_ajax_form_unavailable_dates_validate_end_time()
  {
    var nomeCampo_end_time = "end_time";
    var var_end_time = scAjaxGetFieldText(nomeCampo_end_time);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_unavailable_dates_validate_end_time(var_end_time, var_script_case_init, do_ajax_form_unavailable_dates_validate_end_time_cb);
  } // do_ajax_form_unavailable_dates_validate_end_time

  function do_ajax_form_unavailable_dates_validate_end_time_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_unavailable_dates_validate_end_time_cb

  // ---------- Validate yearly
  function do_ajax_form_unavailable_dates_validate_yearly()
  {
    var nomeCampo_yearly = "yearly";
    var var_yearly = scAjaxGetFieldCheckbox(nomeCampo_yearly, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_unavailable_dates_validate_yearly(var_yearly, var_script_case_init, do_ajax_form_unavailable_dates_validate_yearly_cb);
  } // do_ajax_form_unavailable_dates_validate_yearly

  function do_ajax_form_unavailable_dates_validate_yearly_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "yearly";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_unavailable_dates_validate_yearly_cb

  // ---------- Validate individual
  function do_ajax_form_unavailable_dates_validate_individual()
  {
    var nomeCampo_individual = "individual";
    var var_individual = scAjaxGetFieldCheckbox(nomeCampo_individual, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_unavailable_dates_validate_individual(var_individual, var_script_case_init, do_ajax_form_unavailable_dates_validate_individual_cb);
  } // do_ajax_form_unavailable_dates_validate_individual

  function do_ajax_form_unavailable_dates_validate_individual_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_unavailable_dates_validate_individual_cb

  // ---------- Validate staff
  function do_ajax_form_unavailable_dates_validate_staff()
  {
    var nomeCampo_staff = "staff";
    nm_pack(nomeCampo_staff + '_dest', nomeCampo_staff);
    var var_staff = scAjaxGetFieldText(nomeCampo_staff);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_unavailable_dates_validate_staff(var_staff, var_script_case_init, do_ajax_form_unavailable_dates_validate_staff_cb);
  } // do_ajax_form_unavailable_dates_validate_staff

  function do_ajax_form_unavailable_dates_validate_staff_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "staff";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_unavailable_dates_validate_staff_cb

  // ---------- Event onclick individual
  function do_ajax_form_unavailable_dates_event_individual_onclick()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_unavailable_dates_event_individual_onclick(var_individual, var_staff, var_script_case_init, do_ajax_form_unavailable_dates_event_individual_onclick_cb);
  } // do_ajax_form_unavailable_dates_event_individual_onclick

  function do_ajax_form_unavailable_dates_event_individual_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "individual";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_unavailable_dates_event_individual_onclick_cb_after_alert);
  } // do_ajax_form_unavailable_dates_event_individual_onclick_cb
  function do_ajax_form_unavailable_dates_event_individual_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_unavailable_dates_event_individual_onclick_cb_after_alert

  // ---------- Event onchange start_date
  function do_ajax_form_unavailable_dates_event_start_date_onchange()
  {
    var var_end_date = scAjaxGetFieldText("end_date");
    var var_start_date = scAjaxGetFieldText("start_date");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_unavailable_dates_event_start_date_onchange(var_end_date, var_start_date, var_script_case_init, do_ajax_form_unavailable_dates_event_start_date_onchange_cb);
  } // do_ajax_form_unavailable_dates_event_start_date_onchange

  function do_ajax_form_unavailable_dates_event_start_date_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "start_date";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_unavailable_dates_event_start_date_onchange_cb_after_alert);
  } // do_ajax_form_unavailable_dates_event_start_date_onchange_cb
  function do_ajax_form_unavailable_dates_event_start_date_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_unavailable_dates_event_start_date_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_unavailable_dates_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_unavailable_dates_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_unavailable_dates_submit_form(var_unavailable_dates_id, var_title, var_start_date, var_start_time, var_end_date, var_end_time, var_yearly, var_individual, var_staff, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_unavailable_dates_submit_form_cb);
  } // do_ajax_form_unavailable_dates_submit_form

  function do_ajax_form_unavailable_dates_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_unavailable_dates_submit_form_cb_after_alert);
  } // do_ajax_form_unavailable_dates_submit_form_cb
  function do_ajax_form_unavailable_dates_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_unavailable_dates_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_unavailable_dates_navigate_form()
  {
    perform_ajax_form_unavailable_dates_navigate_form();
  }

  function perform_ajax_form_unavailable_dates_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_unavailable_dates_navigate_form(var_unavailable_dates_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_unavailable_dates_navigate_form_cb);
  } // do_ajax_form_unavailable_dates_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_unavailable_dates']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_unavailable_dates_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_unavailable_dates_navigate_form_cb_after_alert);
  } // do_ajax_form_unavailable_dates_navigate_form_cb
  function do_ajax_form_unavailable_dates_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_unavailable_dates_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_unavailable_dates_navigate_form_cb_after_alert

  function sc_hide_form_unavailable_dates_form()
  {
