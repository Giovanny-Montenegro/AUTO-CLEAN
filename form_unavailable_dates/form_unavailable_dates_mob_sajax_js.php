  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_unavailable_dates_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_unavailable_dates_mob_form();
	}
...
?>
  ...
  // ---------- Validate unavailable_dates_id
  function do_ajax_form_unavailable_dates_mob_validate_unavailable_dates_id()
  {
    var nomeCampo_unavailable_dates_id = "unavailable_dates_id";
    var var_unavailable_dates_id = scAjaxGetFieldHidden(nomeCampo_unavailable_dates_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_unavailable_dates_mob_validate_unavailable_dates_id(var_unavailable_dates_id, var_script_case_init, do_ajax_form_unavailable_dates_mob_validate_unavailable_dates_id_cb);
  } // do_ajax_form_unavailable_dates_mob_validate_unavailable_dates_id

  function do_ajax_form_unavailable_dates_mob_validate_unavailable_dates_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "unavailable_dates_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_unavailable_dates_mob_validate_unavailable_dates_id_cb

  // ---------- Validate title
  function do_ajax_form_unavailable_dates_mob_validate_title()
  {
    var nomeCampo_title = "title";
    var var_title = scAjaxGetFieldText(nomeCampo_title);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_unavailable_dates_mob_validate_title(var_title, var_script_case_init, do_ajax_form_unavailable_dates_mob_validate_title_cb);
  } // do_ajax_form_unavailable_dates_mob_validate_title

  function do_ajax_form_unavailable_dates_mob_validate_title_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "title";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_unavailable_dates_mob_validate_title_cb

  // ---------- Validate start_date
  function do_ajax_form_unavailable_dates_mob_validate_start_date()
  {
    var nomeCampo_start_date = "start_date";
    var var_start_date = scAjaxGetFieldText(nomeCampo_start_date);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_unavailable_dates_mob_validate_start_date(var_start_date, var_script_case_init, do_ajax_form_unavailable_dates_mob_validate_start_date_cb);
  } // do_ajax_form_unavailable_dates_mob_validate_start_date

  function do_ajax_form_unavailable_dates_mob_validate_start_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_unavailable_dates_mob_validate_start_date_cb

  // ---------- Validate start_time
  function do_ajax_form_unavailable_dates_mob_validate_start_time()
  {
    var nomeCampo_start_time = "start_time";
    var var_start_time = scAjaxGetFieldText(nomeCampo_start_time);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_unavailable_dates_mob_validate_start_time(var_start_time, var_script_case_init, do_ajax_form_unavailable_dates_mob_validate_start_time_cb);
  } // do_ajax_form_unavailable_dates_mob_validate_start_time

  function do_ajax_form_unavailable_dates_mob_validate_start_time_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_unavailable_dates_mob_validate_start_time_cb

  // ---------- Validate end_date
  function do_ajax_form_unavailable_dates_mob_validate_end_date()
  {
    var nomeCampo_end_date = "end_date";
    var var_end_date = scAjaxGetFieldText(nomeCampo_end_date);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_unavailable_dates_mob_validate_end_date(var_end_date, var_script_case_init, do_ajax_form_unavailable_dates_mob_validate_end_date_cb);
  } // do_ajax_form_unavailable_dates_mob_validate_end_date

  function do_ajax_form_unavailable_dates_mob_validate_end_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_unavailable_dates_mob_validate_end_date_cb

  // ---------- Validate end_time
  function do_ajax_form_unavailable_dates_mob_validate_end_time()
  {
    var nomeCampo_end_time = "end_time";
    var var_end_time = scAjaxGetFieldText(nomeCampo_end_time);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_unavailable_dates_mob_validate_end_time(var_end_time, var_script_case_init, do_ajax_form_unavailable_dates_mob_validate_end_time_cb);
  } // do_ajax_form_unavailable_dates_mob_validate_end_time

  function do_ajax_form_unavailable_dates_mob_validate_end_time_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_unavailable_dates_mob_validate_end_time_cb

  // ---------- Validate yearly
  function do_ajax_form_unavailable_dates_mob_validate_yearly()
  {
    var nomeCampo_yearly = "yearly";
    var var_yearly = scAjaxGetFieldCheckbox(nomeCampo_yearly, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_unavailable_dates_mob_validate_yearly(var_yearly, var_script_case_init, do_ajax_form_unavailable_dates_mob_validate_yearly_cb);
  } // do_ajax_form_unavailable_dates_mob_validate_yearly

  function do_ajax_form_unavailable_dates_mob_validate_yearly_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "yearly";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_unavailable_dates_mob_validate_yearly_cb

  // ---------- Validate individual
  function do_ajax_form_unavailable_dates_mob_validate_individual()
  {
    var nomeCampo_individual = "individual";
    var var_individual = scAjaxGetFieldCheckbox(nomeCampo_individual, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_unavailable_dates_mob_validate_individual(var_individual, var_script_case_init, do_ajax_form_unavailable_dates_mob_validate_individual_cb);
  } // do_ajax_form_unavailable_dates_mob_validate_individual

  function do_ajax_form_unavailable_dates_mob_validate_individual_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "individual";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_unavailable_dates_mob_validate_individual_cb

  // ---------- Validate staff
  function do_ajax_form_unavailable_dates_mob_validate_staff()
  {
    var nomeCampo_staff = "staff";
    nm_pack(nomeCampo_staff + '_dest', nomeCampo_staff);
    var var_staff = scAjaxGetFieldText(nomeCampo_staff);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_unavailable_dates_mob_validate_staff(var_staff, var_script_case_init, do_ajax_form_unavailable_dates_mob_validate_staff_cb);
  } // do_ajax_form_unavailable_dates_mob_validate_staff

  function do_ajax_form_unavailable_dates_mob_validate_staff_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "staff";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_unavailable_dates_mob_validate_staff_cb

  // ---------- Event onclick individual
  function do_ajax_form_unavailable_dates_mob_event_individual_onclick()
  {
    var var_individual = scAjaxGetFieldCheckbox("individual", ";");
    nm_pack('staff_dest', 'staff');
    var var_staff = scAjaxGetFieldText("staff", "@?@");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_unavailable_dates_mob_event_individual_onclick(var_individual, var_staff, var_script_case_init, do_ajax_form_unavailable_dates_mob_event_individual_onclick_cb);
  } // do_ajax_form_unavailable_dates_mob_event_individual_onclick

  function do_ajax_form_unavailable_dates_mob_event_individual_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "individual";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_unavailable_dates_mob_event_individual_onclick_cb_after_alert);
  } // do_ajax_form_unavailable_dates_mob_event_individual_onclick_cb
  function do_ajax_form_unavailable_dates_mob_event_individual_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_unavailable_dates_mob_event_individual_onclick_cb_after_alert

  // ---------- Event onchange start_date
  function do_ajax_form_unavailable_dates_mob_event_start_date_onchange()
  {
    var var_end_date = scAjaxGetFieldText("end_date");
    var var_start_date = scAjaxGetFieldText("start_date");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_unavailable_dates_mob_event_start_date_onchange(var_end_date, var_start_date, var_script_case_init, do_ajax_form_unavailable_dates_mob_event_start_date_onchange_cb);
  } // do_ajax_form_unavailable_dates_mob_event_start_date_onchange

  function do_ajax_form_unavailable_dates_mob_event_start_date_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "start_date";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_unavailable_dates_mob_event_start_date_onchange_cb_after_alert);
  } // do_ajax_form_unavailable_dates_mob_event_start_date_onchange_cb
  function do_ajax_form_unavailable_dates_mob_event_start_date_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_unavailable_dates_mob_event_start_date_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_unavailable_dates_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_unavailable_dates_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_unavailable_dates_id = scAjaxGetFieldHidden("unavailable_dates_id");
    ...
    var var_yearly = scAjaxGetFieldCheckbox("yearly", ";");
    var var_individual = scAjaxGetFieldCheckbox("individual", ";");
    nm_pack("staff_dest", "staff");
    var var_staff = scAjaxGetFieldText("staff", "@?@");
    ...
    scAjaxProcOn();
    x_ajax_form_unavailable_dates_mob_submit_form(var_unavailable_dates_id, var_title, var_start_date, var_start_time, var_end_date, var_end_time, var_yearly, var_individual, var_staff, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_unavailable_dates_mob_submit_form_cb);
  } // do_ajax_form_unavailable_dates_mob_submit_form

  function do_ajax_form_unavailable_dates_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("unavailable_dates_id");
      ...
      scAjaxHideErrorDisplay("yearly");
      scAjaxHideErrorDisplay("individual");
      scAjaxHideErrorDisplay("staff");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_unavailable_dates_mob_submit_form_cb_after_alert);
  } // do_ajax_form_unavailable_dates_mob_submit_form_cb
  function do_ajax_form_unavailable_dates_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_unavailable_dates_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_unavailable_dates_mob_navigate_form()
  {
    perform_ajax_form_unavailable_dates_mob_navigate_form();
  }

  function perform_ajax_form_unavailable_dates_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("individual");
    scAjaxHideErrorDisplay("staff");
    var var_unavailable_dates_id = document.F2.unavailable_dates_id.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_unavailable_dates_mob_navigate_form(var_unavailable_dates_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_unavailable_dates_mob_navigate_form_cb);
  } // do_ajax_form_unavailable_dates_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_unavailable_dates_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_unavailable_dates_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.unavailable_dates_id.value = scAjaxGetKeyValue("unavailable_dates_id");
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_unavailable_dates_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_unavailable_dates_mob_navigate_form_cb
  function do_ajax_form_unavailable_dates_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_unavailable_dates_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_unavailable_dates_mob_navigate_form_cb_after_alert

  function sc_hide_form_unavailable_dates_mob_form()
  {
  ...
  ajax_field_list[0] = "unavailable_dates_id";
  ajax_field_list[1] = "title";
  ajax_field_list[2] = "start_date";
  ajax_field_list[3] = "start_time";
  ajax_field_list[4] = "end_date";
  ajax_field_list[5] = "end_time";
  ajax_field_list[6] = "yearly";
  ajax_field_list[7] = "individual";
  ajax_field_list[8] = "staff";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "unavailable_dates_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_unavailable_dates_fld_unavailable_dates_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "title": {"label": "<?php echo $this->Ini->Nm_lang['lang_unavailable_dates_fld_title'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "start_date": {"label": "<?php echo $this->Ini->Nm_lang['lang_unavailable_dates_fld_start_date'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "start_time": {"label": "<?php echo $this->Ini->Nm_lang['lang_unavailable_dates_fld_start_time'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "end_date": {"label": "<?php echo $this->Ini->Nm_lang['lang_unavailable_dates_fld_end_date'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "end_time": {"label": "<?php echo $this->Ini->Nm_lang['lang_unavailable_dates_fld_end_time'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "yearly": {"label": "<?php echo $this->Ini->Nm_lang['lang_unavailable_dates_fld_yearly'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "individual": {"label": "<?php echo $this->Ini->Nm_lang['lang_unavailable_dates_fld_individual'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "staff": {"label": "<?php echo $this->Ini->Nm_lang['lang_tbl_staff'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "unavailable_dates_id": new Array(),
    "title": new Array(),
    ...
    "end_time": new Array(),
    "yearly": new Array(),
    "individual": new Array(),
    "staff": new Array()
  };
  ajax_field_mult["unavailable_dates_id"][1] = "unavailable_dates_id";
  ...
  ajax_field_mult["yearly"][1] = "yearly";
  ajax_field_mult["individual"][1] = "individual";
  ajax_field_mult["staff"][1] = "staff";

  var ajax_field_id = {
    "unavailable_dates_id": new Array("hidden_field_label_unavailable_dates_id", "hidden_field_data_unavailable_dates_id"),
    ...
    "yearly": new Array("hidden_field_label_yearly", "hidden_field_data_yearly"),
    "individual": new Array("hidden_field_label_individual", "hidden_field_data_individual"),
    "staff": new Array("hidden_field_label_staff", "hidden_field_data_staff")
  };

  var ajax_read_only = {
    "unavailable_dates_id": "on",
    "title": "off",
    "start_date": "off",
    "start_time": "off",
    "end_date": "off",
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("unavailable_dates_id" == sIndex)
    {
